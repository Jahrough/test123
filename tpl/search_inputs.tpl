...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tr>
  <TMPL_IF NAME="IRS">
    <TMPL_INCLUDE NAME="irs/irs_search_inputs_tabs.tpl">
  <TMPL_ELSE>
    <TMPL_IF NAME="HEA">
      <TMPL_INCLUDE NAME="hea/hea_search_inputs_tabs.tpl">
    <TMPL_ELSE>
      <TMPL_IF NAME="INS">
	<TMPL_INCLUDE NAME="ins/ins_search_inputs_tabs.tpl">
      <TMPL_ELSE>
        <TMPL_IF NAME="LEG">
	  <TMPL_INCLUDE NAME="leg/leg_search_inputs_tabs.tpl">
        <TMPL_ELSE>
        <TMPL_IF NAME="GOV">
	  <TMPL_INCLUDE NAME="gov/gov_search_inputs_tabs.tpl">
        <TMPL_ELSE>
	      <TMPL_INCLUDE NAME="search_inputs_tabs.tpl">
	 </TMPL_IF>
	 </TMPL_IF>
      </TMPL_IF>
    </TMPL_IF>
...
<table id="search_inputs" border="0" cellpadding="0" cellspacing="0" width="100%">
  <tr>
	...
	<table border="0" cellpadding="2" cellspacing="0">
      ...
      <tr>
        <td align="center"><TMPL_INCLUDE NAME="search_buttons.tpl"></td>
      </tr>
      <tr height="5">
        <td height="5" class="unifont1"></td>
      </tr>
...
<TMPL_UNLESS SSN_ONLY_SEARCH>
      <tr height="5">
        <td class="unifont1" align="center">
          <TMPL_INCLUDE NAME="advanced_insert.tpl">
	</td>
      </tr>
</TMPL_UNLESS>
</TMPL_IF>
