<!-- begin: manage_account_username_password_req.tpl -->
	<table border="0" cellpadding="1" cellspacing="0" width="70%" class="myaccountborder" style="margin: 0 auto">
	  <tr>
		...
		<img border="0" width="11" height="10" src="<TMPL_VAR NAME=IMGPATH>/star.gif" alt="">&nbsp;<strong>Login ID Requirements:</strong>
		<ol style="margin-top: 2px; margin-bottom: 2px;">
		  <li>Must be at least 6 characters long.</li>
		</ol>
		<img border="0" width="11" height="10" src="<TMPL_VAR NAME=IMGPATH>/star.gif" alt="">&nbsp;<strong>Password Requirements:</strong>
		<ol style="margin-top: 2px; margin-bottom: 2px;">
...
<!-- end: manage_account_username_password_req.tpl -->
