...
<TMPL_IF ENABLE_MYACC_V3>
<body>
<form name="EMAIL_ERROR_SCREEN" action="<TMPL_VAR NAME=ACTION>" method="post">
<input type="hidden" name="EVENT" value="MYACCOUNT/SHOW_EMAIL_EXIT">
<div class="topBarCon">
      ...
      <table cellpadding="0" cellspacing="0" class="myaccountbody">
        <tr>
          <td align="center" class="myaccounttitle" height="20" valign="middle">
            <span class="w80pc error"><TMPL_VAR NAME="ERROR_MESSAGE">&nbsp;</span><br/>
          </td>
        </tr>
      </table>
    ...
    <tr>
      <td align="center" valign="top">
        <table border="0" cellpadding="0" cellspacing="0" width="856">
          <tr>
            <td align="center" class="myaccounttitle" height="20" valign="middle">
              <span class="error"><TMPL_VAR NAME="ERROR_MESSAGE">&nbsp;</span><br/>
            </td>
          </tr>
        </table>
      </td>
