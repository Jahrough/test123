...
<table border="0" cellpadding="0" cellspacing="0" width="100%" background="<TMPL_VAR NAME=IMGPATH>/<TMPL_VAR NAME=APPLICATION_TYPE>/main/mainmenu_slice.gif">
  <tr>
    <td width="191" rowspan="2"><img alt="" src="<TMPL_VAR NAME=IMGPATH>/<TMPL_VAR NAME=APPLICATION_TYPE>/main/mainmenu_logo.gif" width="191" height="70" border="0"></td>
    <td width="300"><img alt="" src="<TMPL_VAR NAME=IMGPATH>/<TMPL_VAR NAME=APPLICATION_TYPE>/main/mainmenu_topart.jpg" width="300" height="43" border="0"></td>
  ...
  <tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%">
      <tr>
        <td width="94"><a href="#" onClick="show_post_popup('LOGIN/SHOW_POPUP','HTMLCoverage','680','480',1,1,1,1,1,0,'','main_coverage');"><img src="<TMPL_VAR NAME=IMGPATH>/main/main_coverage.gif" width="94" height="27" border="0"></a></td>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%" background="<TMPL_VAR NAME=IMGPATH>/main/navbar_spcr.gif">
          <tr>
            <td><img alt="" src="<TMPL_VAR NAME=IMGPATH>/spacer.gif" width="1" height="27" border="0"></td>
          </tr>
        </table>
        </td>
        ...
        <td width="56"><a href="javascript:show_post_popup('LOGIN/SHOW_POPUP','HTMLHelp','680','505',1,1,1,1,1,0,'','main_help');"><img src="<TMPL_VAR NAME=IMGPATH>/main/main_help.gif" width="56" height="27" border="0"></a></td>
...
<table height="600" border="0" cellpadding="5" cellspacing="0" width="764">
  <tr>
    <!-- People and DA -->  
  <td align="center" valign="top" width="124" height="290" style="height: 100%">
    <table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
      ...
      <tr>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="119" height="100%">
          <tr>
            <td colspan="3" width="100%"><img alt="" src="<TMPL_VAR NAME=IMGPATH>/main/peop_top_hdr.gif" width="119" height="40" border="0"></td>
          </tr>
          <tr>
            <td class="people" width="1"><img alt="" src="<TMPL_VAR NAME=IMGPATH>/main/pix_spcr.gif" width="1" height="1" border="0"></td>
            <td bgcolor="white" width="117" height="100%" valign="top" align="center">
            <table border="0" cellpadding="0" cellspacing="0" width="117" height="335">
              <tr>
             ...
             <TMPL_UNLESS DONT_SHOW_NEWS> 
                  ...
                  <tr>
                    <td width="4" valign="top" align="right" class="smallfont1">&#149;</td>
                    <td valign="top" align="left" class="smallfont1grey"><TMPL_UNLESS DISABLE_BATCH><a class="mainmenu" href="javascript:show_post_popup('PHONEBATCH/START_BATCH','BatchWin',800,650,0,0,0,1,0,0,'<TMPL_VAR NAME=ACTION_BATCH>');">Phone Batching</a><TMPL_ELSE>Phone Batching</TMPL_UNLESS></td>
                  </tr>
<TMPL_IF IS_BATCH_ADMIN>
                  <tr>
                    <td width="4" valign="top" align="right" class="smallfont1">&#149;</td>
                  ...
                  <tr>
                    <td width="4" valign="top" align="right" class="smallfont1">&#149;</td>
                    <td valign="top" align="left" class="smallfont1grey"><TMPL_UNLESS DISABLE_BATCH><a class="mainmenu" href="javascript:show_post_popup('PHONESPLUSBATCH/START_BATCH','BatchWin',800,650,0,0,0,1,1,0,'<TMPL_VAR NAME=ACTION_BATCH>');">Phones Plus Batching</a><TMPL_ELSE>Phone Plus Batching</TMPL_UNLESS></td>
                  </tr>
                  <tr>
                    <td width="4" valign="top" align="right" class="smallfont1">&#149;</td>
                  ...
                  <tr>
                    <td valign="top" align="right" class="smallfont1">&#149;</td>
          ...
          <tr>
            <td colspan="3"><img alt="" src="<TMPL_VAR NAME=IMGPATH>/main/peop_bottm_hdr.gif" width="119" height="14" border="0"></td>
          </tr>
        </table>
        </td>
      </tr>
      ...
      <!-- DA -->
      <tr>
        <td valign="bottom" align="center" height="135" style="height: 40%">
        <table border="0" cellpadding="0" cellspacing="0" width="119">
          <tr>
            <td colspan="3" width="100%"><img alt="" src="<TMPL_VAR NAME=IMGPATH>/main/dirass_top_hdr.gif" width="119" height="40" border="0"></td>
          </tr>
          <tr>
            <td class="da" width="1"><img alt="" src="<TMPL_VAR NAME=IMGPATH>/main/pix_spcr.gif" width="1" height="1" border="0"></td>
            <td bgcolor="white" width="117" height="100%" valign="top" align="center">
  ...
  <TMPL_IF SHOW_RT_PHONE>
          ...
          <tr>
            <td colspan="3"><img alt="" src="<TMPL_VAR NAME=IMGPATH>/main/dirass_bottm_hdr.gif" width="119" height="14" border="0"></td>
          </tr>
        </table>
        </td>
      </tr>
  ...
  <td align="center" valign="top" width="124" height="290" style="height: 100%">
    <table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
      ...
      <tr>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="119" height="100%">
          <tr>
            <td colspan="3" width="100%"><img alt="" src="<TMPL_VAR NAME=IMGPATH>/main/bus_top_hdr.gif" width="119" height="40" border="0"></td>
          </tr>
          <tr>
            <td class="business" width="1"><img alt="" src="<TMPL_VAR NAME=IMGPATH>/main/pix_spcr.gif" width="1" height="1" border="0"></td>
            <td bgcolor="white" width="117" height="100%" valign="top" align="center">
            <table border="0" cellpadding="0" cellspacing="0" width="117" height="335">
              <tr>
                <td valign="top" align="center">
          ...
          <tr>
            <td colspan="3"><img alt="" src="<TMPL_VAR NAME=IMGPATH>/main/bus_bottm_hdr.gif" width="119" height="14" border="0"></td>
          </tr>
        </table>
        </td>
      </tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="117" height="100%">
      <tr height="1%">
        <td colspan="3"><img alt="" src="<TMPL_VAR NAME=IMGPATH>/main/asset_top_hdr.gif" width="119" height="40" border="0"></td>
      </tr>
      <tr height="98%">
        <td class="asset" width="1"><img alt="" src="<TMPL_VAR NAME=IMGPATH>/main/pix_spcr.gif" width="1" height="1" border="0"></td>
        <td bgcolor="white" valign="top" align="left" height="290" style="height: 100%">
        <table border="0" cellpadding="0" cellspacing="0" width="117" height="100%">
          <tr height="65">
        ...
        <td class="asset"><img alt="" src="<TMPL_VAR NAME=IMGPATH>/main/pix_spcr.gif" width="1" height="1" border="0"></td>
      </tr>
      <tr height="1%">
        <td colspan="3"><img alt="" src="<TMPL_VAR NAME=IMGPATH>/main/asset_bottm_hdr.gif" width="119" height="14" border="0"></td>
      </tr>
    </table>
    </td>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="117" height="100%">
      <tr height="1%">
        <td colspan="3"><img alt="" src="<TMPL_VAR NAME=IMGPATH>/main/licen_top_hdr.gif" width="119" height="40" border="0"></td>
      </tr>
      <tr height="98%">
        <td class="license" width="1"><img alt="" src="<TMPL_VAR NAME=IMGPATH>/main/pix_spcr.gif" width="1" height="1" border="0"></td>
        <td bgcolor="white" valign="top" align="left" height="290" style="height: 100%">
        <table border="0" cellpadding="0" cellspacing="0" width="117" height="100%">
          <tr height="65">
            <td height="65" valign="top" align="left">
      ...
      <tr height="1%">
        <td colspan="3"><img alt="" src="<TMPL_VAR NAME=IMGPATH>/main/licen_bottm_hdr.gif" width="119" height="14" border="0"></td>
      </tr>
    </table>
    </td>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="117" height="100%">
      <tr height="1%">
        <td colspan="3"><img alt="" src="<TMPL_VAR NAME=IMGPATH>/main/court_top_hdr.gif" width="119" height="40" border="0"></td>
      </tr>
      <tr height="98%">
        <td class="court" width="1"><img alt="" src="<TMPL_VAR NAME=IMGPATH>/main/pix_spcr.gif" width="1" height="1" border="0"></td>
        <td bgcolor="white" valign="top" align="left" height="290" style="height: 100%">
        <table border="0" cellpadding="0" cellspacing="0" width="117" height="100%">
          <tr height="65">
            <td height="65" valign="top" align="left">
      ...
      <tr height="1%">
        <td colspan="3"><img alt="" src="<TMPL_VAR NAME=IMGPATH>/main/court_bottm_hdr.gif" width="119" height="14" border="0"></td>
      </tr>
    </table>
    </td>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
      ...
      <tr>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="119" height="100%">
          <tr>
            <td colspan="3" width="100%"><img alt="" src="<TMPL_VAR NAME=IMGPATH>/main/accnt_top_hdr.gif" width="119" height="40" border="0"></td>
          </tr>
          <tr>
            <td class="myaccount" width="1"><img alt="" src="<TMPL_VAR NAME=IMGPATH>/main/pix_spcr.gif" width="1" height="1" border="0"></td>
            <td bgcolor="white" width="117" valign="top" align="center">
            <table border="0" cellpadding="0" cellspacing="0" width="117" height="375">
              <tr>
                <td valign="top" align="center">
                <table border="0" cellpadding="0" cellspacing="5" width="100%">
	      ...
	      <TMPL_IF SA>
              <tr>
                <td width="4" valign="top" align="right" class="smallfont1">&#149;</td>
                <td valign="top" align="left" width="97" class="smallfont1grey"><a class="mainmenu" href="javascript:show_post_popup('MYACCOUNT/SHOW_BATCH_REPORTING_DASHBOARD','MyAccountWin','960','900',1,1,1,1,1,0,'<TMPL_VAR NAME=ACTION_BATCH>');">Batch Reporting Dashboard</a></td>
	      </TMPL_IF>
	      <TMPL_UNLESS SA>
    ...
    <TMPL_IF IS_BATCH_ADMIN>
              <tr>
                <td width="4" valign="top" align="right" class="smallfont1">&#149;</td>
            <td valign="top" align="left" width="97" class="smallfont1grey"><a class="mainmenu" href="javascript:show_post_popup('AHASBATCH/SERVICES','BatchServices',800,650,0,0,0,1,1,0,'<TMPL_VAR NAME=ACTION_BATCH>');">Batch Services</a></td> 
              </tr>
    </TMPL_IF>
      ...
      <tr>
        <td height=10><img alt="" src="<TMPL_VAR NAME=IMGPATH>/spacer.gif" width=1 height=10></td>
      </tr>
      ...
      <tr>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="119">
          <tr>
            <td colspan="3" width="100%"><img alt="" src="<TMPL_VAR NAME=IMGPATH>/main/security_header_green.gif" width="119" height="40" border="0"></td>
          </tr>
          <tr>
            <td class="security" width="1"><img alt="" src="<TMPL_VAR NAME=IMGPATH>/main/pix_spcr.gif" width="1" height="1" border="0"></td>
            <td bgcolor="white" width="117" height="100%" valign="top" align="center">
          ...
          <tr>
            <td colspan="3"><img alt="" src="<TMPL_VAR NAME=IMGPATH>/main/security_footer_green.gif" width="119" height="14" border="0"></td>
          </tr>
        </table>
        </td>
      </tr>
...
<table border="0" cellpadding="5" cellspacing="0" width="764">
  <tr>
    ...
    <td align="right" width="202"><img alt="" src="<TMPL_VAR NAME=IMGPATH>/main/main_logo.gif" border="0" width="202" height="45"></td>
  </tr>
</table>
</form> 
