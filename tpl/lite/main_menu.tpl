        ...
        <table border="0" cellpadding="0" cellspacing="0" width="100%">
          <tr class="mainmenuheaderbk">
            ...
            <table border="0" cellpadding="0" cellspacing="0">
              <tr>
                <td><input class="bs" type="button" value="Coverage" onClick="show_post_popup('LOGIN/SHOW_POPUP','HTMLCoverage','680','475',1,1,1,1,1,0,'','main_coverage');" onMouseOver="flip_style(this,'bso');" onMouseOut="flip_style(this,'bs');" onMouseDown="flip_style(this,'bsd');"></td>
            ...
            <table border="0" cellpadding="0" cellspacing="0">
              <tr>
                ...
                <td><input class="bs" type="button" value="Help" onClick="show_post_popup('LOGIN/SHOW_POPUP','HTMLHelp','680','505',1,1,1,1,1,0,'','main_help');" onMouseOver="flip_style(this,'bso');" onMouseOut="flip_style(this,'bs');" onMouseDown="flip_style(this,'bsd');"></td>
...
<TMPL_IF IS_BATCH_ADMIN>
    ...
    <TMPL_UNLESS DELETE_POWER_BOOLEAN>
                  <tr>
                    <td width="4" valign="top" align="right" class="smallfont1">&#149;</td>
                    <td valign="top" align="left" class="smallfont1grey"><TMPL_IF DISABLE_POWER_BOOLEAN>Power Records<TMPL_ELSE><a class="mainmenu" href="javascript:send_event('SEARCH2/SHOW_POWER_BOOLEAN');">Power Records</a></TMPL_IF></td>
                  </tr>
    </TMPL_UNLESS>
                  <tr>
  ...
  <TMPL_IF SHOW_RT_PHONE>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="117" height="100%">
      <tr class="court">
        <td rowspan="3" class="unifont2" width="1">&nbsp;</td>
        <td height="40" align="center" valign="middle" class="unifont12white" width="100%"><b>court</b></td>
        <td rowspan="3" class="unifont2" width="1">&nbsp;</td>
      </tr>
      <tr height="98%">
        <td bgcolor="white" valign="top" align="left" height="290" style="height: 100%">
