<!-- begin lite/search_inputs_tabs.tpl -->
...
<td width="10%" class="utiltabs" align="center" nowrap><a class="searchtabs" href="javascript:void(0);" onClick="show_post_popup('LOGIN/SHOW_POPUP','HTMLCoverage','420','350',0,0,0,0,0,0,'','coverage/all50_coverage');">Coverage</a></td>
<td width="6%" class="utiltabs" align="center" nowrap><a class="searchtabs"  href="javascript:void(0);" onClick="general_win('<TMPL_VAR NAME=HLPPATH>/power_boolean_help.html','HelpWindow',680,490,1,1,1,1,1,0);void(0);">Help</a></td>
  </TMPL_IF>
    </TMPL_UNLESS>
...
<!-- end lite/search_inputs_tabs.tpl -->
