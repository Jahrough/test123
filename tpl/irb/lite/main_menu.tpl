    ...
    <table border="0" cellpadding="2" cellspacing="0" width="191" height="70">
      <tr>
        ...
        <table border="0" cellpadding="0" cellspacing="0" bgcolor="#ffffff" width="100%" height="66">
          <tr>
            <td bgcolor="#ffffff" align="center" class="logo">IRB</td>
          </tr>
        </table>
        </td>
      </tr>
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
	  <tr class="mainmenuheaderbk">
	    ...
	    <table border="0" cellpadding="0" cellspacing="0">
	      <tr>
	        <td><input class="bs" type="button" value="Coverage" onClick="show_post_popup('LOGIN/SHOW_POPUP','HTMLCoverage','680','450',1,1,1,1,1,0,'','<TMPL_VAR NAME=APPLICATION_TYPE>/main_coverage');" onMouseOver="flip_style(this,'bso');" onMouseOut="flip_style(this,'bs');" onMouseDown="flip_style(this,'bsd');"></td>
		<TMPL_UNLESS HIDE_PRICES><td><input class="bs" type="button" value="Pricing" onClick="general_win('http://www.irbsearch.com/price2.html','PriceSchedule','','',1,1,1,1,1,0);void(0);" onMouseOver="flip_style(this,'bso');" onMouseOut="flip_style(this,'bs');" onMouseDown="flip_style(this,'bsd');"></td></TMPL_UNLESS>
	    ...
	    <table border="0" cellpadding="0" cellspacing="0">
	      <tr>
	        <td><input class="bs" type="button" value="Help" onClick="show_post_popup('LOGIN/SHOW_POPUP','HTMLHelp','680','455',1,1,1,1,1,0,'','<TMPL_VAR NAME=APPLICATION_TYPE>/main_help');" onMouseOver="flip_style(this,'bso');" onMouseOut="flip_style(this,'bs');" onMouseDown="flip_style(this,'bsd');"></a></td>
...
<table border="0" cellpadding="0" cellspacing="5" width="764">
  <tr>
    ...
    <table border="0" cellpadding="3" cellspacing="0" width="100%">
      <tr>
        <td align="center">
        <table border="0" cellpadding="5" cellspacing="0" bgcolor="#527394" width="285" height="65">
          <tr>
            <td class="unifont10white"><b>Trouble Finding Your Subject?<br>Dig Deeper with Advanced Person Search!</b></td>
          </tr>
          <tr>
            <td align="right"><a class="adver" href="javascript:general_win('<TMPL_VAR NAME=HTMLPATH>/irb/adv_person_popup.html','AdvPersonBanner',550,400,0,0,0,1,1,0);void(0);">Click Here ></a></td>
          </tr>
        </table>
        </td>
        <td align="center">
        <table border="0" cellpadding="5" cellspacing="0" bgcolor="#747474" width="280" height="70">
          ...
          <tr>
            <td align="right"><a class="adver" href="javascript:general_win('<TMPL_VAR NAME=HTMLPATH>/irb/irb_finder_report_popup.html','FinderBanner',575,500);void(0);">Click Here To Learn More!</a></td>
          </tr>
        </table>
        </td>
      </tr>
...
<table height="320" border="0" cellpadding="5" cellspacing="0" width="764">
  <tr>
	...
	<td rowspan="3" class="unifont2">&nbsp;</td>
      ...
      <tr>
        <td bgcolor="white" valign="top" align="left">
	<table border="0" cellpadding="0" cellspacing="0" width="120" height="270">
	  <tr>
	    <td valign="top" align="left">
	    <table border="0" cellpadding="0" cellspacing="5" width="120">
	      <tr>
