                        <br><br>
             <li><font color="red"><b>NEW!&nbsp;</b></font>Choose your <TMPL_IF IRB>IRBsearch<TMPL_ELSE>Accurint</TMPL_IF> theme&nbsp;(Click on the images below to see sample screens)<br/>After clicking Save Preferences the new theme will be applied the next time you run a search.</li>
                        ...
                        <tr class="smalllabel">
                                ...
                                <td align="center"><label for="ut2"><b>Classic <TMPL_IF IRB>IRBsearch<TMPL_ELSE>Accurint</TMPL_IF><b></label></td>
