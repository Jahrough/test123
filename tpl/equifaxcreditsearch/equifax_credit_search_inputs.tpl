<!-- begin equifaxcreditsearch/equifax_credit_search_inputs.tpl -->
      <tr>
      ...
      <tr>
        ...
        <table border="0" cellpadding="2" cellspacing="0">
          ...
          <tr>
            <td class="nsinputs"><input type="text" name="SSN" tabindex="10" size="11" maxlength="11" value="<TMPL_VAR NAME=SSN>" autocomplete="off"></td>
          </tr>
        </table>
        </td>
      </tr>
<!-- end equifaxcreditsearch/equifax_credit_search_inputs.tpl -->
