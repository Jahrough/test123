<!-- begin equifaxcreditsearch/gov_search_inputs_tabs.tpl -->
...
<TMPL_IF NAME=IM_ON_HEALTH_CARE_SEARCH>
  ...
  <TMPL_UNLESS DELETE_BUS_QUALIFIER>
  <TMPL_IF NAME="BUS_QUALIFIER_REPORT">
    <td><img width="75" height="46" border="0" src="<TMPL_VAR NAME=IMGPATH>/bus_qualifier_tab_up.gif"></td>
  <TMPL_ELSE>
    <td><a href="javascript:send_event('SEARCH/SHOW_BUS_QUALIFIER');" onMouseOver="bus_qualifier.src='<TMPL_VAR NAME=IMGPATH>/bus_qualifier_tab_over.gif';showalt('Comprehensive Health Care Business Search','bus_qualifier');" onMouseOut="bus_qualifier.src='<TMPL_VAR NAME=IMGPATH>/bus_qualifier_tab_on.gif';return nd();"><img width="52" height="46" border="0" name="bus_qualifier" src="<TMPL_VAR NAME=IMGPATH>/bus_qualifier_tab_on.gif" id="bus_qualifier"></a></td>
  </TMPL_IF>
  </TMPL_UNLESS>

  <TMPL_UNLESS DELETE_IND_QUALIFIER>
  <TMPL_IF NAME="IND_QUALIFIER_REPORT">
    <td><img width="75" height="46" border="0" src="<TMPL_VAR NAME=IMGPATH>/ind_qualifier_tab_up.gif"></td>
  <TMPL_ELSE>
    <td><a href="javascript:send_event('SEARCH/SHOW_IND_QUALIFIER');" onMouseOver="ind_qualifier.src='<TMPL_VAR NAME=IMGPATH>/ind_qualifier_tab_over.gif';showalt('Comprehensive Health Care Provider Report','ind_qualifier');" onMouseOut="ind_qualifier.src='<TMPL_VAR NAME=IMGPATH>/ind_qualifier_tab_on.gif';return nd();"><img width="52" height="46" border="0" name="ind_qualifier" src="<TMPL_VAR NAME=IMGPATH>/ind_qualifier_tab_on.gif" id="ind_qualifier"></a></td>
  </TMPL_IF>
  </TMPL_UNLESS>
...
<TMPL_IF NAME=IM_ON_AVM_SEARCH>
  ...
  <TMPL_IF NAME=AVM_SEARCH>
    <td><img width="75" height="46" border="0" src="<TMPL_VAR NAME=IMGPATH>/avm_
tab_up.gif"></td>
  <TMPL_ELSE>
    <td><a href="javascript:send_event('SEARCH/SHOW_AVM');" onMouseOver="avm.src
='<TMPL_VAR NAME=IMGPATH>/avm_tab_over.gif';showalt('AVM Property Report','avm')
;" onMouseOut="avm.src='<TMPL_VAR NAME=IMGPATH>/avm_tab_on.gif';return nd();"><i
mg width="52" height="46" border="0" name="avm" src="<TMPL_VAR NAME=IMGPATH>/avm
_tab_on.gif" id="avm"></a></td>
  </TMPL_IF>
  </TMPL_IF>
</TMPL_IF>
...
<!-- end equifaxcreditsearch/gov_search_inputs_tabs.tpl -->
