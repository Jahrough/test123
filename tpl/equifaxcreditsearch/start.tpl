<!-- begin equifaxcreditsearch/start.tpl -->
...
<body leftmargin="0" marginwidth="0" topmargin="0" marginheight="0" class="alternatebody">
  ...
  <form name="EQUIFAX_CREDIT" action="<TMPL_VAR NAME=ACTION_MISC>" method="post">

      <TMPL_INCLUDE NAME=equifaxcreditsearch/common_hidden_input.tpl>
...
<table border="0" cellpadding="0" cellspacing="0" width="790" style="min-width: 790px">
  ...
  <tr>
    <td align="left" colspan="2" class="unifont1">
      Equifax Credit Report is a consumer report product provided by LexisNexis Risk Solutions Group Inc., a consumer reporting agency, and is designed to be compliant with the federal Fair Credit Reporting Act (15 USC 1681 et seq.) (the "FCRA") and may only be accessed for limited FCRA permissible purposes.
    </td>
  </tr>
</table>

<TMPL_INCLUDE NAME="equifaxcreditsearch/search_body.tpl">
<table border="0" cellpadding="0" cellspacing="0" width="790" style="min-width: 790px">
  <tr>
    <td align="center" colspan="2" class="unifont1">&nbsp;</td>
  </tr>
  <tr>
    <td align="left" colspan="2" class="unifont1">
      &#169; <TMPL_VAR NAME=CURRENT_YEAR> LexisNexis Risk Solutions Group Inc. All Rights Reserved.
    </td>
  </tr>
  <tr>
    <td align="center" colspan="2" class="unifont1">&nbsp;</td>
  ...
  <tr>
    <td align="left" colspan="2" class="unifont1">
      ...
      <INPUT type=hidden NAME="EVENT" VALUE="REPORT/EQUIFAX_CREDIT_REPORT">
...
<!-- end equifaxcreditsearch/start.tpl -->
