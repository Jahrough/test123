<!-- begin le/lite/le_search_inputs_tabs.tpl -->
...
<TMPL_IF NAME=IM_ON_SEARCH>
  ...
  <TMPL_IF NAME="PERSON_SEARCH">
        <td width="10%" class="utiltabs" align="center" nowrap><a class="searchtabs" href="javascript:void(0);" onClick="show_post_popup('LOGIN/SHOW_POPUP','HTMLCoverage','420','350',0,0,0,0,0,0,'','coverage/all50_coverage');">Coverage</a></td>
        <td width="6%" class="utiltabs" align="center" nowrap><a class="searchtabs"  href="javascript:void(0);" onClick="general_win('<TMPL_VAR NAME=HLPPATH>/le/person_help.html','HelpWindow',680,490,1,1,1,1,1,0);void(0);">Help</a></td>
  </TMPL_IF>
 ...
 <TMPL_IF NAME="REAL_TIME_PERSON_SEARCH">
  ...
  <TMPL_IF NAME="ADV_SEARCH">
        <td width="10%" class="utiltabs" align="center" nowrap><a class="searchtabs" href="javascript:void(0);" onClick="show_post_popup('LOGIN/SHOW_POPUP','HTMLCoverage','420','350',0,0,0,0,0,0,'','coverage/all50_coverage');">Coverage</a></td>
        <td width="6%" class="utiltabs" align="center" nowrap><a class="searchtabs"  href="javascript:void(0);" onClick="general_win('<TMPL_VAR NAME=HLPPATH>/le/advanced_person_help.html','HelpWindow',680,490,1,1,1,1,1,0);void(0);">Help</a></td>
  </TMPL_IF>
...
<TMPL_IF NAME=BUS_SEARCH>
        <td width="10%" class="utiltabs" align="center" nowrap><a class="searchtabs" href="javascript:void(0);" onClick="show_post_popup('LOGIN/SHOW_POPUP','HTMLCoverage','420','350',0,0,0,0,0,0,'','coverage/all50_coverage');">Coverage</a></td>
        <td width="6%" class="utiltabs" align="center" nowrap><a class="searchtabs" href="javascript:void(0);" onClick="general_win('<TMPL_VAR NAME=HLPPATH>/le/business_help.html','HelpWindow',680,490,1,1,1,1,1,0);void(0);">Help</a></td>
</TMPL_IF>
...
<!-- end le/lite/le_search_inputs_tabs.tpl -->
