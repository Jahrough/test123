  ...
  <tr>
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%" class="reportselectbody">
	  ...
	  <tr>
		...
		<TMPL_ELSE>
		    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="disabled_small">Bankruptcy (disabled)&nbsp;&nbsp;<TMPL_UNLESS HIDE_PRICES> -- $<TMPL_VAR NAME=bankruptcy-price></span></TMPL_UNLESS>
		</TMPL_UNLESS>
		</TMPL_UNLESS>
		</td>
	  ...
	  <tr>
		...
		<span class="disabled_small">Liens &amp; Judgments (disabled)<TMPL_UNLESS HIDE_PRICES> -- $<TMPL_VAR NAME=liens-price></TMPL_UNLESS>
	      <TMPL_ELSE>
	  ...
	  <tr>
		...
		<TMPL_ELSE>
		    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="disabled_small">FAA Aircraft (disabled)<TMPL_UNLESS HIDE_PRICES> -- $<TMPL_VAR NAME=faa-aircraft-price></TMPL_UNLESS></span>
		</TMPL_UNLESS>
	      </TMPL_UNLESS>
		</td>
	  ...
	  <tr>
		...
		<TMPL_ELSE>
		    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="disabled_small">Watercraft (disabled)<TMPL_UNLESS HIDE_PRICES> -- $<TMPL_VAR NAME=merchant-vessels-price></TMPL_UNLESS></span>
		</TMPL_UNLESS>
	      </TMPL_UNLESS>
		</td>
	  </tr>
