  ...
  <tr>
   ...
   <table border="0" cellpadding="2" cellspacing="0" width="100%" class="myaccountborder">
	...
	<table border="0" cellpadding="2" cellspacing="0" width="100%" class="reportselectbody">
	  <tr>
	    <td class="myaccountlabel">&nbsp;Base Report Features:&nbsp;</td>
	  </tr>
	  <tr>
	    <td valign="top">
	    <table border="0" cellpadding="0" cellspacing="0" width="100%">
	      <tr>
        <td width="1%" nowrap="nowrap" class="smallfont1"><label for="bestSubjectInfo">&nbsp;Best Subject Information&nbsp;&nbsp;</label></td>
		<td width="1%" nowrap="nowrap" class="reportprices">&nbsp;&nbsp;</td>
	...
	<table border="0" cellpadding="2" cellspacing="0" width="100%" class="reportselectbody">
	  <tr>
	    <td class="myaccountlabel">&nbsp;Additional Report Features:&nbsp;</td>
	  </tr>
	  <tr>
	    ...
	    <table border="0" cellpadding="0" cellspacing="0" width="100%">       
		  ...
		  <tr>
		    ...
		    <td class="medblack"><label for="table-borders">Display table borders on report</label>&nbsp;&nbsp;</td>
		    <td align="right" class="medblack">&nbsp;</td>
		  </tr>
	      </TMPL_IF>
		  ...
		  <tr>
		    ...
		    <td class="medblack"><label for="section-icons">Display icons on report</label>&nbsp;&nbsp;</td>
		    <td align="right" class="medblack">&nbsp;</td>
		  </tr>
	      </TMPL_IF>
	    </table>
    ...
    <table border="0" cellpadding="2" cellspacing="0" width="100%">
      <tr>
      <td width="49%" class="myaccounttitle" class="medblack" nowrap>&nbsp;</td>
...
<!-- End short_ind_qualifier_report_body.tpl-->
