...
<TMPL_IF NAME="PREFERENCES_ERROR_MESSAGE">
  ...
  <tr>
	...
	<table border="0" cellpadding="2" cellspacing="0" width="100%" class="reportselectbody">
	  <tr>
	    <td class="smallfont1">
	    <span class="myaccountlabel">&nbsp;<TMPL_UNLESS HIDE_PRICES>Base Report Price:&nbsp;&nbsp;<TMPL_IF NAME="REPORT_PRICE"><TMPL_VAR NAME="REPORT_PRICE"><TMPL_ELSE>$6.00</TMPL_IF><TMPL_ELSE>Base Report Features:</TMPL_UNLESS></span>
	    <br><br>
	    </td>
	  </tr>
	</table>
