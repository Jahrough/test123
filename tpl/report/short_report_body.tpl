...
-->
  <tr>
	...
	<table border="0" cellpadding="2" cellspacing="0" width="100%" class="reportselectbody">
	  <tr>
	    <td class="myaccountlabel">&nbsp;<TMPL_UNLESS HIDE_PRICES>Base Report Price:&nbsp;&nbsp;$<TMPL_VAR NAME="base-report-price"><TMPL_ELSE>Base Report Features:</TMPL_UNLESS>&nbsp;</td>
	  </tr>
	  <tr>
	    <td valign="top">
	...
	<table border="0" cellpadding="2" cellspacing="0" width="100%" class="reportselectbody">
	  ...
	  <tr>
		...
		<TMPL_IF DISABLE_ASSESSMENT>
			...
			<td align="right" class="disabled_small"><TMPL_UNLESS DELETE_ASSESSMENT><TMPL_UNLESS HIDE_PRICES>$<TMPL_VAR NAME="property-price"></TMPL_UNLESS>&nbsp;</TMPL_UNLESS></td>
		<TMPL_ELSE>
		<TMPL_IF DISABLE_DEEDS>
	        <td width="1%">&nbsp;</td>
			<td class="disabled_small"><TMPL_UNLESS DELETE_DEEDS>Properties&nbsp;(disabled)&nbsp;</TMPL_UNLESS></td>
			<td align="right" class="disabled_small"><TMPL_UNLESS DELETE_DEEDS><TMPL_UNLESS HIDE_PRICES>$<TMPL_VAR NAME="property-price"></TMPL_UNLESS>&nbsp;</TMPL_UNLESS></td>
		<TMPL_ELSE>
	    ...
	    <TMPL_UNLESS DISABLE_BANKRUPTCY>
	        <td width="1%"><input type="checkbox" id="bankruptcy" name="bankruptcy" value="1" <TMPL_VAR NAME="bankruptcy"> onClick="change_total(this, <TMPL_VAR NAME='bankruptcy-price'>, document.forms[0].REPORT_TOTAL,document.forms[0].REPORT_PRE_TOTAL)"></td>
			<td class="smallfont1"><label for="bankruptcy">Bankruptcy<TMPL_UNLESS HIDE_PRICES> <img src="<TMPL_VAR NAME='IMGPATH'>/star.gif" border="0" width="11" height="10" alt="See Note Below Regarding Charges"><img src="<TMPL_VAR NAME='IMGPATH'>/star.gif" border="0" width="11" height="10" alt="See Note Below Regarding Charges"></TMPL_UNLESS></label></td>
			<td align="right" class="reportprices"><TMPL_UNLESS HIDE_PRICES>$<TMPL_VAR NAME="bankruptcy-price"></TMPL_UNLESS>&nbsp;</td>
		<TMPL_ELSE>
	        <td width="1%">&nbsp;</td>
			<td class="disabled_small">Bankruptcy (disabled)</td>
			<td align="right" class="disabled_small"><TMPL_UNLESS HIDE_PRICES>$<TMPL_VAR NAME="bankruptcy-price"></TMPL_UNLESS>&nbsp;</td>
		</TMPL_UNLESS>
	      </tr>
	      </TMPL_UNLESS>
		...
		<TMPL_UNLESS DISABLE_CRIM>
	        <td width="1%"><input type="checkbox" id="criminal-records" name="criminal-records" value="1" <TMPL_VAR NAME="criminal-records"> onClick="change_total(this, <TMPL_VAR NAME='criminal-records-price'>, document.forms[0].REPORT_TOTAL,document.forms[0].REPORT_PRE_TOTAL)"></td>
			<td class="smallfont1"><label for="criminal-records">Possible Criminal Records<TMPL_UNLESS HIDE_PRICES> <img src="<TMPL_VAR NAME='IMGPATH'>/star.gif" border="0" width="11" height="10" alt="See Note Below Regarding Charges"><img src="<TMPL_VAR NAME='IMGPATH'>/star.gif" border="0" width="11" height="10" alt="See Note Below Regarding Charges"></TMPL_UNLESS></label></td>
			<td align="right" class="reportprices"><TMPL_UNLESS HIDE_PRICES>$<TMPL_VAR NAME="criminal-records-price"></TMPL_UNLESS>&nbsp;</td>
		<TMPL_ELSE>
	        <td width="1%">&nbsp;</td>
			...
			<td align="right" class="disabled_small"><TMPL_UNLESS HIDE_PRICES>$<TMPL_VAR NAME="criminal-records-price"></TMPL_UNLESS>&nbsp;</td>
		</TMPL_UNLESS>
	      </tr>
	      </TMPL_UNLESS>
		...
		<TMPL_UNLESS DISABLE_SEXPREDATOR>
	        <td width="1%"><input type="checkbox" id="sexpredator" name="sexpredator" value="1" <TMPL_VAR NAME="sexpredator"> onClick="change_total(this, <TMPL_VAR NAME="sexpredator-price">, document.forms[0].REPORT_TOTAL,document.forms[0].REPORT_PRE_TOTAL)"></td>
			<td class="smallfont1"><label for="sexpredator">Sexual Offenses<TMPL_UNLESS HIDE_PRICES> <img src="<TMPL_VAR NAME=IMGPATH>/star.gif" border="0" width="11" height="10" alt="See Note Below Regarding Charges"><img src="<TMPL_VAR NAME='IMGPATH'>/star.gif" border="0" width="11" height="10" alt="See Note Below Regarding Charges"></TMPL_UNLESS></label></td>
			<td align="right" class="reportprices"><TMPL_UNLESS HIDE_PRICES>$<TMPL_VAR NAME=sexpredator-price></TMPL_UNLESS>&nbsp;</td>
		<TMPL_ELSE>
	        <td width="1%">&nbsp;</td>
			...
			<td align="right" class="disabled_small"><TMPL_UNLESS HIDE_PRICES>$<TMPL_VAR NAME=sexpredator-price></TMPL_UNLESS>&nbsp;</td>
		</TMPL_UNLESS>
	      </tr>
	      </TMPL_UNLESS>
        ...
        <TMPL_IF SHOW_ADDED_REPORT_FDN>
          <tr>
            ...
            <td align="left" class="smallfont1"><label for="fdn-network">Include Fraud Defense Network&nbsp;<TMPL_UNLESS MYACCOUNT_PREFERENCES><i>additional charges apply</i></TMPL_UNLESS></label></td>
            <td align="right" class="reportprices"><TMPL_UNLESS HIDE_PRICES>&nbsp;&nbsp;$<TMPL_VAR NAME="fdn-network-price"></TMPL_UNLESS>&nbsp;</td>
          </tr>
		...
		<TMPL_UNLESS DISABLE_LIEN>
            <td width="1%"><input type="checkbox" id="liens" name="liens" value="1" <TMPL_VAR NAME="liens"> onClick="change_total(this, <TMPL_VAR NAME='liens-price'>, document.forms[0].REPORT_TOTAL,document.forms[0].REPORT_PRE_TOTAL)"></td>
            <td class="smallfont1"><label for="liens">Liens and Judgments<TMPL_UNLESS HIDE_PRICES> <img src="<TMPL_VAR NAME='IMGPATH'>/star.gif" border="0" width="11" height="10" alt="See Note Below Regarding Charges"><img src="<TMPL_VAR NAME=IMGPATH>/star.gif" border="0" width="11" height="10" alt="See Note Below Regarding Charges"></TMPL_UNLESS></label></td>
            <td align="right" class="reportprices"><TMPL_UNLESS HIDE_PRICES>$<TMPL_VAR NAME="liens-price"></TMPL_UNLESS>&nbsp;</td>
		<TMPL_ELSE>
            <td width="1%">&nbsp;</td>
            <td class="disabled_small">Liens and Judgments (disabled)</td>
            <td align="right" class="disabled_small"><TMPL_UNLESS HIDE_PRICES>$<TMPL_VAR NAME="liens-price"></TMPL_UNLESS>&nbsp;</td>
		</TMPL_UNLESS>
          </tr>
	      </TMPL_UNLESS>
		...
		<TMPL_UNLESS DISABLE_CENSUS>
	        <td width="1%"><input type="checkbox" id="census-data" name="census-data" value="1" <TMPL_VAR NAME="census-data"> onClick="change_total(this, <TMPL_VAR NAME="census-data-price">, document.forms[0].REPORT_TOTAL,document.forms[0].REPORT_PRE_TOTAL)"></td>
			<td class="smallfont1"><label for="census-data">Neighborhood Profile (2010 Census)&nbsp;&nbsp;</label></td>
			<td align="right" class="reportprices"><TMPL_UNLESS HIDE_PRICES>$<TMPL_VAR NAME="census-data-price"></TMPL_UNLESS>&nbsp;</td>
		<TMPL_ELSE>
	        <td width="1%">&nbsp;</td>
			<td class="disabled_small">Neighborhood Profile (disabled)&nbsp;&nbsp;</td>
			<td align="right" class="disabled_small"><TMPL_UNLESS HIDE_PRICES>$<TMPL_VAR NAME="census-data-price"></TMPL_UNLESS>&nbsp;</td>
		</TMPL_UNLESS>
	      </tr>
	      </TMPL_UNLESS>
