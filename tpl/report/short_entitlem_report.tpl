<!-- begin: $RCSfile: short_entitlem_report.tpl,v $ -->
    ...
    <form name="SHORT_REPORT" action="<TMPL_VAR NAME=ACTION_REPORT>" method="post">
      ...
      <div align="center" id="mainbody">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="500">
          <tr height="30">
            <td height="30" valign="bottom" align="right" class="myaccountlabel">
              <a style="cursor: help;" href="javascript:void(0);"
               onclick="general_win('http://www.accurint.com/help/bps/entitlements_report_help.html','HelpWindow',780,490,1,1,1,1,1,0);">HELP?</a>
            </td>
          </tr>
          <tr>
...
<!-- end: $RCSfile: short_entitlem_report.tpl,v $ -->
