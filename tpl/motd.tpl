      ...
      <tr>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="290">
          <tr>
            ...
            <div align="center">
            <font face="Arial,Helvetica,Geneva,Swiss,SunSans-Regular" size="3"><b>Friday, October 4, 2002</b></font>
            </div>
            </td>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="732">
      <tr>
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="360" height="297">
          <tr>
            <td colspan="3" bgcolor="#444962" class="unifont1">&nbsp;<font color=white>News Alert!</b></font></td>
          </tr>
          <tr height="4">
          ...
          <tr height="261">
            ...
            <td width="702" height="261" valign="top" align="left" bgcolor="white" class="unifont1">

	    <table cellpadding=3 class="unifont1">
	      <tr>
	        <td>
		    <p>

		    Last updated :<i>10-Oct-2002 11:30 AM EST</i>
