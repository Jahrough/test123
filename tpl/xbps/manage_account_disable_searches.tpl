<!-- BEGIN xbps/manage_account_disable_searches.tpl -->
	 ...
	 <fieldset>
	  <span class="unifont1bold"><legend>People</legend></span>
        ...
        <TMPL_UNLESS HIDE_RT_PERSON>
	      ...
	      <TMPL_ELSE>
              <TR>
                <td width="10%" nowrap class="unifont1" align="left">&nbsp;Person Investigations:&nbsp;&nbsp;</TD>
...
-->              
	 ...
	 <fieldset>
	  <span class="unifont1bold"><legend>Businesses</legend></span>
	      ...
	      <TMPL_ELSE>
              <TR>
                <td width="75%" nowrap class="unifont1" align="left">&nbsp;Corporate Records:</TD>
                <td width="25%" align="left">
                <table border="0" cellpadding="0" cellspacing="0">
                  <tr>
...
-->              
	 ...
	 <fieldset>
	  <span class="unifont1bold"><legend>Assets</legend></span>
	      ...
	      <TMPL_ELSE>
              <TR>
                <td width="75%" nowrap class="unifont1" align="left">&nbsp;Vehicle Investigations:&nbsp;&nbsp;</TD>
                <td width="25%" align="left">
                <table border="0" cellpadding="0" cellspacing="0">
                  <tr>
	 ...
	 <fieldset>
	  <span class="unifont1bold"><legend>Licenses</legend></span>
           <table border="0" cellpadding="0" cellspacing="0" width="95%">
              ...
              <TMPL_ELSE>
              <TR>
                <td width="75%" nowrap class="unifont1" align="left">&nbsp;Driver Licenses:</TD>
                <td width="25%" align="left">
                <table border="0" cellpadding="0" cellspacing="0">
                  <tr>
              ...
              <TMPL_ELSE>
              <TR>
                <td width="75%" nowrap class="unifont1" align="left">&nbsp;Professional Licenses:</TD>
                <td width="25%" align="left">
                <table border="0" cellpadding="0" cellspacing="0">
                  <tr>
	 ...
	 <fieldset>
	   <span class="unifont1bold"><legend>Courts</legend></span>
        ...
        <TMPL_IF NAME=SECURITY_COMPANY>
	      ...
	      <TMPL_ELSE>
              <TR>
                <td width="75%" nowrap class="unifont1" align="left">&nbsp;Bankruptcies, Liens and Judgments Search:</TD>
                <td width="25%" align="left">
                <table border="0" cellpadding="0" cellspacing="0">
                  <tr>
	  ...
	  <span class="unifont1bold"><legend>Miscellaneous</legend></span>
        ...
        <TMPL_IF INSTANTID_FRAUD_DEFENDER_CHECKBOX_SECTION>
	      ...
	      <TMPL_ELSE>
            ...
            <TMPL_ELSE>
              <tr>
                <td width="75%" nowrap="nowrap" class="unifont1" align="left">&nbsp;LexiNexis&reg; Fraud Defense Network Search Indicator:&nbsp;&nbsp;</td>
                <td width="25%" align="left">
                <table border="0" cellpadding="0" cellspacing="0">
                  <tr>
  ...
  <TMPL_IF ENABLE_SSN_ONLY_PERSON_SEARCH>
              <TR>
                <td width="75%" nowrap class="unifont1" align="left">&nbsp;SSN Only Search (Person / Person Investigations):</TD>
                <td width="25%" align="left">
                <table border="0" cellpadding="0" cellspacing="0">
                  <tr>
...
<!-- END xbps/manage_account_disable_searches.tpl -->
