...
<font face="Arial,Helvetica,Geneva,Swiss,SunSans-Regular" size="3"><b>Thursday, May 26, 2011</b></font>
...
<table border="0" cellpadding="5" cellspacing="0">
  <tr>
    <td width="16"></td>
    <td><font face="Arial,Helvetica,Geneva,Swiss,SunSans-Regular" size="3" color="#cc0033"><b>Coming Soon: A New Design for Risk Investigations!</b></font>
...
<center><img src="<TMPL_VAR NAME=IMGPATH>/xbps/v2_setting_themes.gif" width="800" height="677" border="1"></center>
    ...
    <font face="Arial,Helvetica,Geneva,Swiss,SunSans-Regular" size="2"><br><br>
     LexisNexis<sup>&reg;</sup> not only provides current public records data -- we also provide up to 30+ years of historical data.
    <br><br>
