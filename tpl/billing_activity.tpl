    ...
    <tr>
      ...
      <table border="0" cellpadding="2" cellspacing="0">
        <tr>
          ...
          <td height="40"><span class="unifont1"><b>NON-FCRA Results</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></td>
          </TMPL_IF>
	  <td height="40"><a href="javascript:send_event('BILLING/SUMMARY')"><img alt="" width="65" height="24" border="0" name="backadmin" src="<TMPL_VAR NAME=IMGPATH>/previous_page.gif"></a></td>
	  <td height="40" class="unifont1">&nbsp;&nbsp;&nbsp;&nbsp;</td>
	  <td height="40" class="unifont1"><b>User:</b>&nbsp;&nbsp;</td>
	  ...
	  <td height="40" class="unifont1">&nbsp;&nbsp;&nbsp;&nbsp;</td>
	  <td height="40"><TMPL_IF NAME=PREV_ON><a href="javascript:send_billing_event('BILLING/ACTIVITY_PREV')"><img alt="" width="65" height="24" border="0" name="prevadmin" src="<TMPL_VAR NAME=IMGPATH>/previous_page.gif"></a><TMPL_ELSE><img alt="" width="65" height="24" border="0" name="prevadmin" src="<TMPL_VAR NAME=IMGPATH>/previous_page_off.gif"></TMPL_IF></td>
	  <td height="40"><a href="javascript:send_billing_event('BILLING/ACTIVITY')"><img alt="" width="65" height="24" border="0" name="refreshadmin" src="<TMPL_VAR NAME=IMGPATH>/refresh.gif"></a></td>
	  <td height="40"><TMPL_IF NAME=NEXT_ON><a href="javascript:send_billing_event('BILLING/ACTIVITY_NEXT')"><img alt="" width="65" height="24" border="0" name="nextadmin" src="<TMPL_VAR NAME=IMGPATH>/next_page.gif"></a><TMPL_ELSE><img alt="" width="65" height="24" border="0" name="nextadmin" src="<TMPL_VAR NAME=IMGPATH>/next_page_off.gif"></TMPL_IF></td>
	</tr>
      </table>
      </td>
    </tr>
...
<TMPL_INCLUDE NAME="billing_activity_fcra.tpl">
</TMPL_IF>
