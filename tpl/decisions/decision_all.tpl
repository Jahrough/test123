...
<table border="0" cellpadding="5" cellspacing="0" width="600">
  ...
  <TMPL_IF SHOW_RT_PHONE>
    ...
    <a href="javascript:do_patriotact_search_by_name();"><script>write_image('patriot_act_pull');</script>&nbsp;USA PATRIOT ACT SEARCH</a><br>
	</TMPL_UNLESS>
    ...
    <a href="javascript:setevent('SEARCH/SEARCH_OFFICIAL_RECORDS');submitevent();window.close();"><script>write_image('official_records_pull');</script>&nbsp;OFFICIAL RECORDS</a><br>
	</TMPL_UNLESS>
