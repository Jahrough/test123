	  ...
	  <tr>
		...
		<TMPL_IF DISABLE_DEEDS>
		 <TMPL_UNLESS DELETE_DEEDS>
	        <td width="1%">&nbsp;</td>
			<td><span class="disabled_small"><TMPL_IF LNP>Real Property Locator<TMPL_ELSE>Property Ownership Current/Previous</TMPL_IF>&nbsp;&nbsp;</span><span class="reportprices"><TMPL_IF properties-count>(<TMPL_VAR NAME="properties-count">)</TMPL_IF> </span><span class="disabled_small">(disabled)</span></td>
		...
		<TMPL_ELSE>
			...
			<td><span class="smallfont1"><TMPL_IF LNP>Real Property Locator<TMPL_ELSE>Property Ownership Current/Previous</TMPL_IF>&nbsp;&nbsp;</span><span class="reportprices"><TMPL_IF properties-count>(<TMPL_VAR NAME="properties-count">)</TMPL_IF></span></td>
		...
		<TMPL_UNLESS DISABLE_RT_MVR>
			...
			<td><span class="smallfont1"><TMPL_IF LNP>Motor Vehicle Locator<TMPL_ELSE>Motor Vehicle(s) Registered at Address</TMPL_IF>&nbsp;</span><TMPL_IF vehicles-count><span class="reportprices">(<TMPL_VAR NAME="vehicles-count">)</span></TMPL_IF></td>
			<td align="right" class="reportprices"><TMPL_UNLESS HIDE_PRICES>&nbsp;&nbsp;$<TMPL_VAR NAME=addr-motor-vehicles-price></TMPL_UNLESS>&nbsp;</td>
		<TMPL_ELSE>
	        <td width="1%">&nbsp;</td>
			<td class="disabled_small"><TMPL_IF LNP>Motor Vehicle Locator<TMPL_ELSE>Motor Vehicle(s) Registered at Address</TMPL_IF>&nbsp;<TMPL_IF vehicles-count>(<TMPL_VAR NAME="vehicles-count">)</TMPL_IF>&nbsp;(disabled)</td>
