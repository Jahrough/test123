...
<input type="hidden" name="COMPANYBILLING_EDIT" value="0">
        <table border="0" cellpadding="0" cellspacing="0" width="640" >
              ...
              <TR>
                <td class="unifont1" align="left" width="640"><img alt="" border="0" height="20" width="1" src="<TMPL_VAR NAME=IMGPATH>/spacer.gif"></td>
	      </TR>
	    <TMPL_IF NAME="ERROR_MSG">
              <TR>
                <td class="unifont1" align="center" width="640" colspan="2"><b><font color="red"><TMPL_VAR NAME="ERROR_MSG"></font></b>&nbsp;</TD>
              </TR>
              <TR>
                <td class="unifont1" align="left" width="640"><img alt="" border="0" height="20" width="1" src="<TMPL_VAR NAME=IMGPATH>/spacer.gif"></td>
	      </TR>
	    ...
	    <TMPL_IF NAME="SUCCESS_MSG">
	      ...
	      <TMPL_IF NAME="CONFIRMATION">
                <td class="style1" align="left" width="640"><b>VERIFY CREDIT CARD INFORMATION:</b></TD>
	      <TMPL_ELSE>
                <td class="style1" align="left" width="640"><b>CREDIT CARD INFORMATION:</b></TD>
	      </TMPL_IF>
              </TR>
	    ...
	    <TMPL_IF NAME="COMPANYBILLING_EDIT">
			...
			<table border="0" cellpadding="0" cellspacing="0">
              ...
              <tr>
                <td colspan="2"><img alt="" src="<TMPL_VAR NAME=IMGPATH>/spacer.gif" height="10" width="1" border="0"></td>
              </tr>
		...
		<td width=-"60%"><INPUT TYPE="text" NAME="CARDCITY" SIZE="20" VALUE="<TMPL_VAR NAME=CARDCITY>" MAXLENGTH=30 tabindex="8">&nbsp;&nbsp;<INPUT TYPE="text" NAME="CARDSTATE" SIZE="2" VALUE="<TMPL_VAR NAME=CARDSTATE>" MAXLENGTH=2 tabindex="9">&nbsp;&nbsp;<INPUT TYPE="text" NAME="CARDZIP" SIZE="9" VALUE="<TMPL_VAR NAME=CARDZIP>" MAXLENGTH="10" tabindex="10"></td>
              ...
              <TR>
                <td class="unifont1" align="left"><img alt="" border="0" height="20" width="1" src="<TMPL_VAR NAME=IMGPATH>/spacer.gif"></td>
	      </TR>
	  <TMPL_IF NAME="VERSION">
              <TR>
		...
		<input type="checkbox" name="CARDFLAG" value="default" checked>&nbsp;<b>Save credit card information for future court searches</b>
	      ...
	      <tr>
	        <td align="center" class="smallfont1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(Will not affect existing payment arrangements on your Accurint account)</td>
	      </tr>
              <TR>
                <td class="unifont1" align="left"><img alt="" border="0" height="20" width="1" src="<TMPL_VAR NAME=IMGPATH>/spacer.gif"></td>
	      </TR>
	  ...
	  <TMPL_ELSE>
                <td class="unifont1" align="center"><a href="javascript: history.back();"><img alt="" src="<TMPL_VAR NAME="IMGPATH">/back.gif" width="61" height="29" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript:send_event('MANAGE/<TMPL_VAR NAME="VERSION">CONFIRM_CARD');" ><img alt="" src="<TMPL_VAR NAME=IMGPATH>/save_changes.gif" height="29" width="100" border="0"></a></td>
	  </TMPL_IF>
	      </TR>
         <TMPL_ELSE>
              <TR>
	  ...
	  <TMPL_IF NAME="CONFIRMATION">
              <TR>
                <td class="style1" align="center" width="640"><b>Is this correct?</b></td>
	      </TR>
              <TR>
                <td class="unifont1" align="left" width="640"><img alt="" border="0" height="20" width="1" src="<TMPL_VAR NAME=IMGPATH>/spacer.gif"></td>
	      </TR>
	...
	<TMPL_ELSE>
                <td class="unifont1" align="center"><a href="javascript:send_event('MANAGE/<TMPL_VAR NAME="VERSION">SAVE_CARD');"><img alt="" src="<TMPL_VAR NAME="IMGPATH">/yes.gif" width="54" height="29" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;<a href="javascript: history.back();"><img alt="" src="<TMPL_VAR NAME="IMGPATH">/no.gif" width="54" height="29" border="0"></a></td>
	</TMPL_IF>
	      </TR>
	  <TMPL_ELSE>
          <TR>
<TMPL_UNLESS NAME="VERSION">
                <td class="unifont1" align="center"><a href="javascript: send_event('BILLING/SUMMARY');"><img alt="" src="<TMPL_VAR NAME="IMGPATH">/back.gif" width="61" height="29" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;<TMPL_UNLESS NAME="SUCCESS_MSG"><a href="javascript:document.forms[0].COMPANYBILLING_EDIT.value='1';send_event('MANAGE/<TMPL_VAR NAME="VERSION">MANAGE_CARDS');"><img alt="" src="<TMPL_VAR NAME="IMGPATH">/edit_record.gif" width="100" height="29" border="0"></a></TMPL_UNLESS></td>
<TMPL_ELSE>
<TMPL_UNLESS NAME="SUCCESS_MSG">
                <td class="unifont1" align="center"><a href="javascript: history.back()"><img alt="" src="<TMPL_VAR NAME="IMGPATH">/back.gif" width="61" height="29" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;<TMPL_UNLESS NAME="SUCCESS_MSG"><a href="javascript:document.forms[0].COMPANYBILLING_EDIT.value='1';send_event('MANAGE/<TMPL_VAR NAME="VERSION">MANAGE_CARDS');"><img alt="" src="<TMPL_VAR NAME="IMGPATH">/edit_record.gif" width="100" height="29" border="0"></a></TMPL_UNLESS></td>
		<TMPL_ELSE>
