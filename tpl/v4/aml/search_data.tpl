...
<div id="main_menu_data" class="no-print">
	...
	<ul data-sid="peoplelinks" data-li-prefix="people">
			<li data-deleted="<TMPL_VAR NAME="DELETE_PERSON">" data-disabled="<TMPL_VAR NAME="DISABLE_PERSON">" data-id="people_<TMPL_VAR NAME=IDX_PERSON>" class="menu-show-group<TMPL_IF NAME="FAP_SEARCH"> active</TMPL_IF>" data-icon="person_icon">
		...
		<TMPL_IF ALLOW_LNFP>
			...
			<li data-deleted="<TMPL_VAR NAME="DELETE_DA_BASIC">" data-disabled="<TMPL_VAR NAME="DISABLE_DA_BASIC">" data-icon="phone_icon" data-id="people_<TMPL_VAR NAME=IDX_DA_BASIC>" class="menu-show-group<TMPL_IF NAME="SEARCH_PHONE_LOOKUP"> active</TMPL_IF>">
				<a href="javascript:pm_tab_v3('SEARCH2/SHOW_PHONE_LOOKUP');">Phone Lookup</a>
			</li>
			<li data-deleted="<TMPL_VAR NAME="DELETE_BIOGRAPHIES_SEARCH">" data-disabled="<TMPL_VAR NAME="DISABLE_BIOGRAPHIES_SEARCH">" data-id="people_<TMPL_VAR NAME=IDX_BIOGRAPHIES_SEARCH>" class="menu-hide-group<TMPL_IF NAME="BUSINESS_EXECUTIVE_AND_POLITICAL_BIOGRAPHIES_SEARCH"> active</TMPL_IF>" data-icon="person_icon">
			...
			<li data-deleted="<TMPL_VAR NAME="DELETE_DL">" data-disabled="<TMPL_VAR NAME="DISABLE_DL">" data-id="people_<TMPL_VAR NAME=IDX_DL>" class="menu-hide-group<TMPL_IF NAME="LICENSE_SEARCH"> active</TMPL_IF>" data-icon="person_icon">
				<a href="javascript:pm_tab_v3('SEARCH2/SHOW_LICENSE');">Driver Licenses</a>
			</li>
			<li data-deleted="<TMPL_VAR NAME="DELETE_EMAIL">" data-disabled="<TMPL_VAR NAME="DISABLE_EMAIL">" data-id="people_<TMPL_VAR NAME=IDX_EMAIL>" class="menu-hide-group<TMPL_IF NAME="EMAIL_SEARCH"> active</TMPL_IF>" data-icon="person_icon">
...
<!-- 		<TMPL_UNLESS DELETE_IRS_VERIFY>
		<TMPL_UNLESS DISABLE_IRS_VERIFY>
			<li data-deleted="<TMPL_VAR NAME="DELETE_IRS_VERIFY">" data-disabled="<TMPL_VAR NAME="DISABLE_IRS_VERIFY">" data-id="people_<TMPL_VAR NAME=IDX_IRS_VERIFY>" class="menu-hide-group<TMPL_IF NAME="SEARCH_IRS_VERIFY"> active</TMPL_IF>">
				<a href="javascript:pm_tab_v3('SEARCH/SHOW_IRS_VERIFY');">IRS Verify</a>
			</li>
		</TMPL_UNLESS>
		</TMPL_UNLESS> -->
			<li data-deleted="<TMPL_VAR NAME="DELETE_SSA_VERIFY">" data-disabled="<TMPL_VAR NAME="DISABLE_SSA_VERIFY">" data-id="people_<TMPL_VAR NAME=IDX_SSA_VERIFY>" class="menu-hide-group<TMPL_IF NAME="SEARCH_SSA_VERIFY"> active</TMPL_IF>">
			...
			<li data-deleted="<TMPL_VAR NAME="DELETE_PAW">" data-disabled="<TMPL_VAR NAME="DISABLE_PAW">" data-id="people_<TMPL_VAR NAME=IDX_PAW>" class="menu-hide-group<TMPL_IF NAME="PAW_SEARCH"> active</TMPL_IF>" data-icon="person_icon">
				<a href="javascript:pm_tab_v3('SEARCH/SHOW_PAW');">People At Work</a>
			</li>
			<li data-deleted="<TMPL_VAR NAME="DELETE_PROF_LICENSE">" data-disabled="<TMPL_VAR NAME="DISABLE_PROF_LICENSE">" data-id="people_<TMPL_VAR NAME=IDX_PROF_LICENSE>" class="menu-hide-group<TMPL_IF NAME="PROF_LICENSE_SEARCH"> active</TMPL_IF>" data-icon="person_icon">
		...
		<TMPL_IF DO_NOT_WRITE_TO_CLIENT>
			...
			======================================================================================
				...
				<li data-deleted="<TMPL_VAR NAME="DELETE_CONCEALED_WEAPON">" data-disabled="<TMPL_VAR NAME="DISABLE_CONCEALED_WEAPON">" data-id="people_<TMPL_VAR NAME=IDX_CONCEALED_WEAPON>"<TMPL_IF NAME="CONCEALED_WEAPON_SEARCH"> class="active"</TMPL_IF> data-icon="person_icon">
					<a href="javascript:pm_tab_v3('SEARCH2/SHOW_CONCEALED_WEAPON');">Concealed Weapons Permits</a>
				</li>
				<li data-deleted="<TMPL_VAR NAME="DELETE_DEA">" data-disabled="<TMPL_VAR NAME="DISABLE_DEA">" data-id="people_<TMPL_VAR NAME=IDX_DEA>"<TMPL_IF NAME="DEA_SEARCH"> class="active"</TMPL_IF> data-icon="person_icon">
					<a href="javascript:pm_tab_v3('SEARCH2/SHOW_DEA');">Drug Enforcement Administration Registrants</a>
				</li>
				<li data-deleted="<TMPL_VAR NAME="DELETE_FAA_PILOT">" data-disabled="<TMPL_VAR NAME="DISABLE_FAA_PILOT">" data-id="people_<TMPL_VAR NAME=IDX_FAA_PILOT>"<TMPL_IF NAME="FAA_PILOT_SEARCH"> class="active"</TMPL_IF> data-icon="person_icon">
					<a href="javascript:pm_tab_v3('SEARCH2/SHOW_FAA_PILOT');">FAA Pilot Licenses</a>
				</li>
				<li data-deleted="<TMPL_VAR NAME="DELETE_FIREARMS">" data-disabled="<TMPL_VAR NAME="DISABLE_FIREARMS">" data-id="people_<TMPL_VAR NAME=IDX_FIREARMS>"<TMPL_IF NAME="FIREARMS_SEARCH"> class="active"</TMPL_IF> data-icon="person_icon">
					<a href="javascript:pm_tab_v3('SEARCH2/SHOW_FIREARMS');">Federal Firearms &amp; Explosives Licenses</a>
				</li>
				<li data-deleted="<TMPL_VAR NAME="DELETE_HUNTING_LICENSE">" data-disabled="<TMPL_VAR NAME="DISABLE_HUNTING_LICENSE">" data-id="people_<TMPL_VAR NAME=IDX_HUNTING_LICENSE>"<TMPL_IF NAME="HUNTING_LICENSE_SEARCH"> class="active"</TMPL_IF> data-icon="person_icon">
					<a href="javascript:pm_tab_v3('SEARCH2/SHOW_HUNTING_LICENSE');">Hunting &amp; Fishing Licenses</a>
				</li>
				<li data-deleted="<TMPL_VAR NAME="DELETE_MILITARY_PERSONNEL">" data-disabled="<TMPL_VAR NAME="DISABLE_MILITARY_PERSONNEL">" data-id="people_<TMPL_VAR NAME=IDX_MILITARY_PERSONNEL>"<TMPL_IF NAME="MILITARY_PERSONNEL_SEARCH"> class="active"</TMPL_IF>  data-icon="person_icon">
					<a href="javascript:pm_tab_v3('SEARCH2/SHOW_MILITARY_PERSONNEL')">Military Personnel (Archived)</a>
				</li>
		</TMPL_IF>			
	</ul>
	<ul data-sid="businesseslinks" data-li-prefix="business">
			...
			<li data-deleted="<TMPL_VAR NAME="DELETE_EXPERIAN">" data-disabled="<TMPL_VAR NAME="DISABLE_EXPERIAN">" data-id="business_<TMPL_VAR NAME=IDX_EXPERIAN>" class="menu-show-group<TMPL_IF NAME="EXPERIAN_BUSINESS"> active</TMPL_IF>" data-icon="bus_icon">
			...
			<li data-deleted="<TMPL_VAR NAME="DELETE_GUIDESTAR_SEARCH_INDEX">" data-disabled="<TMPL_VAR NAME="DISABLE_GUIDESTAR_SEARCH_INDEX">" data-id="business_<TMPL_VAR NAME=IDX_GUIDESTAR_SEARCH_INDEX>" class="menu-show-group<TMPL_IF NAME="GUIDESTAR_SEARCH"> active</TMPL_IF>" data-icon="bus_icon">
				<a href="javascript:portal_disclaimer_v3('SEARCH2/SHOW_GUIDESTAR');">GuideStar</a>
			</li>
			<li data-deleted="<TMPL_VAR NAME="DELETE_LN_CORP_AFFILIATIONS">" data-disabled="<TMPL_VAR NAME="DISABLE_LN_CORP_AFFILIATIONS">" data-id="business_<TMPL_VAR NAME=IDX_LN_CORP_AFFILIATIONS>" class="menu-show-group<TMPL_IF NAME="LN_CORP_AFFILIATIONS_SEARCH"> active</TMPL_IF>" data-icon="bus_icon">
			...
			<li data-deleted="<TMPL_VAR NAME="DELETE_FEIN">" data-disabled="<TMPL_VAR NAME="DISABLE_FEIN">" data-id="business_<TMPL_VAR NAME=IDX_FEIN>" class="menu-hide-group<TMPL_IF NAME="FEIN_SEARCH"> active</TMPL_IF>" data-icon="bus_icon">
			...
			<li data-deleted="<TMPL_VAR NAME="DELETE_SMALLBUSRISK_SEARCH_INDEX">" data-disabled="<TMPL_VAR NAME="DISABLE_SMALLBUSRISK_SEARCH_INDEX">" data-id="business_<TMPL_VAR NAME=IDX_SMALLBUSRISK_SEARCH_INDEX>" class="menu-hide-group<TMPL_IF NAME="SMALL_BUSINESS_RISK_SCORE_REPORT"> active</TMPL_IF>" data-icon="bus_icon">
			...
			<li data-deleted="<TMPL_VAR NAME="DELETE_STATEWIDE_BUSINESS">" data-disabled="<TMPL_VAR NAME="DISABLE_STATEWIDE_BUSINESS">" data-id="business_<TMPL_VAR NAME=IDX_STATEWIDE_BUSINESS>" class="menu-hide-group<TMPL_IF NAME="STATEWIDE_BUSINESS_SEARCH"> active</TMPL_IF>" data-icon="bus_icon">
		...
		<TMPL_IF DO_NOT_WRITE_TO_CLIENT>
			...
			<!-- Not part of phase 1 release. -->
				<li data-deleted="<TMPL_VAR NAME="DELETE_SUPPLIER_RISK_BUSINESS">" data-disabled="<TMPL_VAR NAME="DISABLE_SUPPLIER_RISK_BUSINESS">" data-id="business_<TMPL_VAR NAME=IDX_SUPPLIER_RISK_BUSINESS>" class="menu-show-group<TMPL_IF NAME="BUS_RISK_COMPLIANCE_REPORT"> active</TMPL_IF>" data-icon="bus_icon">
	...
	<ul data-sid="courtslinks" data-li-prefix="courts">
			...
			<li data-deleted="<TMPL_VAR NAME="DELETE_CASE_LAW_SEARCH">" data-disabled="<TMPL_VAR NAME="DISABLE_CASE_LAW_SEARCH">" data-id="courts_<TMPL_VAR NAME=IDX_CASE_LAW_SEARCH>"<TMPL_IF NAME="CASE_LAW_SEARCH"> class="active"</TMPL_IF> data-icon="court_icon">
	...
	<ul data-sid="internationallinks" data-li-prefix="inter">
			...
			<li data-deleted="<TMPL_VAR NAME="DELETE_COUNTRY_RISK_REPORT">" data-disabled="<TMPL_VAR NAME="DISABLE_COUNTRY_RISK_REPORT">" data-id="inter_<TMPL_VAR NAME=IDX_COUNTRY_RISK_REPORT>"<TMPL_IF NAME="COUNTRY_RISK_REPORT_SEARCH"> class="active"</TMPL_IF> data-icon="international_icon">
	...
	<ul data-sid="regcompliancelinks" data-li-prefix="regs"> 
			<li data-deleted="<TMPL_VAR NAME="DELETE_LN_ADMIN_LAW_DECISIONS">" data-disabled="<TMPL_VAR NAME="DISABLE_LN_ADMIN_LAW_DECISIONS">" data-id="regs_<TMPL_VAR NAME=IDX_LN_ADMIN_LAW_DECISIONS>"<TMPL_IF NAME="LN_ADMIN_LAW_DECISIONS"> class="active"</TMPL_IF> data-icon="regulations_icon">
				<a href="javascript:pm_tab_v3('SEARCH2/SHOW_ADMIN_LAW_DECISIONS');">Administrative Law Judge Decisions</a>
			</li>
			<li data-deleted="<TMPL_VAR NAME="DELETE_AGENCY_OPINIONS_SEARCH">" data-disabled="<TMPL_VAR NAME="DISABLE_AGENCY_OPINIONS_SEARCH">" data-id="regs_<TMPL_VAR NAME=IDX_AGENCY_OPINIONS_SEARCH>"<TMPL_IF NAME="AGENCY_OPINIONS_SEARCH"> class="active"</TMPL_IF> data-icon="regulations_icon">
				<a href="javascript:pm_tab_v3('SEARCH2/SHOW_AGENCY_OPINIONS');">Agency Opinions</a>
			</li>
			<li data-deleted="<TMPL_VAR NAME="DELETE_LN_FED_BANKING_CODE">" data-disabled="<TMPL_VAR NAME="DISABLE_LN_FED_BANKING_CODE">" data-id="regs_<TMPL_VAR NAME=IDX_LN_FED_BANKING_CODE>"<TMPL_IF NAME="LN_FED_BANKING_CODE"> class="active"</TMPL_IF> data-icon="regulations_icon">
				<a href="javascript:pm_tab_v3('SEARCH2/SHOW_FED_BANKING_CODE');">Code of Federal Regulations - Banking Titles 12 & 31</a>
			</li>
			<li data-deleted="<TMPL_VAR NAME="DELETE_LN_FED_REGISTER">" data-disabled="<TMPL_VAR NAME="DISABLE_LN_FED_REGISTER">" data-id="regs_<TMPL_VAR NAME=IDX_LN_FED_REGISTER>"<TMPL_IF NAME="FED_REGISTER_SEARCH"> class="active"</TMPL_IF> data-icon="regulations_icon">
				<a href="javascript:pm_tab_v3('SEARCH2/SHOW_FED_REGISTER');">Code of Federal Regulations &amp; Federal Register</a>
			</li>
			<li data-deleted="<TMPL_VAR NAME="DELETE_LN_CONG_RECORD">" data-disabled="<TMPL_VAR NAME="DISABLE_LN_CONG_RECORD">" class="active" data-id="regs_<TMPL_VAR NAME=IDX_LN_CONG_RECORD>" data-icon="regulations_icon">
				<a href="javascript:pm_tab_v3('SEARCH2/SHOW_CONG_RECORD');">Congressional Record</a>
			</li>
			<li data-deleted="<TMPL_VAR NAME="DELETE_LN_FDIC_RES_TRUST_CORP">" data-disabled="<TMPL_VAR NAME="DELETE_LN_FDIC_RES_TRUST_CORP">" class="active" data-id="regs_<TMPL_VAR NAME=IDX_LN_FDIC_RES_TRUST_CORP>" data-icon="regulations_icon">
				<a href="javascript:pm_tab_v3('SEARCH2/SHOW_FDIC');">FDIC &amp; Resolution Trust Corp</a>
			</li>
			<li data-deleted="<TMPL_VAR NAME="DELETE_LN_FEDERAL_RESERVE">" data-disabled="<TMPL_VAR NAME="DELETE_LN_FEDERAL_RESERVE">" class="active" data-id="regs_<TMPL_VAR NAME=IDX_LN_FEDERAL_RESERVE>" data-icon="regulations_icon">
				<a href="javascript:pm_tab_v3('SEARCH2/SHOW_LN_FEDERAL_RESERVE');">Federal Reserve</a>                    
			</li>
			<li data-deleted="<TMPL_VAR NAME="DELETE_LN_GAO_REPORTS">" data-disabled="<TMPL_VAR NAME="DELETE_LN_GAO_REPORTS">" class="active" data-id="regs_<TMPL_VAR NAME=IDX_LN_GAO_REPORTS>" data-icon="regulations_icon">
				<a href="javascript:pm_tab_v3('SEARCH2/SHOW_LN_GAO_REPORTS');">GAO Reports &amp; Testimonies</a>
			</li>
			<li data-deleted="<TMPL_VAR NAME="DELETE_LN_COMP_CURRENCY">" data-disabled="<TMPL_VAR NAME="DELETE_LN_COMP_CURRENCY">" class="active" data-id="regs_<TMPL_VAR NAME=IDX_LN_COMP_CURRENCY>" data-icon="regulations_icon">
				<a href="javascript:pm_tab_v3('SEARCH2/SHOW_LN_COMPTROLLER_CURRENCY');">Office of the Comptroller of the Currency</a>
			</li>
			<li data-deleted="<TMPL_VAR NAME="DELETE_LN_THRIFT_SUPERVISION">" data-disabled="<TMPL_VAR NAME="DELETE_LN_THRIFT_SUPERVISION">" class="active" data-id="regs_<TMPL_VAR NAME=IDX_LN_THRIFT_SUPERVISION>" data-icon="regulations_icon">
				<a href="javascript:pm_tab_v3('SEARCH2/SHOW_OFFICE_THRIFT_SUPERVISIONS');">Office of Thrift Supervision (Archive)</a>
			</li>
			<li data-deleted="<TMPL_VAR NAME="DELETE_LN_US_PUBLIC_LAWS">" data-disabled="<TMPL_VAR NAME="DELETE_LN_US_PUBLIC_LAWS">" class="active" data-id="regs_<TMPL_VAR NAME=IDX_LN_US_PUBLIC_LAWS>" data-icon="regulations_icon">
				<a href="javascript:pm_tab_v3('SEARCH2/SHOW_LN_US_PUBLIC_LAWS');">US Public Laws</a>
			</li>
			<li data-deleted="<TMPL_VAR NAME="DELETE_LN_BANKS_TITLE_12">" data-disabled="<TMPL_VAR NAME="DELETE_LN_BANKS_TITLE_12">" class="active" data-id="regs_<TMPL_VAR NAME=IDX_LN_BANKS_TITLE_12>" data-icon="regulations_icon">
	...
	<ul data-sid="directtosource" data-li-prefix="direct">
			...
			<li data-deleted="<TMPL_VAR NAME="DELETE_OFFLINE_CIV_CRIM">" data-disabled="<TMPL_VAR NAME="DISABLE_OFFLINE_CIV_CRIM">" data-id="direct_<TMPL_VAR NAME=IDX_OFFLINE_CIV_CRIM>"<TMPL_IF NAME="OCCCR_SEARCH"> class="active"</TMPL_IF>>
	...
	<ul data-sid="authserviceslinks" data-li-prefix="auth">
			<li data-deleted="<TMPL_VAR NAME="DELETE_KBA">" data-disabled="<TMPL_VAR NAME="DISABLE_KBA">" data-id="auth_<TMPL_VAR NAME=IDX_KBA>" class="active" data-icon="authentication_services_icon">
