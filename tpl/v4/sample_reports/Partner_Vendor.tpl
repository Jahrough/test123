...
<title>Partner/Vendor Report</title>
...
<div id="Identities" class="report_section collapsible-section">
  <h3><span class="collapsible open fa-icon-tiny-before">Partner/Vendor Report</span></h3>
...
<tr>
<tr>
<td><strong>The Sample Company</strong><br>
  <br>
1234 Your Street<br>
...
<a href="#sec" class="clear">SEC Violations&nbsp;&nbsp;<strong>1</strong></a><br>
...
<div id="Bankruptcy" class="report_section collapsible-section">
  <h3><span class="collapsible open fa-icon-tiny-before" id="sec">SEC Violations</span></h3>
  <div class="section_container">
<table class="fixed">
  <thead><tr> </tr></thead>
<tbody>
...
<tr>
    <td align="right"><strong>Location:</strong></td>
<td>Securities and Exchange Commission Washington DC</td>
    <td align="right"><strong>Time Period:</strong></td>
    <td>02/28/2000 - 03/03/2010</td>
</tr>
<tr>
    <td align="right"><strong>Comments:</strong></td>
<td>REGULATORY INQUIRIES: This phase of the investigation consisted of inquiry with available online public record sources for regulatory disciplinary actions only. These search results will reveal records by name match only. We reviewed available online files containing disciplinary actions and sanctions collected from various federal and state agencies such as the National Association of Securities Dealers, the Securities and Exchange Commission (SEC), HUD, stock exchanges, state mortgage and real estate regulators, and other federal and state agencies. These files generally date back to 1989, although coverage varies by agency. In addition, we reviewed online Securities and Exchange Commission administrative materials including administrative decisions and administrative proceedings and rulings. <br>
  <br>
  No derogatory items were located. The SEC search is conducted with licensing information.</td>
<td align="right">&nbsp;</td>
<td>&nbsp;</td>
</tr>
...
<td align="right"><strong>*Verified By:</strong></td>
<td colspan="3">BUSINESS NAME=The Sample Company</td>
</tr>
