...
<title>FraudPoint® Score with Red Flags Rule Report</title>
...
<ul id="nav-fav-bar" class="nav">
    ...
    <ul id="history-tab-ul" class="nav nav-tabs multi-tab-view">
        ...
        <li class="btn-group history-tab dropdown active  not-form-tab hx-show" data-paramli="55d7efcaf552d5cd2dbadac4530a808d" data-isactive="1" data-islocked="0">
            <div class="btn-group" data-paramrecent="55d7efcaf552d5cd2dbadac4530a808d">
                ...
                <button data-container=".nav-tabs" data-toggle="popover" data-placement="top" data-trigger="hover" data-closebutton="off" class="tab-crit btn btn-lg btn-danger" onclick="" data-original-title="" title="">
                    <span data-searchtype="FraudPoint<sup class='sup-reg-symbol'>®</sup> Score" data-tabshowevt="SEARCH2/SHOW_FRAUDPOINT_SCORE" class="svg-icon-normal document-icon"></span>
                    <span class="history-tab-data" data-value="111-11-xxxx; 05/10/77; doe, john; cincinnati; OH" aria-hidden="true">111-11-xxxx; 05/10/77; Doe, john; cincin...</span>
                </button>
		<div class="popper-content hide"><div class="popover-font-9 popover-tabs">111-11-1111; 05/10/77; Doe, john; cincinnati; OH</div></div>
                ...
                <ul id="tab_55d7efcaf552d5cd2dbadac4530a808d" class="dropdown-menu tab-dropdown anim-fadeInDown">
                    <li role="presentation" class="dropdown-header">
                        Tab History 
                                ...
                                <li tabindex="0" class="tab-dropdown-item lnkRecent recentRun is-current-page" data-paramli="55d7efcaf552d5cd2dbadac4530a808d" data-isreport="1" data-page="1">
        ...
        <div class="additional-info">
            ...
            <ul id="tab-options-dropdown" class="dropdown-menu tab-dropdown anim-fadeInDown more-tabs-item">
                ...
                <li role="presentation" class="dropdown-header">Open Tabs (<span id="open-tab-count">1</span>)</li>
                    ...
                    <li tabindex="0" class="tab-dropdown-item lnkRecent more-tabs-item not-form-tab is-current-page" data-paramli="55d7efcaf552d5cd2dbadac4530a808d">
        ...
        <li class="right">
                ...
                <strong>Return to searches &gt;&gt;</strong>
					...
					<div class="container-fluid" id="search-container">
						<span id="web20-search-flags" class="hidden" data-search-disabled="0" data-search-error-message="0" data-report-error-message="0" data-is-from-main-menu="0" data-hit-tab-limit="0" data-rerun-display-event="0" data-web20-page-title="FraudPoint<sup class='sup-reg-symbol'>®</sup> Score" data-search-idx="" data-clear-browser-cache-pages="" data-is-clk-search="0" data-is-search-within="0" data-search-within-terms="" data-webpubrec-request="0" data-is-new-window="0" data-active-tab="55d7efcaf552d5cd2dbadac4530a808d" data-tab-id="55d7efcaf552d5cd2dbadac4530a808d" data-page="0" data-is-report="1" data-report-has-form="1" data-show-event="SEARCH2/SHOW_FRAUDPOINT_SCORE"></span>
    ...
    <h2>
        <strong>FraudPoint<sup class="sup-reg-symbol">®</sup> Score</strong>
    </h2>
...
<a href="javascript:void(0);" onclick="javascript:update_start_page_prefs(this);" id="make-start-page-link" class="button-icon  make-start-page" data-placement="bottom" data-original-title="Make This My Start Page" data-startpage-idx="">Make This My Start Page</a>
    ...
    <form name="FRAUDPOINT_SCORE_REPORT" action="/app/evolution/main" method="post" class="smart-form" onkeypress="" onkeyup="javascript:isEnterKeyDown=false; submitFormKeyPress(event);" novalidate>


    <input name="EVENT" value="REPORT2/FRAUDPOINT_SCORE" type="hidden">
...
<input name="CURRENT_EVENT" id="CURRENT_EVENT" value="REPORT2/FRAUDPOINT_SCORE" type="hidden">
...
<div id="search-form-fields" class="col col-7">
    <div class="instant_id_options_text clearafter">
        <div>
            For optimal results enter SSN, DOB, Last Name, First Name, Street, City, State, Zip Code and Phone.
        </div>
        <div class="pull-left">
            * Entry Required - 
        </div>
...
<div class="row">
    ...
    <div class="input col col-3">
        <label>
            <input id="DOB" class="form-control" name="DOB" value="05/23/66" placeholder="Date of Birth" maxlength="10" type="text">
            <span class="tooltip">
                Date of Birth
                <br>
...
<div class="row">
    ...
    <div class="input col col-1">
        <label>
            <input id="NAME_SUFFIX" class="form-control" name="NAME_SUFFIX" value="" placeholder="Suffix" maxlength="40" type="text">
...
<div class="row">
    <div class="input col col-3">
        <label>
            <input id="IP_ADD" name="IP_ADD" value="" class="form-control" placeholder="IP Address" maxlength="35" type="text">
            <span class="tooltip">
                IP Address
...
<div class="col col-3" id="search-options">
    ...
    <div class="pull-right">
					...
					<input name="DIRECT_REPORT" value="1" type="HIDDEN">
							...
							<input class="btn btn-danger" id="searchBtn" value="Search" onblur="ENTER_FOCUS=0;" onfocus="ENTER_FOCUS=1" onclick="if(!web20_validate('FRAUDPOINT_SCORE_REPORT')){ return false;}else{ show_loading(); send_ajax_event('REPORT2/FRAUDPOINT_SCORE','/app/evolution/misc');}" type="button">
...
<input name="CURRENT_EVENT" value="REPORT2/FRAUDPOINT_SCORE" type="HIDDEN">
...
<input name="PSID" value="55d7efcaf552d5cd2dbadac4530a808d" type="hidden">
<input name="ACTION_MISC" value="/app/evolution/misc" type="hidden">
...
<div id="main_menu_data" class="no-print">
	...
	<ul data-sid="peoplelinks" data-li-prefix="people">
			...
			<li data-id="people_IDX_123" class="menu-show-group active" data-icon="person_icon">
				<a href="javascript:pm_tab_v3('SEARCH2/SHOW_FRAUDPOINT_SCORE');">FraudPoint<sup class="sup-reg-symbol">®</sup> Score</a>
			</li>
...
<div class="new-edit-search-buttons" data-active-tabid="55d7efcaf552d5cd2dbadac4530a808d"> 
    ...
    <button class="btn" onclick="">New Search</button> 
        ...
        <div id="search-results-con">
            <form name="SEARCH_RESULTS" method="post">
                    ...
                    <span class="hidden" id="custom-css">iidi_styles.css</span><div id="report_body"><div id="report_content" role="article">
<h2 class="person_icon svg-icon-normal">FraudPoint<sup class="sup-reg-symbol">®</sup> Score with Red Flags Rule Report</h2>
...
<strong>Search Terms: </strong>SSN:&nbsp;<strong class="term">111-11-1111</strong>;&nbsp;DOB:&nbsp;<strong class="term">05/10/77</strong>;&nbsp;Last Name:&nbsp;<strong class="term">Doe</strong>;&nbsp;First Name:&nbsp;<strong class="term">john</strong>;&nbsp;City:&nbsp;<strong class="term">cincinnati</strong>;&nbsp;State:&nbsp;<strong class="term">OH</strong>
</div>
<div id="report-created-for-container" class="report_title">
<strong>Report For: </strong><span>DOE,&nbsp;JOHN</span>
</div>
<span class="font-10">
            FraudPoint<sup class="sup-reg-symbol">®</sup> Score predicts the likelihood that an application contains fraudulent or misrepresented information and will result in identity fraud if the account is opened. The Score presents results in a three-digit score ranging from 300 (highest fraud risk) to 999 (lowest fraud risk). Along with a numeric score, FraudPoint<sup class="sup-reg-symbol">®</sup> Score returns Warning Codes, which provide additional granular insight to pinpoint the high fraud-risk conditions that most contributed to the score. To further focus your efforts, Risk Indices are also returned, summarized as a 1-9 value, to provide powerful insight into the type of identity fraud that is being attempted. 
        </span><div id="fraudpoint-score" class="report_section iid_section_separator">
...
<span id="warning-level-score" style="margin-left: 318px;" class="block-display dontRead">725</span><img class="block-display" style="margin-left: 333px;" alt="FraudPoint Score equals 725" src="<TMPL_VAR HTMLPATH>/v4/img/fraud_scale_arrow.gif"><img class="block-display" alt=" " src="<TMPL_VAR HTMLPATH>/v4/img/fraud_scale.gif">
</div></div>
</div>
<div id="fraudrisk-indices" class="report_section iid_section_separator">
<h3 class="iid_no_border">
<span>Fraud Risk Indices </span><span class="font-10">- 1 (Lowest Risk) to 9 (Highest Risk)</span><div class="additional-info padding-bottom-4 font-12"><a href="javascript:void(0);" onclick=""><u>About these indices</u></a></div>
</h3>
...
<div id="fraudrisk-indices-display">
<ul class="unmarked_list">
<li>Synthetic Identity</li>
<li>Stolen Identity</li>
<li>Manipulated Identity</li>
<li>Vulnerable Victim</li>
<li>Friendly Fraud</li>
<li>Suspicious Activity</li>
</ul>
<img id="fraudrisk-indices-display-graph" alt=" " src="<TMPL_VAR HTMLPATH>/v4/img/fpnt_scale_indices_bkg.png"><img id="synthetic-identity-index" class="indicies-bar" alt="Synthetic Identity Index equals 1" src="<TMPL_VAR HTMLPATH>/v4/img/fpnt_indice_bar1.jpg"><img id="stolen-identity-index" class="indicies-bar" alt="Stolen Identity Index equals 1" src="<TMPL_VAR HTMLPATH>/v4/img/fpnt_indice_bar1.jpg"><img id="manipulated-identity-index" class="indicies-bar" alt="Manipulated Identity Index equals 1" src="<TMPL_VAR HTMLPATH>/v4/img/fpnt_indice_bar1.jpg"><img id="vulnerable-victim-index" class="indicies-bar" alt="Vulnerable Victim Index equals 1" src="<TMPL_VAR HTMLPATH>/v4/img/fpnt_indice_bar1.jpg"><img id="friendly-fraud-index" class="indicies-bar" alt="Friendly Fraud Index equals 6" src="<TMPL_VAR HTMLPATH>/v4/img/fpnt_indice_bar6.jpg"><img id="suspicious-activity-index" class="indicies-bar" alt="Suspicious Activity Index equals 6" src="<TMPL_VAR HTMLPATH>/v4/img/fpnt_indice_bar6.jpg">
</div>
<table class="fixed">
<tbody><tr>
<th>Synthetic Identity</th>
<td>Indicates application may contain a manufactured identity</td>
<td><strong>1</strong></td>
</tr>
<tr>
<th>Stolen Identity</th>
<td>Indicates application may be an attempt to compromise a real identity</td>
<td><strong>1</strong></td>
</tr>
<tr>
<th>Manipulated Identity</th>
<td>Indicates the identity has evidence of being intentionally manipulated</td>
<td><strong>1</strong></td>
</tr>
<tr>
<th>Vulnerable Victim</th>
<td>Indicates the identity is at risk for being a victim of identity fraud</td>
<td><strong>1</strong></td>
</tr>
<tr>
<th>Friendly Fraud</th>
<td>Indicates the identity is at risk for being a victim of identity fraud perpetrated by a relative</td>
<td><strong>6</strong></td>
</tr>
<tr>
<th>Suspicious Activity</th>
<td>Indicates the identity has previous high risk activity</td>
<td><strong>6</strong></td>
</tr>
</tbody></table>
</div>
</div>
<div id="fraud-warning-codes" class="report_section iid_section_separator">
<h3 class="iid_no_border"><span>Fraud Warning Codes</span></h3>
<div class="section_container padding-left-20">
<ul class="report_help_links"><li><button type="button" data-event="scroll" class="caret_up has-click-event btn btn-link btn-tight">Top</button></li></ul>
...
<td rowspan="4">
<span class="ico-id-1" aria-label="Risk Priority equals 1">Incomplete verification</span><br><span class="ico-id-2" aria-label="Risk Priority equals 2">Evidence of suspicious identity activity</span><br>
</td>
</tr>
<tr>
...
<td class="col-4_5">Not Entered</td>
<td rowspan="4">
<span class="ico-id-3" aria-label="Risk Priority equals 3">The input address was missing</span><br>
</td>
</tr>
<tr>
...
<td class="col-4_5">Not Entered</td>
<td><span class="ico-id-4" aria-label="Risk Priority equals 4">The input phone was missing or incomplete</span></td>
</tr>
<tr>
<th class="col-1_5">SSN</th>
<td class="col-4_5">111-11-1111</td>
<td></td>
</tr>
<tr>
<th class="col-1_5">DOB</th>
<td class="col-4_5">5/10/1977</td>
<td></td>
</tr>
<tr>
<th class="col-1_5">Driver License Number</th>
<td class="col-4_5">Not Entered</td>
<td rowspan="2"></td>
</tr>
<tr>
<th class="col-1_5">Driver License State</th>
<td class="col-4_5">Not Entered</td>
</tr>
<tr>
<th class="col-1_5">IP Address</th>
<td class="col-4_5">Not Entered</td>
<td></td>
</tr>
</tbody>
...
<table>
<thead><tr><th colspan="3">Consider using the Search &amp; Verification Solutions below to obtain additional information</th></tr></thead>
<tbody><tr>
<th>Other solutions</th>
<td class="col-6">
<a onclick="">InstantID<sup class="sup-reg-symbol">®</sup> Q&amp;A</a><input name="KEY_VALUES" value="" type="hidden"> - &nbsp;Conduct Knowledge Based Authentication with your customer.</td>
<td></td>
</tr></tbody>
</table>
</div>
...
<div id="RedFlagReport" class="report_section iid_section_separator">
	<h3 class="iid_no_border">
		<span>Red Flag Report </span><div class="additional-info padding-bottom-4 font-12"><a href="javascript:void(0);" data-helpid="INSTANT_ID_REPORT_SECTION" data-helptype="help-search-results" data-subsection="bsp_instantid_about_red_flags_rule_report"><u>About this Report</u></a></div>
	</h3>
	<div class="section_container padding-left-20">
		<ul class="report_help_links">
			<li>
		...
		<table>
			...
			<tbody>
				<tr>
					...
					<td class="col-4_5">
						<strong>Suspicious Personal Identifying Information:</strong> SSN is associated with multiple individuals
					</td>
					<td>
						<ul class="unmarked_list">
							<li>The input SSN is associated with a different name and address</li>
						</ul>
					</td>
				</tr>
				<tr>
					<td class="col-1 center"><span class="high-risk-icon svg-icon-normal" aria-label="High-Risk Flag"></span></td>
					<td class="col-4_5">
						<strong>Suspicious Personal Identifying Information:</strong> The person opening the covered account or the customer fails to provide all required personal identifying information on an application or in response to notification that the application is incomplete
					</td>
					<td>
						<ul class="unmarked_list">
							<li>The input phone was missing or incomplete</li>
							<li>The input address was missing</li>
				...
				<tr>
					<td class="col-1 center"><span class="high-risk-icon svg-icon-normal" aria-label="High-Risk Flag"></span></td>
					<td class="col-4_5">
						<strong>Alerts, Notifications, or Warnings from a Consumer Reporting Agency:</strong> SSN is associated with multiple individuals
					</td>
					<td>
						<ul class="unmarked_list">
							<li>The input SSN is associated with a different name and address</li>
				...
				<tr>
					<td class="col-1 center"><span class="high-risk-icon svg-icon-normal" aria-label="High-Risk Flag"></span></td>
					<td class="col-4_5">
						<strong>Suspicious Personal Identifying Information:</strong> Address Discrepency
					</td>
					<td>
						<ul class="unmarked_list">
							<li>The input address may be invalid according to postal specifications</li>
						</ul>
					</td>
				</tr>
				<tr>
					<td class="col-1 center"><span class="high-risk-icon svg-icon-normal" aria-label="High-Risk Flag"></span></td>
					<td class="col-4_5">
						<strong>Suspicious Personal Identifying Information:</strong> Address
					</td>
					<td>
						<ul class="unmarked_list">
							<li>Unable to verify name, address, SSN/TIN and phone</li>
						</ul>
					</td>
				</tr>
				<tr>
					<td class="col-1 center"><span class="high-risk-icon svg-icon-normal" aria-label="High-Risk Flag"></span></td>
					<td class="col-4_5">
						<strong>Suspicious Personal Identifying Information:</strong> Phone
					</td>
					<td>
						<ul class="unmarked_list">
							<li>The input phone number is potentially invalid</li>
							<li>The input phone number is not found in the public record</li>
						</ul>
					</td>
				</tr>
			</tbody>
                ...
                <div class="modal-body">
                    ...
                    <div id="error-body" class="wordwrap clear">
                        ...
                        <div id="bridger-message" class="hidden">
                            <p><strong>Your file is being exported to Bridger Insight™ XG.</strong></p>
                            <hr class="simple">
                            <br>
                        </div>
                        <div id="bridger-empty-finished" class="hidden">
                            ...
                            <br>
                            It may take up to five minutes for documents to appear in Bridger Insight™ XG.
                            <br>
                            <br>
                            <br>
                            You can continue to work within LexisNexis<sup class="sup-reg-symbol">®</sup>  or Bridger Insight™ XG after closing this window.
                            <br>
                            <br>
                        </div>
                        ...
                        <p>
                            <strong>FraudPoint - [301: Insufficient input] </strong>
                        </p>
                        ...
                        <input name="ERROR_MESSAGE_BLOB" value="" type="hidden">
                    </div>

                </div>
                <div class="modal-footer">
                    <div class="text-center" id="new-edit-buttons">
                        <button type="button" class="btn btn-danger" onclick="javascript:portal_edit_search();">Edit Search</button>
                        <button type="button" class="btn btn-default" onclick="javascript:web20_clear_all();portal_new_search();">New Search</button>
                    </div>
                </div>
            </div>
        </div>
