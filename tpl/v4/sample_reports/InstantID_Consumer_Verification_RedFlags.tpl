...
<title>InstantID® Consumer Verification with Red Flags Rule Report</title>
...
<link rel="stylesheet" type="text/css" media="screen" href="<TMPL_VAR HTMLPATH>/v4/css/icons.css">
	...
	<style type="text/css"> #popover703590{ top:97.5px; left:241.5px; display:block} </style>
	<style type="text/css"> #popover184873{ top:97.5px; left:241.5px; display:block} </style>
	...
	<div class="pull-right">	
		...
		<div class="btn-group btn-group2" role="group">
			...
			<ul role="menu" class="dropdown-menu">
				<li class="hlOptions">
					<a href="javascript:void(0);" onclick="javascript:get_prefs_data(1);">Preferences</a>
				</li>
...
<ul id="nav-fav-bar" class="nav">
    ...
    <ul id="history-tab-ul" class="nav nav-tabs multi-tab-view">
        ...
        <li class="btn-group history-tab dropdown active  not-form-tab hx-show" data-paramli="49604934bc89e7e134ce2371813b17bc" data-isactive="1" data-islocked="0">
            <div class="btn-group" data-paramrecent="49604934bc89e7e134ce2371813b17bc">
                ...
                <button data-container=".nav-tabs" data-toggle="popover" data-placement="top" data-trigger="hover" data-closebutton="off" class="tab-crit btn btn-lg btn-danger" onclick="" data-original-title="" title="">
                    <span data-searchtype="InstantID<sup class='sup-reg-symbol'>®</sup> Consumer Verification with Red Flags Rule Report" data-tabshowevt="SEARCH2/SHOW_INSTANT_IDRF" class="svg-icon-normal document-icon"></span>
                    <span class="history-tab-data" data-value="" aria-hidden="true">111-11-xxxx; 000000000000; Doe, john</span>
                </button>
		<div class="popper-content hide"><div class="popover-font-9 popover-tabs"></div></div>
                ...
                <ul id="tab_49604934bc89e7e134ce2371813b17bc" class="dropdown-menu tab-dropdown anim-fadeInDown">
                    <li role="presentation" class="dropdown-header">
                        Tab History 
                                ...
                                <li tabindex="0" class="tab-dropdown-item lnkRecent recentRun is-current-page" data-paramli="49604934bc89e7e134ce2371813b17bc" data-isreport="1" data-page="1">
                                    <div class="history-tab-data" onclick="javascript:if($('.popup-link:hover').length === 0){process_tab_request(this,'49604934bc89e7e134ce2371813b17bc',1);}">
                                        <span data-searchtype="InstantID<sup class='sup-reg-symbol'>®</sup> Consumer Verification with Red Flags Rule Report" data-tabshowevt="SEARCH2/SHOW_INSTANT_IDRF" class="svg-icon-small document-icon"></span>
                                        <span class="tab-search-name">InstantID<sup class="sup-reg-symbol">®</sup> Consumer Verification with Red Flags Rule Report</span>
                                        <span class="tab-search-terms"></span>
                                    </div>
                                    
                                    <button type="button" class="btn btn-default pull-right external_link_icon svg-icon-x-tiny tab-btn" onclick="run_history_popup_search('49604934bc89e7e134ce2371813b17bc',1);"></button>
        ...
        <div class="additional-info">
            ...
            <ul id="tab-options-dropdown" class="dropdown-menu tab-dropdown anim-fadeInDown more-tabs-item">
                ...
                <li role="presentation" class="dropdown-header">Open Tabs (<span id="open-tab-count">1</span>)</li>
                    ...
                    <li tabindex="0" class="tab-dropdown-item lnkRecent more-tabs-item not-form-tab is-current-page" data-paramli="49604934bc89e7e134ce2371813b17bc">
                        <span class="close close-tab">
                            <a class="close-icon font-12" href="javascript:void(0);" onclick="remove_tab('49604934bc89e7e134ce2371813b17bc');">
                                <span class="sr-only">Delete tab</span>
                            </a>
                        </span>
                        <div class="history-tab-data">
                            <section onclick="javascript:if($('.popup-link:hover').length === 0){process_tab_request(this,'49604934bc89e7e134ce2371813b17bc',1,1);}">
                                <span class="svg-icon-normal document-icon" data-tabshowevt="SEARCH2/SHOW_INSTANT_IDRF"></span>
                                <span class="tab-search-name">
                                    InstantID<sup class="sup-reg-symbol">®</sup> Consumer Verification with Red Flags Rule Report (1)
                                </span>
        ...
        <li class="right">
                ...
                <strong>Return to searches &gt;&gt;</strong>
					...
					<div class="container-fluid" id="search-container">
						<span id="web20-search-flags" class="hidden" data-search-disabled="0" data-search-error-message="0" data-report-error-message="0" data-is-from-main-menu="0" data-hit-tab-limit="0" data-rerun-display-event="0" data-web20-page-title="InstantID<sup class='sup-reg-symbol'>®</sup> Consumer Verification with Red Flags Rule Report" data-search-idx="" data-clear-browser-cache-pages="" data-is-clk-search="0" data-is-search-within="0" data-search-within-terms="" data-webpubrec-request="0" data-is-new-window="0" data-active-tab="49604934bc89e7e134ce2371813b17bc" data-tab-id="49604934bc89e7e134ce2371813b17bc" data-page="0" data-is-report="1" data-report-has-form="1" data-show-event="SEARCH2/SHOW_INSTANT_IDRF"></span>
    ...
    <h2>
        <strong>InstantID<sup class="sup-reg-symbol">®</sup> Consumer Verification with Red Flags Rule Report</strong>
    </h2>
...
<a href="javascript:void(0);" onclick="javascript:update_start_page_prefs(this);" id="make-start-page-link" class="button-icon  make-start-page" data-placement="bottom" data-original-title="Make This My Start Page" data-startpage-idx="">Make This My Start Page</a>
    ...
    <form name="INSTANT_IDRF_REPORT" action="/app/evolution/main" method="post" class="smart-form" onkeypress="" onkeyup="javascript:isEnterKeyDown=false; submitFormKeyPress(event);" novalidate>


    <input name="EVENT" value="REPORT2/INSTANT_IDRF" type="hidden">
...
<input name="CURRENT_EVENT" id="CURRENT_EVENT" value="REPORT2/INSTANT_IDRF" type="hidden">
...
<div id="search-form-fields" class="col col-7">
    <span class="font-12">For optimal results enter SSN, DOB, Last Name, First Name, Street, City, State, Zip Code and Phone.</span>
    <div class="row">
        ...
        <div class="input col col-1_1">
            <label>
                <input id="DOB_M" class="form-control" name="DOB_M" value="" placeholder="DOB:MM" maxlength="2" onkeyup="show_or_hide_birth_range()" type="text">
                <span class="tooltip">DOB:MM</span>
            </label>
        </div>
        <div class="input col col-1_1">
            <label>
                <input id="DOB_D" class="form-control" name="DOB_D" value="" placeholder="DOB:DD" onkeyup="show_or_hide_birth_range()" maxlength="2" type="text">
                <span class="tooltip">DOB:DD</span>
            </label>
        </div>
        <div class="input col col-1_25">
            <label>
                <input id="DOB_Y" class="form-control" name="DOB_Y" value="" placeholder="DOB:YYYY" maxlength="4" onkeyup="show_or_hide_birth_range()" type="text">
    ...
    <fieldset class="radiogroup" id="watchListInfo">
        <legend>
            <span aria-hidden="true">Watchlists</span>
            <span class="sr-only">Select a watch list type</span>
        </legend>
        <input name="WATCH_LIST_OPT" id="WATCH_LIST_OFAC" onclick="toggle_watchlist(1)" value="1" type="radio">
        <label class="radio-inline" for="WATCH_LIST_OFAC">OFAC</label>
        <input name="WATCH_LIST_OPT" id="WATCH_LIST_OFAC_GLOB" onclick="toggle_watchlist(2)" value="2" type="radio">
        <label class="radio-inline" for="WATCH_LIST_OFAC_GLOB">OFAC &amp; Global Sanctions Lists</label>
        <input name="WATCH_LIST_OPT" id="WATCH_LIST_FARA" onclick="toggle_watchlist(3)" value="3" type="radio">
        <label class="radio-inline" for="WATCH_LIST_FARA">FARA &amp; PEP</label>
        <input name="WATCH_LIST_OPT" id="WATCH_LIST_NONE" onclick="toggle_watchlist(4)" value="4" type="radio">
        <label class="radio-inline" for="WATCH_LIST_NONE">FARA &amp; PEP</label>
    </fieldset> 
    <div class="row">
        <div class="input col col-1 hidden">
            <label>
                <input id="HID_WATCH_LIST_OPT" name="HID_WATCH_LIST_OPT" value="1" class="form-control" type="hidden">
            </label>
        </div>
    </div>
    ...
    <div class="row">
        <div class="input col col-1 hidden">
            <label>
                <input id="HID_SELECTED_OPTS" name="HID_SELECTED_OPTS" value="" class="form-control" type="hidden">
            </label>
        </div>
    </div>    
    <div class="row">
        <div id="instantid_birthdate" class="hidden">
            ...
            <div class="col col-1_5 hidden">
                <label for="LBY_RADIUS_REF">
                    ...
                    <select id="LBY_RADIUS_REF" name="LBY_RADIUS_REF" class="form-control" data-value="">
            ...
            <div class="additional-info hidden">
                <button type="button" class="btn btn-link btn-tight info-icon svg-icon-tiny" onclick="javascript:window.open('https://risk.nexis.com/AMLSolutions/help/Portal_Help.htm#Year_Of_Birth_Radius.htm', 'help', 'width=800,height=600,left=25,top=25,scrollbars=yes,menubar=no,resizable=yes');return false;">
                    <span class="tooltip centered">Help</span>
                </button>
            </div>
        </div>
    ...
    <div class="row">
        ...
        <div class="" id="watchlists_container">
            <div id="watchlists-info" class="hidden">
                <div id="watchlists_more" class="clear col col-9 collapse in hidden">
                            ...
                            <ul class="unmarked_list">
                                <li>
                                    <label for="FAR_CHECK" class="check">
                                        <input name="FAR_CHECK" id="FAR_CHECK" checked="checked" type="checkbox"><span>Foreign Agent Registrations</span>
                                    </label>
                                </li>
                                <li>
                                    <label for="PEP_CHECK" class="check">
                                        <input name="PEP_CHECK" id="PEP_CHECK" checked="checked" type="checkbox"><span>Politically Exposed Persons</span>
                                    </label>
                                </li>
                            </ul>
                        </div>
                            ...
                            <ul class="unmarked_list">
                                <li>
                                    <label for="GLOB_ALLSACTIONS" class="check">
                                        <input name="GLOB_ALLSACTIONS" id="GLOB_ALLSACTIONS" checked="checked" type="checkbox">
                                        <span>All</span>
                                    </label>
                                </li>
                                <li class="padding-left-15">
                                    <label for="GLOB_OFAC" class="check">
                                        <input name="GLOB_OFAC" id="GLOB_OFAC" checked="checked" type="checkbox">
                                        <span>OFAC - Office of Foreign Assets Control</span>
                                    </label>
                                </li>
                                <li class="padding-left-15">
                                    <label for="GLOB_COMMO" class="check">
                                        <input name="GLOB_COMMO" id="GLOB_COMMO" checked="checked" type="checkbox">
                                ...
                                <li class="padding-left-15">
                                    <label for="GLOB_MOST_WANTED" class="check">
                                        <input name="GLOB_MOST_WANTED" id="GLOB_MOST_WANTED" checked="checked" type="checkbox">
                                        <span>International Police Most Wanted and Red Alerts</span>
                                    </label>
                                </li>
                                <li class="padding-left-15">
                                    <label for="GLOB_CONTROLLER" class="check">
                                        <input name="GLOB_CONTROLLER" id="GLOB_CONTROLLER" checked="checked" type="checkbox">
                                        <span>Office of Controller of Currency - Unauthorized Banks</span>
                                    </label>
                                </li>
                                <li class="padding-left-15">
                                    <label for="GLOB_OSFI" class="check">
                                        <input name="GLOB_OSFI" id="GLOB_OSFI" checked="checked" type="checkbox">
                                        <span>OSFI - Canada</span>
                                    </label>
                                </li>
                                <li class="padding-left-15">
                                    <label for="GLOB_PEP" class="check">
                                        <input name="GLOB_PEP" id="GLOB_PEP" checked="checked" type="checkbox">
                                        <span>Politically Exposed Persons</span>
                                    </label>
                                </li>
                                <li class="padding-left-15">
                                    <label for="GLOB_TERROR" class="check">
                                        <input name="GLOB_TERROR" id="GLOB_TERROR" checked="checked" type="checkbox">
                                        <span>State Department Terrorist Exclusions</span>
                                    </label>
                                </li>
                                <li class="padding-left-15">
                                    <label for="GLOB_UNNT" class="check">
                                        <input name="GLOB_UNNT" id="GLOB_UNNT" checked="checked" type="checkbox">
                                        <span>United Nations Named Terrorists</span>
                                    </label>
                                </li>
                                <li class="padding-left-15">
                                    <label for="GLOB_USIS" class="check">
                                        <input name="GLOB_USIS" id="GLOB_USIS" checked="checked" type="checkbox">
                                ...
                                <li class="padding-left-15">
                                    <label for="GLOB_FIRMS" class="check">
                                        <input name="GLOB_FIRMS" id="GLOB_FIRMS" checked="checked" type="checkbox">
        ...
        <div id="passportorvisa-info">
            ...
            <div id="passportorvisa_more" class="clear col col-9 collapse in">
                <div class="row padding-left-10">
                    <div class="input col col-6">
                        <label>
                            <input id="MACHINE_READONE" name="MACHINE_READONE" value="" placeholder="Passport upper line (Format validation only)" class="form-control" type="text">
                            <span class="tooltip">
                ...
                <div class="row padding-left-10">
                    <div class="input col col-6">
                        <label>
                            <input id="MACHINE_READTWO" name="MACHINE_READTWO" value="" placeholder="Passport lower line (Format validation only)" class="form-control" type="text">
                            <span class="tooltip">
                ...
                <div class="row padding-left-10">
                    <div class="input col col-2">
                        <label>
                            ...
                            <select name="PASSPORT_GENDER" id="PASSPORT_GENDER" data-value="" class="form-control">
...
<div class="col col-3" id="search-options">
    ...
    <hr>
    <div id="instandidextlink" class="instand-ext-link" style="height: 0px; width: 30px;">
        <a target="_blank" href="javascirpt:void(0);">
            <img id="show_aba_image" name="show_aba_image" alt="Endorsed by the American Bankers Association" src="" border="0">
        </a>
    </div>
</div>
    ...
    <div class="pull-right">
					...
					<input name="DIRECT_REPORT" value="1" type="HIDDEN">
							...
							<input class="btn btn-danger" id="searchBtn" value="Search" onblur="ENTER_FOCUS=0;" onfocus="ENTER_FOCUS=1" onclick="if(!web20_validate('INSTANT_IDRF_REPORT')){ return false;}else{ show_loading(); send_ajax_event('REPORT2/INSTANT_IDRF','/app/evolution/misc');}" type="button">
...
<input name="CURRENT_EVENT" value="REPORT2/INSTANT_IDRF" type="HIDDEN">
...
<input name="PSID" value="49604934bc89e7e134ce2371813b17bc" type="hidden">
<input name="ACTION_MISC" value="/app/evolution/misc" type="hidden">
...
<div id="main_menu_data" class="no-print">
	...
	<ul data-sid="peoplelinks" data-li-prefix="people">
			...
			<li data-id="people_IDX_195" class="menu-show-group active" data-icon="person_icon">
...
<div class="new-edit-search-buttons" data-active-tabid="49604934bc89e7e134ce2371813b17bc"> 
    ...
    <button class="btn" onclick="">New Search</button> 
        ...
        <div id="search-results-con">
            <form name="SEARCH_RESULTS" method="post">
                    ...
                    <span class="hidden" id="custom-css">iidi_styles.css</span><div id="report_body" role="article"><div id="report_content">
<h2 class="person_icon svg-icon-normal report-header-h2">InstantID<sup class="sup-reg-symbol">®</sup> Consumer Verification with Red Flags Rule Report</h2>
<div class="report_title">
<strong>Generated On: </strong><time>10/01/2016&nbsp;12:00 PM EST</time> | Version: 1 | FOR INFORMATIONAL PURPOSES ONLY | Copyright © 2016 LexisNexis, All rights reserved.</div>
<div id="search_terms" class="ellipsis">
<strong>Search Terms: </strong>SSN:&nbsp;<strong class="term">111-11-1111</strong>;&nbsp;Last Name:&nbsp;<strong class="term">Doe</strong>;&nbsp;First Name:&nbsp;<strong class="term">john</strong>;&nbsp;Street Address:&nbsp;<strong class="term">1234 your street</strong>;&nbsp;City:&nbsp;<strong class="term">your city</strong>;&nbsp;State:&nbsp;<strong class="term">OH</strong>
</div>
<div id="report-created-for-container">
<strong>Report For:&nbsp;</strong><span>Doe,&nbsp;john</span>
</div>
<div class="report_title"></div>
<a id="InstantIDAnchor" class="navAnchor"></a><div id="index" class="report_section iid_section_separator">
...
<figure><img src="<TMPL_VAR HTMLPATH>/v4/img/cautionk_20.gif" alt="Risk Index(0 = High Risk, 50 = Low Risk): 20"><figcaption class="no-speak"><span class="">0</span><span class="">10</span><span class="selected">20</span><span class="">30</span><span class="">40</span><span class="">50</span></figcaption></figure><span class="fa fa-chevron-right index_right_arrow"></span><div class="inline-block-display col-5" id="verification-details">
<span class="font-em-1_3">Verification Risk Level: </span><br><span class="font-12">Minimal verification, critical ID elements not verified or associated with different person(s)<div class="font-12"><a href="javascript:void(0);" onclick=""><u>View List Possible Results</u></a></div></span>
</div>
</div>
</div>
...
<tr>
<th>DOB Match Level</th>
<td class="padding-left-5">No DOB found or no DOB submitted</td>
</tr>
</tbody></table>
...
<ul class="report_help_links"><li><button type="button" data-event="scroll" class="caret_up has-click-event btn btn-link btn-tight">Top</button></li></ul>
<table id="verification-details-table">
<thead><tr>
...
<td rowspan="3">1234 YOUR STREET<br>YOUR CITY, OH 45200-0000<br>
            (
            2004 - Oct 2016
            )
        <br><span class="font-12">Probable current address</span><br><br>6000 OLD AVE<br>YOUR CITY, OH 45200-0000<br>
            (
            Nov 1999 - Mar 2011
            )
        <br><br>4000 BIG AVE<br>YOUR CITY, OH 45200-0000<br>
            (
            Dec 2002 - Nov 2008
            )
        <br>
...
<div id="followupactions" class="report_section iid_section_separator">
<h3 class="iid_no_border">
<span>Follow-Up Actions </span><div class="additional-info padding-bottom-4 font-12"><a href="javascript:void(0);" onclick=""><u>About these Actions</u></a></div>
</h3>
<div class="section_container padding-left-20">
<ul class="report_help_links"><li><button type="button" data-event="scroll" class="caret_up has-click-event btn btn-link btn-tight">Top</button></li></ul>
<table><tbody>
<tr><th colspan="2" class="in-body-table-header">Request More Information from your Customer</th></tr>
<tr>
<th class="col-1_5">Potential Follow-Up Actions</th>
<td>1. Verify phone (Directory Assistance, utility bill)</td>
</tr>
<tr><th colspan="2" class="in-body-table-header">Risk Summary</th></tr>
<tr>
<th class="col-1_5">Other Solutions</th>
<td>
                                Instant ID<sup class="sup-reg-symbol">®</sup> Q&amp;A: Conduct knowledge based authentication with your customer<br>
                                Identity may be further authenticated through the use of InstantID<sup class="sup-reg-symbol">®</sup> Q&amp;A.
                                <a onclick="javascript:single_click_search(this,'SEARCH2/SHOW_ID_VERIFY','IIDQA', 0, '', '', 'ID_VERIFY',1);">Click here</a> to access InstantID<sup class="sup-reg-symbol">®</sup> Q&amp;A
...
<div id="RedFlagReport" class="report_section iid_section_separator">
<h3 class="iid_no_border">
<span>Red Flag Report </span><div class="additional-info padding-bottom-4 font-12"><a href="javascript:void(0);" onclick=""><u>About this Report</u></a></div>
</h3>
<div class="section_container padding-left-20">
<ul class="report_help_links"><li><button type="button" data-event="scroll" class="caret_up has-click-event btn btn-link btn-tight">Top</button></li></ul>
<table>
<thead><tr>
<th colspan="2">Red Flags Report Categories</th>
<th>Alerts</th>
</tr></thead>
<tbody><tr>
<td class="col-1 center"><span class="high-risk-icon svg-icon-normal" aria-label="High-Risk Flag"></span></td>
<td class="col-4_5">
<strong>Suspicious Personal Identifying Information:</strong> The person opening the covered account or the customer fails to provide all required personal identifying information on an application or in response to notification that the application is incomplete</td>
