...
<ul id="nav-fav-bar" class="nav">
    ...
    <ul id="history-tab-ul" class="nav nav-tabs multi-tab-view">
        ...
        <li class="btn-group history-tab dropdown active  not-form-tab hx-show" data-paramli="8a4c62476e7ffe4c4bb65019e0d0381c" data-isactive="1" data-islocked="0">
            <div class="btn-group" data-paramrecent="8a4c62476e7ffe4c4bb65019e0d0381c">
                ...
                <button data-container=".nav-tabs" data-toggle="popover" data-placement="top" data-trigger="hover" data-closebutton="off" class="tab-crit btn btn-lg btn-danger" onclick="" data-original-title="" title="">
                    <span data-searchtype="Motor Vehicle Registrations" data-tabshowevt="SEARCH2/SHOW_DL_REG" class="svg-icon-normal property_icon"></span>
                    <span class="history-tab-data" data-value="111-11-xxxx; Doe, john" aria-hidden="true">111-11-xxxx; Doe, john</span>
                </button>
		<div class="popper-content hide"><div class="popover-font-9 popover-tabs"></div></div>
                ...
                <ul id="tab_8a4c62476e7ffe4c4bb65019e0d0381c" class="dropdown-menu tab-dropdown anim-fadeInDown">
                    <li role="presentation" class="dropdown-header">
                        Tab History 
                                ...
                                <li tabindex="0" class="tab-dropdown-item lnkRecent" onclick="if($('.popup-link:hover').length === 0){process_tab_request(this,'8a4c62476e7ffe4c4bb65019e0d0381c',0);}" data-paramli="8a4c62476e7ffe4c4bb65019e0d0381c" data-page="1">
                                    <div class="history-tab-data">
                                        <span data-searchtype="Motor Vehicle Registrations" data-tabshowevt="SEARCH2/SHOW_DL_REG" class="svg-icon-small property_icon"></span>
                                        <span class="tab-search-name">Motor Vehicle Registrations (26)</span>
                                ...
                                <li tabindex="0" class="tab-dropdown-item lnkRecent recentRun hidden is-current-page" data-paramli="652d4745fc6980e660b2434ac03ed979" data-isreport="1" data-page="1">
                                    <div class="history-tab-data" onclick="javascript:if($('.popup-link:hover').length === 0){process_tab_request(this,'652d4745fc6980e660b2434ac03ed979',1);}">
                                        <span data-searchtype="Motor Vehicle" data-tabshowevt="" class="svg-icon-small document-icon"></span>
                                        <span class="tab-search-name">Motor Vehicle</span>
                                        <span class="tab-search-terms"></span>
                                    </div>
                                    
                                    <button type="button" class="btn btn-default pull-right external_link_icon svg-icon-x-tiny tab-btn" onclick="run_history_popup_search('652d4745fc6980e660b2434ac03ed979',1);"></button>
        ...
        <div class="additional-info">
            ...
            <ul id="tab-options-dropdown" class="dropdown-menu tab-dropdown anim-fadeInDown more-tabs-item">
                ...
                <li role="presentation" class="dropdown-header">Open Tabs (<span id="open-tab-count">1</span>)</li>
                    ...
                    <li tabindex="0" class="tab-dropdown-item lnkRecent more-tabs-item not-form-tab" data-paramli="8a4c62476e7ffe4c4bb65019e0d0381c">
                        <span class="close close-tab">
                            <a class="close-icon font-12" href="javascript:void(0);" onclick="remove_tab('8a4c62476e7ffe4c4bb65019e0d0381c');">
                                <span class="sr-only">Delete tab</span>
                            </a>
                        </span>
                        <div class="history-tab-data">
                            <section onclick="javascript:if($('.popup-link:hover').length === 0){process_tab_request(this,'8a4c62476e7ffe4c4bb65019e0d0381c',0,1);}">
                                <span class="svg-icon-normal property_icon" data-tabshowevt="SEARCH2/SHOW_DL_REG"></span>
                                <span class="tab-search-name">
                                    Motor Vehicle Registrations (26)
                                </span>
        ...
        <li class="right">
                ...
                <strong>Return to searches &gt;&gt;</strong>
					...
					<div class="container-fluid" id="search-container">
						<span id="web20-search-flags" class="hidden" data-search-disabled="0" data-search-error-message="0" data-report-error-message="0" data-is-from-main-menu="0" data-hit-tab-limit="0" data-rerun-display-event="0" data-web20-page-title="Motor Vehicle" data-search-idx="" data-clear-browser-cache-pages="" data-is-clk-search="0" data-is-search-within="0" data-search-within-terms="" data-webpubrec-request="0" data-is-new-window="0" data-active-tab="652d4745fc6980e660b2434ac03ed979" data-tab-id="8a4c62476e7ffe4c4bb65019e0d0381c" data-page="0" data-is-report="1" data-report-has-form="0" data-show-event="SEARCH2/SHOW_DL_REG"></span>
...
<input name="PSID" value="652d4745fc6980e660b2434ac03ed979" type="hidden">
<input name="ACTION_MISC" value="/app/evolution/misc" type="hidden">
...
<div id="main_menu_data" class="no-print">
	...
	<ul data-sid="assetslinks" data-li-prefix="assets">
			...
			<li data-id="assets_IDX_4" class="active" data-icon="property_icon">
				<a href="javascript:pm_tab_v3('SEARCH2/SHOW_DL_REG');">Motor Vehicle Registrations</a>
			</li>
...
<div class="new-edit-search-buttons" data-active-tabid="652d4745fc6980e660b2434ac03ed979"> 
...
<a class="navAnchor" id="mvrDocsAnchor"></a><a class="windowNavAnchor" id="mvrDocs"></a><h2 class="document-icon svg-icon-normal">Motor Vehicle Registrations Document</h2>
...
<h3><span id="mvr_header_1">Ohio Motor Vehicle Registration</span></h3>
<table class="source-chart">
<thead><tr><th colspan="6" id="mvr_vehicle_info_1_header">Vehicle Information</th></tr></thead>
<tbody>
<tr>
<th id="mvr_vehicle_info_vin_1">VIN</th>
<td headers="mvr_vehicle_info_1_header mvr_vehicle_info_vin_1">JTDK000000000000</td>
<th id="mvr_vehicle_info_restraint_1">Restraint</th>
<td headers="mvr_vehicle_info_1_header mvr_vehicle_info_restraint_1"></td>
<th id="mvr_vehicle_info_transmission_1">Transmission</th>
<td headers="mvr_vehicle_info_1_header mvr_vehicle_info_transmission_1">L</td>
</tr>
<tr>
<th id="mvr_vehicle_info_class_1">Vehicle Class</th>
<td headers="mvr_vehicle_info_1_header mvr_vehicle_info_class_1">PASSENGER CAR/LIGHT TRUCK</td>
<th id="mvr_vehicle_info_power_steering_1">Power Steering</th>
<td headers="mvr_vehicle_info_1_header mvr_vehicle_info_power_steering_1">Standard</td>
<th id="mvr_vehicle_info_air_cond_1">Air Conditioning</th>
<td headers="mvr_vehicle_info_1_header mvr_vehicle_info_air_cond_1">Standard</td>
</tr>
<tr>
<th id="mvr_vehicle_info_model_year_1">Model Year</th>
<td headers="mvr_vehicle_info_1_header mvr_vehicle_info_model_year_1">2009</td>
<th id="mvr_vehicle_info_roof_1">Roof</th>
<td headers="mvr_vehicle_info_1_header mvr_vehicle_info_roof_1">None / not available</td>
<th id="mvr_vehicle_info_front_wd_1">Front Wd</th>
<td headers="mvr_vehicle_info_1_header mvr_vehicle_info_front_wd_1">Yes</td>
</tr>
<tr>
<th id="mvr_vehicle_info_make_1">Make</th>
<td headers="mvr_vehicle_info_1_header mvr_vehicle_info_make_1">Toyota</td>
<th id="mvr_vehicle_info_optional_roof_1">Optional Roof</th>
<td headers="mvr_vehicle_info_1_header mvr_vehicle_info_optional_roof_1"></td>
<th id="mvr_vehicle_info_4wd_1">4WD</th>
<td headers="mvr_vehicle_info_1_header mvr_vehicle_info_4wd_1">No</td>
</tr>
<tr>
<th id="mvr_vehicle_info_model_1">Model</th>
<td headers="mvr_vehicle_info_1_header mvr_vehicle_info_model_1">Camry</td>
<th id="mvr_vehicle_info_fuel_type_1">Fuel</th>
<td headers="mvr_vehicle_info_1_header mvr_vehicle_info_fuel_type_1"></td>
<th id="mvr_vehicle_info_antilock_brakes_1">Anti-Lock Brakes</th>
<td headers="mvr_vehicle_info_1_header mvr_vehicle_info_antilock_brakes_1">4 wheel standard</td>
</tr>
<tr>
<th id="mvr_vehicle_info_series_1">Series</th>
<td headers="mvr_vehicle_info_1_header mvr_vehicle_info_series_1">BASE</td>
<th id="mvr_vehicle_info_tilt_wheel_1">Tilt Wheel</th>
<td headers="mvr_vehicle_info_1_header mvr_vehicle_info_tilt_wheel_1">Standard</td>
<th id="mvr_vehicle_info_power_brakes_1">Power Brakes</th>
<td headers="mvr_vehicle_info_1_header mvr_vehicle_info_power_brakes_1">Standard</td>
</tr>
<tr>
<th id="mvr_vehicle_info_style_1">Style</th>
<td headers="mvr_vehicle_info_1_header mvr_vehicle_info_style_1">Hatchback 4 Door</td>
<th id="mvr_vehicle_info_security_system_1">Security System</th>
<td headers="mvr_vehicle_info_1_header mvr_vehicle_info_security_system_1">Passive Engine Immobilizer, Keyless Entry &amp; Alarm</td>
<th id="mvr_vehicle_info_power_windows_1">Power Windows</th>
<td headers="mvr_vehicle_info_1_header mvr_vehicle_info_power_windows_1">Standard</td>
</tr>
<tr>
<th id="mvr_vehicle_info_color_1">Color</th>
<td headers="mvr_vehicle_info_1_header mvr_vehicle_info_color_1">Blue</td>
<th id="mvr_vehicle_info_radio_1">Radio</th>
<td headers="mvr_vehicle_info_1_header mvr_vehicle_info_radio_1">AM/FM CD/MP3</td>
<th id="mvr_vehicle_info_daytime_running_lights_1">Daytime Running Lights</th>
<td headers="mvr_vehicle_info_1_header mvr_vehicle_info_daytime_running_lights_1">Not available</td>
</tr>
<tr>
<th id="mvr_vehicle_info_engine_type_1">Engine Type</th>
<td headers="mvr_vehicle_info_1_header mvr_vehicle_info_engine_type_1">4</td>
<th id="mvr_vehicle_info_engine_size_1">Engine Size</th>
<td headers="mvr_vehicle_info_1_header mvr_vehicle_info_engine_size_1">91</td>
<th id="mvr_vehicle_info_base_price_1">Base Price</th>
<td headers="mvr_vehicle_info_1_header mvr_vehicle_info_base_price_1">$22,000</td>
</tr>
<tr>
<th id="mvr_vehicle_info_net_weight_1">Net Weight</th>
<td headers="mvr_vehicle_info_1_header mvr_vehicle_info_net_weight_1"></td>
...
<table>
<thead><tr><th colspan="2" id="mvr_owners_1_header">Owner Information</th></tr></thead>
<tbody>
<tr>
<th id="mvr_owners_name_1_1">Name</th>
<td headers="mvr_owners_1_header  mvr_owners_name_1_1">DOE,&nbsp;JOHN</td>
</tr>
<tr>
<th id="mvr_owners_dob_1_1">Date of Birth</th>
<td headers="mvr_owners_1_header  mvr_owners_dob_1_1">05/1977</td>
</tr>
<tr>
<th id="mvr_owners_address_1_1">Address</th>
<td headers="mvr_owners_1_header  mvr_owners_address_1_1">1234 YOUR STREET <br>YOUR CITY, OH 45200-0000<br>YOUR COUNTY</td>
</tr>
</tbody>
</table>
<table>
<thead><tr><th colspan="2" id="mvr_title_1_header">Title Information</th></tr></thead>
<tbody>
<tr>
<th id="mvr_title_number_1">Title Number</th>
<td headers="mvr_title_1_header mvr_title_number_1">30000011111</td>
</tr>
<tr>
<th id="mvr_title_original_title_date_1">Original Title Date</th>
<td headers="mvr_title_1_header mvr_title_original_title_date_1">08/25/2016</td>
</tr>
</tbody>
</table>
<table>
<thead><tr><th colspan="2" id="mvr_lienholders_1_header">LienHolder Information</th></tr></thead>
<tbody>
<tr>
<th id="mvr_lienholders_company_1_1">Company</th>
<td headers="mvr_lienholders_1_header  mvr_lienholders_company_1_1">LIEN OF OHIO INC.</td>
</tr>
<tr>
<th id="mvr_lienholders_address_1_1">Address</th>
<td headers="mvr_lienholders_1_header  mvr_lienholders_address_1_1">5000 MAIN AVE <br>YOUR CITY, OH 45200-0000<br>YOUR COUNTY</td>
</tr>
</tbody>
</table>
<table>
<thead><tr><th colspan="2" id="mvr_source_info_1_header">Source Information</th></tr></thead>
<tbody><tr>
<th id="mvr_source_info_data_source_1">Data Source</th>
<td headers="mvr_source_info_1_header mvr_source_info_data_source_1">Governmental</td>
</tr></tbody>
</table>
