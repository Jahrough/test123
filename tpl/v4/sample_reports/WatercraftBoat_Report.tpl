...
<title>Boat Registrations Document</title>
...
<link rel="stylesheet" type="text/css" media="screen" href="<TMPL_VAR HTMLPATH>/v4/css/icons.css">
	...
	<style type="text/css"> #popover792777{ top:80.5px; left:0px; display:block} </style>
...
<ul id="nav-fav-bar" class="nav">
        ...
        <li class="btn-group history-tab dropdown active  not-form-tab hx-show" data-paramli="" data-isactive="1" data-islocked="0">
            <div class="btn-group" data-paramrecent="">
                ...
                <button data-container=".nav-tabs" data-toggle="popover" data-placement="top" data-trigger="hover" data-closebutton="off" class="tab-crit btn btn-lg btn-danger" onclick="" data-original-title="" title="">
                    <span data-searchtype="Boat Registrations" data-tabshowevt="SEARCH2/SHOW_VESSEL" class="svg-icon-normal property_icon"></span>
                    <span class="history-tab-data" data-value="doe, john" aria-hidden="true">doe, john</span>
                </button>
		<div class="popper-content hide"><div class="popover-font-9 popover-tabs">doe, john</div></div>
                ...
                <ul id="tab_78e51110fcfa87900df3137a6c66cae1" class="dropdown-menu tab-dropdown anim-fadeInDown">
                    <li role="presentation" class="dropdown-header">
                        Tab History 
                                ...
                                <li tabindex="0" class="tab-dropdown-item lnkRecent" onclick="if($('.popup-link:hover').length === 0){process_tab_request(this,'78e51110fcfa87900df3137a6c66cae1',0);}" data-paramli="78e51110fcfa87900df3137a6c66cae1" data-page="1">
                                    <div class="history-tab-data">
                                        <span data-searchtype="Boat Registrations" data-tabshowevt="SEARCH2/SHOW_VESSEL" class="svg-icon-small property_icon"></span>
                                        <span class="tab-search-name">Boat Registrations (29)</span>
                                        <span class="tab-search-terms">doe, john</span>
                                    </div>
                                ...
                                <li tabindex="0" class="tab-dropdown-item lnkRecent recentRun hidden is-current-page" data-paramli="9fad76956d32ddc5b2879a78047ebfd0" data-isreport="1" data-page="1">
                                    <div class="history-tab-data" onclick="javascript:if($('.popup-link:hover').length === 0){process_tab_request(this,'9fad76956d32ddc5b2879a78047ebfd0',1);}">
                                        <span data-searchtype="Boat Registrations Document" data-tabshowevt="" class="svg-icon-small document-icon"></span>
                                        <span class="tab-search-name">Boat Registrations Document</span>
                                        <span class="tab-search-terms"></span>
                                    </div>
                                    
                                    <button type="button" class="btn btn-default pull-right external_link_icon svg-icon-x-tiny tab-btn" onclick="run_history_popup_search('9fad76956d32ddc5b2879a78047ebfd0',1);"></button>
        ...
        <div class="additional-info">
            ...
            <ul id="tab-options-dropdown" class="dropdown-menu tab-dropdown anim-fadeInDown more-tabs-item">
                ...
                <li role="presentation" class="dropdown-header">Open Tabs (<span id="open-tab-count">1</span>)</li>
                    ...
                    <li tabindex="0" class="tab-dropdown-item lnkRecent more-tabs-item not-form-tab" data-paramli="78e51110fcfa87900df3137a6c66cae1">
                        <span class="close close-tab">
                            <a class="close-icon font-12" href="javascript:void(0);" onclick="remove_tab('78e51110fcfa87900df3137a6c66cae1');">
                                <span class="sr-only">Delete tab</span>
                            </a>
                        </span>
                        <div class="history-tab-data">
                            <section onclick="javascript:if($('.popup-link:hover').length === 0){process_tab_request(this,'78e51110fcfa87900df3137a6c66cae1',0,1);}">
                                <span class="svg-icon-normal property_icon" data-tabshowevt="SEARCH2/SHOW_VESSEL"></span>
                                <span class="tab-search-name">
                                    Boat Registrations (29)
                                </span>
        ...
        <li class="right">
                ...
                <strong>Return to searches &gt;&gt;</strong>
					...
					<div class="container-fluid" id="search-container">
						<span id="web20-search-flags" class="hidden" data-search-disabled="0" data-search-error-message="0" data-report-error-message="0" data-is-from-main-menu="0" data-hit-tab-limit="0" data-rerun-display-event="0" data-web20-page-title="Boat Registrations Document" data-search-idx="" data-clear-browser-cache-pages="" data-is-clk-search="0" data-is-search-within="0" data-search-within-terms="" data-webpubrec-request="0" data-is-new-window="0" data-active-tab="9fad76956d32ddc5b2879a78047ebfd0" data-tab-id="78e51110fcfa87900df3137a6c66cae1" data-page="0" data-is-report="1" data-report-has-form="0" data-show-event="SEARCH2/SHOW_VESSEL"></span>
    ...
    <h2>
        <strong>Boat Registrations Document</strong>
    </h2>
...
<input name="PSID" value="9fad76956d32ddc5b2879a78047ebfd0" type="hidden">
<input name="ACTION_MISC" value="/app/evolution/misc" type="hidden">
...
<ul id="primary_sections_data" class="hidden no-print">
	...
	<li data-id="assetslinks_ps" data-icon="property_icon" data-active="true">
...
<div id="main_menu_data" class="no-print">
	...
	<ul data-sid="assetslinks" data-li-prefix="assets">
			...
			<li data-id="assets_IDX_16" class="active" data-icon="property_icon">
				<a href="javascript:pm_tab_v3('SEARCH2/SHOW_VESSEL');">Boat Registrations</a>
			</li>
...
<div class="new-edit-search-buttons" data-active-tabid="9fad76956d32ddc5b2879a78047ebfd0"> 
...
<a class="navAnchor" id="boatRegAnchor"></a><a class="windowNavAnchor" id="boatReg"></a><h2 class="document-icon svg-icon-normal">Boat Registrations Document</h2>
...
<h3 id="watercraft_header_1">Maine&nbsp;Boat Registration</h3>
<table>
<thead><tr><th colspan="2" id="watercraft_owner_1_header">Owner Information</th></tr></thead>
<tbody>
<tr>
<th id="watercraft_owner_name_1">Name</th>
<td headers="watercraft_owner_1_header  watercraft_owner_name_1">DOE,&nbsp;JOHN&nbsp;H</td>
</tr>
<tr>
<th id="watercraft_owner_ssn_1">SSN</th>
<td headers="watercraft_owner_1_header  watercraft_owner_ssn_1">006-30-XXXX</td>
</tr>
<tr>
<th id="watercraft_owner_address_1">Address</th>
<td headers="watercraft_owner_1_header  watercraft_owner_address_1">1234 YOUR STREET <br>YOUR CITY, ME 04400-0000<br>YOUR COUNTY</td>
</tr>
</tbody>
</table>
<table>
<thead><tr><th colspan="2" id="watercraft_registration_1_header">Registration Information</th></tr></thead>
<tbody>
<tr>
<th id="watercraft_registration_number_1">Registration Number</th>
<td headers="watercraft_registration_1_header watercraft_registration_number_1">1111K</td>
</tr>
<tr>
<th id="watercraft_registration_date_1">Registration Date</th>
<td headers="watercraft_registration_1_header watercraft_registration_date_1">07/27/2015</td>
</tr>
<tr>
<th id="watercraft_registration_expirationdate_1">Expiration Date</th>
<td headers="watercraft_registration_1_header watercraft_registration_expirationdate_1">12/31/2015</td>
</tr>
<tr>
<th id="watercraft_registrant_status_1">Status</th>
<td headers="watercraft_registration_1_header watercraft_registrant_status_1">ACTIVE</td>
</tr>
<tr>
<th id="watercraft_registration_datelastseen_1">Date Last Seen</th>
<td headers="watercraft_registration_1_header watercraft_registration_datelastseen_1">07/27/2015</td>
</tr>
</tbody>
</table>
<table>
<thead><tr><th colspan="6" id="watercraft_description_1_header">Description</th></tr></thead>
<tbody>
<tr>
<th id="watercraft_description_hull_num_1">Hull Number</th>
<td headers="watercraft_description_1_header watercraft_description_hull_num_1">T44F0000</td>
</tr>
<tr>
<th id="watercraft_description_imo_num_1">Class</th>
<td headers="watercraft_description_1_header watercraft_description_imo_num_1">0-10 HSP</td>
</tr>
<tr>
<th id="watercraft_description_type_1">Type</th>
<td headers="watercraft_description_1_header watercraft_description_type_1">OPEN</td>
</tr>
<tr>
<th id="watercraft_description_use_1">Use</th>
<td headers="watercraft_description_1_header watercraft_description_use_1">PLEASURE</td>
</tr>
<tr>
<th id="watercraft_description_model_year_1">Model Year</th>
<td headers="watercraft_description_1_header watercraft_description_model_year_1">1993</td>
</tr>
<tr>
<th id="watercraft_description_make_1">Make</th>
<td headers="watercraft_description_1_header watercraft_description_make_1">SEARS</td>
</tr>
<tr>
<th id="watercraft_description_propulsion_1">Propulsion</th>
<td headers="watercraft_description_1_header watercraft_description_propulsion_1">OUTBOARD</td>
</tr>
<tr>
<th id="watercraft_description_fuel_1">Fuel</th>
<td headers="watercraft_description_1_header watercraft_description_fuel_1">GAS</td>
</tr>
<tr>
<th id="watercraft_description_hull_1">Hull</th>
<td headers="watercraft_description_1_header watercraft_description_hull_1">ALUMINUM</td>
</tr>
<tr>
<th id="watercraft_description_length_1">Length</th>
<td headers="watercraft_description_1_header watercraft_description_length_1">14 ft </td>
</tr>
</tbody>
</table>
<table>
<thead><tr><th colspan="2" id="watercraft_engine_info_1_header">Engine Information</th></tr></thead>
<tbody><tr>
<th id="watercraft_engine_info_horsepower_1">HP</th>
<td headers="watercraft_engine_info_1_header  watercraft_engine_info_horsepower_1">9</td>
</tr></tbody>
</table>
<table>
<thead><tr><th colspan="2" id="watercraft_title_info_1_header">Title Information</th></tr></thead>
<tbody><tr>
<th id="watercraft_title_info_transaction_type_1">Transaction Type</th>
<td headers="watercraft_title_info_1_header watercraft_title_info_transaction_type_1">RENEWAL</td>
</tr></tbody>
</table>
<table>
<thead><tr><th colspan="2" id="watercraft_data_source_1_header">Data Source</th></tr></thead>
<tbody><tr>
<th id="watercraft_data_source_1">Data Source</th>
<td headers="watercraft_data_source_1_header watercraft_data_source_1">GOVERNMENTAL</td>
</tr></tbody>
</table>
<button type="button" class="caret_up has-click-event btn btn-link btn-tight pull-right" data-event="scroll">Top</button><h3 id="watercraft_header_2">Maine&nbsp;Boat Registration</h3>
<table>
<thead><tr><th colspan="2" id="watercraft_owner_2_header">Owner Information</th></tr></thead>
<tbody>
<tr><th colspan="2" id="watercraft_owner_2_subheader_1" class="sub-header">Owner 1</th></tr>
<tr>
<th id="watercraft_owner_name_2">Name</th>
<td headers="watercraft_owner_2_header watercraft_owner_2_subheader_1 watercraft_owner_name_2">DOE,&nbsp;JOHN&nbspD</td>
</tr>
<tr>
<th id="watercraft_owner_ssn_2">SSN</th>
<td headers="watercraft_owner_2_header watercraft_owner_2_subheader_1 watercraft_owner_ssn_2">111-11-XXXX</td>
</tr>
<tr>
<th id="watercraft_owner_address_2">Address</th>
<td headers="watercraft_owner_2_header watercraft_owner_2_subheader_1 watercraft_owner_address_2">998 MEDWAY RD <br>
  YOUR CITY, ME 04400-0000<br>
  YOUR COUNTY</td>
</tr>
<tr><th colspan="2" id="watercraft_owner_2_subheader_2" class="sub-header">Owner 2</th></tr>
<tr>
<th id="watercraft_owner_name_2">Name</th>
<td headers="watercraft_owner_2_header watercraft_owner_2_subheader_2 watercraft_owner_name_2">NULL</td>
</tr>
<tr>
<th id="watercraft_owner_address_2">Address</th>
<td headers="watercraft_owner_2_header watercraft_owner_2_subheader_2 watercraft_owner_address_2">998 MEDWAY RD <br>
  YOUR CITY, ME 04400-0000<br>
  YOUR COUNTY</td>
</tr>
</tbody>
...
<table>
<thead><tr><th colspan="2" id="watercraft_registration_2_header">Registration Information</th></tr></thead>
<tbody>
<tr>
<th id="watercraft_registration_number_2">Registration Number</th>
<td headers="watercraft_registration_2_header watercraft_registration_number_2">1111K</td>
</tr>
<tr>
<th id="watercraft_registration_date_2">Registration Date</th>
<td headers="watercraft_registration_2_header watercraft_registration_date_2">08/01/2011</td>
</tr>
<tr>
<th id="watercraft_registration_expirationdate_2">Expiration Date</th>
<td headers="watercraft_registration_2_header watercraft_registration_expirationdate_2">12/31/2011</td>
</tr>
<tr>
<th id="watercraft_registration_datelastseen_2">Date Last Seen</th>
<td headers="watercraft_registration_2_header watercraft_registration_datelastseen_2">08/01/2011</td>
</tr>
</tbody>
</table>
<table>
<thead><tr><th colspan="6" id="watercraft_description_2_header">Description</th></tr></thead>
<tbody>
<tr>
<th id="watercraft_description_hull_num_2">Hull Number</th>
<td headers="watercraft_description_2_header watercraft_description_hull_num_2">T44F0000</td>
</tr>
<tr>
<th id="watercraft_description_imo_num_2">Class</th>
<td headers="watercraft_description_2_header watercraft_description_imo_num_2">0-10 hsp</td>
</tr>
<tr>
<th id="watercraft_description_type_2">Type</th>
<td headers="watercraft_description_2_header watercraft_description_type_2">OPEN           BOAT</td>
</tr>
<tr>
<th id="watercraft_description_use_2">Use</th>
<td headers="watercraft_description_2_header watercraft_description_use_2">PLEASURE</td>
</tr>
<tr>
<th id="watercraft_description_model_year_2">Model Year</th>
<td headers="watercraft_description_2_header watercraft_description_model_year_2">1993</td>
</tr>
<tr>
<th id="watercraft_description_make_2">Make</th>
<td headers="watercraft_description_2_header watercraft_description_make_2">SEARS</td>
</tr>
<tr>
<th id="watercraft_description_propulsion_2">Propulsion</th>
<td headers="watercraft_description_2_header watercraft_description_propulsion_2">OUTBOARD</td>
</tr>
<tr>
<th id="watercraft_description_color_2">Color</th>
<td headers="watercraft_description_2_header watercraft_description_color_2">NULL</td>
</tr>
<tr>
<th id="watercraft_description_fuel_2">Fuel</th>
<td headers="watercraft_description_2_header watercraft_description_fuel_2">GAS</td>
</tr>
<tr>
<th id="watercraft_description_hull_2">Hull</th>
<td headers="watercraft_description_2_header watercraft_description_hull_2">ALUMINUM</td>
</tr>
<tr>
<th id="watercraft_description_length_2">Length</th>
<td headers="watercraft_description_2_header watercraft_description_length_2">14 ft </td>
</tr>
</tbody>
</table>
<table>
<thead><tr><th colspan="2" id="watercraft_engine_info_2_header">Engine Information</th></tr></thead>
<tbody><tr>
<th id="watercraft_engine_info_horsepower_2">HP</th>
<td headers="watercraft_engine_info_2_header  watercraft_engine_info_horsepower_2">9</td>
</tr></tbody>
</table>
<table>
<thead><tr><th colspan="2" id="watercraft_title_info_2_header">Title Information</th></tr></thead>
<tbody><tr>
<th id="watercraft_title_info_transaction_type_2">Transaction Type</th>
<td headers="watercraft_title_info_2_header watercraft_title_info_transaction_type_2">RENEWAL</td>
</tr></tbody>
</table>
<table>
<thead><tr><th colspan="2" id="watercraft_data_source_2_header">Data Source</th></tr></thead>
<tbody><tr>
<th id="watercraft_data_source_2">Data Source</th>
<td headers="watercraft_data_source_2_header watercraft_data_source_2">GOVERNMENTAL</td>
</tr></tbody>
</table>
