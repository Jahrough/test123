...
<title>Verification of Occupancy</title>
...
<link rel="stylesheet" type="text/css" media="screen" href="<TMPL_VAR HTMLPATH>/v4/css/icons.css">
    ...
    <link class="dynamic-css" rel="stylesheet" type="text/css" media="screen" href="<TMPL_VAR HTMLPATH>/v4/css/voo_styles.css">
...
<ul id="nav-fav-bar" class="nav">
    ...
    <ul id="history-tab-ul" class="nav nav-tabs multi-tab-view">
        ...
        <li class="btn-group history-tab dropdown  not-form-tab hx-show" data-paramli="0a03925ff01f375f5034993072f592b9" data-isactive="0" data-islocked="0">
            <div class="btn-group" data-paramrecent="0a03925ff01f375f5034993072f592b9">
                
                
		<div class="popper-content hide"><div class="popover-font-9 popover-tabs">Thigpen, james; 4809 winona terrace; cincinnati; OH; 45227</div></div>
                        ...
                        Tab History 
                                ...
                                <li tabindex="0" class="tab-dropdown-item lnkRecent" onclick="if($('.popup-link:hover').length === 0){process_tab_request(this,'0a03925ff01f375f5034993072f592b9',0);}" data-paramli="0a03925ff01f375f5034993072f592b9" data-page="1">
                                    <div class="history-tab-data">
                                        ...
                                        <span class="tab-search-terms">Thigpen, james; 4809 winona terrace; cincinna...</span>
                                    </div>
                                ...
                                <li tabindex="0" class="tab-dropdown-item lnkRecent recentRun hidden" data-paramli="b8e8ea78152da8e0efab2006f6c78353" data-isreport="1" data-page="1">
        ...
        <li class="btn-group history-tab dropdown active  not-form-tab hx-show" data-paramli="6d1e294e408a9c3d50729654d49bd421" data-isactive="1" data-islocked="0">
            <div class="btn-group" data-paramrecent="6d1e294e408a9c3d50729654d49bd421">
                ...
                <button data-container=".nav-tabs" data-toggle="popover" data-placement="top" data-trigger="hover" data-closebutton="off" class="tab-crit btn btn-lg btn-danger" onclick="" data-original-title="" title="">
                    <span data-searchtype="Verification of Occupancy" data-tabshowevt="SEARCH2/SHOW_VERIFICATION_OF_OCCUPANCY" class="svg-icon-normal document-icon"></span>
                    <span class="history-tab-data" data-value="" aria-hidden="true">111-11-xxxx; Doe, john; 1234 your street...</span>
                </button>
		<div class="popper-content hide"><div class="popover-font-9 popover-tabs"></div></div>
                ...
                <button class="multi-tab btn btn-danger hidden" onclick="javascript:set_tab_view_session('multi');">Toggle to Multi-tab View</button>
                <ul id="tab_6d1e294e408a9c3d50729654d49bd421" class="dropdown-menu tab-dropdown anim-fadeInDown">
                    <li role="presentation" class="dropdown-header">
                        Tab History 
                    </li>
                                ...
                                <li tabindex="0" class="tab-dropdown-item lnkRecent recentRun is-current-page" data-paramli="6d1e294e408a9c3d50729654d49bd421" data-isreport="1" data-page="1">
                                    <div class="history-tab-data" onclick="javascript:if($('.popup-link:hover').length === 0){process_tab_request(this,'6d1e294e408a9c3d50729654d49bd421',1);}">
                                        <span data-searchtype="Verification of Occupancy" data-tabshowevt="SEARCH2/SHOW_VERIFICATION_OF_OCCUPANCY" class="svg-icon-small document-icon"></span>
                                        <span class="tab-search-name">Verification of Occupancy</span>
                                        <span class="tab-search-terms">329-66-xxxx; Thigpen, james; 4809 winona terr...</span>
                                    </div>
                                    
                                    <button type="button" class="btn btn-default pull-right external_link_icon svg-icon-x-tiny tab-btn" onclick="run_history_popup_search('6d1e294e408a9c3d50729654d49bd421',1);"></button>
        ...
        <div class="additional-info">
            ...
            <ul id="tab-options-dropdown" class="dropdown-menu tab-dropdown anim-fadeInDown more-tabs-item">
                ...
                <li role="presentation" class="dropdown-header">Open Tabs (<span id="open-tab-count">2</span>)</li>
                        ...
                        <div class="history-tab-data">
                            <section onclick="javascript:if($('.popup-link:hover').length === 0){process_tab_request(this,'0a03925ff01f375f5034993072f592b9',0,1);}">
                                ...
                                <span class="tab-search-terms">
                                    Thigpen, james; 4809 winona terrace; cincinna...
                                </span>
                            </section>
                        </div>
                        <br class="clear">
                    ...
                    <li tabindex="0" class="tab-dropdown-item lnkRecent more-tabs-item not-form-tab is-current-page" data-paramli="6d1e294e408a9c3d50729654d49bd421">
                        <span class="close close-tab">
                            <a class="close-icon font-12" href="javascript:void(0);" onclick="remove_tab('6d1e294e408a9c3d50729654d49bd421');">
                                <span class="sr-only">Delete tab</span>
                            </a>
                        </span>
                        <div class="history-tab-data">
                            <section onclick="javascript:if($('.popup-link:hover').length === 0){process_tab_request(this,'6d1e294e408a9c3d50729654d49bd421',1,1);}">
                                <span class="svg-icon-normal document-icon" data-tabshowevt="SEARCH2/SHOW_VERIFICATION_OF_OCCUPANCY"></span>
                                <span class="tab-search-name">
                                    Verification of Occupancy (1)
                                </span>
                                <span class="tab-search-terms">
                                    329-66-xxxx; Thigpen, james; 4809 winona terr...
                                </span>
                            </section>
                        </div>
                        <br class="clear">
...
<h2 class="bus_icon svg-icon-normal report-header-h2">Verification of Occupancy Report - Occupancy as of 10/01/2016</h2>
<div class="report_title"><span class="font-12 report-generated-on"><strong>Generated On: </strong><time>10/01/2016&nbsp;12:00 PM EST</time> | FOR INFORMATIONAL PURPOSES ONLY | Copyright ©&nbsp;2016 LexisNexis, All rights reserved.</span></div>
<div id="search_terms" class="clear report-search-terms">
<strong>Search Terms: </strong>SSN:&nbsp;<strong class="term">111-11-1111</strong>;&nbsp;Last Name:&nbsp;<strong class="term">Doe</strong>;&nbsp;First Name:&nbsp;<strong class="term">john</strong>;&nbsp;Street:&nbsp;<strong class="term">1234 your street</strong>;&nbsp;City:&nbsp;<strong class="term">your city</strong>;&nbsp;State:&nbsp;<strong class="term">OH</strong><br>
</div>
<div id="report-created-for-container" class="report_title">
<strong>Report created for:&nbsp;</strong>LN Product QA(1831638)</div>
<div id="Summary" class="report_section collapsible-section">
<h3><span class="collapsible open fa-icon-tiny-before" role="heading" aria-level="3">Person Summary</span></h3>
...
<tr>
<td>DOE,&nbsp;JOE&nbsp;D</td>
<td>1234 YOUR STREET <br>YOUR CITY, OH 45200<br><span class="font-12 textGray">(Residence, Street)</span>
</td>
<td>YOUR COUNTY</td>
<td><ul class="unmarked_list">
<li>513-555-5555</li>
<li class="green-check-icon svg-icon-small font-12">(Most Recent Listing)</li>
<li class="residential-phone-icon svg-icon-small font-12">(Residential)</li>
</ul></td>
</tr>
<tr>
<th><img src="<TMPL_VAR HTMLPATH>/v4/img/lexid.png" alt="LexID®" id="lexid-img"></th>
<th>SSN</th>
<th>DOB</th>
<th>Email</th>
</tr>
...
<td>111-11-XXXX<div><span class="font-12 textGray">(Issued in IL, 1978 - 1979)</span></div>
</td>
<td>05/1977<br><span class="font-12 textGray">(Age: 40)</span>
</td>
<td>jd@aol.com<br>jdoen@gmail.com</td>
</tr>
</tbody></table>
<h4 class="textRed">Target Property Summary</h4>
<table id="target_summary_table" class="fixed"><tbody>
<tr>
<th>Address</th>
<th>County</th>
...
<tr>
<td>1234 YOUR STREET <br>YOUR CITY, OH 45200</td>
<td>YOUR COUNTY</td>
<td colspan="2">Single family</td>
</tr>
</tbody></table>
<div id="ScoreSection" class="report_section">
<div id="vooPropertyInfo">
<div id="vooScore">
<h4 class="font-bold textRed">Verification of Occupancy Score</h4>
<div id="score"><span style="left: 432px;" class="caret_down">90</span></div>
<div id="scale">


<ul id="scale-items">
<div style="text-align:center;"><img src="<TMPL_VAR HTMLPATH>/v4/img/fraud_scale.gif"></div>
<ul id="scale-descriptions">
<li>
<strong class="block-display">High</strong><span>Occupancy Risk</span>
</li>
<li>
<strong class="block-display">Moderate</strong><span>Occupancy Risk</span>
</li>
<li>
<strong class="block-display">Low</strong><span>Occupancy Risk</span>
</li>
</ul>
</div>
<a href="javascript:void(0);" data-helpid="VOO_SCORE_HELP" data-helptype="score-help">Score Help</a><span class="block-display font-em-1_3">Subject likely occupies the target property</span>
</div>
<div id="ownerStatus">
<h4 class="font-bold textRed">Ownership Status and Property Type</h4>
<ul id="property-type">
<li><div class="additional-info">
<img src="<TMPL_VAR HTMLPATH>/v4/img/house_icon0.png" alt="Property Not Owned"><span class="tooltip hover">Property Not Owned</span>
</div></li>
<li><div class="additional-info">
<img src="<TMPL_VAR HTMLPATH>/v4/img/house_icon1.png" alt="Owned but Likely Unoccupied"><span class="tooltip hover">Owned but Likely Unoccupied</span>
</div></li>
<li><div class="additional-info">
<img src="<TMPL_VAR HTMLPATH>/v4/img/house_icon2.png" alt="Investment Property"><span class="tooltip hover">Investment Property</span>
</div></li>
<li><div class="additional-info">
<img src="<TMPL_VAR HTMLPATH>/v4/img/house_icon3.png" alt="Second Home"><span class="tooltip hover">Second Home</span>
</div></li>
<li><div class="additional-info">
<img src="<TMPL_VAR HTMLPATH>/v4/img/house_icon4-over.png" alt="Primary Residence"><span class="tooltip hover">Primary Residence</span>
</div></li>
</ul>
<strong class="font-em-1_5 block-display">Primary Residence</strong><span class="font-em-1_3 block-display">Subject owns the target property, and the property is likely a primary residence</span>
</div>
</div>
<table><tbody>
<tr>
<th><div class="additional-info">
<a href="javascript:void(0);">Confirming Sources</a><span class="tooltip hover tooltip-25 info-text">Level of evidence from credit bureau header records and public record data that the target property is or was the most recently reported property based on the input date.</span>
</div></th>
<td></td>
<td>Target property is most recently reported by at least one public record source and all three credit header source</td>
<th><div class="additional-info">
<a href="javascript:void(0);">Property Mailing Characteristics</a><span class="tooltip hover tooltip-25 info-text">Level of evidence that the deed or tax assessment mailing addresses match the target property address.</span>
</div></th>
<td></td>
<td>Mailing address and physical address of the target property match</td>
</tr>
<tr>
<th><div class="additional-info">
<a href="javascript:void(0);">Address History</a><span class="tooltip hover tooltip-25 info-text">Level of evidence that the target property is or was the most recently reported address and a uniquely reported address based on the input date.</span>
</div></th>
<td></td>
<td>Target address is the only recently reported address for the subjec</td>
<th><div class="additional-info">
<a href="javascript:void(0);" class="tooltips">Prior Address Evidence of Move</a><span class="tooltip-25 tooltip info-text hover">Level of evidence that the subject recently moved and therefore is more likely to reside at the target address.</span>
</div></th>
<td></td>
<td>Subject never owned the prior property, and the prior address is no longer reported for the subject and is not currently reported for new identities</td>
</tr>
<tr>
<th><div class="additional-info">
<a href="javascript:void(0);">Phone &amp; Utility History</a><span class="hover tooltip tooltip-25 info-text">Level of evidence of existing utility services</span>
</div></th>
<td></td>
<td>Sources reporting multiple utilities at the target addres</td>
<th><div class="additional-info">
<a href="javascript:void(0);">Prior Residents Move Evidence</a><span class="tooltip-25 tooltip hover info-text">Level of evidence that the prior residents of the target address moved and therefore are unlikely to occupy the target address.</span>
</div></th>
<td></td>
<td>Prior residents sold the target property and have since bought a new property</td>
</tr>
<tr>
<th><div class="additional-info">
<a href="javascript:void(0);">Property Ownership Status</a><span class="info-text tooltip-25 tooltip hover">Level of evidence of the subject's ownership based on the address deed and tax records.</span>
</div></th>
<td></td>
<td>Subject or spouse own the target property and no other propertie</td>
<th><div class="additional-info">
<a href="javascript:void(0);">Occupancy Override</a><span class="tooltip-25 tooltip hover info-text">Whether evidence exists that the subject was deceased or incarcerated as of the input date.</span>
</div></th>
<td></td>
<td>Subject not reported as deceased at or before the input date, or subject not reported as incarcerated at the input date</td>
</tr>
<tr>
<th><div class="additional-info">
<a href="javascript:void(0);">Identities Associated with Target Property</a><span class="hover tooltip-25 tooltip info-text">Level of evidence of first-degree relatives or associated identities.</span>
</div></th>
<td></td>
<td>Subject has first-degree relatives or associated identities currently reported at the target addres</td>
<th><div class="additional-info">
<a href="javascript:void(0);">Other Owned Property Proximity</a><span class="hover tooltip-25 tooltip info-text">Approximate distance in miles between the target property and the nearest additional property owned by the subject.</span>
</div></th>
<td></td>
<td>Distance is not applicable.  Subject either does not own target property or does not own additional property</td>
</tr>
</tbody></table>
</div>
</div>
</div>
<a id="Sources" class="navAnchor"></a><div id="Sources" class="report_section collapsible-section">
<h3><span class="collapsible open fa-icon-tiny-before">Confirming Sources</span></h3>
<div class="section_container">
<p>Most recent sources associating relationship or person to target property</p>
<table class="fixed">
<thead><tr>
<th>Source Type</th>
<th>From-To</th>
...
<td>07/2005 - 08/2016</td>
<td>6</td>
</tr>
<tr>
<td>Consumer Reporting Agency 2</td>
<td>10/2004 - 10/2016</td>
<td>5</td>
</tr>
<tr>
<td>Property Record</td>
<td>08/2004 - 07/2010</td>
<td>5</td>
</tr>
<tr>
...
<td>07/2005 - 09/2016</td>
<td>2</td>
</tr>
<tr>
<td>Court Record</td>
<td>07/2007 - 02/2016</td>
<td>2</td>
</tr>
<tr>
<td>Whitepages</td>
<td>10/2009 - 08/2016</td>
<td>1</td>
</tr>
<tr>
<td>Voter Registration</td>
<td>11/2004 - 03/2016</td>
<td>1</td>
</tr>
<tr>
<td>Driver's License</td>
<td>05/2008 - 12/2015</td>
<td>1</td>
</tr>
<tr>
<td>Utility Record</td>
<td>06/2015 - 10/2015</td>
<td>1</td>
</tr>
</tbody>
</table>
...
<a id="Utilities" class="navAnchor"></a><div id="Utilities" class="report_section collapsible-section">
<h3><span class="collapsible open fa-icon-tiny-before">Phone and Utility History</span></h3>
<div class="section_container">
<p>Phone and Utility history associated to the subject and subject property</p>
<div id="Target_Records" class="report_sub_section collapsible-section">
<h4><span class="collapsible open fa-icon-tiny-before">Target Property Records</span></h4>
<div class="section_container"><table class="fixed">
<thead><tr>
<th>Service Type</th>
<th>Reported Subject</th>
<th>Service Connect Date</th>
<th>Actions</th>
</tr></thead>
<tbody>
<tr>
...
<td>Phone</td>
<td>DOE, JANE</td>
<td>09/2013 - 10/2016</td>
<td>
<a href="javascript:void(0);" class="clear">Person Report</a><div class="additional-info pull-right"><a href="javascript:void(0);" class="btn btn-default external_link_icon svg-icon-x-tiny tab-btn" aria-label="Open Person Report in a new window"><span class="tooltip tooltip-right">Open in New Window</span></a></div>
<input name="targetrecord_2" id="targetrecord_2" value="UNIQUEID|2530752006|LOG_AS|cp_lpersrpt" type="hidden">
</td>
</tr>
<tr>
<td>Phone</td>
<td>DOE, JOHN D</td>
<td>09/2009 - 10/2016</td>
<td>
<a href="javascript:void(0);" class="clear">Person Report</a><div class="additional-info pull-right"><a href="javascript:void(0);" class="btn btn-default external_link_icon svg-icon-x-tiny tab-btn" aria-label="Open Person Report in a new window"><span class="tooltip tooltip-right">Open in New Window</span></a></div>
<input name="targetrecord_3" id="targetrecord_3" value="UNIQUEID|1228537164|LOG_AS|cp_lpersrpt" type="hidden">
</td>
</tr>
<tr>
<td>Phone</td>
...
<td>
<a href="javascript:void(0);" class="clear">Person Report</a><div class="additional-info pull-right"><a href="javascript:void(0);" class="btn btn-default external_link_icon svg-icon-x-tiny tab-btn" aria-label="Open Person Report in a new window"><span class="tooltip tooltip-right">Open in New Window</span></a></div>
<input name="targetrecord_4" id="targetrecord_4" value="UNIQUEID|1228537164|LOG_AS|cp_lpersrpt" type="hidden">
</td>
</tr>
</tbody>
</table></div>
</div>
<div id="Subject_Records" class="report_sub_section collapsible-section">
<h4><span class="collapsible open fa-icon-tiny-before">Subject Records</span></h4>
<div class="section_container"><table class="fixed">
<thead><tr>
<th>Service Type</th>
...
<tr>
<td>Utility</td>
<td>1234 YOUR STREET <br>
  YOUR CITY, OH 45200</td>
<td>06/2015</td>
</tr>
<tr>
<td>Phone</td>
<td>1234 YOUR STREET <br>YOUR CITY, OH 45208</td>
<td>09/2009 - 10/2016</td>
</tr>
</tbody>
</table></div>
...
<a id="Properties" class="navAnchor"></a><div id="Properties" class="report_section collapsible-section">
<h3><span class="collapsible open fa-icon-tiny-before">Other Real Estate Owned</span></h3>
<div class="section_container"><div id="Curr_Properties" class="report_sub_section collapsible-section">
<h4><span class="collapsible open fa-icon-tiny-before" aria-level="3" role="heading">Current Properties</span></h4>
<div class="section_container"><table class="brownTable">
<thead><tr>
<th>#</th>
<th>Address</th>
<th>Purchase Date</th>
...
<td>1</td>
<td>
<ul class="unmarked_list col">
<li>1234 YOUR STREET </li>
<li>YOUR CITY, OH 45220</li>
</ul>
<div class="col col-max-1 no-print"><div class="additional-info block-display">
<button type="button" id="current_1_map_button" onclick="" class="btn btn-link map_icon add-actions" data-toggle="modal" data-target="#current_1_map" aria-hidden="true"><span class="tooltip centered">View Map</span></button><div id="current_1_map" class="modal addressmap disclaimer" data-backdrop="static" role="dialog" tabindex="0" aria-hidden="true" data-address="4809 WINONA TER CINCINNATI OH 45227 " data-viewtype="0" data-title="Address" data-refcode=""><div class="resizable-dialog">
<div class="resizable-header">
<button type="button" class="close close-icon" data-dismiss="modal"></button><h4 class="modal-title">4809 WINONA TER CINCINNATI OH 45227 </h4>
</div>
...
<button type="button" class="btn btn-default" data-dismiss="modal">I Decline</button><button type="button" class="btn" onclick="javascript:map_shown(current_1_map);">I Agree</button>
</div>
<div class="resizable-footer disclaimer-dismiss"><button type="button" class="btn btn-default" onclick="javascript:hide_map_disclaimer(current_1_map);">Ok</button></div>
<div class="resizable-footer disclaimer-link"><button type="button" class="btn btn-link" onclick="javascript:show_map_disclaimer(current_1_map);">Disclaimer</button></div>
</div></div>
</div></div>
</td>
<td>05/10/2002</td>
...
<li class="clear">
<a href="javascript:void(0);" class="clear pull-left col-8">Property History Report</a><div class="additional-info pull-right"><a href="javascript:void(0);" class="btn btn-default external_link_icon svg-icon-x-tiny tab-btn" aria-label="Open Property History Report in a new window"><span class="tooltip tooltip-right">Open in New Window</span></a></div>
</li>
<li class="clear">
<a href="javascript:void(0);" class="clear">Verification of Occupancy</a><div class="additional-info pull-right"><a href="javascript:void(0);" class="btn btn-default external_link_icon svg-icon-x-tiny tab-btn" aria-label="Open Verification of Occupancy in a new window"><span class="tooltip tooltip-right">Open in New Window</span></a></div>
</li>
</ul>
<input name="realproperty_address_dict_1" id="realproperty_address_dict_1" value="" type="hidden"><input name="targetrecord_1" id="targetrecord_1" value="UNIQUEID||LOG_AS|cp_lpersrpt" type="hidden">
</td>
</tr></tbody>
</table></div>
</div></div>
</div>
<a id="Identities" class="navAnchor"></a><div id="Identities" class="report_section collapsible-section">
<h3><span class="collapsible open fa-icon-tiny-before">Identities Associated with Target Property</span></h3>
<div class="section_container">
<p>Identities associated with target property</p>
<table class="fixed">
<thead><tr>
<th>Names</th>
<th>LexID</th>
<th>From-To</th>
<th>Association To Subject</th>
<th>Actions</th>
</tr></thead>
<tbody>
<tr>
...
<td>04/2016 - 04/2016</td>
<td>Relative or Associate</td>
<td>
<a href="javascript:void(0);" class="clear">Person Report</a><div class="additional-info pull-right"><a href="javascript:void(0);" class="btn btn-default external_link_icon svg-icon-x-tiny tab-btn" aria-label="Open Person Report in a new window"><span class="tooltip tooltip-right">Open in New Window</span></a></div>
<input name="identityrecord_1" id="identityrecord_1" value="" type="hidden">
</td>
</tr>
<tr>
<td>DOE, JANE</td>
<td>0000-3333-6666</td>
<td>09/2004 - 08/2016</td>
<td>Spouse</td>
<td>
<a href="javascript:void(0);" class="clear">Person Report</a><div class="additional-info pull-right"><a href="javascript:void(0);" class="btn btn-default external_link_icon svg-icon-x-tiny tab-btn" aria-label="Open Person Report in a new window"><span class="tooltip tooltip-right">Open in New Window</span></a></div>
<input name="identityrecord_2" id="identityrecord_2" value="" type="hidden">
</td>
</tr>
<tr>
<td>DOE, JOHN</td>
<td>0000-2222-7777</td>
<td>08/2004 - 08/2016</td>
<td>Subject</td>
<td>
<a href="javascript:void(0);" class="clear">Person Report</a><div class="additional-info pull-right"><a href="javascript:void(0);" class="btn btn-default external_link_icon svg-icon-x-tiny tab-btn" aria-label="Open Person Report in a new window"><span class="tooltip tooltip-right">Open in New Window</span></a></div>
<input name="identityrecord_3" id="identityrecord_3" value="" type="hidden">
</td>
</tr>
</tbody>
</table>
