<div class="col-xs-7 portfolio-item innercontent">
    ...
    <div class="row">
        ...
        <div id="peoplelinks_ps_widget" class="col-3-grid collapsible-menu" data-link-threshold="12">
    ...
    <div class="row">
        ...
        <div id="businesseslinks_ps_widget" class="col-3-grid collapsible-menu" data-link-threshold="10">
            <ul class="main-menu-ul col-xs-4">
            </ul>
            <ul class="main-menu-ul col-xs-4">
            </ul>
    ...
    <div class="row">
        ...
        <!-- FCRA -->
        <div class="col-xs-4 no-padding-left fcra">
