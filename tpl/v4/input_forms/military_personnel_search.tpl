<div id="search-form-fields" class="col col-7">
    <fieldset class="row">
        ...
        <script>
            var input_group_arr = [
                ...
                ['BOOL_NAME_FULL', 'ADDITIONAL_TERMS', 'TERMS_SEGMENTS', 'TERMS_SEGMENTS_ADD', 'BOOL_MILITARY_SERVICE_BRANCH', 'BOOL_STATE']
            ];
            var segment_arr = [
    ...
    <div class="row">
        <div class="input col col-3">
            <label>
                <span class="sr-only">State</span>
                <select id="BOOL_STATE" name="BOOL_STATE" data-value="<TMPL_VAR NAME=BOOL_STATE>" class="form-control">
                    <option value="">All Available States</option>
                    <option value="AL">AL - Alabama</option>
                    <option value="AK">AK - Alaska</option>
                    <option value="AZ">AZ - Arizona</option>
    ...
    <div class="row">
        <div class="input col col-3">
            <label>
                <span class="sr-only">Military Service Branch</span>
                <select name="MILITARY_SERVICE_BRANCH" id="MILITARY_SERVICE_BRANCH" data-value="<TMPL_VAR NAME=MILITARY_SERVICE_BRANCH>" class="form-control">
    ...
    <div class="row">
        <div class="input col col-3">
            <label>
                <span class="sr-only">Military Service Branch</span>
                <select name="BOOL_MILITARY_SERVICE_BRANCH" data-value="<TMPL_VAR NAME=BOOL_MILITARY_SERVICE_BRANCH>" id="BOOL_MILITARY_SERVICE_BRANCH"  class="form-control">
                    <option selected="selected" value="">All Available</option>
                    <option value="Army">US Army</option>
                    <option value="Air Force">US Air Force</option>
                    <option value="Marines">US Marines</option>
