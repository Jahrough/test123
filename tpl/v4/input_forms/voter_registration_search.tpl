<div id="search-form-fields" class="col col-7">
    <fieldset class="row">
        ...
        <script>
            var input_group_arr = [
                ['SSN', 'UNIQUEID', 'LAST_NAME', 'FIRST_NAME', 'MI', 'STREET_ADDRESS', 'CITY', 'STATE', 'ZIP'],
                ['BOOL_SSN', 'BOOL_NAME_FULL', 'BOOL_ADDRESS', 'ADDITIONAL_TERMS', 'TERMS_SEGMENTS', 'TERMS_SEGMENTS_ADD']
            ];
            var segment_arr = [
                ['County', 'county()'],
                ['Name', 'name()'],
