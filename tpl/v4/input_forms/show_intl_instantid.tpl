<div id="search-form-fields" class="col col-7">
    ...
    <div class="row">
        <div class="input col col-3">
            <label>
                ...
                <select id="COUNTRY_REF" name="COUNTRY_REF" class="form-control" data-value="<TMPL_VAR NAME=COUNTRY_REF>" onchange="javascript:toggle_address_fields(1, 1);">
        ...
        <a href="#" class="help-search" data-helpid="INSTANTID_VERIFICATION_GUIDANCE" data-helptype="help" ><u>Verification Guidance</u></a>
    </div>    
    <div class="row">
        <div class="input col col-3">
            <label>
    ...
    <div class="row">
        <div class="input col col-1_1">
            <label>
                ...
                <span class="tooltip" id="span_dob_m">DOB: MM</span>
            </label>
        </div>
        <div class="input col col-1_1">
            <label>
                ...
                <span class="tooltip" id="span_dob_d">DOB: DD</span>
            </label>
        </div>
        <div class="input col col-1_25">
            <label>
                ...
                <span class="tooltip" id="span_dob_y">DOB: YYYY</span>
            </label>
        </div>
        <div class="input col col-1_75">
            <label for="GENDER">
                <span class="sr-only">Gender</span>
                <select name="GENDER" id="GENDER" data-value="<TMPL_VAR NAME=GENDER>" class="form-control">
    ...
    <div class="row">
        ...
        <div class="input col col-3">
            <label for="PROVINCE">
                ...
                <select name="PROVINCE" id="PROVINCE" data-value="<TMPL_VAR NAME=PROVINCE>" class="form-control">
    ...
    <div class="row">
        ...
        <div class="input col col-3" id="div_ip_address">
            <label>
    ...
    <div class="row">
        ...
        <div class="input col col-3">
            <label>
                <input type="text" id="FAMILYNAME_AT_BIRTH" name="FAMILYNAME_AT_BIRTH" class="form-control" value="<TMPL_VAR NAME=FAMILYNAME_AT_BIRTH>" placeholder="Family Name at Birth" maxlength="35">
    ...
    <div class="row" id="instantid_birthdate_row">
        <div id="instantid_birthdate" class="pull-left">
            ...
            <div class="additional-info hidden">
                <label for="LBY_RADIUS_REF">
                    ...
                    <select id="LBY_RADIUS_REF" name="LBY_RADIUS_REF" data-value="<TMPL_VAR NAME=LBY_RADIUS_REF>" class="form-control">
                        <option value="" selected="selected">Exact Year</option>
                            ...
                            <ul class="unmarked_list">
                                ...
                                <li class="padding-left-15">
                                    <label for="GLOB_FCEN" class="check">
                                        ...
                                        <span>Financial Crimes Enforcement Network Special Alert List (FCEN)</span>
                                    </label>
                                </li>
                                <li class="padding-left-15">
                                    <label for="GLOB_MAJESTY" class="check">
                                        <input type="checkbox" name="GLOB_MAJESTY" id="GLOB_MAJESTY" checked="checked">
                                        <span>Her Majesty's Treasury's Consolidated List of Financial Sanctions Targets<br /> <span class="font-12 padding-left-20">(formerly known as Bank of England Consolidated Sanctions)</span></span>
                                    </label>
                                </li>
                                <li class="padding-left-15">
                                ...
                                <li class="padding-left-15">
                                    <label for="GLOB_USIS" class="check">
                                        ...
                                        <span>US Bureau of Industry &amp; Security</span>
                                    </label>
                                </li>
                                <li class="padding-left-15">
...
<div class="col col-3" id="search-options">
    ...
    <div id="search-options-container">
        <h3>Form Settings</h3>
        <fieldset>
            <legend class="minimal">Format Validation:</legend>
            <div class="col col-2_5">
                <label class="radio">
                    <input name="VALIDATION" checked="checked" type="radio" id="VALIDATION" onclick="toggle_passport_visa(0)" value="1">
                    <span class="col-7">Passport</span>
                </label>
            </div>
            <div class="col col-1_5">
                <label class="radio">
                    <input name="VALIDATION" type="radio" id="VALIDATION" onclick="toggle_passport_visa(0)" value="2">
                    <span class="col-7">Visa</span>
                </label>
            </div>
            <div class="col col-6">
                <label class="radio">
                    <input name="VALIDATION" type="radio" id="VALIDATION" onclick="toggle_passport_visa(0)" value="3">
                    <span>Passport &amp; Visa</span>
                </label>
            </div>
            <input type="hidden" id="HID_PASSPORT_VAL" name="HID_PASSPORT_VAL" value="<TMPL_VAR NAME=VALIDATION>" class="form-control">
        </fieldset>
    </div>
</div>
