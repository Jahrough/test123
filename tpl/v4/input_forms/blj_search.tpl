    ...
    <div class="row">                
        <div class="col-sm-12">
            <label>
                ...
                <select name="BLJ_SOURCE" class="form-control inline-display col-8 pull-right" id="BLJ_SOURCE1" data-value="<TMPL_VAR NAME="BLJ_SOURCE">" data-default-value="<TMPL_VAR NAME="BLJ_SOURCE_DEFAULT">">
                    <TMPL_IF SHOW_BANKRUPTCY_CHECK>
                    <TMPL_UNLESS NAME="DISABLE_BLJ">
                    <option value="">Bankruptcies, Judgments &amp; Liens</option>
                    </TMPL_UNLESS>
                    <TMPL_UNLESS NAME="DISABLE_BANKRUPTCY">
                    <option value="BRs">Bankruptcies Only</option>
                    </TMPL_UNLESS>
                    </TMPL_IF>
                    <TMPL_UNLESS NAME="DISABLE_LIEN">
                    <option value="JandL">Judgments &amp; Liens Only</option>
                    </TMPL_UNLESS>
                </select>
            </label>
        </div>
