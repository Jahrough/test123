<div id="search-form-fields" class="col col-7">
    ...
    <div class="row">
        <div class="input col col-3">
            <label>
                <span class="sr-only">Select search region</span>
                <select name="COMPANY_SOURCE" id="COMPANY_SOURCE" class="form-control" data-value="<TMPL_VAR NAME=COMPANY_SOURCE>">
                    <option value="COMPNY" aria-label="all regions">All Company Information</option>
                    <option value="INTLCO" aria-label="only regions outside of the united states">Non-U.S. Companies Only</option>
                </select>
            </label>
        </div>
    </div>    
