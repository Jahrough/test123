<div id="search-form-fields" class="col col-7">
    <div class="row">
        ...
        <div class="input col col-3">
            <label>
                <input class="form-control" type="text" id="FEIN" name="FEIN" value="<TMPL_VAR NAME="FEIN">" placeholder="FEIN" maxlength="11">
    ...
    <div class="row">
        <div class="input col col-3">
            <label>
                ...
                <span class="tooltip">
                    Phone
                    <span class="font-10">(e.g. 9375550110, 937-555-0110, (937) 555-0110, 937.555.0110)</span>
                </span> 
            </label>
        </div>
    </div>    
