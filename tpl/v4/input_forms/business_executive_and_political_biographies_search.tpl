<div id="search-form-fields" class="col col-7">
    ...
    <div class="row">
        <div class="input col col-6">
            <label>
                <select id="BIO_SOURCES_DROP" name="BIO_SOURCES_DROP" class="form-control" data-value="<TMPL_VAR NAME=BIO_SOURCES_DROP>">
                    <option value="">Select a source ...</option>
                    <!-- option value="BiographiesBRDMIN">Boardroom Insiders</option -->
                    <option value="BiographiesAMPOL">COMPLETE FILE: The Almanac of American Politics</option>
                    <option value="BiographiesCONTNT">Content5 Persons (English and German)</option>
                    <option value="BiographiesGALBIO">Gale Biographies</option>
                    <option value="BiographiesINFODI">Infolegale - Dirigeants</option>
                    <option value="BiographiesLAGEFI">L'AGEFI - Biographies</option>
                    <option value="BiographiesCONPRE">London Stock Exchange - Board Membership</option>
                    <option value="BiographiesDRSIRS">McGregor BFA CIPC Bios</option>
                    <!-- option value="BiographiesSPBIO">S&P Corporate Register of Directors & Executives</option -->
                    <option value="BiographiesAPBIO">The Associated Press Candidate Biographies</option>
                    <option value="BiographiesITWCIO">The CIO Directory</option>
                    <option value="BiographiesTPMGTP">Top Management Biographies</option>
                    <option value="BiographiesUSEXCP">U.S. Executive Compensation Database - Executive Biographies</option>
                </select>
            </label>
        </div>
    </div>
