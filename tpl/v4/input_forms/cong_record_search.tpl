    ...
    <fieldset>
        ...
        <div class="row">
            <div class="input col col-9">
                <label>
                    <textarea maxlength='83' name="ARTICLE_WORDS" class="form-control" id="ARTICLE_WORDS" placeholder="Words in the Article"><TMPL_VAR NAME=ARTICLE_WORDS></textarea>
                    <span class="tooltip">
        ...
        <div class="row">
            <div class="input col col-9">
                <label>
                    <textarea maxlength='83' name="WITHOUT_WORDS" class="form-control" id="WITHOUT_WORDS" placeholder="Without the Words"><TMPL_VAR NAME=WITHOUT_WORDS></textarea>
                    <span class="tooltip">
                        Without the Words
