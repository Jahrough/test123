<div id="search-form-fields" class="col col-7">
    ...
    <span class="font-10 textRed search-note">
        <ul>
            <li>SSN, Last Name, First Name, Current Address (Street, State, Zip) and Previous Address (Street, State, Zip)</li>
        </ul>
    </span>
    ...
    <div class="row">
        ...
        <div class="input col col-1">
            <label>
                <input type="text" id="SUFFIX" name="SUFFIX" class="form-control" value="<TMPL_VAR NAME=SUFFIX>" placeholder="Suffix" maxlength="35">
    ...
    <div class="row">
        <div class="input col col-6">
            <label>             
                <input type="text" id="STREET_ADDRESS" name="STREET_ADDRESS" value="<TMPL_VAR NAME=STREET_ADDRESS>" placeholder="Current Street Address *" class="form-control" maxlength="35">
                <span class="tooltip">
    ...
    <div class="row">
        <div class="input col col-6">
            <label>
                <input type="text" id="STREET_ADDRESS2" name="STREET_ADDRESS2" value="<TMPL_VAR NAME=STREET_ADDRESS2>" placeholder="Previous Street Address *" class="form-control" maxlength="35">
                <span class="tooltip">
    ...
    <div class="row">
        ...
        <div class="input col col-2">
            <label>
                <input type="text" id="ZIP2" name="ZIP2" value="<TMPL_VAR NAME=ZIP2>" placeholder="Zip Code *" maxlength="10" class="form-control">
                <span class="tooltip">Zip Code *</span>
            </label>
        </div>
    </div> 
