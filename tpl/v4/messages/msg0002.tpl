...
<input type=hidden id="ANNOUNCEMENT_MSG" name="ANNOUNCEMENT_MSG" value="0002">
...
<input type=hidden id="announcement_list_title" name="AnnounceTitle"  value="Introducing New Enhancements to LexisNexis Risk Management Solutions&reg;">
 ...
 <table class="rflags">
   <tr>
     <td class="lower"><div align="left">
        ...
        <p class="style2">
            Introducing New Enhancements to LexisNexis Risk Management Solutions&reg;<br />
        ...
        <p align="center"><img src="<TMPL_VAR NAME=IMGPATH>/rm1.jpg" alt="New Product Enhancements"></p>
        <p class="style3">As you know, <strong>Risk Management Solutions</strong> is so much more than just access to data. With advanced linking technologies and cutting-edge scoring analytics, you receive actionable information for immediate and effective decision making.</p>
        <p align="center" class="style2">
            Enjoy LexisNexis Risk Management Solutions<br />
            enhancements and experience your job with <br />
            a new level of ease and productivity.
        </p>
        <p align="center">
            <span class="style3">
        ...
        <p align="center"><img src="<TMPL_VAR NAME=IMGPATH>/rm2.jpg" alt="Pricing for Product Enhancements"></p>
