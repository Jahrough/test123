		...
		<tr>
		    ...
		    <input class="btn btn-danger" type=button value="Disable" onclick="verify_cancel()">
		    <TMPL_ELSE>
		    ...
		    <TMPL_UNLESS NAME=CONFIRM>		    
		    <td valign=middle>
		    <input class="btn btn-danger" type=button value="Cancel" onclick="send_event('MYACCOUNT/SHOW_PREFERENCES')">
		    </td>
		    </TMPL_UNLESS>
		    </tr>
		    </table>
