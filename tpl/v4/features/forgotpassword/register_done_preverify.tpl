<!-- begin: register_done_preverify.tpl -->
				  ...
				  complete the Forgot Password registration process. You will be prompted for this code on your next login, or you can enter it via the My Account page (Preferences section).
				  <br/><br/>
				  <TMPL_ELSE>
				Thank you for completing your information.
				  You will now receive a Verification Email to the email address you
