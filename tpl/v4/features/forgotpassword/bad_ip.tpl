	      ...
	      -->
			...
			<td align="center">
			  <table border="0" cellpadding="10" cellspacing="0" width="500" class="myaccountalert">
				...
				<p>
				<br>
				<center><b>Code : FPW11</b></center>
				<br><br>
				The password recover feature is not available for this loginID. Please contact our Customer Support
				Department at <TMPL_IF IRB>(800)447-2112<TMPL_ELSE>(866)277-8407</TMPL_IF> and indicate this code. FPW11 .
				</p>
				<br>
