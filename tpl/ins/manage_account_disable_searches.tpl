<!-- BEGIN ins/manage_account_disable_searches.tpl -->
	 ...
	 <fieldset>
	  <span class="unifont1bold"><legend>People</legend></span>
	      ...
	      <TMPL_IF COMPANY_DISABLE_CARRIER_DISCOVERY>
	      <INPUT TYPE=HIDDEN NAME="DISABLE_CARRIER_DISCOVERY" VALUE="<TMPL_IF DISABLE_CARRIER_DISCOVERY>1<TMPL_ELSE>0</TMPL_IF>">
	      <TMPL_ELSE>
              <TR>
                <td width="75%" nowrap class="unifont1" align="left">&nbsp;Carrier Discovery:&nbsp;&nbsp;</TD>
                <td width="25%" align="left">
                <table border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td><INPUT TYPE=RADIO NAME="DISABLE_CARRIER_DISCOVERY" VALUE='0' <TMPL_UNLESS NAME=DISABLE_CARRIER_DISCOVERY>CHECKED</TMPL_UNLESS>></td>
                    <td class="unifont1">Yes&nbsp;&nbsp;&nbsp;</td>
                    <td><INPUT TYPE=RADIO NAME="DISABLE_CARRIER_DISCOVERY" VALUE='1' <TMPL_IF NAME=DISABLE_CARRIER_DISCOVERY>CHECKED</TMPL_IF>></td>
                    <td class="unifont1">No</td>
                  </tr>
                </table>
                </td>    
	      ...
	      <TMPL_IF COMPANY_DISABLE_CLAIMS_DISCOVERY>
	      <INPUT TYPE=HIDDEN NAME="DISABLE_CLAIMS_DISCOVERY" VALUE="<TMPL_IF DISABLE_CLAIMS_DISCOVERY>1<TMPL_ELSE>0</TMPL_IF>">
	      <TMPL_ELSE>
              <TR>
                <td width="75%" nowrap class="unifont1" align="left">&nbsp;Claims Discovery:&nbsp;&nbsp;</TD>
                <td width="25%" align="left">
                <table border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td><INPUT TYPE=RADIO NAME="DISABLE_CLAIMS_DISCOVERY" VALUE='0' <TMPL_UNLESS NAME=DISABLE_CLAIMS_DISCOVERY>CHECKED</TMPL_UNLESS>></td>
                    <td class="unifont1">Yes&nbsp;&nbsp;&nbsp;</td>
                    <td><INPUT TYPE=RADIO NAME="DISABLE_CLAIMS_DISCOVERY" VALUE='1' <TMPL_IF NAME=DISABLE_CLAIMS_DISCOVERY>CHECKED</TMPL_IF>></td>
                    <td class="unifont1">No</td>
                  </tr>
                </table>
                </td>    
	      ...
	      <TMPL_IF COMPANY_DISABLE_POLICE_RECORDS>
	      <INPUT TYPE=HIDDEN NAME="DISABLE_POLICE_RECORDS" VALUE="<TMPL_IF DISABLE_POLICE_RECORDS>1<TMPL_ELSE>0</TMPL_IF>">
	      <TMPL_ELSE>
              <TR>
                <td width="75%" nowrap class="unifont1" align="left">&nbsp;Police Records:&nbsp;&nbsp;</TD>
                <td width="25%" align="left">
                <table border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td><INPUT TYPE=RADIO NAME="DISABLE_POLICE_RECORDS" VALUE='0' <TMPL_UNLESS NAME=DISABLE_POLICE_RECORDS>CHECKED</TMPL_UNLESS>></td>
                    <td class="unifont1">Yes&nbsp;&nbsp;&nbsp;</td>
                    <td><INPUT TYPE=RADIO NAME="DISABLE_POLICE_RECORDS" VALUE='1' <TMPL_IF NAME=DISABLE_POLICE_RECORDS>CHECKED</TMPL_IF>></td>
                    <td class="unifont1">No</td>
                  </tr>
                </table>
                </td>    
        ...
        <TMPL_UNLESS AIG>
        <TMPL_UNLESS HIDE_INTL_INSTANTID>
          <TMPL_IF COMPANY_DISABLE_INSTANTID_INTERNATIONAL>
          <INPUT TYPE=HIDDEN NAME="DISABLE_INSTANTID_INTERNATIONAL" VALUE="<TMPL_IF DISABLE_INSTANTID_INTERNATIONAL>1<TMPL_ELSE>0</TMPL_IF>">
          <TMPL_ELSE>
          <TR>
                <td width="75%" nowrap class="unifont1" align="left">&nbsp;InstantID International:</TD>
                <td width="25%" align="left">
                <table border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td><INPUT TYPE=RADIO NAME="DISABLE_INSTANTID_INTERNATIONAL" VALUE='0' <TMPL_UNLESS NAME=DISABLE_INSTANTID_INTERNATIONAL>CHECKED</TMPL_UNLESS>></td>
                    <td class="unifont1">Yes&nbsp;&nbsp;&nbsp;</td>
                    <td><INPUT TYPE=RADIO NAME="DISABLE_INSTANTID_INTERNATIONAL" VALUE='1' <TMPL_IF NAME=DISABLE_INSTANTID_INTERNATIONAL>CHECKED</TMPL_IF>></td>
                    <td class="unifont1">No</td>
                  </tr>
                </table>
                </td>    
        ...
        <TMPL_IF NAME=SECURITY_COMPANY>
            ...
            <TMPL_IF NAME="THRESHOLD">
              ...
              <TMPL_ELSE>
              <TR>
                <td width="75%" nowrap class="unifont1" align="left">&nbsp;<TMPL_IF NAT_ACC_ENABLE>National Motor Vehicle Accidents Search<TMPL_ELSE>Florida Accidents</TMPL_IF>:</TD>
                <td width="25%" align="left">
                <table border="0" cellpadding="0" cellspacing="0">
                  <tr>
              ...
              <TR>
                <td width="75%" nowrap class="unifont1" align="left">&nbsp;National Motor Vehicle Accidents Archived:</TD>
                <td width="25%" align="left">
                <table border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td><INPUT TYPE=RADIO NAME="DISABLE_NAT_ACC_ARCHIVED_REPORT" VALUE='0' <TMPL_UNLESS NAME=DISABLE_NAT_ACC_ARCHIVED_REPORT>CHECKED</TMPL_UNLESS>></td>
                    <td class="unifont1">Yes&nbsp;&nbsp;&nbsp;</td>
                    <td><INPUT TYPE=RADIO NAME="DISABLE_NAT_ACC_ARCHIVED_REPORT" VALUE='1' <TMPL_IF NAME=DISABLE_NAT_ACC_ARCHIVED_REPORT>CHECKED</TMPL_IF>></td>
                    <td class="unifont1">No</td>
                  </tr>
                </table>
                </td>
	      ...
	      <TMPL_ELSE>
              ...
              <TMPL_IF NAME=ALLOW_PRUDENTIAL_REPORTS>
              <TMPL_IF COMPANY_DISABLE_PRUDENTIAL_REPORT>
              <INPUT TYPE=HIDDEN NAME="DISABLE_PRUDENTIAL_REPORT" VALUE="<TMPL_IF DISABLE_PRUDENTIAL_REPORT>1<TMPL_ELSE>0</TMPL_IF>">
              <TMPL_ELSE>
              <TR>
                <td width="75%" nowrap class="unifont1" align="left">&nbsp;Combined Comp Report:</TD>
                <td width="25%" align="left">
                <table border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td><INPUT TYPE=RADIO NAME="DISABLE_PRUDENTIAL_REPORT" VALUE='0' <TMPL_UNLESS NAME=DISABLE_PRUDENTIAL_REPORT>CHECKED</TMPL_UNLESS>></td>
                    <td class="unifont1">Yes&nbsp;&nbsp;&nbsp;</td>
                    <td><INPUT TYPE=RADIO NAME="DISABLE_PRUDENTIAL_REPORT" VALUE='1' <TMPL_IF NAME=DISABLE_PRUDENTIAL_REPORT>CHECKED</TMPL_IF>></td>
                    <td class="unifont1">No</td>
                  </tr>
                </table>
                </td>
              ...
              <TMPL_UNLESS NAME=HIDE_CARRIER_ID>
              <TMPL_IF COMPANY_DISABLE_CARRIER_ID>
              <INPUT TYPE=HIDDEN NAME="DISABLE_CARRIER_ID" VALUE="<TMPL_IF DISABLE_CARRIER_ID>1<TMPL_ELSE>0</TMPL_IF>">
              <TMPL_ELSE>
              <TR>
                <td width="75%" nowrap class="unifont1" align="left">&nbsp;Carrier Id Report:</TD>
                <td width="25%" align="left">
                <table border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td><INPUT TYPE=RADIO NAME="DISABLE_CARRIER_ID" VALUE='0' <TMPL_UNLESS NAME=DISABLE_CARRIER_ID>CHECKED</TMPL_UNLESS>></td>
                    <td class="unifont1">Yes&nbsp;&nbsp;&nbsp;</td>
                    <td><INPUT TYPE=RADIO NAME="DISABLE_CARRIER_ID" VALUE='1' <TMPL_IF NAME=DISABLE_CARRIER_ID>CHECKED</TMPL_IF>></td>
                    <td class="unifont1">No</td>
                  </tr>
                </table>
                </td>    
	 ...
	 <fieldset>
	  <span class="unifont1bold"><legend>Businesses</legend></span>
	      ...
	      <TMPL_ELSE>
	      <TR>
	        <td width="75%" nowrap class="unifont1" align="left">&nbsp;Fictitious Business Names Information:&nbsp;&nbsp;</TD>
	        <td width="25%" align="left">
	        <table border="0" cellpadding="0" cellspacing="0">
		  <tr>
    ...
    <TMPL_UNLESS NAME=DISALLOW_D_AND_B_SEARCH>
	 ...
	 <fieldset>
	  <span class="unifont1bold"><legend>Assets</legend></span>
	      ...
	      <TMPL_ELSE>
              <TR>
                <td width="75%" nowrap class="unifont1" align="left">&nbsp;Real-Time Vehicle Registrations:&nbsp;&nbsp;</TD>
                <td width="25%" align="left">
                <table border="0" cellpadding="0" cellspacing="0">
                  <tr>
	      ...
	      <TMPL_IF COMPANY_DISABLE_VEHICLE_LOCATION_HISTORY>
	      <INPUT TYPE=HIDDEN NAME="DISABLE_VEHICLE_LOCATION_HISTORY" VALUE="<TMPL_IF DISABLE_VEHICLE_LOCATION_HISTORY>1<TMPL_ELSE>0</TMPL_IF>">
	      <TMPL_ELSE>
              <TR>
                <td width="75%" nowrap class="unifont1" align="left">&nbsp;Vehicle Location History:</TD>
                <td width="25%" align="left">
                <table border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td><INPUT TYPE=RADIO NAME="DISABLE_VEHICLE_LOCATION_HISTORY" VALUE='0' <TMPL_UNLESS NAME=DISABLE_VEHICLE_LOCATION_HISTORY>CHECKED</TMPL_UNLESS>></td>
                    <td class="unifont1">Yes&nbsp;&nbsp;&nbsp;</td>
                    <td><INPUT TYPE=RADIO NAME="DISABLE_VEHICLE_LOCATION_HISTORY" VALUE='1' <TMPL_IF NAME=DISABLE_VEHICLE_LOCATION_HISTORY>CHECKED</TMPL_IF>></td>
                    <td class="unifont1">No</td>
                  </tr>
                </table>
                </td>    
	 ...
	 <fieldset>
	  <span class="unifont1bold"><legend>News</legend></span>
           <table border="0" cellpadding="0" cellspacing="0" width="95%">
              ...
              <TMPL_ELSE>
              <TR>
                <td width="75%" nowrap class="unifont1" align="left">&nbsp;Negative News:&nbsp;&nbsp;</TD>
                <td width="25%" align="left">
                <table border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td><INPUT TYPE=RADIO NAME="DISABLE_LN_NEGATIVE_NEWS" VALUE='0' <TMPL_UNLESS NAME=DISABLE_LN_NEGATIVE_NEWS>CHECKED</TMPL_UNLESS>></td>
                    <td class="unifont1">Yes&nbsp;&nbsp;&nbsp;</td>
                    <td><INPUT TYPE=RADIO NAME="DISABLE_LN_NEGATIVE_NEWS" VALUE='1' <TMPL_IF NAME=DISABLE_LN_NEGATIVE_NEWS>CHECKED</TMPL_IF>></td>
                    <td class="unifont1">No</td>
                  </tr>
                </table>
                </td>
...
<!-- END ins/manage_account_disable_searches.tpl -->
