...
<TMPL_UNLESS DELETE_CLAIMS_DISCOVERY> 
<TMPL_IF NAME="CLAIMS_DISCOVERY_REPORT">
        <td width="10%" class="utiltabs" align="center" nowrap><a class="searchtabs" href="javascript:void(0);" onClick="show_post_popup('LOGIN/SHOW_POPUP','HTMLCoverage','420','350',0,0,0,0,0,0,'','coverage/CLAIMS_discovery_coverage');">Coverage</a></td>
        <td width="6%" class="utiltabs" align="center" nowrap><a class="searchtabs" href="javascript:void(0);" onClick="general_win('<TMPL_VAR NAME=HLPPATH>/CLAIMS_discovery_help.html','HelpWindow',680,490,1,1,1,1,1,0);void(0);">Help</a></td>
</TMPL_IF>
</TMPL_UNLESS>
</TMPL_UNLESS>
<TMPL_UNLESS NAME=HIDE_CARRIER_DISCOVERY_CONTRIBUTOR>
<TMPL_UNLESS DELETE_CARRIER_DISCOVERY> 
<TMPL_IF NAME="CARRIER_DISCOVERY_REPORT">
        <td width="10%" class="utiltabs" align="center" nowrap><a class="searchtabs" href="javascript:void(0);" onClick="show_post_popup('LOGIN/SHOW_POPUP','HTMLCoverage','420','350',0,0,0,0,0,0,'','coverage/carrier_discovery_coverage');">Coverage</a></td>
        <td width="6%" class="utiltabs" align="center" nowrap><a class="searchtabs" href="javascript:void(0);" onClick="general_win('<TMPL_VAR NAME=HLPPATH>/carrier_discovery_help.html','HelpWindow',680,490,1,1,1,1,1,0);void(0);">Help</a></td>
</TMPL_IF>
</TMPL_UNLESS>
</TMPL_UNLESS>
...
<TMPL_IF NAME=IM_ON_SEARCH>
  ...
  <TMPL_UNLESS DO_NOT_DISPLAY_PRUDENTIAL>
	<TMPL_IF ALLOW_PRUDENTIAL_REPORTS>
        <TMPL_UNLESS DELETE_PRUDENTIAL><td align="center" nowrap <TMPL_IF NAME=PRUDENTIAL_REPORT>class="activetabs"</TMPL_IF>><a class="searchtabs" href="javascript:send_event('SEARCH/SHOW_PRUDENTIAL')">Combined Comp<br>Report</a></td>
        </TMPL_UNLESS>
	</TMPL_IF>
  </TMPL_UNLESS>
        ...
        <TMPL_UNLESS NAME=HIDE_CLAIMS_DISCOVERY_CONTRIBUTOR>
        <TMPL_UNLESS DELETE_CLAIMS_DISCOVERY> 
              <td align="center" nowrap <TMPL_IF NAME=CLAIMS_DISCOVERY_REPORT>class="activetabs"</TMPL_IF>><a class="searchtabs" href="javascript:send_event('SEARCH/SHOW_CLAIMS_DISCOVERY')">CLAIMS<br>Discovery</a></td>
        </TMPL_UNLESS>
        </TMPL_UNLESS>

        <TMPL_UNLESS NAME=HIDE_CARRIER_DISCOVERY_CONTRIBUTOR>
        <TMPL_UNLESS DELETE_CARRIER_DISCOVERY> 
              <td align="center" nowrap <TMPL_IF NAME=CARRIER_DISCOVERY_REPORT>class="activetabs"</TMPL_IF>><a class="searchtabs" href="javascript:send_event('SEARCH/SHOW_CARRIER_DISCOVERY')">Carrier<br>Discovery</a></td>
        </TMPL_UNLESS>
        </TMPL_UNLESS>
...
<TMPL_IF NAME=IM_ON_LEGAL_SEARCH>
        ...
        <TMPL_UNLESS DELETE_CRIM><td align="center" nowrap <TMPL_IF NAME=CRIM_SEARCH>class="activetabs"</TMPL_IF>><a class="searchtabs" href="javascript:send_event('SEARCH/SHOW_CRIM')">State & Local<br>Criminal Records</a></td></TMPL_UNLESS>
        <TMPL_UNLESS DELETE_CIVIL_COURT><td align="center" nowrap <TMPL_IF NAME=CIVIL_COURT_SEARCH>class="activetabs"</TMPL_IF>><a class="searchtabs" href="javascript:send_event('SEARCH/SHOW_CIVIL_COURT')">State & Local<br>Civil Courts</a></td></TMPL_UNLESS>
...
<TMPL_IF NAME=IM_ON_BUS_SEARCH>
  ...
  <TMPL_UNLESS INS>
	<TMPL_UNLESS DONT_SHOW_NEWS>
	<TMPL_UNLESS DELETE_BUS_NEWS><td  align="center" nowrap <TMPL_IF NAME=BUS_NEWS_SEARCH>class="activetabs"</TMPL_IF>><a class="searchtabs" href="javascript:send_event('SEARCH/SHOW_BUS_NEWS')">Businesses in<br>the News</a></td></TMPL_UNLESS>
	</TMPL_UNLESS>
  </TMPL_UNLESS>
...
<TMPL_IF NAME=IM_ON_NEWS_SEARCH>
        <TMPL_UNLESS DELETE_NEWS><td align="center" nowrap  <TMPL_IF NAME=NEWS_SEARCH>class="activetabs"</TMPL_IF>><a class="searchtabs" href="javascript:send_event('SEARCH/SHOW_NEWS')">People in<br>the News</a></td></TMPL_UNLESS>
        <TMPL_UNLESS DELETE_NEWS><td  align="center" nowrap <TMPL_IF NAME=BUS_NEWS_SEARCH>class="activetabs"</TMPL_IF>><a class="searchtabs" href="javascript:send_event('SEARCH/SHOW_BUS_NEWS')">Businesses in<br>the News</a></td></TMPL_UNLESS>
	...
	<!-- Holding Insurance News
	<td align="center" nowrap <TMPL_IF NAME=TODAYS_NEWS_SEARCH>class="activetabs"</TMPL_IF>><a class="searchtabs" href="javascript:send_event('SEARCH/SHOW_TODAYS_NEWS')">Insurance<br>News</a></td>
	-->
