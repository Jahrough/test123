<!-- begin ins_search_inputs_tabs.tpl -->
...
<TMPL_IF NAME=IM_ON_ASSET_SEARCH>
  ...
  <TMPL_IF NAME=CARFAX_REPORT>
    <td><img width="75" height="46" border="0" src="<TMPL_VAR NAME=IMGPATH>/carfax_tab_up.gif"></td>
  <TMPL_ELSE>
    <td><a href="javascript:send_event('SEARCH/SHOW_CARFAX');" onMouseOver="carfax.src='<TMPL_VAR NAME=IMGPATH>/carfax_tab_over.gif';showalt('Motor Vehicles','carfax');" onMouseOut="carfax.src='<TMPL_VAR NAME=IMGPATH>/carfax_tab_on.gif';return nd();"><img width="52" height="46" border="0" name="carfax" src="<TMPL_VAR NAME=IMGPATH>/carfax_tab_on.gif" id="carfax"></a></td>
  </TMPL_IF>
  </TMPL_UNLESS>
...
<TMPL_IF NAME=IM_ON_SEARCH>
  ...
  <!--<TMPL_UNLESS DELETE_PSPR> 
  <TMPL_IF NAME="PSPR_SEARCH">
    <td><img width="75" height="46" border="0" src="<TMPL_VAR NAME=IMGPATH>/pub_rec_tab_up.gif"></td>
  <TMPL_ELSE>
    <td><a href="javascript:send_event('SEARCH/SHOW_PSPR');" onMouseOver="pspr.src='<TMPL_VAR NAME=IMGPATH>/pub_rec_tab_over.gif';showalt('People Statewide Public Records','pspr');" onMouseOut="pspr.src='<TMPL_VAR NAME=IMGPATH>/pub_rec_tab_on.gif';return nd();"><img width="52" height="46" border="0" name="pspr" src="<TMPL_VAR NAME=IMGPATH>/pub_rec_tab_on.gif" id='pspr'></a></td>
  </TMPL_IF>
  </TMPL_UNLESS>-->
  ...
  <TMPL_UNLESS DELETE_PRUDENTIAL> 
  <TMPL_IF NAME="PRUDENTIAL_REPORT">
    <td><img width="75" height="46" border="0" src="<TMPL_VAR NAME=IMGPATH>/combined_comp_report_tab_up.gif"></td>
  <TMPL_ELSE>
    <td><a href="javascript:send_event('SEARCH/SHOW_PRUDENTIAL');" onMouseOver="prud.src='<TMPL_VAR NAME=IMGPATH>/combined_comp_report_tab_over.gif';showalt('Combined Comp Report','prud');" onMouseOut="prud.src='<TMPL_VAR NAME=IMGPATH>/combined_comp_report_tab_on.gif';return nd();"><img width="52" height="46" border="0" name="prud" src="<TMPL_VAR NAME=IMGPATH>/combined_comp_report_tab_on.gif" id="prud"></a></td>
  </TMPL_IF>
  </TMPL_UNLESS>
  </TMPL_IF>
  </TMPL_UNLESS>
  ...
  <TMPL_IF NAME="CLAIMS_DISCOVERY_REPORT">
    <td><img width="75" height="46" border="0" src="<TMPL_VAR NAME=IMGPATH>/CLAIMS_tab_up.gif"></td>
  <TMPL_ELSE>
    <td><a href="javascript:send_event('SEARCH/SHOW_CLAIMS_DISCOVERY');" onMouseOver="CLAIMS_discovery.src='<TMPL_VAR NAME=IMGPATH>/CLAIMS_tab_over.gif';showalt('CLAIMS Discovery','CLAIMS_discovery');" onMouseOut="CLAIMS_discovery.src='<TMPL_VAR NAME=IMGPATH>/CLAIMS_tab_on.gif';return nd();"><img width="52" height="46" border="0" name="paw" src="<TMPL_VAR NAME=IMGPATH>/CLAIMS_tab_on.gif" id="CLAIMS_discovery"></a></td>
  </TMPL_IF>
  </TMPL_UNLESS>
  </TMPL_UNLESS>
  ...
  <TMPL_IF NAME="CARRIER_DISCOVERY_REPORT">
    <td><img width="75" height="46" border="0" src="<TMPL_VAR NAME=IMGPATH>/carrier_tab_up.gif"></td>
  <TMPL_ELSE>
    <td><a href="javascript:send_event('SEARCH/SHOW_CARRIER_DISCOVERY');" onMouseOver="carrier_discovery.src='<TMPL_VAR NAME=IMGPATH>/carrier_tab_over.gif';showalt('Carrier Discovery','carrier_discovery');" onMouseOut="carrier_discovery.src='<TMPL_VAR NAME=IMGPATH>/carrier_tab_on.gif';return nd();"><img width="52" height="46" border="0" name="paw" src="<TMPL_VAR NAME=IMGPATH>/carrier_tab_on.gif" id="carrier_discovery"></a></td>
  </TMPL_IF>
  </TMPL_UNLESS>
  </TMPL_UNLESS>
...
<!--
  <TMPL_IF NAME=TODAYS_NEWS_SEARCH>
    <td><img width="75" height="46" border="0" src="<TMPL_VAR NAME=IMGPATH>/ins/ins_news_tab_up.gif"></td>
  <TMPL_ELSE>
    <td><a href="javascript:send_event('SEARCH/SHOW_TODAYS_NEWS');" onMouseOver="todnews.src='<TMPL_VAR NAME=IMGPATH>/ins/ins_news_tab_over.gif';showalt('Todays News','todnews');" onMouseOut="todnews.src='<TMPL_VAR NAME=IMGPATH>/ins/ins_news_tab_on.gif';return nd();"><img width="52" height="46" border="0" name="todnews" src="<TMPL_VAR NAME=IMGPATH>/ins/ins_news_tab_on.gif" id="todnews"></a></td>
  </TMPL_IF>
-->
...
<!-- end ins_search_inputs_tabs.tpl -->
