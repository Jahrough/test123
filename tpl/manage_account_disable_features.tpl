     ...
     <TMPL_IF COMPANY_REGISTERED_FORGOT_PASSWORD_FEATURE>
        ...
        <tr>
          <td class="perc75 unifont1">
            &nbsp;Forgot Password: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <a href="javascript:show_post_popup('LOGIN/SHOW_POPUP','FPWInfo','600','500',0,0,0,1,0,0,'','fpw_help');">Help</a>
          </td>
     ...
     <TMPL_IF SHOW_ADMIN_CONTACT_LINK>
        <tr>
          <td class="perc75 unifont1">
            ...
            <a href="javascript:show_post_popup('LOGIN/SHOW_POPUP','FPWInfo','644','500',0,0,0,1,0,0,'','company_admin_link_help');">Help</a>
          </td>
          <td class="perc25 unifont1">
          <table cellpadding="0" cellspacing="0">
            <tr>
