<html>
<head>
<title>Watchdog Wizard <TMPL_VAR TITLE_PAGE></title>
...
<FORM NAME="WATCHDOG" action="<TMPL_VAR NAME=ACTION_BATCH>" METHOD="POST" <TMPL_VAR FORM_ARGS>>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" bgcolor="#cccccc">
  <tr>
    <td><img src="<TMPL_VAR NAME=IMGPATH>/<TMPL_VAR NAME=APPLICATION_TYPE>/watch_dog_header.gif" width="680" height="66" border="0"></td>
  </tr>
</table>
