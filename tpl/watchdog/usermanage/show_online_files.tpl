...
<fieldset>
    <legend> Online Watchlist </legend>
	    <table  cellspacing="5" cellpadding="3" align="left">
		<tr>
		    <td class="unifont1">Login ID:&nbsp;</td><td class="smallfont1"><b><TMPL_VAR LOGINID></b></td>
		    <td class="unifont1">Company ID:&nbsp;</td><td class="smallfont1"><b><TMPL_VAR COMPANY_ID></b></td>
		</tr>
		<tr>
		    <td class="unifont1">Watchdog Order Name:&nbsp;</td><td class="smallfont1"><b><TMPL_VAR WATCHLIST_NAME></b></td>
		    <td class="unifont1">Watchlist ID:&nbsp;</td><td class="smallfont1"><b><TMPL_VAR WATCHLIST_ID></b></td>
		</tr>
	    </table>
</fieldset>
<br>
<fieldset>
	...
	<input type="hidden" name="WATCHLIST_ID" value="<TMPL_VAR WATCHLIST_ID>">
	...
	<a href="<TMPL_VAR NAME=ACTION_BATCH>?EVENT=WATCHDOGMANAGE/DOWNLOAD&SESSION_ID=<TMPL_VAR NAME=SESSION_ID>&CSRF_TOKEN=<TMPL_VAR NAME=CSRF_TOKEN>&WATCHLIST_ID=<TMPL_VAR NAME=WATCHLIST_ID>&FILE_ID=<TMPL_VAR NAME=FILE_ID>"><TMPL_VAR BASENAME></a>
	</td>
