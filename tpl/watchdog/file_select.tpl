...
<INPUT TYPE=HIDDEN NAME=EVENT VALUE="WATCHDOG/SAVE_FILE">
...
<table border="0" width="600">
  <tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="600">
      <tr>
        <td class="wizardcounter" width="50%" align="left">Watchdog <b><TMPL_VAR TITLE_PAGE></b></td>
...
<table border="0" width="600">
  <tr>
    ...
    <td class="nsinputs"><input type="file" name="FILE" size="50"></td>
  </tr>
  <tr>
...
<table border="0" width="600">
  <tr>
    <td align="left" class="smallfont1"><TMPL_IF ADD_ITEMS><TMPL_INCLUDE NAME="watchdog_uploadnow_radio.tpl"><BR></TMPL_IF><TMPL_IF FILE_UPLOADED><br><span class="batchfilealert"><b>NOTE:</b>&nbsp;&nbsp;File <b><TMPL_VAR USER_FILE_NAME></b> has already been uploaded.&nbsp;&nbsp;Select a new file if you wish to replace it.</span><INPUT TYPE=HIDDEN NAME="FILE_UPLOADED" VALUE="1"></TMPL_IF></td>
<BR>
  ...
  <tr>
    <td valign="bottom" align="right" width="550"><a href="javascript:send_event('WATCHDOG/<TMPL_IF EDIT_ORDER>EDIT_ORDER<TMPL_ELSE>SHOW_NAME</TMPL_IF>')"><img src="<TMPL_VAR NAME=IMGPATH>/BATCH/back.gif" width="87" height="29" border="0"></a>&nbsp;&nbsp;&nbsp;<a href="javascript:send_please_wait_event('WATCHDOG/SAVE_FILE')" onClick="if(!validate()){return false;}"><img src="<TMPL_VAR NAME=IMGPATH>/BATCH/next.gif" width="87" height="29" border="0"></a></td>
  </tr>
