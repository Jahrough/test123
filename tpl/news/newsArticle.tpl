...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tr>
    <td class="no-print" bgcolor="white"><img src="<TMPL_VAR NAME=IMGPATH>/<TMPL_VAR NAME=APPLICATION_TYPE>/news_logo.gif"  border="0"></td>
...
<tr bgcolor="white"><td><br></td></tr>
  <tr bgcolor="white">
    <td align="center"  height="37" class="unifont1">
     ...
     <a href="http://www.lexisnexis.com/terms/copyright.aspx" target="_blank">Copyright &copy;</a> <script>document.write(new Date().getFullYear());</script> LexisNexis Risk Solutions. All rights reserved.
     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
     <a href="http://www.lexisnexis.com/risk/terms/" target="_blank">Terms and Conditions</a>
