...
<font face="Arial,Helvetica,Geneva,Swiss,SunSans-Regular" size="3"><b>Thursday, November 12, 2015</b></font>
...
<table border="0" cellpadding="5" cellspacing="0">
  <tr>
    ...
    <font face="Arial,Helvetica,Geneva,Swiss,SunSans-Regular" size="3"><b>New Functionality Available for System Administrators</b></font>
    <font face="Arial,Helvetica,Geneva,Swiss,SunSans-Regular" size="2">
    <br><br>
    As part of our commitment to providing you with secure and flexible user management solutions, we have incorporated new fields into your system administrator enablement setting to enhance your ability to provide an existing user with administrator credentials online.
    <br><br>
    Mandatory fields:
    <ul>
      <li>Home Street Address
      <li>Home City
      <li>Home State
      <li>Home Zip Code
    </ul>
    Optional fields:
    <ul>
      <li>Full Date of Birth (DOB): MM/DD/YYYY
      <li>First (5) digits of the Social Security Number (SSN)
    </ul>
    While logged into the application, select the "Manage Users" tab to update an existing user profile, enable the system administrator setting and complete the fields above to begin the admin credentialing process.
    <br><br>
    This new functionality is designed to enable more efficiency and we are committed to making this change as seamless as possible.
    <br><br><br>
    </font>
    ...
    <font color="#ed1c24" face="Arial,Helvetica,Geneva,Swiss,SunSans-Regular" size="3"><b>EPIC 360 Now Available for LexisNexis&reg; Accurint&reg;</b></font>
    <font face="Arial,Helvetica,Geneva,Swiss,SunSans-Regular" size="2">
    <br><br>
    We are excited to announce Accurint invoices are now available to view and pay through the LexisNexis Electronic Payment &amp; Invoice Center, EPIC 360.
    <br><br>
    Features include:
    <ul>
    ...
    <font color="#ed1c24"><b>Take a Tour of EPIC 360:</b></font>
    <br><br>
    ...
    <br>
    <font color="#ed1c24"><b>EPIC 360</b></font>
    <br><br>
    <a href="https://invoice.risk.lexisnexis.com" target="_blank"><b><u>https://invoice.risk.lexisnexis.com</u></b></a>
    <br><br>
    This new feature is included in all price plans and is available at no additional cost.
    <br><br>
    If you have any questions regarding EPIC 360, please contact LexisNexis Customer Support at <b>866.277.8407</b> or <a href="https://accurint.custhelp.com/" target="_blank"><b><u>Email Us.</u></b></a>
    <br><br>
    <b>Epic 360 Tutorial URLs</b>
    <br><br>
