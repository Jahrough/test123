...
<div id="rpMyAccount">
	<ul>
        ...
        <TMPL_UNLESS XBPS><li><a href="http://www.accurint.com/security_center/index.html?source=<TMPL_VAR NAME=APPLICATION_TYPE>" target="_blank">Security Center</a></li></TMPL_UNLESS>
        <li><a href="javascript:show_post_popup('MYACCOUNT/SHOW_PREFERENCES','MyAccountWin','','',1,1,1,1,1,0);">Preferences</a><TMPL_IF XBPS>&nbsp; <font color="#ed1c24"><i>(Updated)</i></font></TMPL_IF></li>
