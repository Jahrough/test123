  ...
  <div id="hide_radio">
    <table border="0" cellpadding="2" cellspacing="0" width="300">
      <tr>
        ...
        <td class="smallblack" width="295"><label for="DOWNLOAD_TYPE_SINGLE">EXPORT RECORDS <TMPL_VAR START> TO <TMPL_VAR END> OF <TMPL_VAR TOTAL_RECS></label></td>
      </tr>
    </table>
    <div id="more_than_25" style="display:none;">
      <table border="0" cellpadding="2" cellspacing="0" width="250">
        <tr>
          ...
          <td class="smallblack" width="295"><label for="DOWNLOAD_TYPE_ALL">EXPORT ALL <TMPL_VAR TOTAL_RECS> RECORDS</label></td>
        </tr>
      </table>
    </div>
  </div>
...
<table border="0" cellpadding="0" cellspacing="10">
  <tr>
    ...
    <div id="close_dl_button" style="display:none;">
      <br><input name="DOWNLOAD_BUTTON" type="BUTTON" value="*** Close Window AFTER Receiving File ***" onClick="self.close();">
    </div>
...
<INPUT TYPE="HIDDEN" NAME="IN_HOUSEHOLD_TAB" VALUE="<TMPL_VAR IN_HOUSEHOLD_TAB>">
</form>
</body>
</html>
