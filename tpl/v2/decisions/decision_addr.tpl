...
<table border="0" cellpadding="5" cellspacing="0" width="600">
  <tr>
	...
	<TMPL_UNLESS DISABLE_D_AND_B>
            <li><a href="javascript:setevent('SEARCH/SEARCH_D_AND_B');submitevent();">D &amp; B Search</a></li>
	</TMPL_UNLESS>
  ...
  <TMPL_IF SHOW_RT_PHONE>
	...
	<TMPL_UNLESS DISABLE_MAPQUEST>
            <li><a href="javascript: setformelement('MAP','EVENT','ESRI/INITIAL_MAP');esri_submitevent();">Map this Address</a></li>
	</TMPL_UNLESS>

	<TMPL_UNLESS DISABLE_SATELLITE_IMAGE>
            <li><a href="javascript: setformelement('MAP','EVENT','SATELLITE/CHECK_IMAGE');satellite_submitevent();">Satellite Image</a></li>
	</TMPL_UNLESS>
