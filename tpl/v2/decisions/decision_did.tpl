...
<table border="0" cellpadding="5" cellspacing="0" width="600">
  ...
  <TMPL_UNLESS DELETE_CONTACT_PLUS>
    ...
    <TMPL_UNLESS CONTACTPLUS_CAP_MET>
      <li><a href="javascript:setevent('SEARCH2/SEARCH_CONTACT_PLUS');submitevent();">Contact Plus Search</a></li>
    </TMPL_UNLESS>
    </TMPL_UNLESS>
  </TMPL_UNLESS>
  ...
  <TMPL_UNLESS PROPERTYSEARCH_CAP_MET>
    ...
    <li><a href="javascript:setevent('SEARCH/SEARCH_REAL_PROPERTY');submitevent()"><TMPL_UNLESS IRS>Real </TMPL_UNLESS>Property (Property Assessments, Deeds &amp; Mortgages)</a></li>
    </TMPL_UNLESS>
  </TMPL_UNLESS>
  ...
  <TMPL_UNLESS HIDE_MV>
    ...
    <TMPL_UNLESS DISABLE_PERSON_DTR>
      <TMPL_UNLESS DISABLE_DIRECT_TO_REPORT>
        <li><a href="javascript:setevent('SEARCH/SHOW_PERSON_DTR');submitevent();">Direct-To-Report</a></li>
      </TMPL_UNLESS>
    </TMPL_UNLESS>
