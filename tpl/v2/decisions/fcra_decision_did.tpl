...
<TMPL_UNLESS PROPERTYSEARCH_CAP_MET>
    <TMPL_UNLESS DISABLE_ASSESSMENT>
        ...
        <li><a href="javascript:setevent('SEARCH/SEARCH_REAL_PROPERTY_A');submitevent()">Real Property Locator (Property Assessments)</a></li>
        <TMPL_ELSE>
        <TMPL_UNLESS NAME="COMBINED_REAL_PROPERTY">
        <li><a href="javascript:setevent('SEARCH/SEARCH_PROP');submitevent()">Real Property Locator (Property Assessments)</a></li>
        </TMPL_UNLESS>
        </TMPL_IF>
    </TMPL_UNLESS>
    ...
    <TMPL_UNLESS DISABLE_DEEDS>
        <TMPL_IF NAME="HYBRID_REAL_PROPERTY">
        <li><a href="javascript:setevent('SEARCH/SEARCH_REAL_PROPERTY_D');submitevent()">Real Property Locator (Property Deeds)</a></li>
        <TMPL_ELSE>
        <TMPL_UNLESS NAME="COMBINED_REAL_PROPERTY">
        <li><a href="javascript:setevent('SEARCH/SEARCH_PROP_DEED');submitevent()">Real Property Locator (Property Deeds)</a></li>
        </TMPL_UNLESS>
        </TMPL_IF>
    </TMPL_UNLESS>

    <TMPL_UNLESS DISABLE_REAL_PROPERTY>
    <li><a href="javascript:setevent('SEARCH/SEARCH_REAL_PROPERTY');submitevent()">Real Property Locator (Property Assessments, Deeds &amp; Mortgages)</a></li>
    </TMPL_UNLESS>
</TMPL_UNLESS>
