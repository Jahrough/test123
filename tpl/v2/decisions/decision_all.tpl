...
<table border="0" cellpadding="5" cellspacing="0" width="600">
  <tr>
    ...
    <li><a href="javascript:setevent('SEARCH/SEARCH_PROVIDER');submitevent();">Provider Search</a></li>
	</TMPL_UNLESS>
    </TMPL_IF>
  ...
  <TMPL_UNLESS SSN_ONLY_SEARCH>
    ...
    <TMPL_UNLESS DISABLE_ADV>
		<li><a href="javascript:<TMPL_UNLESS IRB>setaction('<TMPL_VAR NAME=ACTION_MISC>');</TMPL_UNLESS>setevent('SEARCH/SEARCH_ADV');submitevent();"><span id="advanced_person"></span></a></li>
    </TMPL_UNLESS>
    ...
    <li><a href="javascript:setevent('SEARCH/SEARCH_PAW');submitevent();"><TMPL_IF FCOL_TCOL>People At Work Locator<TMPL_ELSE>People At Work Search</TMPL_IF></a></li>
	</TMPL_UNLESS>

	<TMPL_UNLESS DISABLE_BUS>
    <li><a href="javascript:setevent('SEARCH/SEARCH_BUS');submitevent()"><TMPL_IF FCOL>Find a Business<TMPL_ELSE>Business Search</TMPL_IF></a></li>
	</TMPL_UNLESS>
    ...
    <li><a href="javascript:setevent('SEARCH2/SEARCH_UCC');submitevent();">UCC Search</a></li>
	</TMPL_UNLESS>
  ...
  <TMPL_UNLESS PROPERTYSEARCH_CAP_MET>
	<TMPL_UNLESS DISABLE_ASSESSMENT>
	    ...
	    <li><a href="javascript:setevent('SEARCH/SEARCH_REAL_PROPERTY_A');submitevent()"><TMPL_IF FCOL_TCOL>Real Property Locator (Property Assessments)<TMPL_ELSE>Property Assessment</TMPL_IF></a></li>
	    <TMPL_ELSE>
	...
	<TMPL_UNLESS DISABLE_DEEDS>
	    <TMPL_IF NAME="HYBRID_REAL_PROPERTY">
	    <li><a href="javascript:setevent('SEARCH/SEARCH_REAL_PROPERTY_D');submitevent()"><TMPL_IF FCOL_TCOL>Real Property Locator (Property Deeds)<TMPL_ELSE>Property Deeds</TMPL_IF></a></li>
	    <TMPL_ELSE>
	    <TMPL_UNLESS NAME="COMBINED_REAL_PROPERTY">
	    <li><a href="javascript:setevent('SEARCH/SEARCH_PROP_DEED');submitevent()"><TMPL_IF FCOL_TCOL>Real Property Locator (Property Deeds)<TMPL_ELSE>Property Deeds</TMPL_IF></a></li>
	    </TMPL_UNLESS>
	    </TMPL_IF>
	</TMPL_UNLESS>

	<TMPL_UNLESS DISABLE_REAL_PROPERTY>
    <li><a href="javascript:setevent('SEARCH/SEARCH_REAL_PROPERTY');submitevent()"><TMPL_IF FCOL_TCOL>Real Property Locator (Property Assessments, Deeds &amp; Mortgages)<TMPL_ELSE><TMPL_UNLESS IRS>Real </TMPL_UNLESS>Property (Property Assessments, Deeds &amp; Mortgages)</TMPL_IF></a></li>
	</TMPL_UNLESS>
	</TMPL_UNLESS>
    ...
    <li><a href="javascript:setevent('SEARCH/SEARCH_FAA_PILOT');submitevent();">FAA Pilots</a></li>
	</TMPL_UNLESS>
	...
	<li><a href="javascript:setevent('SEARCH/SEARCH_SANCTION');submitevent();">Provider Sanction Search</a></li>
	</TMPL_UNLESS>
	</TMPL_IF>

  <TMPL_UNLESS DISABLE_DEA>
      <li><a href="javascript:setevent('SEARCH/SEARCH_DEA');submitevent();">DEA Controlled Substances</a></li>
  </TMPL_UNLESS>
    ...
    <TMPL_IF XBPS>
       <TMPL_UNLESS DONT_SHOW_NEWS>
         <TMPL_UNLESS DISABLE_NEWS>    
            <li><a href="javascript:setevent('SEARCH/SHOW_NEWS');submitevent();">People in the News</a></li>
         </TMPL_UNLESS>
         <TMPL_UNLESS DISABLE_LN_NEGATIVE_NEWS>
            <li><a href="javascript:setevent('SEARCH/SHOW_NEG_NEWS');submitevent();">Negative News</a></li>
         </TMPL_UNLESS>
         <TMPL_UNLESS DISABLE_DO_NEWS>
            <li><a href="javascript:setevent('SEARCH/SHOW_DO_NEWS');submitevent();">Deaths & Obituaries in the News</a></li>
         </TMPL_UNLESS>
         <TMPL_UNLESS DISABLE_ARCHIVED_NEWS>
            <li><a href="javascript:setevent('SEARCH/SHOW_ARCHIVED_NEWS');submitevent();">Archived News</a></li>
         </TMPL_UNLESS>
       </TMPL_UNLESS>
    </TMPL_IF>
    </TMPL_UNLESS>
  ...
  <TMPL_UNLESS DISABLE_CONCEALED_WEAPON>
    ...
    <li><a href="javascript:setevent('SEARCH/SEARCH_DA_BASIC');submitevent();">Basic Lookup</a></li>
	</TMPL_UNLESS>
