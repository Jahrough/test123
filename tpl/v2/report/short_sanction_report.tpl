...
<div align="center" id="mainbody">
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%" height="10">
	  ...
	  <table width="740" border="0" align="center" cellpadding="0" cellspacing="0">
		<tr>
		  <td align="center">
		  	<input name="BUTTON" tabindex="1" type="button" value="<TMPL_IF REPORT_BUTTON><TMPL_VAR NAME=REPORT_BUTTON><TMPL_ELSE>Request Report</TMPL_IF>" onclick="showpw();send_event('REPORT/SAVE_SANCTION_PREFS');disable_buttons('BUTTON');" /> 
		  </td>
		</tr>
	  </table>
