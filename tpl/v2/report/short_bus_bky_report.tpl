<!-- Begin short_bus_bky_report.tpl -->
...
<form name="SHORT_BUS_REPORT" action="<TMPL_VAR NAME=ACTION_REPORT>" method="post"> 
      ...
      <INPUT type=hidden NAME="EVENT" VALUE="REPORT/SAVE_SHORT_BUS_BKY_PREFS">
...
<table border="0" cellpadding="0" cellspacing="0" width="95%" height="10">
  ...
  <table width="700" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
        <td align="center"><input name="BUTTON" tabindex="1" class="rb" type="button" value="<TMPL_IF REPORT_BUTTON><TMPL_VAR NAME=REPORT_BUTTON><TMPL_ELSE>Request Report</TMPL_IF>" onMouseDown="flip_style(this,'rbd');" onClick="showpw();send_event('REPORT/SAVE_SHORT_BUS_BKY_PREFS');disable_buttons('BUTTON');" onMouseOut="flip_style(this,'rb');"></td>
    </tr>
  </table>
...
<TMPL_INCLUDE NAME="short_bus_bky_report_body.tpl">
