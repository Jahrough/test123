...
<TMPL_IF NAME="PREFERENCES_ERROR_MESSAGE">
  ...
  <tr>
    <td align="left" colspan="3"class="medblack"><b>&nbsp;<TMPL_UNLESS HIDE_PRICES>Base Report Price:&nbsp;&nbsp;$<TMPL_VAR NAME="base-report-price"><TMPL_ELSE>Base Report Features:</TMPL_UNLESS>&nbsp;</b></td>
  </tr>
    ...
    <td align="left" colspan="3" class="medblack"><b>&nbsp;Additional Report Options:</b></td>
      ...
      <tr>
        ...
        <TMPL_UNLESS DISABLE_CRIM>
            ...
            <td align="left" class="medblack"><label for="criminal-records">&nbsp;Possible Criminal Records<TMPL_UNLESS HIDE_PRICES> <img src="<TMPL_VAR NAME='IMGPATH'>/star.gif" border="0" width="11" height="10" alt="See Note Below Regarding Charges"><img src="<TMPL_VAR NAME='IMGPATH'>/star.gif" border="0" width="11" height="10" alt="See Note Below Regarding Charges"></TMPL_UNLESS></label></td>
            <td align="right" class="medblue"><TMPL_UNLESS HIDE_PRICES>$<TMPL_VAR NAME="criminal-records-price"></TMPL_UNLESS>&nbsp;</td>
        <TMPL_ELSE>
            <td width="1%">&nbsp;</td>
        ...
        <TMPL_UNLESS DISABLE_SEXPREDATOR>
            ...
            <td align="left" class="medblack"><label for="sexpredator">&nbsp;Sexual Offenses<TMPL_UNLESS HIDE_PRICES> <img src="<TMPL_VAR NAME=IMGPATH>/star.gif" border="0" width="11" height="10" alt="See Note Below Regarding Charges"><img src="<TMPL_VAR NAME='IMGPATH'>/star.gif" border="0" width="11" height="10" alt="See Note Below Regarding Charges"></TMPL_UNLESS></label></td>
            <td align="right" class="medblue"><TMPL_UNLESS HIDE_PRICES>$<TMPL_VAR NAME=sexpredator-price></TMPL_UNLESS>&nbsp;</td>
        <TMPL_ELSE>
            <td width="1%">&nbsp;</td>
        ...
        <TMPL_IF SHOW_ADDED_REPORT_FDN>
          <tr>
            ...
            <td align="left" class="medblack"><label for="fdn-network">&nbsp;Include LexisNexis&reg; Fraud Defense Network&nbsp;<img src="<TMPL_VAR NAME='IMGPATH'>/star.gif" border="0" width="11" height="10" alt="See Note Below Regarding Charges"></label></td>
            <td align="right" class="medblue"><TMPL_UNLESS HIDE_PRICES>&nbsp;&nbsp;$<TMPL_VAR NAME="fdn-network-price"></TMPL_UNLESS>&nbsp;</td>
          </tr>
        ...
        <TMPL_UNLESS DISABLE_LIEN>
            ...
            <td align="left" class="medblack"><label for="liens">&nbsp;Liens and Judgments<TMPL_UNLESS HIDE_PRICES> <img src="<TMPL_VAR NAME='IMGPATH'>/star.gif" border="0" width="11" height="10" alt="See Note Below Regarding Charges"><img src="<TMPL_VAR NAME=IMGPATH>/star.gif" border="0" width="11" height="10" alt="See Note Below Regarding Charges"></TMPL_UNLESS></label></td>
        ...
        <TMPL_UNLESS DISABLE_CENSUS>
            ...
            <td align="right" class="medblue"><TMPL_UNLESS HIDE_PRICES>$<TMPL_VAR NAME="census-data-price"></TMPL_UNLESS>&nbsp;</td>
        <TMPL_ELSE>
            <td width="1%">&nbsp;</td>
            <td align="left" class="disabled_small">&nbsp;Neighborhood Profile (disabled)&nbsp;&nbsp;</td>
