...
<table border="0" cellpadding="0" cellspacing="0" width="100%" height="10">
  ...
  <table width="740" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
        <td align="center"><input name="BUTTON" tabindex="1" class="rb" type="button" value="<TMPL_IF REPORT_BUTTON><TMPL_VAR NAME=REPORT_BUTTON><TMPL_ELSE>Request Report</TMPL_IF>" onMouseDown="flip_style(this,'rbd');" onClick="showpw();send_event('REPORT/SAVE_BUS_PREFS');disable_buttons('BUTTON');" onMouseOut="flip_style(this,'rb');"></td>
    </tr>
  </table>
...
<TMPL_ELSE>
<TMPL_IF TCOL>
<TMPL_INCLUDE NAME="../tcol/report/short_bus_report_body.tpl">
<TMPL_ELSE>
<TMPL_IF FCOL>
