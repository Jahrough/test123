<!-- Begin v2/report/short_ind_qualifier_report_body.tpl-->
...
<TMPL_IF NAME="PREFERENCES_ERROR_MESSAGE">
  ...
  <tr>
    <td colspan="3" valign="top">&nbsp;<b>Base Report Features:</b>&nbsp;</td>
  </tr>
    ...
    <tr>
      <td width="56%" valign="top">
	      ...
	      <tr>
                <td align="left" class="medblack"><label for="baseSubjectInfo">&nbsp;&nbsp;Base Subject Information</label></td>
  ...
  <tr>
    <td colspan="3" valign="top">&nbsp;<b>Additional Report Features:</b>&nbsp;</td>
  </tr>
...
<!-- End v2/report/short_ind_qualifier_report_body.tpl-->
