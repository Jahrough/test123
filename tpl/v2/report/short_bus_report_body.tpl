  ...
  <tr>
    <td align="left" colspan="3" class="medblack"><b>&nbsp;Additional Report Options:</b></td>
	  ...
	  <tr>
		...
		<tr>
                <td width="1%">&nbsp;</td>
            <td align="left" class="medblack"><input type="checkbox" id="associated-businesses" name="associated-businesses" value="1" <TMPL_VAR NAME="associated-businesses"> onClick="change_total(this, <TMPL_VAR NAME='associated-businesses-price'>, document.forms[0].BUS_TOTAL,document.forms[0].BUS_PRE_TOTAL)"><label for="associated-businesses">&nbsp;Associated Businesses</label></td>
    ...
    <TMPL_UNLESS DISABLE_CORPORATION>
                <td width="1%">&nbsp;</td>
            <td align="left" class="medblack"><input type="checkbox" id="contacts" name="contacts" value="1" <TMPL_VAR NAME="contacts"> onClick="change_total(this, <TMPL_VAR NAME='contacts-price'>, document.forms[0].BUS_TOTAL,document.forms[0].BUS_PRE_TOTAL)"><label for="contacts">&nbsp;Associated People</label></td>
    ...
    <tr>
      ...
      <td width="1%">&nbsp;</td>
		...
		<TMPL_ELSE>
			...
			<td align="right" class="disabled_small"><TMPL_UNLESS HIDE_PRICES>$<TMPL_VAR NAME="faa-aircraft-price"></TMPL_UNLESS>&nbsp;</td>
		</TMPL_UNLESS>
	      </tr>
	      </TMPL_UNLESS>
		...
		<TMPL_ELSE>
		    ...
		    <td align="right" class="disabled_small"><TMPL_UNLESS HIDE_PRICES>$<TMPL_VAR NAME="merchant-vessels-price"></TMPL_UNLESS>&nbsp;</td>
		</TMPL_UNLESS>
	      </tr>
	      </TMPL_UNLESS>
		...
		<TMPL_UNLESS DISABLE_WHOIS>
                <td width="1%">&nbsp;</td>
            <td align="left" class="medblack"><input type="checkbox" id="domains" name="domains" value="1" <TMPL_VAR NAME="domains"> onClick="change_total(this, <TMPL_VAR NAME='domains-price'>, document.forms[0].BUS_TOTAL,document.forms[0].BUS_PRE_TOTAL)"><label for="domains">&nbsp;Internet Domain Names</label></td>
        ...
        <tr>
            <td width="1%">&nbsp;</td>
            <td align="left" class="medblack"><input type="checkbox" id="irs-5500" name="irs-5500" value="1" <TMPL_VAR NAME="irs-5500"> onClick="change_total(this, <TMPL_VAR NAME='irs-5500-price'>, document.forms[0].BUS_TOTAL,document.forms[0].BUS_PRE_TOTAL)"><label for="irs-5500">&nbsp;IRS5500</label></td>
    ...
    <TMPL_UNLESS HIDE_D_AND_B>
		...
		<TMPL_UNLESS DISABLE_D_AND_B>
                <td width="1%">&nbsp;</td>
            <td align="left" class="medblack"><input type="checkbox" id="d_and_b" name="d_and_b" value="1" <TMPL_VAR NAME="d_and_b"> onClick="change_total(this, <TMPL_VAR NAME='d_and_b-price'>, document.forms[0].BUS_TOTAL,document.forms[0].BUS_PRE_TOTAL)"><label for="d_and_b">&nbsp;Dun &amp; Bradstreet Records</label></td>
