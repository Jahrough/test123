<!-- Begin short_claims_register_report.tpl -->
<html>
<head>
<title><TMPL_IF NAME='REPORT_NAME'><TMPL_VAR NAME='REPORT_NAME'><TMPL_ELSE>Claim Register Report</TMPL_IF></title>
...
<form name="SHORT_CLAIM_REGISTER_REPORT" action="<TMPL_VAR NAME=ACTION_DOCKET>" method="post"> 
      <TMPL_INCLUDE NAME=common_hidden_input.tpl>
      <INPUT type=hidden NAME="SKIN_TYPE" VALUE="<TMPL_VAR NAME=SKIN_TYPE>">
      <INPUT type=hidden NAME="APPLICATION_TYPE" VALUE="<TMPL_VAR NAME=APPLICATION_TYPE>">
      <INPUT type=hidden NAME="EVENT" VALUE="DOCKET/PULL_CLAIMS_REGISTER">
...
<table width="740" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td align="center">
      <input name="BUTTON" tabindex="1" type="button" value="<TMPL_IF REPORT_BUTTON><TMPL_VAR NAME=REPORT_BUTTON><TMPL_ELSE>Request Report</TMPL_IF>" onclick="showpw();send_event('DOCKET/PULL_CLAIMS_REGISTER');disable_buttons('BUTTON');" /> 
      </td>
      <td>
...
<!-- End short_claims_register_report.tpl -->
