...
<div id="myAccount" onMouseOver="show_section('myaccountcontent');" onMouseOut="hide_section('myaccountcontent');">
        <div id="myaccountcontenttitle" class="myAccountHdr" onClick="toggle_section('myaccountcontent');"></div>
	...
	<TMPL_UNLESS HIDE_ACTIVITY><li><a href="javascript:show_post_popup('MYACCOUNT/SHOW_ACTIVITY','MyAccountWin','','',1,1,1,1,1,0,'<TMPL_VAR NAME=ACTION_ADMIN>');">Activity</a></li></TMPL_UNLESS>
        <TMPL_UNLESS BILLING_END_USER>
