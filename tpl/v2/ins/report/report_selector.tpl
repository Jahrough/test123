...
<!-- Begin ins/report/report_selector.tpl -->
...
<!-- Start Points of Contact Report Section -->
<div id="reportPopContainer">
 <div id="reportPop">
   <div class="reportPopHdr">Points of Contact Report</div>
...
<!-- End Points of Contact Report Section -->
</TMPL_UNLESS>
 ...
 <div id="reportPop">
   <div class="reportPopHdr">Comprehensive Report</div>
      <ul>
        ...
        <TMPL_UNLESS INS>
        <li>National Motor Vehicle Accidents</li></TMPL_UNLESS>
        <TMPL_ELSE>
