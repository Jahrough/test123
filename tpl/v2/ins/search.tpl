...
onLoad="LN.misc.appInit(<TMPL_IF BLIND>0<TMPL_ELSE><TMPL_IF SKIP_RECENT_SEARCH_AJAX>0<TMPL_ELSE>2</TMPL_IF></TMPL_IF>);setup_form();<TMPL_IF NAME="POLICE_REPORT_ALREADY"> police_records_order('MYACCOUNT/SHOW_POLICE_RECORDS_REPORT','<TMPL_VAR NAME="POLICE_REPORT_ALREADY">');</TMPL_IF><TMPL_IF NAME="SOCIALMEDIA_SEARCH">SML_onload();</TMPL_IF>">
...
<!-- <table width="98%" border="0" class="sortable" > -->
<table width="98%" border="0">
  <tbody>
  <tr>
  <td colspan="1">
	<form name="SEARCH_RESULTS" action="<TMPL_VAR NAME=ACTION>" method="post">
	     <TMPL_INCLUDE NAME="ins/search_footer.tpl">
...
<img id="sWimg" src="<TMPL_VAR NAME=IMGPATH>/bg_searching_sml.gif" alt="Running Search.." />
<TMPL_ELSE>
...
<TMPL_IF NAME="SEARCH_ERROR_MESSAGE">
    if ($('resultsError')) { $('resultsError').scrollTo(); }
</TMPL_IF>
</TMPL_IF>
</script>
