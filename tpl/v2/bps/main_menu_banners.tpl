...
banner[0] = 
    { image:'<TMPL_VAR NAME=IMGPATH>/main/bus_we_also_found_banner.gif',url:'<TMPL_VAR NAME=HTMLPATH>/social_network_report_popup.html',width:'500',height:'300',name:'SocialNetwork' }
banner[1] = 
