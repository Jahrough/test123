...
<table width="100%">
  <tbody><tr>
    <td id="containerLeft" align="left" valign="top">
	  ...
	  <div id="bannerinfo">
            <ul>
	      <li><strong><a href="javascript:open_banner(6);">Important Security enhancement - Multi Factor Authentication</a></strong></li>
	      ...
	      <li><strong><a href="javascript:open_banner(4);">Now even MORE contact information from the LexisNexis<sup>&reg;</sup> Batch Wizard!</a></strong></li>
...
-->
      <tr>
         ...
         <big>|</big>
         <input type="checkbox" id="rollovers" onClick="toggle_rollovers();"> <a href="javascript:toggle_rollovers();" onMouseOver="set_tip('tip_rem','<div style=\'width: 215px\'><br><b>Rollovers Enabled</b><br>When checked, show content when pointer rolls over hidden sections.<br><br></div>',event,'relative');setOpacity('tip_rem',0);fadeIn('tip_rem',100,2);" onMouseOut="close_tip('tip_rem');">Rollovers Enabled</a>
         </small></div>
         </td>
      </tr>
	  ...
	  <ul>
            ...
            <TMPL_UNLESS DELETE_CONTACT_PLUS>
                    <li><TMPL_IF CONTACTPLUS_CAP_MET>Contact Plus Search &nbsp;<a href="javascript:void(0);" onMouseOver="set_tip('tip_rem',cap_notice,event,'relative');setOpacity('tip_rem',0);fadeIn('tip_rem',100,2);" onMouseOut="close_tip('tip_rem');"><img src='<TMPL_VAR NAME=IMGPATH>/main/security_lock.gif' border='0'></a><TMPL_ELSE><TMPL_IF DISABLE_CONTACT_PLUS>Contact Plus Search<TMPL_ELSE><a href="javascript:send_event('SEARCH2/SHOW_CONTACT_PLUS');" title="Contact Plus Search">Contact Plus Search</a></TMPL_IF></TMPL_IF></li>
           </TMPL_UNLESS>
...
<TMPL_IF SHOW_SOCIAL_MEDIA_LOCATOR><li><TMPL_IF DISABLE_SOCIALMEDIA>Social Media Locator<TMPL_ELSE><a href="javascript:send_event('SEARCH/SHOW_SOCIALMEDIA');">Social&nbsp;Media Locator</a>&nbsp;&nbsp;<font color="#ed1c24"><b>NEW!</b></font></TMPL_IF></li></TMPL_IF>
	 ...
	 <div><img src="<TMPL_VAR NAME=IMGPATH>/spacer.gif" border="1" height="5" width="1" /></div>
	    ...
	    <li><TMPL_IF DISABLE_BUS_INSTANT_ID>Business InstantID (Temporarily Not Available)<TMPL_ELSE><a href="javascript:send_event('SEARCH/SHOW_BUS_INSTANT_ID');">Business InstantID</a></TMPL_IF></li>
	    <TMPL_IF IS_BATCH_ADMIN><li><TMPL_UNLESS DISABLE_BATCH><a href="javascript:show_post_popup('INSTANTIDBATCH/START_BATCH','BatchWin',800,650,0,0,0,1,1,0,'<TMPL_VAR NAME=ACTION_BATCH>');">Business<br>InstantID Batch</a><TMPL_ELSE>Business<br>InstantID Batch</TMPL_UNLESS></li></TMPL_IF>
	    <TMPL_IF IS_BATCH_ADMIN><li><TMPL_UNLESS DISABLE_BATCH><a class="mainmenu" href="javascript:show_post_popup('BATCH/BUS_START_BATCH','BatchWin',800,650,0,0,0,1,1,0,'<TMPL_VAR NAME=ACTION_BATCH>');">Business Batching</a><TMPL_ELSE>Business Batching</TMPL_UNLESS></li></TMPL_IF>
         </ul>
         </div>
	 <div><img src="<TMPL_VAR NAME=IMGPATH>/spacer.gif" border="1" height="5" width="1" /></div>
         </div>
...
<div id="containerRight">
	...
	<!-- END DIV for right column content container -->
        ...
        <div id="myAccount" onMouseOver="show_section('security');" onMouseOut="hide_section('security');">
          ...
          <div style="position:relative;top:10px;left:160px;margin-bottom:-35px;width:50px;height:49px;"><img src="<TMPL_VAR NAME=IMGPATH>/security_lock.gif" border="0" /></div>
