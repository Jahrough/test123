...
<div id="recentSearch">
    <div class="recentSearchHdr">Recent Searches</div>
    <p>[<a href="javascript:show_post_popup('MYACCOUNT/SHOW_ALL_RECENT','MyAccountWin','','',1,1,1,1,1,0,'<TMPL_VAR NAME=ACTION_ADMIN>');">All Searches</a>]</p>
    <div id="rsContainer">
