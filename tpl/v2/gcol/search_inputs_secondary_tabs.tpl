...
<TMPL_IF NAME=IM_ON_DA_SEARCH>
 <ul>
  ...
  <TMPL_IF NAME=RT_PHONE_SEARCH>
    <li class="active"><a trackid="subtab_realtime_phone" href="javascript:send_event('SEARCH/SHOW_RT_PHONE');">Real-Time Phones</a></li>
  <TMPL_ELSE>
    <li><a trackid="subtab_realtime_phone" href="javascript:send_event('SEARCH/SHOW_RT_PHONE');">Real-Time Phones</a></li>
  </TMPL_IF>
