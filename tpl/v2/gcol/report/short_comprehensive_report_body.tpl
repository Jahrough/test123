  ...
  <tr height="10">
    ...
    <!--
	      ...
	      <TMPL_ELSE>
	        ...
	        <td align="left" class="medblack"><label for="fcra-weapon-permits">&nbsp;Concealed Weapons Permits</label>&nbsp;&nbsp;</td>
	        <td align="right" class="medblack">&nbsp;</td>
	      </TMPL_IF>
	      </tr>
              </TMPL_UNLESS>
	      ...
	      <TMPL_ELSE>
	        ...
	        <td align="left" class="medblack"><label for="fcra-hunting-fishing-licenses">&nbsp;Hunting/Fishing Permits</label>&nbsp;&nbsp;</td>
	        <td align="right" class="medblack">&nbsp;</td>
	      </TMPL_IF>
	      </tr>
              </TMPL_UNLESS>
