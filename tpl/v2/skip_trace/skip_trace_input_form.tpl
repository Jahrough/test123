...
<tbody>
        <tr>
          <td style="padding-left: 10px; padding-top: 5px;" valign="top">
           ...
           <tbody>
	        <TMPL_INCLUDE NAME="skip_trace/skip_trace_inputs.tpl">
           </tbody>
           </table>
          </td>
		  ...
		  <tr>
		    ...
		    <div id="searchBlock">
			<input name="BUTTON" tabindex="101" id="searchBtn" type="button" value="Search" onBlur="ENTER_FOCUS=0;" onFocus="ENTER_FOCUS=1" onClick="if(!validate()) return false;if(!validate_st_features('<TMPL_VAR NAME="ST_LIMIT_BY_BALANCE">')) return false; flip_ids(); send_event('SEARCH2/SEARCH_SKIP_TRACE');">
          ...
          <td style="padding-left: 10px; padding-top: 5px; padding-bottom: 10px;" valign="top">
           <table cellspacing="0" border="0">
              <tr>
                ...
                <td style="font-size: 9pt;" align="center" valign="middle"><input type=text tabindex="91" size="16" maxlength="<TMPL_IF REFERENCE_CODE_MAX_LENGTH><TMPL_VAR REFERENCE_CODE_MAX_LENGTH><TMPL_ELSE>30</TMPL_IF>" name="REFERENCE_CODE" id="REF_CODE" value="<TMPL_VAR NAME=REFERENCE_CODE>"<TMPL_IF DISABLE_REF_CODE> DISABLED</TMPL_IF>></td>
              </tr>
           </table>
          </td>
        </tr>
