<!-- begin v2/hea/search_inputs_primary_tabs_pulldown_menus.tpl -->
 ...
 <TMPL_UNLESS RESTRICT_LNLP_CONTENT>
  ...
  <TMPL_UNLESS HIDE_RT_MVR>
    <li><a trackid="subtab_rt_mvr" href="javascript:pm_tab('SEARCH/SHOW_RT_MVR');">Real-Time MVR</a></li>
  </TMPL_UNLESS>
  ...
  <TMPL_UNLESS DELETE_DISCLOSED_ENTITY_REPORT>
    <li><a trackid="subtab_disclosed_entity" href="javascript:pm_tab('SEARCH2/SHOW_DISCLOSED_ENTITY');">Disclosed Entity Report</a></li>
  </TMPL_UNLESS>
  ...
  <TMPL_IF SHOW_IDM_ANALYSIS_SECTION>
    <div id="analysisSearches" class="upperTab" style="border-top:1px solid #b7b7b7;" onmouseout='$("analysisSearches").style.display = "none";' onmouseover='this.style.cursor="pointer";$("analysisSearches").style.display = "block";'>
      <div id="navlist">
        <ul style="font-size:11px">
          <TMPL_IF SHOW_IDM_VISUALIZATION>
          <li><a trackid="subtab_idm_management" href="javascript:show_post_popup('SEARCH/SHOW_IDM_VISUALIZATION','IDMVisualizationWin',850,650,0,0,0,1,1,0);">Identity Management Dashboard</a></li>
          </TMPL_IF>
          <TMPL_IF SHOW_BIZ_ANALYTICS_HOLD> <!-- hold on first release -->
          <li><a trackid="subtab_biz_analytics" href="javascript:show_post_popup('SEARCH/SHOW_BIZ_ANALYTICS','BusAnalyticsWin',850,650,0,0,0,1,1,0);">Business Analytics Dashboard</a></li>
          </TMPL_IF>
        </ul>
      </div>
      <br/>
...
<!-- End v2/hea/search_inputs_primary_tabs_pulldown_menus.tpl -->
