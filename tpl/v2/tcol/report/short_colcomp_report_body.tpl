    ...
    <tr>
      <td width="56%" valign="top">
          ...
          <tr>
            ...
            <td align="left" class="medblack"><label for="imposters">&nbsp;Others Associated with Subject&apos;s SSN&nbsp;&nbsp;</label></td>
   ...
   <tr>
      <td width="49%" valign="top">
         <table border="0" cellpadding="0" cellspacing="0" width="100%">
            ...
            <tr>
               <td width="1%">
                  <input type="checkbox" name="relatives" id="relatives" value="8" <TMPL_VAR NAME=relatives> onClick="var relativedepth=get_form_element('relative-depth'); change_depth_total(<TMPL_VAR NAME='relatives-price'>,relativedepth.selectedIndex + 1, document.forms[0].REPORT_TOTAL,document.forms[0].REPORT_PRE_TOTAL)">
               </td>
