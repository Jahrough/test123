...
<html>
<head>
<title><TMPL_IF NAME=NAT_COMP_REPORT>National Comprehensive Report Options<TMPL_ELSE>Comprehensive Report Options</TMPL_IF></title>
  ...
  <table width="740" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <TMPL_UNLESS NAME="HIDE_PRICES">
          <td align="center" class="medblack"><b>Select Any or All Options for ONLY $<TMPL_VAR NAME=ALL_FOR_TOTAL></b></td>
      </TMPL_UNLESS>
      </TMPL_UNLESS>
      <td align="center">
...
<!--
<TMPL_IF NAME=COL_COMP_REPORT>
<TMPL_INCLUDE NAME="short_col_comprehensive_report_body.tpl">
<TMPL_ELSE>
-->
...
<TMPL_ELSE>
<TMPL_IF NAME=TCOL>
<TMPL_INCLUDE NAME="../tcol/report/short_comprehensive_report_body.tpl">
<TMPL_ELSE>
<TMPL_IF NAME=FCOL>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%" height="10">
<tr><td>tpl/v2/report/short_flat_rate_report.tpl -- short_comprehensive_report_body.tpl</td></tr>
</table>
