<!-- Begin short_colcomp_flat_rate_report_body.tpl -->
...
<TMPL_IF NAME="LINKED_COMP">
   <input type="hidden" name="fcra-property" value="<TMPL_VAR NAME="fcra-property">">
   <input type="hidden" name="fcra-criminal-records" value="<TMPL_VAR NAME="fcra-criminal-records">">
   <input type="hidden" name="fcra-sexpredator" value="<TMPL_VAR NAME="fcra-sexpredator">">
   <input type="hidden" name="fcra-bankruptcy" value="<TMPL_VAR NAME=fcra-bankruptcy">">
   <input type="hidden" name="fcra-liens" value="<TMPL_VAR NAME=fcra-liens">">
   <input type="hidden" name="variety-bundle" value="<TMPL_VAR NAME="variety-bundle">">
</TMPL_IF>
