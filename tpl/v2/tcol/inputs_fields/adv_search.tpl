<!-- begin col/inputs_fields/adv_search.tpl -->
      <TMPL_IF NAME="PERSON_SEARCH_PLUS">
          <INPUT id="IN_HOUSEHOLD_TAB" TYPE="HIDDEN" NAME="IN_HOUSEHOLD_TAB" VALUE="<TMPL_VAR NAME=IN_HOUSEHOLD_TAB>"> 
          <INPUT id="RECID_OVERRIDE" TYPE="HIDDEN" NAME="RECID_OVERRIDE" VALUE="">
      </TMPL_IF>
      <tr>
      ...
      <tr>
        ...
        <table border="0" cellpadding="2" cellspacing="0">
          ...
          <tr>
            ...
            <td class="nsinputs"><input type="text" name="RADIUS" id="RADIUS" tabindex="14" size="2" value="<TMPL_VAR NAME=RADIUS>" maxlength=2></td>
            </TMPL_IF>
          </tr>
        </table>
	 ...
	 <br /><span class="medgray">Additional Subject Information</span>
	  <div id="lineVertRedDot"></div>
        ...
        <table border="0" cellpadding="2" cellspacing="0">
          ...
          <tr>
            <td class="nsinputs"><input type="text" name="OTHER_LAST_NAME" id="OTHER_LAST_NAME" tabindex="15" size="12" value="<TMPL_VAR NAME=OTHER_LAST_NAME>" maxlength=255 onBlur="this.value=this.value.toUpperCase()"></td>
            <td class="nsinputs"><input type="text" name="OTHER_CITY" id="OTHER_CITY" tabindex="16" size="15" value="<TMPL_VAR NAME=OTHER_CITY>" maxlength=255 onBlur="this.value=this.value.toUpperCase()"></td>
            <td class="nsinputs"><input type="text" name="OTHER_STATE" id="OTHER_STATE" tabindex="17" size="12" maxlength="2" value="<TMPL_VAR NAME=OTHER_STATE>" onBlur="this.value=this.value.toUpperCase()"></td>
            <td class="nsinputs"><input type="text" name="OTHER_STATE2" id="OTHER_STATE2" tabindex="18" size="12" maxlength="2" value="<TMPL_VAR NAME=OTHER_STATE2>" onBlur="this.value=this.value.toUpperCase()"></td>
          </tr>
        </table>
        </td>
      </tr>
      <tr>
        ...
        <table border="0" cellpadding="2" cellspacing="0">
          ...
          <tr>
            <td class="nsinputs"><input type="text" name="RELATIVE_FIRST_NAME" id="RELATIVE_FIRST_NAME" tabindex="19" size="20" value="<TMPL_VAR NAME=RELATIVE_FIRST_NAME>" maxlength=255 onBlur="this.value=this.value.toUpperCase()"></td>
            <td class="nsinputs"><input type="text" name="RELATIVE_FIRST_NAME2" id="RELATIVE_FIRST_NAME2" tabindex="20" size="20" value="<TMPL_VAR NAME=RELATIVE_FIRST_NAME2>" maxlength=255 onBlur="this.value=this.value.toUpperCase()"></td>
          </tr>
        </table>
        </td>
      </tr>
