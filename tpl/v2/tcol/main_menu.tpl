...
<style>
#hd { background:url(<TMPL_VAR NAME=IMGPATH>/tcol/1/ln_logo_home.gif) no-repeat; }
</style>
  ...
  <tbody><tr>
    <td id="containerLeft" align="left" valign="top">
      ...
      <div id="newsBlock">
		...
		<li><strong><a href="javascript:open_banner(5);">Upcoming Important Security enhancement - Multi Factor Authentication</a></strong></li>
        ...
        <div class="hpColHdr">
          ...
          <div class="product_pad">
            ...
            <ul>
              ...
              <li><TMPL_IF CONTACTPLUS_CAP_MET>Contact Plus Search &nbsp;<a href="javascript:void(0);" onMouseOver="set_tip('tip_rem',cap_notice,event,'relative');setOpacity('tip_rem',0);fadeIn('tip_rem',100,2);" onMouseOut="close_tip('tip_rem');"><img src='<TMPL_VAR NAME=IMGPATH>/main/security_lock.gif' border='0'></a><TMPL_ELSE><TMPL_IF DISABLE_CONTACT_PLUS>Contact Plus Search<TMPL_ELSE><a href="javascript:send_event('SEARCH2/SHOW_CONTACT_PLUS');" onMouseOver="set_tip('tip_rem',plus_notice,event,'right',450);setOpacity('tip_rem',0);fadeIn('tip_rem',100,2);" onMouseOut="close_tip('tip_rem');">Contact <font color="#ed1c24"><b>Plus</b></font></a></TMPL_IF></TMPL_IF></li>
              </TMPL_UNLESS>
      ...
      <td width="49%" valign="top">
        <div class="hpColHdrGrn">
	      ...
	      <li><TMPL_IF ALLOW_EQUIFAX_RECOVERY_REPORT><a href="javascript:show_post_popup('SEARCH/SHOW_EQUIFAX_RECOVERY_PERMISSION','EquifaxWin','900','580',1,1,1,1,1,0);" title="Equifax Recovery Report">Equifax Recovery Report (FCRA)</a><TMPL_ELSE><a href="javascript:void(0);" onClick="general_win('<TMPL_VAR NAME=HTMLPATH>/tcol/equifax_grayout.html','EquifaxWin','900','580',1,1,1,1,1,0);void(0);" title="Equifax Recovery Report" targe="_blank">Equifax Recovery Report (FCRA)</a></TMPL_IF></li>
            ...
            <strong>Banko&reg; FCRA Tools</strong>
            <ul>
              <TMPL_IF BANKO>
	      		<li><TMPL_IF DISABLE_FCRA_BANKRUPTCY>Bankruptcies<TMPL_ELSE><a href="javascript:send_event('SEARCH2/SHOW_FCRA_BANKRUPTCY');">Bankruptcies</a></TMPL_IF></li>
              </TMPL_IF>
              <li><TMPL_IF DISABLE_FCRA_BK_COURT_LINKS>BK Court Links<TMPL_ELSE><TMPL_IF DISABLE_FCRA_SEARCH>BK Court Links<TMPL_ELSE><a href="javascript:send_event('SEARCH2/SHOW_BK_COURT_LINK_OPTIONS');">BK Court Links</a></TMPL_IF></TMPL_IF></li>
	     	  <li><TMPL_IF DISABLE_FCRA_EVENTS_TAB_ACCESS>Banko Events<TMPL_ELSE><a href="javascript:send_event('SEARCH2/SHOW_BK_EVENT_OPTIONS');">Banko Events</a></TMPL_IF></li>
            </ul>          
          </div>
        </div>
...
<li><a href="javascript:show_post_popup('SEARCH/SHOW_WEBAR_DISCLAIMER','CollectPointWin','900','580',1,1,1,1,1,0);">Collect Point</a></li>
       ...
       <TMPL_IF IRS_VERIFY_ONLY>
        ...
        <div class="hpColHdrOr">
          <h4>File Transfer &amp; Reporting</h4>
          <div class="product_pad">
            <TMPL_UNLESS DO_NOT_DISPLAY_BANKO_FILE_UPLOAD>
               <strong>File Transfer</strong>
               <ul>
                 <li><TMPL_IF DISABLE_BANKO_FILE_UPLOAD>File Area<TMPL_ELSE><a href="javascript:send_event('SEARCH2/SHOW_FILEAREA_OPTIONS');">File Area</a></TMPL_IF></li>
               </ul>
            </TMPL_UNLESS>
...
if ($('li_fcra_recentSearch')) { $('li_fcra_recentSearch').observe('click', show_fcra_rs); }
	...
	<!-- TMPLS_INCLUDE NAME="tcol/search_inputs_recent_searches.tpl"-->
