...
<!-- Start tcol/search_inputs_secondary_tabs.tpl -->
...
<TMPL_IF NAME=IM_ON_SEARCH>
  ...
  <TMPL_IF NAME="PERSON_SEARCH">
  	<li class="active"><a trackid="subtab_person" href="javascript:send_event('SEARCH/SHOW_SEARCH');">Person Search</a></li>
  <TMPL_ELSE>
  	<li><a trackid="subtab_person" href="javascript:send_event('SEARCH/SHOW_SEARCH');">Person Search</a></li>
  </TMPL_IF>
  </TMPL_UNLESS>
  </TMPL_UNLESS>
...
<TMPL_IF NAME=IM_ON_BUS_SEARCH>
  ...
  <TMPL_IF NAME=CORPORATION_SEARCH>
    <li class="active"><a trackid="subtab_corp_filings" href="javascript:send_event('SEARCH/SHOW_CORPORATION');">asCorporate Filings</a></li>
  <TMPL_ELSE>
...
<TMPL_IF NAME=IM_ON_R_SEARCH>
 <ul>
  <TMPL_IF NAME="TRENDREPORTS">
    <li class="active"><a trackid="subtab_trend_reports" href="javascript:send_event('SEARCH2/SHOW_TRENDREPORTS_OPTIONS');">Bankruptcy Trend Reports</a></li>
  <TMPL_ELSE>
    <li><a trackid="subtab_trend_reports" href="javascript:send_event('SEARCH2/SHOW_TRENDREPORTS_OPTIONS');">Bankruptcy Trend Reports</a></li>
  </TMPL_IF>
  <TMPL_IF NAME="COURTTRUSTEE">
    <li class="active"><a trackid="subtab_court_info" href="javascript:send_event('SEARCH2/SHOW_COURT_TRUSTEE_OPTIONS');">Bankruptcy Court Information</a></li>
  <TMPL_ELSE>
    <li><a trackid="subtab_court_info" href="javascript:send_event('SEARCH2/SHOW_COURT_TRUSTEE_OPTIONS');">Bankruptcy Court Information</a></li>
  </TMPL_IF>
 </ul>
</TMPL_IF>

<TMPL_IF NAME=IM_ON_FT_SEARCH>
 <ul>
  <TMPL_UNLESS DO_NOT_DISPLAY_BANKO_FILE_UPLOAD>
  <TMPL_UNLESS DELETE_BANKO_FILE_UPLOAD>
  <TMPL_IF NAME="FILEAREA">
    <li class="active"><a trackid="subtab_file_upload" href="javascript:send_event('SEARCH2/SHOW_FILEAREA_OPTIONS');">File Area</a></li>
  <TMPL_ELSE>
   <li><a trackid="subtab_file_upload" href="javascript:send_event('SEARCH2/SHOW_FILEAREA_OPTIONS');">File Area</a></li>
  </TMPL_IF>
  </TMPL_UNLESS>
  </TMPL_UNLESS>
 </ul>
...
<TMPL_IF NAME=IM_ON_FCRA_TOOLS>
 <ul>
  <TMPL_UNLESS DELETE_FCRA_BANKRUPTCY>
  <TMPL_IF NAME="FCRA_BANKRUPTCY_SEARCH">
    <li class="active"><a trackid="subtab_fcra_tool_bankruptcy" href="javascript:send_event('SEARCH2/SHOW_FCRA_BANKRUPTCY');">Bankruptcies</a></li>
    <TMPL_ELSE>
    <li><a trackid="subtab_fcra_tool_bankruptcy" href="javascript:send_event('SEARCH2/SHOW_FCRA_BANKRUPTCY');">Bankruptcies</a></li>
  </TMPL_IF>
  </TMPL_UNLESS>
  <TMPL_UNLESS DELETE_FCRA_BK_COURT_LINKS_SEARCH>
  <TMPL_IF NAME="FCRA_BK_COURT_LINKS_SEARCH">
    <li class="active"><a trackid="subtab_fcra_tool_bk_courts" href="javascript:send_event('SEARCH2/SHOW_BK_COURT_LINK_OPTIONS');">BK Court Links</a></li>
  <TMPL_ELSE>
   <li><a trackid="subtab_fcra_tool_bk_courts" href="javascript:send_event('SEARCH2/SHOW_BK_COURT_LINK_OPTIONS');">BK Court Links</a></li>
  </TMPL_IF>
  </TMPL_UNLESS>
  <TMPL_UNLESS DELETE_FCRA_EVENTS_TAB_ACCESS>
  <TMPL_IF NAME="FCRA_BK_EVENTS_SEARCH">
    <li class="active"><a trackid="subtab_fcra_tool_bk_events" href="javascript:send_event('SEARCH2/SHOW_BK_EVENT_OPTIONS');">Banko Events</a></li>
  <TMPL_ELSE>
   <li><a trackid="subtab_fcra_tool_bk_events" href="javascript:send_event('SEARCH2/SHOW_BK_EVENT_OPTIONS');">Banko Events</a></li>
  </TMPL_IF>
  </TMPL_UNLESS>
...
<!-- end tcol/search_inputs_secondary_tabs.tpl -->
