...
<TMPL_IF NAME="RESULTS">
  ...
  <TMPL_IF NAME="RECORD_COUNT"><span class="grey">Records: <TMPL_VAR NAME="START_RECORD"> to <TMPL_VAR NAME="END_RECORD"> of <TMPL_IF NAME="SHOW_ALL"><TMPL_VAR NAME="RECORD_COUNT"><TMPL_ELSE><TMPL_IF NAME="MORE_THAN_MAX_GEN">first </TMPL_IF><TMPL_VAR NAME="END_RECORD"></TMPL_IF></span>
  </TMPL_IF>
  </TMPL_UNLESS>
