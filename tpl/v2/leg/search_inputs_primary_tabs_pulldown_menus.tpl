<!-- begin v2/leg/search_inputs_primary_tabs_pulldown_menus.tpl -->
  ...
  <TMPL_UNLESS POLICE_RECORDS_USER_ROLES_VIEW_ONLY>
    <li><a trackid="subtab_police_records" href="javascript:pm_tab('SEARCH/SHOW_POLICE_RECORDS_AUTO_ACCIDENT');">Police Records</a></li>
  </TMPL_UNLESS>
  </TMPL_UNLESS>
  </TMPL_UNLESS>
      </ul>
  ...
  <div id="listAssetSearches" class="upperTab" onmouseout='$("listAssetSearches").style.display = "none";' onmouseover='this.style.cursor="pointer";$("listAssetSearches").style.display = "block";'>
	...
	<li><a trackid="subtab_rt_mvr" href="javascript:pm_tab('SEARCH/SHOW_RT_MVR');">Motor Vehicle Gateway</a></li>
      </TMPL_UNLESS>
...
<!-- End v2/leg/search_inputs_primary_tabs_pulldown_menus.tpl -->
