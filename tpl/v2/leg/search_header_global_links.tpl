<!-- begin search_header_global_links.tpl -->
	<ul>
	  ...
	  <li><a trackid="hdr_my_account" href="javascript:show_post_popup('LOGIN/SHOW_POPUP','HTMLHelp','475','640',1,1,1,1,1,0,'','contact_select');">Contact Us</a></li>
	  ...
	  <TMPL_UNLESS DA_ONLY><li><a trackid="hdr_home_page" href="javascript:send_event('SEARCH/SHOW_MENU')">Home</a></li></TMPL_UNLESS>
	</ul>
