<!-- begin v2/le/search_inputs_primary_tabs.tpl -->
...
<TMPL_IF SHOW_INTERNATIONAL_SECTION>
          <li <TMPL_IF NAME=IM_ON_INTL_DOCKET_SEARCH>class="active"</TMPL_IF> ><a trackid="tab_intl" href="javascript:pm_tab('SEARCH/SHOW_INTDOCKETS');" onMouseOver="show_upper_tab_layer(this,'intlSearches'); $('intlSearches').style.left = findPos(this) + 'px';" onMouseOut="hide_upper_tab_layer('intlSearches');">International</a></li>
</TMPL_IF>          
