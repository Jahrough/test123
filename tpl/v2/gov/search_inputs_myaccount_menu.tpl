...
<div id="myAccount" onMouseOver="show_section('myaccountcontent');" onMouseOut="hide_section('myaccountcontent');">
	...
	<TMPL_UNLESS IS_RESELLER>
	<TMPL_IF SHOW_CASE_CONNECT><li><a href="javascript:show_post_popup('CC/MANAGER','MyAccountWin','','',1,1,1,1,1,0);" id="CC_COUNTER">Case Deconfliction Alerts</a></li></TMPL_IF>
	<TMPL_IF SA>
