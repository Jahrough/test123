...
<!-- Begin gov/report/report_selector.tpl -->
 ...
 <div id="reportPop">
   <div class="reportPopHdr">Comprehensive Report</div>
      ...
      <div align="center">
        ...
        <TMPL_ELSE>
            <input name="BUTTON" tabindex="3" type="button" value="<TMPL_IF REPORT_BUTTON><TMPL_VAR NAME=REPORT_BUTTON><TMPL_ELSE>Request Report</TMPL_IF>" onclick="resizeWindow(1050, 750, 1);showpw();send_event('REPORT/COMPREHENSIVE');disable_buttons('BUTTON');" />
        </TMPL_IF>
      </div>
 ...
 <div id="reportPop">
   <div class="reportPopHdr">Custom Comp Report</div>
           ...
           <TMPL_IF NAME="DISABLE_COMP_REPORT">
               <input tabindex="6" class="rb" type="button" value="Report Disabled" onClick="void(0);" disabled>
           <TMPL_ELSE>
               <input name="BUTTON" tabindex="5" type="button" value="<TMPL_IF REPORT_BUTTON><TMPL_VAR NAME=REPORT_BUTTON><TMPL_ELSE>Request Report</TMPL_IF>" onClick="resizeWindow(1050, 750, 1);showpw();send_event('REPORT/SHORT_REPORT');disable_buttons('BUTTON');" />
           </TMPL_IF>
           </div>
 </div>
  <div id="reportPopBot"></div>
...
<!-- End gov/report/short_report.tpl -->
