<!-- begin v2/gov/search_inputs_primary_tabs_pulldown_menus.tpl -->
  ...
  <TMPL_UNLESS DELETE_AVM>
    <li><a trackid="tab_avms" href="javascript:pm_tab('SEARCH/SHOW_AVM');">Automated Valuation Models</a></li>
  </TMPL_UNLESS>
...
<!-- End v2/gov/search_inputs_primary_tabs_pulldown_menus.tpl -->
