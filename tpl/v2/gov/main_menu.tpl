...
function setup_sections (flag) {
    ...
    set_section('analysisheader','analysislinks','Analytics',flag);
    </TMPL_IF>
...
<body onLoad="setup_sections();LN.misc.appInit(<TMPL_IF
 BLIND>0<TMPL_ELSE><TMPL_IF SKIP_RECENT_SEARCH_AJAX>0<TMPL_ELSE>1</TMPL_IF></TMPL_IF>); <TMPL_IF NAME="ALERTING_NEW_COUNT">menu_prompt('<TMPL_VAR NAME="ALERTING_NEW_COUNT">');</TMPL_IF>">
...
<table width="100%">
  <tr>
	...
	<li><strong><a href="https://learn.lexisnexis.com/lexisnexis/user_activity_info.aspx?id=489" target="_blank">Learn More! Click here to download a complimentary Get Started Guide.</a></strong></li>
  ...
  <br><br>
     ...
     <ul>
	   ...
	   <TMPL_IF ALLOW_EQUIFAX_CREDIT_REPORT>
	      <li><TMPL_IF DISABLE_EQUIFAX_CREDIT_REPORT>Equifax Credit Reports<TMPL_ELSE><a href="javascript:show_post_popup('SEARCH/SHOW_EQUIFAX_CREDIT_FCRA','EquifaxWin','900','580',1,1,1,1,1,0);">Equifax Credit Reports</a></TMPL_IF></li>
	   </TMPL_IF>

	    <TMPL_IF DISABLE_EMAIL><TMPL_UNLESS DELETE_CUSTOM_EMAIL><li>Email Search</li></TMPL_UNLESS><TMPL_ELSE><li><a href="javascript:send_event('SEARCH/SHOW_EMAIL');">Email Search</a></li></TMPL_IF>
  ...
  <TMPL_IF SHOW_RT_PHONE>
     ...
     <div><img src="<TMPL_VAR NAME=IMGPATH>/spacer.gif" border="1" height="5" width="1" /></div>
         ...
         <div id="batchlinks">
          <ul>
            <li>
            <TMPL_UNLESS DISABLE_BATCH><a href="javascript:show_post_popup('BATCH/SERVICES','BatchServices',800,650,0,0,0,1,1,0,'<TMPL_VAR NAME=ACTION_BATCH>');" title="View Online Batch Services">Online Batch Services</a><TMPL_ELSE>
            Online Batch Services</TMPL_UNLESS>
            </li>
         </ul>
     </div>
     <div><img src="<TMPL_VAR NAME=IMGPATH>/spacer.gif" border="1" height="5" width="1" /></div>
     ...
     <div id="hpColHdr" onMouseOver="show_section('businesseslinks');" onMouseOut="hide_section('businesseslinks');">
	    ...
	    <TMPL_UNLESS RESTRICT_LNLP_CONTENT><TMPL_UNLESS DONT_SHOW_NEWS><TMPL_UNLESS DELETE_CUSTOM_BUS_NEWS><li><TMPL_IF DISABLE_BUS_NEWS>Businesses in the News<TMPL_ELSE><a href="javascript:send_event('SEARCH/SHOW_BUS_NEWS');">Businesses in the News</a></TMPL_IF></li></TMPL_UNLESS></TMPL_UNLESS></TMPL_UNLESS>
	 ...
	 <div id="hpColHdr" onMouseOver="show_section('healthcarelinks');" onMouseOut="hide_section('healthcarelinks');">
         ...
         <ul>
           ...
           <TMPL_UNLESS DELETE_CUSTOM_PROVIDER_REPORT_CARD><li><TMPL_IF DISABLE_PROVIDER_REPORT_CARD>Provider Report Card<TMPL_ELSE><a href="javascript:send_event('SEARCH2/SHOW_PROVIDER_REPORT_CARD');">Provider Report Card</a></TMPL_IF></li></TMPL_UNLESS>
	 </ul>
         </div>
     <div><img src="<TMPL_VAR NAME=IMGPATH>/spacer.gif" border="1" height="5" width="1" /></div>
         </div>
...
<TMPL_UNLESS DELETE_TRIMERGE_REPORT>
  ...
  <TMPL_UNLESS DISABLE_TRIMERGE_REPORT>
    ...
    <div id="hpColHdr" onMouseOver="show_section('analysislinks');" onMouseOut="hide_section('analysislinks');">
      <h4 id="analysisheader" style="cursor: pointer;" onClick="toggle_section('analysislinks');"></h4>
...
<TMPL_IF CASE_AUDITOR_TAB>
    ...
    <div id="myAccount" onMouseOver="show_section('training');" onMouseOut="hide_section('training');">
      ...
      <div id="training">
      <ul>
        <li><a href="javascript:show_post_popup('SAML/ACCESS_LNU','LNINUniversity','1040','600',1,1,1,1,1,1);" title="LexisNexis University, School for Government">LexisNexis University,<br>&nbsp;&nbsp;&nbsp;School for Government</a></li>
        <TMPL_IF NAME=SA>
    ...
    <TMPL_INCLUDE NAME="gov/search_inputs_recent_searches.tpl">
