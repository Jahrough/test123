<!-- begin inputs_fields/police_records_registered_vehicle_search.tpl -->
      ...
      <tr>
        ...
        <td> Claim #, Loss Date, Vehicle Tag, and Tag State. For better search results include City, State, Owner, VIN, Vehicle Make, Vehicle Model, and Vehicle Year.
        </td>
        </table>
      </tr>
	...
	<div id="searchThankYou">
      ...
      <tr>
        ...
        <table border="0" cellpadding="1" cellspacing="0">
          <tr>
            <td>&nbsp;<b>Vehicle Tag #</b><span class=unifont1boldred>*</span></td>
...
<!-- end inputs_fields/police_records_registered_vehicle_search.tpl -->
