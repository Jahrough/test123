<!-- begin inputs_fields/police_records_autopsy_search.tpl -->
      ...
      <tr>
        ...
        <td> Claim #, Date of Death, State, Deceased Person (Last Name or Company Name), Agency Name, and Agency Type. For better search results include Location of Death, City, and Birth Date. 
        </td>
        </table>
      </tr>
	...
	<div id="searchThankYou">
        ...
        <table border="0" cellpadding="1" cellspacing="0">
	      ...
	      <tr>
	         ...
	         <table cellspacing="0" border="0">
	          ...
	          <tr>
                    <td valign="top" class="nsinputs"><input type=text tabindex="40" size="16" maxlength="<TMPL_IF REFERENCE_CODE_MAX_LENGTH><TMPL_VAR REFERENCE_CODE_MAX_LENGTH><TMPL_ELSE>30</TMPL_IF>" name="REFERENCE_CODE" id="REF_CODE" value="<TMPL_VAR NAME=REFERENCE_CODE>"<TMPL_IF DISABLE_REF_CODE> DISABLED</TMPL_IF> ></td>
                    <td valign="top" class="nsinputs"><input  onClick="displayDatePicker('DOL_DATE');" id="DOL_DATE" type=text tabindex="44" size="16" maxlength="10" name="DOL_DATE" value="<TMPL_VAR NAME=DOL_DATE>" ><br /></td>
                  <TMPL_IF NAME="SHOW_DOL_TIME">
                    <td valign="top" class="nsinputs"><input type="text" name="TIME_HOURS" id="TIME_HOURS" tabindex="46" size="3" maxlength="2" value="<TMPL_VAR NAME=TIME_HOURS>" onBlur="" onkeyup='' ></td>
		    <td><b>:</b></td>
		    <td valign="top" class="nsinputs"><input type="text" name="TIME_MINUTES" id="TIME_MINUTES" tabindex="48" size="3" maxlength="2" value="<TMPL_VAR NAME=TIME_MINUTES>" onBlur="" onkeyup='' ></td>
		    <td valign="top" class="nsinputs">
		    <SELECT NAME="TIME_AM_PM" tabindex="50">
			...
			<OPTION VALUE="PM"<TMPL_IF PM_SELECTED> SELECTED</TMPL_IF>>PM
                  ...
                  <tr>
                    ...
                    <td>(mm/dd/yyyy)</td>
                  <TMPL_IF NAME="SHOW_DOL_TIME">
                    <td align="center" colspan="3">(hh:mm)</td>
                    <td></td>
                  </TMPL_IF>
                  </tr>
	         </table>
              ...
              <tr>
                <td class="nsinputs" colspan="3"><input type="text" name="STREET_ADDRESS" id="STREET_ADDRESS" tabindex="52" size="60" value="<TMPL_VAR NAME=STREET_ADDRESS>" maxlength=57 onBlur="this.value=this.value.toUpperCase()"></td>
              </tr>
      ...
      <tr>
        ...
        <table border="0" cellpadding="1" cellspacing="0">
          ...
          <tr>
            <td class="nsinputs"><input type="text" name="CITY" id="CITY" tabindex="54" size="15" value="<TMPL_VAR NAME=CITY>" maxlength="31" onBlur="this.value=this.value.toUpperCase()"></td>
            <td class="nsinputs"><input type="text" name="STATE" id="STATE" tabindex="56" size="3" maxlength="2" value="<TMPL_VAR NAME=STATE>" onBlur="this.value=this.value.toUpperCase()"></td>
            <td class="nsinputs"><input type="text" name="ZIP" id="ZIP" tabindex="58" size="5" maxlength="5" value="<TMPL_VAR NAME=ZIP>" onBlur=this.value=this.value.toUpperCase() >-<input type="text" name="ZIP4" id="ZIP4" tabindex="60" size="4" maxlength="4" value="<TMPL_VAR NAME=ZIP4>" onBlur="this.value=this.value.toUpperCase()"></td>
            <td class="nsinputs"><input type="text" name="COUNTY" id="COUNTY" tabindex="62" size="30" value="<TMPL_VAR NAME=COUNTY>" maxlength="26" onBlur="this.value=this.value.toUpperCase()" onkeyup='' ></td>
          </tr>
        </table>
        </td>
      </tr>
      ...
      <tr>
        ...
        <table border="0" cellpadding="1" cellspacing="0">
          ...
          <tr>
            <td class="nsinputs"><input type="text" name="FIRST_NAME" id="FIRST_NAME" tabindex="64" size="25" value="<TMPL_VAR NAME=FIRST_NAME>" maxlength="20" onBlur="this.value=this.value.toUpperCase()"></td>
            <td class="nsinputs"><input type="text" name="MI" id="MI" tabindex="66" size="15" value="<TMPL_VAR NAME=MI>" maxlength="15" onBlur="this.value=this.value.toUpperCase()"></td>
            <td class="nsinputs"><input type="text" name="LAST_NAME" id="LAST_NAME" tabindex="68" size="33" value="<TMPL_VAR NAME=LAST_NAME>" maxlength="30" onBlur="this.value=this.value.toUpperCase()" onkeyup='' ></td>
          </tr>
          <tr>
            <td><b>(First)</b></td>
      ...
      <tr>
        ...
        <table cellpadding="1" cellspacing="0" border="0">
          ...
          <tr>
            <td class="nsinputs"><input  onClick="displayDatePicker('DOB');" type="text" name="DOB" id="DOB" size="14" tabindex="70" maxlength="10" value="<TMPL_VAR NAME=DOB>" ></td>
            <td class="nsinputs"><input type="text" name="SSN" id="SSN" tabindex="72" size="16" maxlength="11" value="<TMPL_VAR NAME=SSN>" autocomplete="off"></td>
          </tr>
          <tr>
            <td>(mm/dd/yyyy)</td>
          </tr>
...
<!-- end inputs_fields/police_records_autopsy_search.tpl -->
