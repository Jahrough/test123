...
<input type="hidden" name="CARRIER_DISCOVERY_ENHANCED" value="<TMPL_VAR NAME=CARRIER_DISCOVERY_ENHANCED>">
...
<TMPL_IF DEMO>
  ...
  <INPUT type=hidden NAME="DEMO_REPORT_NAME" VALUE="<TMPL_VAR NAME=DEMO_REPORT_NAME>">
        ...
        <table border="0" cellpadding="2" cellspacing="0">
          <tr>
            ...
            <table cellpadding="2" cellspacing="0" border="0">
              <tr>
                <td>&nbsp;<a href="javascript:void(0);" onClick="carrier_tip();"><b>VIN</b></a><span class=unifont1boldred>*</span></td>
      ...
      <tr>
        ...
        <table border="0" cellpadding="2" cellspacing="0">
          <tr>
            <td>&nbsp;<a href="javascript:void(0);" onClick="carrier_tip();"><b>Last Name</b></a><span class=unifont1boldred>*</span></td>
            <td>&nbsp;<a href="javascript:void(0);" onClick="carrier_tip();"><b>First Name</b></a><span class=unifont1boldred>*</span></td>
          ...
          <tr>
            <td class="nsinputs"><input type="text" name="LAST_NAME" id="LAST_NAME" tabindex="3" size="15" value="<TMPL_VAR NAME=LAST_NAME>" maxlength=255 onBlur="this.value=this.value.toUpperCase()" onkeyup='enable_carrier_discovery_fields();'></td>
            ...
            <td class="nsinputs" valign="top"><input onClick="displayDatePicker('DOL_DATE2');" id="DOL_DATE2" type=text tabindex="6" size="16" maxlength="10" name="DOL_DATE2" value="<TMPL_VAR NAME=DOL_DATE2>" ><br /></td>
          </tr>
		  <tr>
			<td></td>
			<td></td>
      ...
      <tr>
        ...
        <table border="0" cellpadding="2" cellspacing="0">
          <tr>
            <td>&nbsp;<a href="javascript:void(0);" onClick="carrier_tip();"><b>Street Address</b></a><span class=unifont1boldred>*</span></td>
            <td>&nbsp;<a href="javascript:void(0);" onClick="carrier_tip();"><b>City</b></a><span class=unifont1boldred>*</span></td>
            ...
            <td>&nbsp;<a href="javascript:void(0);" onClick="carrier_tip();"><b>Zip</b></a><span class=unifont1boldred>*</span></td>
          </tr>
          <tr>
      ...
      <tr>
        ...
        <table cellpadding="2" cellspacing="0" border="0">
          <tr>
            ...
            <td>&nbsp;<b><label for="LICENSE_NUMBER">Driver License Number</label></b></td>
            ...
            <td>&nbsp;<a href="javascript:void(0);" onClick="displayDatePicker('DOB');"><b>DOB</b></a></td>
          </tr>
          <tr>
            ...
            <td class="nsinputs"><input type="text" name="LICENSE_NUMBER" id="LICENSE_NUMBER" tabindex="12" size="25" value="<TMPL_VAR NAME=LICENSE_NUMBER>" maxlength="255" onBlur="this.value=this.value.toUpperCase()" autocomplete="off"></td>
            <td class="nsinputs"><input type="text" name="LICENSE_STATE" id="LICENSE_STATE" tabindex="13" size="3" maxlength="2" value="<TMPL_VAR NAME=LICENSE_STATE>" onBlur="this.value=this.value.toUpperCase()"></td>
            <td class="nsinputs"><input onClick="displayDatePicker('DOB');" type="text" name="DOB" id="DOB" size="14" tabindex="14" maxlength="10" value="<TMPL_VAR NAME=DOB>"></td>
          </tr>
        </table>
        </div>
        </td>
