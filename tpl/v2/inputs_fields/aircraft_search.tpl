<!-- begin inputs_fields/aircraft_search.tpl -->
      <tr>
      ...
      <tr>
        ...
        <table border="0" cellpadding="2" cellspacing="0">
          <tr>
            <td>&nbsp;<b><label for="AIRCRAFT_NUMBER">Aircraft Number</label></b></td>
          </tr>
          <tr>
            <td class="nsinputs"><input type="text" name="AIRCRAFT_NUMBER" id="AIRCRAFT_NUMBER" tabindex="10" size="20" maxlength="255" value="<TMPL_VAR NAME=AIRCRAFT_NUMBER>" onBlur="this.value=this.value.toUpperCase()"></td>
          </tr>
        </table>
        </td>
      </tr>
<!-- end inputs_fields/aircraft_search.tpl -->
