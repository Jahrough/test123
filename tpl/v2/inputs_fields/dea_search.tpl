<!-- begin inputs_fields/dea_search.tpl -->
      ...
      <tr>
        ...
        <table cellpadding="0" cellspacing="0" border="0">
          <tr>
            <td>
              <input type="checkbox" name="STRICT" tabindex="6" value="1" id="strict_cb"
      ...
      <tr>
        ...
        <table border="0" cellpadding="2" cellspacing="0">
          <tr>
            <td>&nbsp;<b><label for="REG_NUMBER">Registration Number</label></b></td>
          ...
          <tr>
            <td class="nsinputs"><input type="text" name="REG_NUMBER" id="REG_NUMBER" tabindex="11" size="20" maxlength="20" onBlur="this.value=this.value.toUpperCase()" value="<TMPL_VAR NAME=REG_NUMBER>" onBlur="this.value=this.value.toUpperCase()"></td>
