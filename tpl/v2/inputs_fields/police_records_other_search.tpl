<!-- begin inputs_fields/police_records_other_search.tpl -->
      ...
      <tr>
        ...
        <td> Claim #, Loss Date, State, 1st Party Involved (Last Name or Company Name), Agency Name, Agency Type, and Additional Information. For better search results include Street, Cross Street, City, 2nd Party Involved, and Report #.
        </td>
        </table>
      </tr>
	...
	<div id="searchThankYou">
      ...
      <tr>
        ...
        <table border="0" cellpadding="1" cellspacing="0">
          <tr>
            <td colspan="2">&nbsp;<b>1st Party Involved</b><span class=unifont1boldred>*</span></td>
          </tr>
          <tr>
      ...
      <tr>
        ...
        <table border="0" cellpadding="1" cellspacing="0">
          ...
          <tr>
            <td>&nbsp;<b><label for="REPORT_NUMBER">Report #</label></b></span></td>
...
<!-- end inputs_fields/police_records_other_search.tpl -->
