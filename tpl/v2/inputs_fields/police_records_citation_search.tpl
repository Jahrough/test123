<!-- begin inputs_fields/police_records_citation_search.tpl -->
      ...
      <tr>
        ...
        <td> Claim #, Loss Date, State, 1st Party/Driver (Last Name or Company Name), Driver License #, License State, Birth Date, Agency Name, and Agency Type. For better search results include Street, Cross Street, City, 2nd Party Involved, and Citation #.
        </td>
        </table>
      </tr>
	...
	<div id="searchThankYou">
      ...
      <tr>
        ...
        <table border="0" cellpadding="1" cellspacing="0">
          ...
          <tr>
            <td>&nbsp;<b><label for="LICENSE_NUMBER">Driver License #</label></b><span class=unifont1boldred>*</span></td>
            <td>&nbsp;<b><label for="LICENSE_STATE">License State</label></b><span class=unifont1boldred>*</span><a href="javascript:void(0);" onClick="state_list('LICENSE_STATE','CA');"><img src="<TMPL_VAR NAME=IMGPATH>/ico_information.gif" alt="More Information" height="13" hspace="5" width="14"></a></td>
          </tr>
          <tr>
      ...
      <tr>
        ...
        <table border="0" cellpadding="1" cellspacing="0">
          ...
          <tr>
            <td>&nbsp;<b><label for="REPORT_NUMBER">Citation #</label></b></td>
...
<!-- end inputs_fields/police_records_citation_search.tpl -->
