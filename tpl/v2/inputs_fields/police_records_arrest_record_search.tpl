<!-- begin inputs_fields/police_records_arrest_record_search.tpl -->
      ...
      <tr>
        ...
        <td> Claim #, Arrest Date, State, Arrestee (Last Name or Company Name), Birth Date, Agency Name, and Agency Type. For better search results include Street, Cross Street, City, Driver License #, License State, and Report #.
        </td>
        </table>
      </tr>
	...
	<div id="searchThankYou">
	         ...
	         <table cellspacing="0" border="0">
	          <tr>
	      	  <td align="left"><b><label for="REF_CODE"><TMPL_IF REFERENCE_CODE_RENAME>&nbsp;Claim #<span class=unifont1boldred>*</span>&nbsp;<TMPL_ELSE>Reference Code:&nbsp;</TMPL_IF></label></b></td>
                  <td>&nbsp;<a href="javascript:void(0);" onClick="displayDatePicker('DOL_DATE');"><b>Arrest Date</b></a>&nbsp;<TMPL_IF NAME="SHOW_DOL_REQUIRED"><span class=unifont1boldred><b>*</b></span></TMPL_IF></td>
      ...
      <tr>
        ...
        <table border="0" cellpadding="1" cellspacing="0">
          ...
          <tr>
            ...
            <td class="nsinputs"><input type="text" name="COUNTY" id="COUNTY" tabindex="34" size="30" value="<TMPL_VAR NAME=COUNTY>" maxlength="26" onBlur="this.value=this.value.toUpperCase()"></td>
          </tr>
        </table>
        </td>
      </tr>
      ...
      <tr>
        ...
        <table border="0" cellpadding="1" cellspacing="0">
          <tr>
            <td colspan="2">&nbsp;<b>Arrestee</b><span class=unifont1boldred>*</span></td>
          </tr>
          <tr>
            ...
            <td class="nsinputs"><input type="text" name="LAST_NAME" id="LAST_NAME" tabindex="40" size="33" value="<TMPL_VAR NAME=LAST_NAME>" maxlength="30" onBlur="this.value=this.value.toUpperCase()"></td>
          </tr>
          <tr>
            <td><b>(First)</b></td>
      ...
      <tr>
        ...
        <table cellpadding="1" cellspacing="0" border="0">
          <tr>
            <td>&nbsp;<a href="javascript:void(0);" onClick="displayDatePicker('DOB');"><b>Birth Date</b></a><span class=unifont1boldred>*</span></td>
      ...
      <tr>
        ...
        <table border="0" cellpadding="1" cellspacing="0">
          <tr>
            ...
            <td>&nbsp;<b><label for="LICENSE_PLATE_STATE">Tag State</label></b><a href="javascript:void(0);" onClick="state_list('LICENSE_PLATE_STATE'<TMPL_UNLESS LEG>,'CA'</TMPL_UNLESS>);"><img src="<TMPL_VAR NAME=IMGPATH>/ico_information.gif" alt="More Information" height="13" hspace="5" width="14"></a></td>
...
<!-- end inputs_fields/police_records_arrest_record_search.tpl -->
