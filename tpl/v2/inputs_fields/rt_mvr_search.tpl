<!-- begin inputs_fields/rt_mvr_search.tpl -->
	  ...
	  <tr>
	    ...
	    <td>The <TMPL_IF XBPS>Vehicle Investigations<TMPL_ELSE><TMPL_IF LEG>Motor Vehicle Gateway<TMPL_ELSE>Real-Time Vehicle Registration</TMPL_IF></TMPL_IF> Search includes data from various data providers.  Some data providers may require a Name and Address to be included in your search.  If you conduct a search without Name and Address and do not receive a match (or the match you were expecting), you may want to run another search including Name, Street Address, Zip Code or Name, Street Address and City/State.</td>
	  </tr>
        </table>
	</td>
      </tr>
      ...
      <tr>
        ...
        <table border="0" cellpadding="2" cellspacing="0">
          ...
          <tr>
            ...
            <TMPL_IF RT_MVR_SHOW_ALL_INPUTS><td class="nsinputs"><input type="text" name="SSN" id="SSN" tabindex="4" size="11" maxlength="11" value="<TMPL_VAR NAME=SSN>" autocomplete="off"></td></TMPL_IF>
          </tr>
        </table>
        </td>
      </tr>
