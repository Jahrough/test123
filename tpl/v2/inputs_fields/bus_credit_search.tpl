<!-- begin $RCSfile: bus_credit_search.tpl,v $ -->
      <tr>
      ...
      <tr>
        ...
        <table border="0" cellpadding="2" cellspacing="0">
          ...
          <tr>
            ...
            <td class="nsinputs"><input type="text" name="PHONE" id="PHONE" tabindex="2" size="15" maxlength="255" value="<TMPL_VAR NAME=PHONE>"></td>
          </tr>
        </table>
        </td>
      </tr>
...
<!-- end $RCSfile: bus_credit_search.tpl,v $ -->
