<!-- begin inputs_fields/property_search.tpl -->
      ...
      <tr>
        ...
        <table border="0" cellpadding="2" cellspacing="0">
          ...
          <tr>
            <td class="nsinputs"><input type="text" name="STREET_ADDRESS" id="STREET_ADDRESS" tabindex="8" size="27" value="<TMPL_VAR NAME=STREET_ADDRESS>" maxlength=50 onBlur="this.value=this.value.toUpperCase()"></td>
      ...
      <tr>
        ...
        <table border="0" cellpadding="2" cellspacing="0">
          ...
          <tr>
            <td class="nsinputs"><input type="text" name="PARCEL_ID" id="PARCEL_ID" tabindex="12" size="20" maxlength="255" value="<TMPL_VAR NAME=PARCEL_ID>"></td>
          </tr>
        </table>
        </td>
      </tr>
