<!-- begin inputs_fields/police_records_ins_verify_search.tpl -->
      ...
      <tr>
        ...
        <td> Claim #, Loss Date, State, Driver or Owner (Last Name or Company Name), Agency Name, and Agency Type. For better search results include Home Address, City, Driver License #, License State, VIN, Vehicle Tag #, and Tag State.
        </td>
        </table>
      </tr>
	...
	<div id="searchThankYou">
      ...
      <tr>
        ...
        <table border="0" cellpadding="1" cellspacing="0">
          <tr>
            <td colspan="2">&nbsp;<b>Driver or Owner</b><span class=unifont1boldred>*</span></td>
          </tr>
          <tr>
...
<!-- end inputs_fields/police_records_ins_verify_search.tpl -->
