<!-- begin inputs_fields/firearms_search.tpl -->
      <tr>
      ...
      <tr>
        ...
        <table cellpadding="0" cellspacing="0" border="0">
          <tr>
            <td>
              <input type="checkbox" name="STRICT" tabindex="5" value="1"  id="strict_cb"
      ...
      <tr>
        ...
        <table cellpadding="2" cellspacing="0" border="0">
          <tr>
            <td>&nbsp;<b><label for="TRADE_NAME">Trade Name</label></b></td>
            <td>&nbsp;<b><label for="LICENSE_NUMBER">License Number</label></b></td>
          </tr>
          <tr>
            <td class="nsinputs"><input type="text" name="TRADE_NAME" id="TRADE_NAME" tabindex="10" size="20" maxlength="255" value="<TMPL_VAR NAME=TRADE_NAME>" onBlur="this.value=this.value.toUpperCase()"></td>
            <td class="nsinputs"><input type="text" name="LICENSE_NUMBER" id="LICENSE_NUMBER" tabindex="11" size="16" maxlength="15" value="<TMPL_VAR NAME=LICENSE_NUMBER>" onBlur="this.value=this.value.toUpperCase()" autocomplete="off"></td>
          </tr>
        </table>
        </td>
      </tr>
<!-- end inputs_fields/firearms_search.tpl -->
