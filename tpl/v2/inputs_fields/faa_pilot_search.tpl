<!-- begin inputs_fields/faa_pilot_search.tpl -->
      ...
      <tr>
        ...
        <table cellpadding="0" cellspacing="0" border="0">
          <tr>
            <td>
              <input type="checkbox" name="PHONETICS" tabindex="4" value="1" id="phonetics_cb"
               <TMPL_IF NAME="PHONETICS">checked="checked" </TMPL_IF>onClick="either_strict_or_phonetics(this)"/>
            </td>
            ...
            <td>
              <input type="checkbox" name="STRICT" tabindex="5" value="1" id="strict_cb"
                <TMPL_IF NAME="STRICT">checked="checked" </TMPL_IF>onClick="either_strict_or_phonetics(this)"/>
            </td>
