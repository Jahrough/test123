<!-- begin inputs_fields/police_records_ems_search.tpl -->
      ...
      <tr>
        ...
        <td> Claim #, Injury Date, Street, State, and Injured Person (Last Name or Company Name). For better search results include Cross Street, City, 2nd Party Involved, and Report #.
        </td>
        </table>
      </tr>
	...
	<div id="searchThankYou">
        ...
        <table border="0" cellpadding="1" cellspacing="0">
	      ...
	      <tr>
	         ...
	         <table cellspacing="0" border="0">
	          <tr>
	      	  <td align="left"><b><label for="REF_CODE"><TMPL_IF REFERENCE_CODE_RENAME>&nbsp;Claim #<span class=unifont1boldred>*</span>&nbsp;<TMPL_ELSE>Reference Code:&nbsp;</TMPL_IF></label></b></td>
                  <td>&nbsp;<a href="javascript:void(0);" onClick="displayDatePicker('DOL_DATE');"><b>Injury Date</b></a>&nbsp;<TMPL_IF NAME="SHOW_DOL_REQUIRED"><span class=unifont1boldred><b>*</b></span></TMPL_IF></td>
			...
			<OPTION VALUE="PM"<TMPL_IF PM_SELECTED> SELECTED</TMPL_IF>>PM
              ...
              <tr>
                <td>&nbsp;<b>Street</b><span class=unifont1boldred>*</span></td>
              </tr>
              <tr>
      ...
      <tr>
        ...
        <table border="0" cellpadding="1" cellspacing="0">
          <tr>
            <td colspan="2">&nbsp;<b>Injured Person</b><span class=unifont1boldred>*</span></td>
          </tr>
          <tr>
      ...
      <tr>
        ...
        <table border="0" cellpadding="1" cellspacing="0">
          ...
          <tr>
            ...
            <td class="nsinputs"><input type="text" name="LICENSE_PLATE_STATE" id="LICENSE_PLATE_STATE" size="10" tabindex="66" maxlength="2" value="<TMPL_VAR NAME=LICENSE_PLATE_STATE>" onBlur="this.value=this.value.toUpperCase()"></td> <td class="nsinputs"><input type="text" name="MAKE" id="MAKE" size="13" tabindex="68" maxlength="20" value="<TMPL_VAR NAME=MAKE>" onBlur="this.value=this.value.toUpperCase()"></td>
      ...
      <tr>
        ...
        <table border="0" cellpadding="1" cellspacing="0">
          <tr>
            <td>&nbsp;<b><label for="AGENCY_NAME">Agency Name</label></b></td>
            <td>&nbsp;<b><label for="AGENCY_TYPE">Agency Type</label></b></td>
          </tr>
          <tr>
            <td class="nsinputs" valign="bottom">
      ...
      <tr>
        ...
        <table>
          <tr>
            <td class="unifont1">
            <span class=unifont1boldred>** A signed release from the injured person or next of kin is required.<br />Please include the Claim# and fax the form to LexisNexis at 678.924.4952.</td></span>
          </tr>
        </table>
        </td>
      </tr>

<!-- end inputs_fields/police_records_ems_search.tpl -->
