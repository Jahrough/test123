<!-- begin inputs_fields/police_records_burglary_search.tpl -->
      ...
      <tr>
        ...
        <td> Claim #, Loss Date, State, Victim Name (Last Name or Company Name), Agency Name, and Agency Type. For better search results include Street, City, 2nd Party Involved, and Report #.
        </td>
        </table>
      </tr>
	...
	<div id="searchThankYou">
      ...
      <tr>
        ...
        <table border="0" cellpadding="1" cellspacing="0">
          <tr>
            <td colspan="2">&nbsp;<b>Victim Name</b><span class=unifont1boldred>*</span></td>
          </tr>
          <tr>
...
<!-- end inputs_fields/police_records_burglary_search.tpl -->
