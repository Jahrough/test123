<!-- begin inputs_fields/police_records_photos_search.tpl -->
      ...
      <tr>
        ...
        <td> Claim #, Loss Date, State, 1st Party Involved (Last Name or Company Name), Agency Name, and Agency Type. For better search results include Street, Cross Street, City, 2nd Party Involved, and Report #.
        </td>
        </table>
      </tr>
	          ...
	          <tr>
	      	  <td align="left"><b><label for="REF_CODE"><TMPL_IF REFERENCE_CODE_RENAME>&nbsp;Claim #<span class=unifont1boldred>*</span>&nbsp;<TMPL_ELSE>Reference Code:&nbsp;</TMPL_IF></label></b></td>
                  ...
                  <TMPL_IF NAME="SHOW_DOL_TIME">
                    <td colspan="4"><b><label for="TIME_HOURS">&nbsp;Loss Time&nbsp;</label></b></td>
                  </TMPL_IF>
	          </tr>
...
<!-- end inputs_fields/police_records_photos_search.tpl -->
