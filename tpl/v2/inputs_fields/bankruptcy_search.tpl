<!-- begin inputs_fields/bankruptcy_search.tpl -->
      ...
      <tr>
        ...
        <table border="0" cellpadding="2" cellspacing="0">
          <tr>
            <td>&nbsp;<b><label for="CASE_NUMBER">Case Number</label></b></td>
          ...
          <tr>
            <td class="nsinputs"><input type="text" name="CASE_NUMBER" id="CASE_NUMBER" tabindex="11" size="11" maxlength="11" value="<TMPL_VAR NAME=CASE_NUMBER>"></td>
      ...
      <tr>
        ...
        <table border="0" cellpadding="2" cellspacing="0">
          <tr>
            <td><input type="checkbox" name="STRICT" id="STRICT" tabindex="13" value="1" <TMPL_IF NAME="STRICT">checked="checked" </TMPL_IF>/></td>
