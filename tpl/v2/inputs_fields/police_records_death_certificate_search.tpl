<!-- begin inputs_fields/police_records_death_certificate_search.tpl -->
      ...
      <tr>
        ...
        <td> Claim #, Date of Death, State, Deceased Person (Last Name), Agency Name, and Agency Type. For better search results include Location of Death, City, Birth Date, and Report #.
        </td>
        </table>
      </tr>
        ...
        <table border="0" cellpadding="1" cellspacing="0">
	      ...
	      <tr>
	         ...
	         <table cellspacing="0" border="0">
	          <tr>
	      	  <td align="left"><b><label for="REF_CODE"><TMPL_IF REFERENCE_CODE_RENAME>&nbsp;Claim #<span class=unifont1boldred>*</span>&nbsp;<TMPL_ELSE>Reference Code:&nbsp;</TMPL_IF></label></b></td>
                  <td>&nbsp;<a href="javascript:void(0);" onClick="displayDatePicker('DOL_DATE');"><b>Date of Death</b></a>&nbsp;<TMPL_IF NAME="SHOW_DOL_REQUIRED"><span class=unifont1boldred><b>*</b></span></TMPL_IF></td>
	          ...
	          <tr>
                    <td valign="top" class="nsinputs"><input type=text tabindex="26" size="16" maxlength="<TMPL_IF REFERENCE_CODE_MAX_LENGTH><TMPL_VAR REFERENCE_CODE_MAX_LENGTH><TMPL_ELSE>30</TMPL_IF>" name="REFERENCE_CODE" id="REF_CODE" value="<TMPL_VAR NAME=REFERENCE_CODE>"<TMPL_IF DISABLE_REF_CODE> DISABLED</TMPL_IF> ></td>
                    <td valign="top" class="nsinputs"><input onClick="displayDatePicker('DOL_DATE');" id="DOL_DATE" type=text tabindex="28" size="16" maxlength="10" name="DOL_DATE" value="<TMPL_VAR NAME=DOL_DATE>" ><br /></td>
                  <TMPL_IF NAME="SHOW_DOL_TIME">
                    <td valign="top" class="nsinputs"><input type="text" name="TIME_HOURS" id="TIME_HOURS" tabindex="30" size="3" maxlength="2" value="<TMPL_VAR NAME=TIME_HOURS>" onBlur="" onkeyup='' ></td>
		    <td><b>:</b></td>
		    <td valign="top" class="nsinputs"><input type="text" name="TIME_MINUTES" id="TIME_MINUTES" tabindex="32" size="3" maxlength="2" value="<TMPL_VAR NAME=TIME_MINUTES>" onBlur="" onkeyup='' ></td>
		    <td valign="top" class="nsinputs">
		    <SELECT NAME="TIME_AM_PM" tabindex="34">
			...
			<OPTION VALUE="PM"<TMPL_IF PM_SELECTED> SELECTED</TMPL_IF>>PM
              ...
              <tr>
                <td>&nbsp;<b>Location of Death</b></td>
              </tr>
              <tr>
                <td class="nsinputs" colspan="3"><input type="text" name="STREET_ADDRESS" id="STREET_ADDRESS" tabindex="36" size="60" value="<TMPL_VAR NAME=STREET_ADDRESS>" maxlength=57 onBlur="this.value=this.value.toUpperCase()"></td>
              </tr>
            </table>
            </td>
          </tr>
...
<!-- end inputs_fields/police_records_death_certificate_search.tpl -->
