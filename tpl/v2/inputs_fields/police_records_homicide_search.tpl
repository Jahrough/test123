<!-- begin inputs_fields/police_records_homicide_search.tpl -->
      ...
      <tr>
        ...
        <td> Claim #, Date of Death, State, Deceased (Last Name or Company Name), Agency Name, and Agency Type. For better search results include Street, City, Birth Date, and Report #.
        </td>
        </table>
      </tr>
	...
	<div id="searchThankYou">
	         ...
	         <table cellspacing="0" border="0">
	          <tr>
	      	  <td align="left"><b><label for="REF_CODE"><TMPL_IF REFERENCE_CODE_RENAME>&nbsp;Claim #<span class=unifont1boldred>*</span>&nbsp;<TMPL_ELSE>Reference Code:&nbsp;</TMPL_IF></label></b></td>
                  <td>&nbsp;<a href="javascript:void(0);" onClick="displayDatePicker('DOL_DATE');"><b>Date of Death</a>&nbsp;<TMPL_IF NAME="SHOW_DOL_REQUIRED"><span class=unifont1boldred><b>*</b></span></TMPL_IF></td>
      ...
      <tr>
        ...
        <table border="0" cellpadding="1" cellspacing="0">
          <tr>
            <td colspan="2">&nbsp;<b>Deceased</b><span class=unifont1boldred>*</span></td>
          </tr>
          <tr>
...
<!-- end inputs_fields/police_records_homicide_search.tpl -->
