<!-- begin inputs_fields/police_records_all_vehicles_search.tpl -->
      ...
      <tr>
        ...
        <td> Claim #, Loss Date, State, Name (Last Name or Company Name), Agency Name, and Agency Type. For better search results include Home Address, City, and VIN.</td>
        </td>
        </table>
      </tr>
	...
	<div id="searchThankYou">
      ...
      <tr>
        ...
        <table border="0" cellpadding="1" cellspacing="0">
		  ...
		  <TMPL_IF NAME="SHOW_DOL_TIME">
		    ...
		    <td valign="top" class="nsinputs"><SELECT NAME="TIME_AM_PM" tabindex="42">  
      ...
      <tr>
        ...
        <table border="0" cellpadding="1" cellspacing="0">
          ...
          <tr>
            ...
            <td class="nsinputs"><input type="text" name="COUNTY" id="COUNTY" tabindex="54" size="30" value="<TMPL_VAR NAME=COUNTY>" maxlength="26" onBlur="this.value=this.value.toUpperCase()" ></td>
          </tr>
        </table>
        </td>
      </tr>
      ...
      <tr>
        ...
        <table border="0" cellpadding="1" cellspacing="0">
          <tr>
            <td colspan="2">&nbsp;<b>Name</b><span class=unifont1boldred>*</span></td>
          </tr>
          <tr>
            ...
            <td class="nsinputs"><input type="text" name="LAST_NAME" id="LAST_NAME" tabindex="60" size="33" value="<TMPL_VAR NAME=LAST_NAME>" maxlength="30" onBlur="this.value=this.value.toUpperCase()" ></td>
          </tr>
          <tr>
            <td><b>(First)</b></td>
      ...
      <tr>
        ...
        <table cellpadding="1" cellspacing="0" border="0">
          ...
          <tr>
            <td class="nsinputs"><input type="text" name="VIN" id="VIN" tabindex="62" size="17" maxlength="25" value="<TMPL_VAR NAME=VIN>" ></td>
          </tr>
        </table>
        </td>
      </tr>
      ...
      <tr>
        ...
        <table border="0" cellpadding="1" cellspacing="0">
          ...
          <tr>
            <td>&nbsp;<b><label for="POLICY_NUMBER">Policy #</label></b></span></td>
          ...
          <tr>
            <td>&nbsp;<b><label for="LOSS_KIND">Loss Kind</label></b></span></td>
          </tr>
          <tr>
...
<!-- end inputs_fields/police_records_all_vehicles_search.tpl -->
