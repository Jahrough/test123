<!-- begin inputs_fields/npi_data_search.tpl -->
      <tr>
        ...
        <script>write_search_title('NPI Data Search');</script>
        </td>
      </tr>
      <tr>
      <tr>
      ...
      <tr>
        ...
        <table border="0" cellpadding="2" cellspacing="0">
          ...
          <tr>
            <td class="nsinputs"><input type="text" name="STREET_ADDRESS" tabindex="6" size="27" value="<TMPL_VAR NAME=STREET_ADDRESS>" maxlength=50 onBlur="this.value=this.value.toUpperCase()"></td>
