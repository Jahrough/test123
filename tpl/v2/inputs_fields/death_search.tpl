<!-- begin inputs_fields/death_search.tpl -->
      <tr>
      ...
      <tr>
        <script type="text/javascript">
            function _show_dmf_disclaimer() {
                build_tip(document.getElementById('dmf_disclaimer_title').innerHTML,document.getElementById('dmf_disclaimer_content').innerHTML);
            }
        </script>
        <td valign="top" align="left">&nbsp;<a href="javascript:_show_dmf_disclaimer();"><b><span id="dmf_disclaimer_title">Death Record Availability Notice</span></b></a>
        <div id="dmf_disclaimer_content" style="display:none;">
            <TMPL_INCLUDE NAME="death_record_availability_notice.tpl">
        </div>
        <br/><br/>
        </td>
      </tr>
...
<!-- end inputs_fields/death_search.tpl -->
