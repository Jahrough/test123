<!-- begin inputs_fields/police_records_auto_accident_search.tpl -->
	      ...
	      <tr>
	         ...
	         <table cellspacing="0" border="0">
	          ...
	          <tr>
                    ...
                    <td valign="top" class="nsinputs"><input onClick="displayDatePicker('DOL_DATE');" id="DOL_DATE" type=text tabindex="14" size="16" maxlength="10" name="DOL_DATE" value="<TMPL_VAR NAME=DOL_DATE>" ></td>
                  <TMPL_IF NAME="SHOW_DOL_TIME">
...
<!-- end inputs_fields/police_records_auto_accident_search.tpl -->
