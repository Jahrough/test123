<!-- begin inputs_fields/fictious_search.tpl -->
      ...
      <tr>
        ...
        <table border="0" cellpadding="2" cellspacing="0">
          ...
          <tr>
            <td class="nsinputs"><input type="text" name="PHONE" id="PHONE" tabindex="8" size="15" maxlength="255" value="<TMPL_VAR NAME=PHONE>"></td>
            <td class="nsinputs"><input type="text" name="FILING_NUMBER" id="FILING_NUMBER" tabindex="10" size="15" maxlength="25" value="<TMPL_VAR NAME=FILING_NUMBER>"></td>
          </tr>
        </table>
        </td>
      </tr>
