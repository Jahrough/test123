<!-- begin inputs_fields/direct_to_report.tpl -->
      ...
      <tr>
        ...
        <table border="0" cellpadding="2" cellspacing="0">
          <tr>
            <td>&nbsp;<b><label for="ADDRESS">Street Address</label></b></td>
          ...
          <tr>
            <td class="nsinputs"><input type="text" name="ADDRESS" id="ADDRESS" tabindex="5" size="27" value="<TMPL_VAR NAME=ADDRESS>" maxlength=255 onBlur="this.value=this.value.toUpperCase()"></td>
