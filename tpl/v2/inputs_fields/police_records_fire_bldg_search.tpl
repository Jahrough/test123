<!-- begin inputs_fields/police_records_fire_bldg_search.tpl -->
      ...
      <tr>
        ...
        <td> Claim #, Loss Date, State, Owner/Caller (Last Name or Company Name), Agency Name, and Agency Type. For better search results include Street, Cross Street, City, 2nd Party Involved, and Report #.
        </td>
        </table>
      </tr>
	...
	<div id="searchThankYou">
        ...
        <table border="0" cellpadding="1" cellspacing="0">
	      ...
	      <tr>
	         ...
	         <table cellspacing="0" border="0">
	          ...
	          <tr>
                    <td valign="top" class="nsinputs"><input type=text tabindex="32" size="16" maxlength="<TMPL_IF REFERENCE_CODE_MAX_LENGTH><TMPL_VAR REFERENCE_CODE_MAX_LENGTH><TMPL_ELSE>30</TMPL_IF>" name="REFERENCE_CODE" id="REF_CODE" value="<TMPL_VAR NAME=REFERENCE_CODE>"<TMPL_IF DISABLE_REF_CODE> DISABLED</TMPL_IF> ></td>
                    <td valign="top" class="nsinputs"><input onClick="displayDatePicker('DOL_DATE');" id="DOL_DATE" type=text tabindex="34" size="16" maxlength="10" name="DOL_DATE" value="<TMPL_VAR NAME=DOL_DATE>" ><br /></td>
                  <TMPL_IF NAME="SHOW_DOL_TIME">
                    <td valign="top" class="nsinputs"><input type="text" name="TIME_HOURS" id="TIME_HOURS" tabindex="36" size="3" maxlength="2" value="<TMPL_VAR NAME=TIME_HOURS>" onBlur="" onkeyup='' ></td>
		    <td><b>:</b></td>
		    <td valign="top" class="nsinputs"><input type="text" name="TIME_MINUTES" id="TIME_MINUTES" tabindex="38" size="3" maxlength="2" value="<TMPL_VAR NAME=TIME_MINUTES>" onBlur="" onkeyup='' ></td>
		    <td valign="top" class="nsinputs">
		    <SELECT NAME="TIME_AM_PM" tabindex="40">
			...
			<OPTION VALUE="PM"<TMPL_IF PM_SELECTED> SELECTED</TMPL_IF>>PM
              ...
              <tr>
                <td class="nsinputs" colspan="3"><input type="text" name="STREET_ADDRESS" id="STREET_ADDRESS" tabindex="42" size="60" value="<TMPL_VAR NAME=STREET_ADDRESS>" maxlength=57 onBlur="this.value=this.value.toUpperCase()"  ></td>
              </tr>
              ...
              <tr>
                <td class="nsinputs" colspan="3"><input type="text" name="CROSS_STREET" id="CROSS_STREET" tabindex="44" size="60" value="<TMPL_VAR NAME=CROSS_STREET>" maxlength=57 onBlur="this.value=this.value.toUpperCase()"></td>
              </tr> 
            </table>
            </td>
          </tr>
      ...
      <tr>
        ...
        <table border="0" cellpadding="1" cellspacing="0">
          <tr>
            <td colspan="2">&nbsp;<b>Owner/Caller</b><span class=unifont1boldred>*</span></td>
          </tr>
          <tr>
...
<!-- end inputs_fields/police_records_fire_bldg_search.tpl -->
