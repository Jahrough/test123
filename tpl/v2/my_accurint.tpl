...
<div id="wrapper">
  ...
  <INPUT type=hidden NAME="NEWMYACC" VALUE="0">
	...
	<br><br>
	<b>CHANGE SEARCH ORDER:</b>&nbsp; Select a search from My Favorites Searches and click  Up or Down  to change the order.&nbsp; Click "SAVE."
	<br><br>
	<b>TO REMOVE A SEARCH:</b>&nbsp; To remove a search from My Favorites Searches, select a search and click remove.&nbsp; Click "SAVE."</p></td>
      </tr>
    </table>
  </form>
