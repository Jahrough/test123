<!-- begin v2/fcol/search_inputs_primary_tabs_pulldown_menus.tpl -->
  ...
  <div id="listPeopleSearches" class="upperTab" onmouseout='$("listPeopleSearches").style.display = "none";' onmouseover='this.style.cursor="pointer";$("listPeopleSearches").style.display = "block";'>
    <div id="navlist">
      ...
      <li><a trackid="subtab_person" href="javascript:pm_tab('SEARCH/SHOW_FAP');">Find a Person</a></li>
      </TMPL_UNLESS>
      </TMPL_UNLESS>
  ...
  <div id="listBusSearches" class="upperTab" onmouseout='$("listBusSearches").style.display = "none";' onmouseover='this.style.cursor="pointer";$("listBusSearches").style.display = "block";'>
	...
	<li><a trackid="subtab_bus" href="javascript:pm_tab('SEARCH/SHOW_BUS');">Find a Business</a></li>
      </TMPL_UNLESS>
  ...
  <table border="0" cellpadding="5" cellspacing="0" width="450">
	...
	<TMPL_UNLESS DO_NOT_DISPLAY_PERSON><li><a href="javascript:send_event('SEARCH/SHOW_FAP');">Find a Person</a></li></TMPL_UNLESS>
	...
	<li><a href="javascript:send_event('SEARCH/SHOW_BUS');">Find a Business</a></li>
...
<!-- End v2/fcol/search_inputs_primary_tabs_pulldown_menus.tpl -->
