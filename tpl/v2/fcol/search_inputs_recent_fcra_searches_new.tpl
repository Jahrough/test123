...
<div id="fcraRecentSearch">

	<tmpl_if fcra_rcs_loop>
	<tmpl_loop fcra_rcs_loop>
	...
	<tmpl_else>
        ...
        <TMPL_UNLESS RECENT_SEARCH_AJAX_REQUEST>
        </TMPL_UNLESS>
        <!--
        <p style="padding-top:15px; padding-bottom:5px; "><a href="javascript:show_post_popup('MYACCOUNT/SHOW_ALL_RECENT_FCRA','MyAccountWin','','',1,1,1,1,1,0,'<TMPL_VAR NAME=ACTION_ADMIN>');">All Recent Searches</a> &raquo;</p>
        -->
        <p style="padding-top:15px; padding-bottom:5px; "><a href="javascript:show_post_popup('MYACCOUNT/SHOW_ALL_RECENT_FCRA','MyAccountWin','','',1,1,1,1,1,0,'<TMPL_VAR NAME=ACTION_ADMIN>','','<INPUT type=hidden NAME=&quot;date_select&quot; VALUE=&quot;date_recent&quot;><INPUT type=hidden NAME=&quot;DATE_RECENT&quot; VALUE=&quot;prev_month&quot;>');">All Recent Searches</a> &raquo;</p>
