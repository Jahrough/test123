...
<TMPL_UNLESS NAME="SEARCH_ERROR_MESSAGE">
   ...
   <TMPL_UNLESS NAME="HIDE_SECURITY_NEWS_POD">
...
<script>
    ...
    tipsMsgArray[1] ='<h4>Search Tip</h4><p>Research shows that most people move within a 50 mile radius. The radius function on the Find a Person Search will allow you to search for a person within a 99 mile radius of an address.</p>';
    tipsMsgArray[2] ='<h4>Search Tip</h4><p>Did you know that the Deep Skip search will display household members when available?</p>';
    tipsMsgArray[3] ='<h4>Search Tip</h4><p>Did you know that Collection Solutions gets feeds everyday from the Phone companies and updates phones EVERY DAY?  White page sources only update monthly and can be 90-120 days old.</p>';
