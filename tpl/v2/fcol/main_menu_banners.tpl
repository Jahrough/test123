<script language="JavaScript">
    ...
    banner[1] = 
    { image:'<TMPL_VAR NAME=IMGPATH>/main/link_id_banner.gif',url:'<TMPL_VAR NAME=HTMLPATH>/fcol/permissible_use.html',width:'675',height:'400',name:'PermissableUse' }

    banner[2] = 
    { image:'<TMPL_VAR NAME=IMGPATH>/main/link_id_banner.gif',url:'<TMPL_VAR NAME=HTMLPATH>/fcol/phone_feedback_popup.html',width:'675',height:'500',name:'PhoneFeedback' }
