...
<div id="nonFcraRecentSearch">
	...
	<tmpl_else>
        ...
        -->
        <p style="padding-top:15px; padding-bottom:5px; "><a href="javascript:show_post_popup('MYACCOUNT/SHOW_ALL_RECENT','MyAccountWin','','',1,1,1,1,1,0,'<TMPL_VAR NAME=ACTION_ADMIN>','','<INPUT type=hidden NAME=&quot;date_select&quot; VALUE=&quot;date_recent&quot;><INPUT type=hidden NAME=&quot;DATE_RECENT&quot; VALUE=&quot;prev_month&quot;>');">All Recent Searches</a> &raquo;</p>
