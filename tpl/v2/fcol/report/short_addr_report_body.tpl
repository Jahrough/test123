	  ...
	  <tr>
		...
		<TMPL_IF DISABLE_DEEDS>
		 <TMPL_UNLESS DELETE_DEEDS>
		     <tr>
       	               <td width="1%">&nbsp;</td>
			<td  width="60%" align="left" span class="disabled_small"><TMPL_IF FCOL>Real Property Locator<TMPL_ELSE>Property Ownership Current/Previous</TMPL_IF>&nbsp;&nbsp;<span class="reportprices"><TMPL_IF properties-count>(<TMPL_VAR NAME="properties-count">)</TMPL_IF> </span>(disabled)</td>
		...
		<TMPL_IF DISABLE_ASSESSMENT>
		  <TMPL_UNLESS DELETE_ASSESSMENT>
		     <tr>
      	                <td width="1%">&nbsp;</td>
			<td  width="60%" align="left" class="disabled_small"><TMPL_IF FCOL>Real Property Locator<TMPL_ELSE>Property Ownership Current/Previous</TMPL_IF>&nbsp;&nbsp;><span class="reportprices"><TMPL_IF properties-count>(<TMPL_VAR NAME="properties-count">)</TMPL_IF> </span>(disabled)</td>
			<td width="39%" align="left" class="disabled_small"><TMPL_UNLESS HIDE_PRICES>$<TMPL_VAR NAME=addr-properties-price></TMPL_UNLESS>&nbsp;</td>
		     </tr>
		  </TMPL_UNLESS> 	
		<TMPL_ELSE>
			...
			<td class="medblack" width="60%" align="left"><label for="addr-properties">&nbsp;<TMPL_IF FCOL>Real Property Locator<TMPL_ELSE>Property Ownership Current/Previous</TMPL_IF></label><span class="reportprices"><TMPL_IF properties-count>&nbsp;(<TMPL_VAR NAME="properties-count">)</TMPL_IF></span></td>
		...
		<TMPL_UNLESS DISABLE_RT_MVR>
			...
			<td class="medblack" width="60%" align="left"><label for="addr-motor-vehicles">&nbsp;<TMPL_IF FCOL>Motor Vehicle Locator<TMPL_ELSE>Motor Vehicle(s) Registered at Address</TMPL_IF></label><span class="reportprices"><TMPL_IF vehicles-count>&nbsp;(<TMPL_VAR NAME="vehicles-count">)</TMPL_IF></span></td>
			<td width="39%" align="left" class="medblue"><TMPL_UNLESS HIDE_PRICES>$<TMPL_VAR NAME="addr-motor-vehicles-price"></TMPL_UNLESS>&nbsp;</td>
		<TMPL_ELSE>
			<td width="1%">&nbsp;</td>
			<td width="60%" align="left" class="disabled_small"><TMPL_IF FCOL>Motor Vehicle Locator<TMPL_ELSE>Motor Vehicle(s) Registered at Address</TMPL_IF>&nbsp;&nbsp;<TMPL_IF vehicles-count>(<TMPL_VAR NAME="vehicles-count">)</TMPL_IF> (disabled)</td>
