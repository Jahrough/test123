...
<script language="JavaScript">
    ...
    securetipsMsgArray[7] ='Never click or follow links included in email messages that purport to come from <TMPL_IF FCOL_TCOL>Contact &amp; Locate<TMPL_ELSE>Accurint</TMPL_IF>.  <TMPL_IF FCOL_TCOL>Contact &amp; Locate<TMPL_ELSE>Accurint</TMPL_IF> will never email you requesting that you provide your user ID or password.';
    securetipsMsgArray[8] ='Report any potentially inappropriate or fraudulent use of <TMPL_IF FCOL_TCOL>Contact &amp; Locate<TMPL_ELSE>Accurint</TMPL_IF> or any other LexisNexis service to our Security Investigations team at 888-872-5375.  Security is a shared responsibility.';
    ...
    securetipsMsgArray[13] ='You can IP-restrict your <TMPL_IF FCOL_TCOL>Contact &amp; Locate<TMPL_ELSE>Accurint</TMPL_IF> account so that access is denied to anyone that is <b>NOT</b> accessing our services from the IP address you have designated.&nbsp; If you would like assistance with setting up IP Restrictions for your company, please   <a href="javascript:show_post_popup(\'SECURITY/SHOW_RESTRICT_IP_HELP\',\'MyAccountWin\',\'\',\'\',1,1,1,1,1,0);"><b><i>click here</i></b></a> to access information about this feature or <a href="javascript:show_post_popup(\'LOGIN/SHOW_POPUP\',\'HTMLHelp\',\'475\',\'640\',0,0,0,1,1,0,\'\',\'contact_select\');"><b><i>contact us</i></b></a>.';
    </TMPL_IF>
</script>
