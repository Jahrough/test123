...
/*
#securitytipall {
    height:<TMPL_IF SA>525<TMPL_ELSE>375</TMPL_IF>px;
}
*/
</style>

<div id="securitytiptitle"></div>

<div id="securitytipcontent"></div>
...
function show_all_tips() {
    ...
    // generic_tip('Security Tips','<div id="securitytipall"></div>',795);
    // setOpacity('securitytipall',0);
    // document.getElementById('securitytipall').innerHTML = all_tip_content;
    // fadeIn('securitytipall',100,2);
}

</script>

<!-- end security_tips.tpl -->
