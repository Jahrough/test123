...
<link href="<TMPL_VAR NAME='CSSPATH'>/<TMPL_VAR NAME=APPLICATION_TYPE>/<TMPL_VAR NAME=USER_THEME>.css" rel="stylesheet" type
="text/css">
...
<table cellpadding="0" cellspacing="0" border="0">
  <tr>
    ...
    <p class="smallgray">&nbsp;</p>
    <p class="smallgray" style="font-weight: bold; padding-left:20px; padding-right:10px;">To begin using the Court Search Wizard please click one of the options below:</p>
    <p class="smallgray">&nbsp;</p>
