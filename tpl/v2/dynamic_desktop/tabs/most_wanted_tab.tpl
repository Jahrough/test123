<!-- BEGIN: dynamic_desktop/mostwanted_tab.tpl -->
                            ...
                            <table cellpadding="0" cellspacing="0" border="0">
                                <tr>
                                    <td class="rbnBarTabIcon">
                                        <img class="rbnBarTabIcon" alt="" src="<TMPL_VAR NAME=IMGPATH>/dynamic_desktop/footbar_wanted.png">
                                    </td>
                                    <td>
                                        <div class="tabMover">&nbsp;</div>
                                        <div class="ribbon-text">Most Wanted&nbsp;</div></div>
                                    </td>
                                    <td>
...
<!-- END: dynamic_desktop/mostwanted_tab.tpl -->
