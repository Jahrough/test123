<!-- begin inputs_fields/instant_id_report.tpl -->
      ...
      <tr>
        <td>&nbsp;<span class=unifont1boldred>*</span><b>&nbsp;Required Fields</b>&nbsp;--&nbsp;Note: The First Name, Last Name and Address fields are required. Address fields require Street Address and either City and State or Zip.</td>
      </tr>
      <tr>
        <td>&nbsp;</td>
      </tr>
      ...
      <tr>
        ...
        <table border="0" cellpadding="2" cellspacing="0">
          ...
          <tr>
            ...
            <TMPL_UNLESS NAME=HIDE_FRAUD_DEFENDER_INPUT>
            <td align="left">&nbsp; <b><label for="FRAUD_DEFENDER">Fraud Defender</label></b>&nbsp;<input type="checkbox" name="FRAUD_DEFENDER" id="FRAUD_DEFENDER" tabindex="13" value="1" <TMPL_IF DISABLE_FRAUD_DEFENDER_INPUT> DISABLED<TMPL_ELSE> checked</TMPL_IF>></td>
            </TMPL_UNLESS>
