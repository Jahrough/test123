...
<div id="myAccount" onMouseOver="show_section('myaccountcontent',event);" onMouseOut="hide_section('myaccountcontent');">
        <div id="myaccountcontenttitle" class="myAccountHdr" style="cursor: pointer;" onClick="toggle_section('myaccountcontent');"></div>
	...
	<li><a href="javascript:show_post_popup('SECURITY/SHOW_COMPANY_SECURITY','MyAccountWin','','',1,1,1,1,1,0);">Manage Company</a></li>
        ...
        <TMPL_UNLESS NAME="DISABLE_USER_PASSWORD_CHANGES"> 
           <li><a href="javascript:show_post_popup('MANAGE/MANAGE_SINGLE_ACCOUNT','MyAccountWin','','',1,1,1,1,1,0);">Change Password</a></li>
	</TMPL_UNLESS>
        <TMPL_IF SA>
	<li><a href="javascript:show_post_popup('BILLING/SUMMARY','MyAccountWin','','',1,1,1,1,1,0);">Billing Info</a></li>
        ...
        <li><a href="javascript:show_post_popup('MYACCOUNT/SHOW_PREFERENCES','MyAccountWin','','',1,1,1,1,1,0);">Preferences</a>&nbsp; <font color="#ed1c24"><i>(Updated)</i></font></i></li>
