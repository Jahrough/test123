<!-- begin inputs_fields/ucc_search.tpl -->
      ...
      <tr>
        ...
        <table border="0" cellpadding="2" cellspacing="0">
          ...
          <tr>
            <td class="nsinputs"><input type="text" name="SSN" id="SSN" tabindex="3" size="11" maxlength="11" value="<TMPL_VAR NAME=SSN>" autocomplete="off"></td>
            ...
            <td class="nsinputs"><input type="text" name="MI" size="10" id="MI" tabindex="6" maxlength="255" value="<TMPL_VAR NAME=MI>" onBlur="this.value=this.value.toUpperCase()"></td>
          </tr>
        </table>
        </td>
      </tr>
	  ...
	  <tr>
	    ...
	    <td colspan="3">&nbsp;<b><label for="START_DATE">Filing Date Range (mm/dd/yyyy)</label></b>&nbsp; </td>
            <td>&nbsp;<b><label for="FILING_JURISDICTION">Filing Jurisdiction</label></b><a href="javascript:void(0);" onClick="show_state_popup('statelist','FILING_JURISDICTION')"><img src="<TMPL_VAR NAME=IMGPATH>/ico_information.gif" alt="More Information" height="13" hspace="5" width="14"></a></td>
          </tr>
          <tr>
	  ...
	  <tr>
        ...
        <table cellpadding="0" cellspacing="0" border="0">
          <tr>
            <td>&nbsp;<b><label for="PHONETICS">Include similar sounding names</label></b><a class="inputlinklabel" href="javascript:void(0);" onClick="show_post_popup('LOGIN/SHOW_POPUP','PhoneticWindow',309,270,0,0,0,0,0,0,'','searches/phonetic');"><img src="<TMPL_VAR NAME=IMGPATH>/ico_information.gif" alt="More Information" height="13" hspace="5" width="14"></a></td>
            ...
            <td>&nbsp;<b><label for="STRICT">Strict Search</label></b><a class="inputlinklabel" href="javascript:void(0);" onClick="show_post_popup('LOGIN/SHOW_POPUP','StrictWindow',309,270,0,0,0,0,0,0,'','searches/strict');"><img src="<TMPL_VAR NAME=IMGPATH>/ico_information.gif" alt="More Information" height="13" hspace="5" width="14"></a></td>
