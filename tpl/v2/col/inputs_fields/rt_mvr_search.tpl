...
<INPUT type=hidden NAME="DPPA_VALUE" VALUE=<TMPL_VAR NAME=DPPA_VALUE>>
	  ...
	  <tr>
	    ...
	    <td>The Motor Vehicles Search includes data from various data providers.  Some data providers may require a Name and Address to be included in your search.  If you conduct a search without Name and Address and do not receive a match (or the match you were expecting), you may want to run another search including Name, Street Address, Zip Code or Name, Street Address and City/State.</td>
	  </tr>
        </table>
	</td>
      </tr>
