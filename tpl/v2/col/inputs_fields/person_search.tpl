<!-- begin col/inputs_fields/person_search.tpl -->
      ...
      <tr>
		...
		<TMPL_ELSE>
			<input name="BUTTON" tabindex="101" id="clearSrch" style="width:100px;" type="button" value="Run Skip Wizard" onBlur="ENTER_FOCUS=0;" onFocus="ENTER_FOCUS=1" onClick="javascript:report_win('<TMPL_VAR HTMLPATH>/skip_wizard.html')">
		</TMPL_IF>
            </td>
          </tr>
          <tr>
