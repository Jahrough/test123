...
<!-- Start xbps/search_inputs_secondary_tabs.tpl -->
...
<TMPL_IF NAME=IM_ON_SEARCH>
  ...
  <TMPL_IF NAME="ADV_SEARCH">
  	<li class="active"><a trackid="subtab_deep_skip" href="javascript:send_event('SEARCH/SHOW_ADV');">Person Investigations</a></li>
  <TMPL_ELSE>
  	<li><a trackid="subtab_deep_skip" href="javascript:send_event('SEARCH/SHOW_ADV');">Person Investigations</a></li>
  </TMPL_IF>
  </TMPL_UNLESS>
  </TMPL_IF>
...
<TMPL_IF NAME=IM_ON_BUS_SEARCH>
  ...
  <TMPL_IF NAME=CORPORATION_SEARCH>
    <li class="active"><a trackid="subtab_corp_filings" href="javascript:send_event('SEARCH/SHOW_CORPORATION');">Corporate Records</a></li>
  <TMPL_ELSE>
    <li><a trackid="subtab_corp_filings" href="javascript:send_event('SEARCH/SHOW_CORPORATION');">Corporate Records</a></li>
  </TMPL_IF>
  </TMPL_UNLESS>
...
<TMPL_IF NAME=IM_ON_ASSET_SEARCH>
 <ul>
  ...
  <TMPL_IF NAME=RT_MVR_SEARCH>
    <li class="active"><a trackid="subtab_mv" href="javascript:send_event('SEARCH/SHOW_RT_MVR');">Vehicle Investigations</a></li>
  <TMPL_ELSE>
    <li><a trackid="subtab_mv" href="javascript:send_event('SEARCH/SHOW_RT_MVR');">Vehicle Investigations</a></li>
  </TMPL_IF>
  </TMPL_UNLESS>
  ...
  <a trackid="subtab_more" onMouseOut='$("moreAssetsSearches").style.display = "none";' onmouseover='this.style.cursor="pointer";$("moreAssetsSearches").style.display = "block";$("moreAssetsSearches").style.left = (findPos(this) -8) + "px";setOpacity("moreAssetsSearches",0);fadeIn("moreAssetsSearches",100,2);'>More Searches <img src="<TMPL_VAR NAME=IMGPATH>/ico_down_arro_blue.gif" alt="More Assets Searches" width="10" height="6" /></a></li>
 </ul>
</TMPL_IF> 
...
<div id="moreAssetsSearches" class="moreSearchesTab" onmouseout='document.getElementById("moreAssetsSearches").style.display = "none";' onmouseover='this.style.cursor="pointer";document.getElementById("moreAssetsSearches").style.display = "block";'>
    <div id="navlist">
      <ul style="font-size:11px">
...
<!-- end xbps/search_inputs_secondary_tabs.tpl -->
