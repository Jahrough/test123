<!-- begin inputs_fields/prof_license_search.tpl -->
      ...
      <tr>
        ...
        <table border="0" cellpadding="2" cellspacing="0">
          ...
          <tr>
            <td class="nsinputs"><input type="text" name="STREET_ADDRESS" tabindex="6" size="25" value="<TMPL_VAR NAME=STREET_ADDRESS>" maxlength=255 onBlur="this.value=this.value.toUpperCase()"></td>
            ...
            <td class="nsinputs"><input type="text" name="LICENSE_NUMBER" tabindex="10" size="20" maxlength="255" value="<TMPL_VAR NAME=LICENSE_NUMBER>" autocomplete="off"></td>
          </tr>
        </table>
        </td>
      </tr>
