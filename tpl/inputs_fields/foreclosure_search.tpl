<!-- begin inputs_fields/foreclosure_search.tpl -->
      <tr>
        ...
        <table border="0" cellpadding="2" cellspacing="0">
          ...
          <tr>
            ...
            <td class="nsinputs"><input type="text" name="COMPANY_NAME" tabindex="5" size="15" maxlength="255" value="<TMPL_VAR NAME=COMPANY_NAME>"></td>
          </tr>
        </table>
        </td>
      </tr>
      ...
      <tr>
        ...
        <table border="0" cellpadding="2" cellspacing="0">
          <tr>
            ...
            <td class="nsinputs"><input type="checkbox" name="STRICT" tabindex="9" value="1" <TMPL_IF NAME="STRICT">checked="checked"</TMPL_IF>></td>
          </tr>
        </table>
        </td>
      </tr>
<!-- end inputs_fields/foreclosure_search.tpl -->
