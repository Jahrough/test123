<!-- begin inputs_fields/merchant_vessel_search.tpl -->
      ...
      <tr>
        ...
        <table border="0" cellpadding="2" cellspacing="0">
          ...
          <tr>
            <td class="nsinputs"><input type="text" name="STREET_ADDRESS" tabindex="5" size="31" value="<TMPL_VAR NAME=STREET_ADDRESS>" maxlength=255 onBlur="this.value=this.value.toUpperCase()"></td>
            <td class="nsinputs"><input type="text" name="CITY" tabindex="6" size="16" value="<TMPL_VAR NAME=CITY>" maxlength=255 onBlur="this.value=this.value.toUpperCase()"></td>
      ...
      <tr>
        ...
        <table border="0" cellpadding="2" cellspacing="0">
          <tr>
            <td class="inputlabel">&nbsp;<b>Hull ID</b></td>
            <td class="inputlabel">&nbsp;<b>Vessel Name</b></td>
          </tr>
          <tr>
            <td class="nsinputs"><input type="text" name="HULL_ID" size="20" tabindex="11" maxlength="30" value="<TMPL_VAR NAME=HULL_ID>" onBlur="this.value=this.value.toUpperCase()"></td>
            <td class="nsinputs"><input type="text" name="VESSEL_NAME" size="20" tabindex="12" maxlength="50" value="<TMPL_VAR NAME=VESSEL_NAME>" onBlur="this.value=this.value.toUpperCase()"></td>
          </tr>
        </table>
        </td>
      </tr>
