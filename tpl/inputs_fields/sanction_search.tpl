<!-- begin inputs_fields/sanction_search.tpl -->
      <tr>
        ...
        <table border="0" cellpadding="2" cellspacing="0">
          ...
          <tr>
            ...
            <td class="nsinputs"><input type="text" name="DOB" size="14" tabindex="4" maxlength="10" value="<TMPL_VAR NAME=DOB>" autocomplete="off"></td>
          </tr>
        </table>
        </td>
      </tr>
      ...
      <tr>
        ...
        <table border="0" cellpadding="2" cellspacing="0">
          <tr>
            <td class="inputlabel">&nbsp;<b>Tax ID (SSN)</b></td>
          </tr>
          <tr>
