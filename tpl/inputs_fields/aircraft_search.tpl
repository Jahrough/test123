      ...
      <tr>
        ...
        <table border="0" cellpadding="2" cellspacing="0">
          <tr>
            ...
            <td class="inputlabel">&nbsp;<b>Aircraft Number</b></td>
          </tr>
          <tr>
            ...
            <td class="nsinputs"><input type="text" name="AIRCRAFT_NUMBER" tabindex="12" size="20" maxlength="255" value="<TMPL_VAR NAME=AIRCRAFT_NUMBER>" onBlur="this.value=this.value.toUpperCase()"></td>
          </tr>
        </table>
        </td>
      </tr>
