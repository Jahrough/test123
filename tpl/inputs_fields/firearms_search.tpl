<!-- begin inputs_fields/firearms_search.tpl -->
      ...
      <tr>
        ...
        <table cellpadding="2" cellspacing="0" border="0">
          <tr>
            <td class="inputlabel">&nbsp;<b>Trade Name</b></td>
            <td class="inputlabel">&nbsp;<b>License Number</b></td>
          </tr>
          <tr>
            <td class="nsinputs"><input type="text" name="TRADE_NAME" tabindex="9" size="20" maxlength="255" value="<TMPL_VAR NAME=TRADE_NAME>" onBlur="this.value=this.value.toUpperCase()"></td>
            <td class="nsinputs"><input type="text" name="LICENSE_NUMBER" tabindex="10" size="16" maxlength="15" value="<TMPL_VAR NAME=LICENSE_NUMBER>" autocomplete="off" onBlur="this.value=this.value.toUpperCase()"></td>
          </tr>
        </table>
        </td>
      </tr>
