<!-- begin inputs_fields/riskview_search.tpl -->
      <tr>
        <td class="inputlabel">&nbsp;<span class=unifont1boldred>*</span><b>&nbsp;Required Fields</b> - Note: For optimal results SSN, Phone and DOB should be populated</td>
      </tr>
      <tr>
...
<!-- end inputs_fields/riskview_search.tpl -->
