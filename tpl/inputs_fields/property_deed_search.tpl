<!-- begin inputs_fields/property_deed_search.tpl -->
      <tr>
      ...
      <tr>
        ...
        <table border="0" cellpadding="2" cellspacing="0">
          <tr>
            ...
            <td class="inputlabel">&nbsp;<b>Parcel Number</b></td>
          </tr>
          <tr>
            ...
            <td class="nsinputs"><input type="text" name="PARCEL_ID" tabindex="12" size="20" maxlength="255" value="<TMPL_VAR NAME=PARCEL_ID>"></td>
          </tr>
        </table>
        </td>
      </tr>
<!-- end inputs_fields/property_deed_search.tpl -->
