<!-- begin inputs_fields/concealed_weapon_search.tpl -->
      <tr>
      ...
      <tr>
        ...
        <table border="0" cellpadding="2" cellspacing="0">
          ...
          <tr>
            ...
            <td class="nsinputs"><input type="text" name="STATE" tabindex="7" size="3" maxlength="2" value="<TMPL_IF COURT_STATE><TMPL_VAR NAME=COURT_STATE><TMPL_ELSE><TMPL_VAR NAME=STATE></TMPL_IF>" onBlur="this.value=this.value.toUpperCase()"></td>
      ...
      <tr>
        ...
        <table border="0" cellpadding="2" cellspacing="0">
          <tr>
            ...
            <td><input type="checkbox" name="STRICT" tabindex="9" value="1" <TMPL_IF NAME="STRICT">checked="checked"</TMPL_IF>/></td>
          </tr>
        </table>
        </td>
      </tr>
<!-- end inputs_fields/concealed_weapon_search.tpl -->
