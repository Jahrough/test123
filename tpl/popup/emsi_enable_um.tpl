...
<table border="0" cellpadding="0" cellspacing="0">
  ...
  <td class="unifont2" >
	...
	the Accurint&reg; for I<TMPL_IF HEA>Health Care<TMPL_ELSE><TMPL_IF GOV>Government<TMPL_ELSE>Insurance</TMPL_IF></TMPL_IF> site.
        <ul>
...
<TMPL_IF NAME="SA">
Thank you for your interest in Accurint for <TMPL_IF HEA>Health Care<TMPL_ELSE><TMPL_IF GOV>Government<TMPL_ELSE>Insurance</TMPL_IF></TMPL_IF> Medical Record Retrieval.&nbsp; To receive set up information and instructions on how to access Medical Records Retrieval please contact your account manager:<br><br>
