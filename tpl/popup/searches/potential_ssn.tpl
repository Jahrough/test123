...
<table border="0" cellpadding="0" cellspacing="0" width="308">
  <tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td align="center" class="popuptitle"><B>Potential SSN</B></td>
      </tr>
    </table>
    </td>
  </tr>
...
<table border="0" cellpadding="20" cellspacing="0" width="308">
  <tr>
    ...
    We have also queried many of our other data sources for information about your subject and, by using our advanced technology and proprietary algorithms, are providing what we believe is a potential SSN for your subject.
    </td>
  </tr>
</table>
<br>
