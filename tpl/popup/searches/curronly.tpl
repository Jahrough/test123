<html>
<head>
<title>Include current record only</title>
...
<table border="0" cellpadding="0" cellspacing="0" width="308">
  <tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td align="center" class="popuptitle"><B>Include current record only</B></td>
      </tr>
    </table>
    </td>
  </tr>
...
<table border="0" cellpadding="20" cellspacing="0" width="308">
  <tr>
    ...
    Check this option if you want to limit your search results to only the current record. Your results will 
    contain only the current deed or property assessment for the search terms entered.
    </td>
  </tr>
</table>
<br>
