<html>
<head>
<title>Perform Strict Search</title>
...
<table border="0" cellpadding="0" cellspacing="0" width="308">
  <tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td align="center" class="popuptitle"><B>Perform Strict Search</B></td>
      </tr>
    </table>
    </td>
  </tr>
...
<table border="0" cellpadding="20" cellspacing="0" width="308">
  <tr>
    ...
    Check this box to limit your search results to only include matches on the full name criteria, 
    and/or specific input street addresses. The Strict Search option is a narrower search and will not allow for
    to searching on similar sounding names, Radius searching, or nicknames (where available).
    </td>
  </tr>
</table>
<br>
