              ...
              <tr>
                ...
                <table border="0" cellpadding="0" cellspacing="5" width="117">
                  <tr>
                    ...
                    <td valign="top" align="left" width="97" class="smallfont1"><a class="mainmenu" href="javascript:open_help('col/advanced_person_help.html','AdvancedPersonSearch');">Deep Skip Search</a></td>
                  </tr>
                  <tr>
                    <td width="4" valign="top" align="right" class="smallfont1">&#149;</td>
