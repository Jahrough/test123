  ...
  <tr>
	...
	<table border="0" cellpadding="0" cellspacing="0" width="117">
	  ...
	  <tr>
	    ...
	    <table border="0" cellpadding="0" cellspacing="0" width="117" height="115">
	      <tr height="65">
        ...
        <table border="0" cellpadding="0" cellspacing="0" width="117" height="80">
          <tr height="65">
            ...
            <table border="0" cellpadding="0" cellspacing="5" width="117">
              <tr>
                <td width="4" valign="top" align="right" class="smallfont1">&#149;</td>
                <td valign="top" align="left" width="97" class="smallfont1"><a class="mainmenu" href="javascript:show_post_popup('LOGIN/SHOW_POPUP','CoverageWindow','420','350',0,0,0,1,1,0,'','coverage/rate_evasion_coverage');">Rate Evasion Evaluation</a></td>
              </tr>
            </table>
            </td>
          </tr>
