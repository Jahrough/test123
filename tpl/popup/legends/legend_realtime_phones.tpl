<!-- begin tpl/popup/legends/legend_realtime_phones.tpl -->
...
<table border="0" cellpadding="0" cellspacing="2" width="308">
  ...
  <tr>
    <td width="25" align="center"><img src="<TMPL_VAR NAME=IMGPATH>/rt_phone_big.gif" width="21" height="21" border="0"></td>
    <td width="289" class="style1"><B>Phone Detail Report</B></td>
  </tr>
  <tr>
    <td class="style1">&nbsp;</td>
    <td class="style1">This icon can be found on the right of the search results.&nbsp; If you wish to create a
     <b>Phone Detail Report</b> for any record, click this icon. This report may contain data on landline phone
     numbers, wireless numbers, carrier company information, and additional details related to the phone number.</td>
  </tr>
  <tr>
    <td colspan="2"><img src="<TMPL_VAR NAME=IMGPATH>/spacer.gif" width="1" height="10" border="0"></td>
  </tr>
...
<!-- end tpl/popup/legends/legend_realtime_phones.tpl -->
