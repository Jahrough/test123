<!-- begin tpl/popup/legends/legend_bankruptcy.tpl -->
...
<table border="0" cellpadding="0" cellspacing="2" width="308">
  ...
  <tr>
    <td class="style1">&nbsp;</td>
    <td class="style1">This icon can be found on the far left of the search results.&nbsp; Click here to run the following reports: <b>Summary</b>, <b>SkipTrace</b>, <b>Asset</b>, <b>Comprehensive</b>, and <b>Custom Comprehensive</b>.</td>
  </tr>
  <tr>
    <td colspan="2"><img src="<TMPL_VAR NAME=IMGPATH>/spacer.gif" width="1" height="10" border="0"></td>
  </tr>
...
<!-- end tpl/popup/legends/legend_bankruptcy.tpl -->
