...
<table border="0" cellpadding="0" cellspacing="2" width="308">
  ...
  <tr>
    <td width="25" align="center"><img src="<TMPL_VAR NAME=IMGPATH>/vessel_big.gif" width="21" height="21" border="0"></td>
    <td width="289" class="style1"><B>Watercraft Report</B></td>
  </tr>
  <tr>
    <td class="style1">&nbsp;</td>
    <td class="style1">This icon can be found on the far right of the search results.&nbsp; If you wish to create a <b>Watercraft Report</b> for any record, click this icon.</td>
  </tr>
  <tr>
    <td colspan="2"><img src="<TMPL_VAR NAME=IMGPATH>/spacer.gif" width="1" height="10" border="0"></td>
  </tr>
