...
<table border="0" cellpadding="5" cellspacing="0">
  <tr>
	  ...
	  <tr>
		...
		<table border="0" cellpadding="0" cellspacing="5" width="117">
		 ...
		 <TMPL_UNLESS DELETE_RT_PERSON>
		  <tr>
		    <td width="4" valign="top" align="right" class="smallfont1">&#149;</td>
		    <td valign="top" align="left" width="97" class="smallfont1"><a class="mainmenu" href="javascript:show_post_popup('LOGIN/SHOW_POPUP','CoverageWindow','420','350',1,1,1,1,1,0,'','coverage/rt_person_coverage');">Real-Time Person Search</a></td>
		  </tr>
		  </TMPL_UNLESS>
	...
	<table border="0" cellpadding="0" cellspacing="0" width="117">
	  ...
	  <tr>
	    <td bgcolor="white" valign="top" align="left">
	    <table border="0" cellpadding="0" cellspacing="0" width="117" height="214">
	      <tr>
	        <td valign="top" align="left">
		<table border="0" cellpadding="0" cellspacing="5" width="117">
      ...
      <tr>
        <td width="4" valign="top" align="right" class="smallfont1">&#149;</td>
        <td valign="top" align="left" width="97" class="smallfont1"><a class="mainmenu" href="javascript:show_post_popup('LOGIN/SHOW_POPUP','CoverageWindow','450','430',1,1,1,1,1,0,'','coverage/rt_phone_coverage');">Real-Time Phones</a></td>
      </tr>
      </TMPL_IF>
		  <tr>
		    <td width="4" valign="top" align="right" class="smallfont1">&#149;</td>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="117">
      ...
      <tr class="healthcare" style="height: 30px;">
        <td rowspan="3" class="unifont2">&nbsp;</td>
        <td align="center" valign="middle" class="unifont12white"><b>health care</b></td>
        <td rowspan="3" class="unifont2">&nbsp;</td>
      </tr>
      <tr>
        <td bgcolor="white" valign="top" align="left">
        <table border="0" cellpadding="0" cellspacing="0" width="117" height="215">
          <tr>
            <td valign="top" align="left">
            <table border="0" cellpadding="0" cellspacing="5" width="117">
              <tr>
        	...
        	<td valign="top" align="left" width="97" class="smallfont1"><a class="mainmenu" href="javascript:show_post_popup('LOGIN/SHOW_POPUP','CoverageWindow','420','350',1,1,1,1,1,0,'','coverage/all50_coverage');">Provider Sanction Search</a></td>
              ...
              <tr>
        	<td width="4" valign="top" align="right" class="smallfont1">&#149;</td>
        	<td valign="top" align="left" width="97" class="smallfont1"><a class="mainmenu" href="javascript:show_post_popup('LOGIN/SHOW_POPUP','CoverageWindow','420','350',1,1,1,1,1,0,'','coverage/bus_qualifier_coverage');">Comprehensive Health Care Business Report</a></td>
              </tr>
              <tr>
        	<td width="4" valign="top" align="right" class="smallfont1">&#149;</td>
        	<td valign="top" align="left" width="97" class="smallfont1"><a class="mainmenu" href="javascript:show_post_popup('LOGIN/SHOW_POPUP','CoverageWindow','420','350',1,1,1,1,1,0,'','coverage/ind_qualifier_coverage');">Comprehensive Health Care Provider Report</a></td>
              </tr>
            </table>
            </td>
          </tr>
          <tr class="healthcare" style="height: 15px;">
            <td class="unifont2" colspan="3">&nbsp;</td>
          </tr>
        </table>
        </td>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="117">
      ...
      <tr>
        <td bgcolor="white" valign="top" align="left">
        <table border="0" cellpadding="0" cellspacing="0" width="117" height="208">
          <tr>
            <td valign="top" align="left">
            <table border="0" cellpadding="0" cellspacing="5" width="117">
              <tr>
              ...
              <TMPL_UNLESS NAME="HIDE_RT_MVR">
              <tr>
                <td width="4" valign="top" align="right" class="smallfont1">&#149;</td>
                <td valign="top" align="left" width="97" class="smallfont1"><a class="mainmenu" href="javascript:show_post_popup('LOGIN/SHOW_POPUP','CoverageWindow','420','350',1,1,1,1,1,0,'','coverage/rt_mvr_coverage');">Real-Time Motor Vehicle Registration</a></td>
              </tr>
              </TMPL_UNLESS>
              <tr>
                <td width="4" valign="top" align="right" class="smallfont1">&#149;</td>
      ...
      <tr>
        <td valign="top">
	<table border="0" cellpadding="0" cellspacing="0" width="117">
	  <tr class="avms" style="height: 30px;">
	    <td rowspan="3" class="unifont2">&nbsp;</td>
	  ...
	  <tr>
	    <td bgcolor="white" valign="top" align="left">
	    <table border="0" cellpadding="0" cellspacing="0" width="117" height="206">
	      <tr>
	        <td valign="top" align="left">
		<table border="0" cellpadding="0" cellspacing="5" width="117">
		  <tr>
		    <td width="4" valign="top" align="right" class="smallfont1">&#149;</td>
		    <td valign="top" align="left" width="97" class="smallfont1"><a class="mainmenu" href="javascript:show_post_popup('LOGIN/SHOW_POPUP','CoverageWindow','420','525',1,1,1,1,1,0,'','coverage/avm_coverage');">Automated Valuation Models</a></td>
		  </tr>
		</table>
		</td>
	      </tr>
	  ...
	  <tr class="avms" style="height: 15px;">
	    <td class="unifont2" colspan="3">&nbsp;</td>
	  </tr>
	</table>
	</td>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="117">
      ...
      <tr>
        <td bgcolor="white" valign="top" align="left">
        <table border="0" cellpadding="0" cellspacing="0" width="117" height="469">
          <tr>
            <td valign="top" align="left">
            <table border="0" cellpadding="0" cellspacing="5" width="117">
              <tr>
