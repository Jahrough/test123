...
function build_adv_link() {
	...
	if (odf.ADVANCED_SEARCH.value == 'col') {
	    ...
	    path_name = 'col/';
	} else if (odf.ADVANCED_SEARCH.value == 'le') {
	    link_name = 'Advanced Person Search';
	    path_name = 'le/';
	} else {
	    link_name = 'Advanced Person Search';
	}
	document.write('<tr><td width="4" valign="top" align="right" class="smallfont1">&#149;</td><td valign="top" align="left" width="97" class="smallfont1"><a class="mainmenu" href="javascript:open_help(\''+ path_name + 'advanced_person_help.html\',\'AdvancedPersonSearch\');">' + link_name + '</a></td></tr>');
    }
}
</script>
</head>
	...
	<table border="0" cellpadding="0" cellspacing="0" width="97">
	  ...
	  <tr>
		...
		<table border="0" cellpadding="0" cellspacing="5" width="117">
		  ...
		  <tr>
		    <td width="4" valign="top" align="right" class="smallfont1">&#149;</td>
		    <td valign="top" align="left" width="97" class="smallfont1"><a class="mainmenu" href="javascript:open_help('phone_identifier_help.html','Phone_Identifier');">Reverse Phone Search Plus</a></td>
		  </tr>
		  <tr>
