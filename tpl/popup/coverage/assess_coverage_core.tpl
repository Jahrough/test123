<!-- begin assess_coverage_core.tpl -->
<script>
function showst(st) {
    var urlpath = 'coverage/assess/' + st;
    show_post_popup('LOGIN/SHOW_POPUP','AssessmentStates',375,400,0,0,0,1,1,0,'',urlpath);
}
</script>
...
<table border="0" cellpadding="5" cellspacing="0" width="100%">
  <tr>
    <td class="coveragetitle" align="right" width="80%"><B>Property Assessments Coverage Area</B></td>
...
<table border="0" cellpadding="5" cellspacing="0" width="100%">
  <tr>
    ...
    <td class="coveragtext" width="33%" valign="top">
    ...
    <a href="javascript:showst('vi');">VIRGIN ISLANDS</a><br>
