<script>
function showst(st) {
    var urlpath = 'coverage/liens/' + st;
    show_post_popup('LOGIN/SHOW_POPUP','LiensandJudgments',650,400,0,0,0,1,1,0,'',urlpath);
}
</script>
...
<table border="0" cellpadding="5" cellspacing="0" width="100%">
  <tr>
    <td class="coveragetitle" align="right" width="70%"><B>Liens and Judgments Coverage Area</B></td>
    <td align="right" width="30%" valign="top"><TMPL_INCLUDE NAME="print_button.tpl"></td>
  </tr>
</table>
<table border="0" cellpadding="10" cellspacing="0" width="100%">
  <tr>
   <td class="coveragetext" colspan="3" valign="top"><b>CLICK A COVERED STATE BELOW TO VIEW DESCRIPTION, COUNTY & COVERAGE DATE</b></td>
  </tr>
  <tr>
    ...
    <a href="javascript:showst('dc');">DISTRICT OF COLUMIBA</a><br>
    <a href="javascript:showst('fl');">FLORIDA</a><br>
    <a href="javascript:showst('ga');">GEORGIA</a><br>
    <a href="javascript:showst('gu');">GUAM</a><br>
