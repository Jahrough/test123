<!-- BEGIN manage_account_disable_searches.tpl -->
  <script language="Javascript">
      function disable_warning(){
        var dis_message = "WARNING: If you disable this search you will NOT be able to enable it. To enable this search, you will have to contact customer support!";
        alert(dis_message);
      }
    </script>
	  ...
	  <span class="unifont1bold"><legend>Miscellaneous</legend></span>
        ...
        <TMPL_IF INSTANTID_FRAUD_DEFENDER_CHECKBOX_SECTION>
	      <TR>
                ...
                <table border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td><INPUT TYPE=RADIO NAME="INSTANT_ID_FRAUD_DEFENDER_CHECKBOX" VALUE='1' <TMPL_IF NAME=INSTANTID_FRAUD_DEFENDER_CHECKBOX>CHECKED</TMPL_IF>></td>
                    <td class="unifont1">Yes&nbsp;&nbsp;&nbsp;</td>
                    <td><INPUT TYPE=RADIO NAME="INSTANT_ID_FRAUD_DEFENDER_CHECKBOX" VALUE='0' <TMPL_UNLESS NAME=INSTANTID_FRAUD_DEFENDER_CHECKBOX>CHECKED</TMPL_UNLESS>></td>
                    <td class="unifont1">No</td>
                  </tr>
                </table>
                </td>
