<!-- begin inputs_fields/person_search.tpl -->
      ...
      <tr>
        ...
        <table border="0" cellpadding="2" cellspacing="0">
          <tr>
            <td class="inputlabel"><TMPL_UNLESS SSN_ONLY_SEARCH><a class="inputlinklabel" href="javascript:void(0);" onClick="general_win('<TMPL_VAR NAME=HLPPATH>/person_help.html#streetaddress','HelpWindow',680,490,1,1,1,1,1,0);void(0);">Street Address</a><TMPL_ELSE><b>Street Address</b></TMPL_UNLESS></td>
          ...
          <tr>
            ...
            <td class="nsinputs"><input type="text" name="COUNTY" tabindex="9" size="10" maxlength="255" value="<TMPL_VAR NAME=COUNTY>"></td>
      ...
      <tr>
        ...
        <table border="0" cellpadding="2" cellspacing="0">
          ...
          <tr>
            ...
            <td class="nsinputs"><input type="text" name="DOB" size="14" tabindex="12" maxlength="10" value="<TMPL_VAR NAME=DOB>"></td>
