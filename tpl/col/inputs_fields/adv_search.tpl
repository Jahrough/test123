<!-- begin inputs_fields/adv_search.tpl -->
      <tr>
        ...
        <table border="0" cellpadding="2" cellspacing="0">
          ...
          <tr>
            <td class="nsinputs"><input type="text" name="SSN" tabindex="1" size="11" maxlength="11" value="<TMPL_VAR NAME=SSN>" autocomplete="off"></td>
            <td class="nsinputs"><input type="text" name="LAST_NAME" tabindex="2" size="20" value="<TMPL_VAR NAME=LAST_NAME>" maxlength=255 onBlur="this.value=this.value.toUpperCase()"></td>
            <td class="nsinputs"><input type="text" name="FIRST_NAME" tabindex="3" size="20" value="<TMPL_VAR NAME=FIRST_NAME>" maxlength=255 onBlur="this.value=this.value.toUpperCase()"></td>
            <td class="nsinputs"><input type="text" name="MI" size="20" tabindex="4" maxlength="255" value="<TMPL_VAR NAME=MI>" onBlur="this.value=this.value.toUpperCase()"></td>
      ...
      <tr>
        ...
        <table border="0" cellpadding="2" cellspacing="0">
          <tr>
            ...
            <td class="inputlabel">&nbsp;<TMPL_UNLESS SSN_ONLY_SEARCH><a class="inputlinklabel" href="javascript:void(0);" onClick="show_state_popup('statelist')">State</a><TMPL_ELSE><b>State</b></TMPL_UNLESS></td>
      ...
      <tr>
        ...
        <table border="0" cellpadding="2" cellspacing="0">
          <tr>
            <td class="inputlabel"><TMPL_UNLESS SSN_ONLY_SEARCH><a class="inputlinklabel" href="javascript:void(0);" onClick="general_win('<TMPL_VAR NAME=HLPPATH>/person_help.html#phone','HelpWindow',680,490,1,1,1,1,1,0);void(0);">Phone</a><TMPL_ELSE><b>Phone</b></TMPL_UNLESS></td>
            <td class="inputlabel"><TMPL_UNLESS SSN_ONLY_SEARCH><a class="inputlinklabel" href="javascript:void(0);" onClick="general_win('<TMPL_VAR NAME=HLPPATH>/person_help.html#dob','HelpWindow',680,490,1,1,1,1,1,0);void(0);">DOB</a><TMPL_ELSE><b>DOB</b></TMPL_UNLESS></td>
          ...
          <tr>
            ...
            <td class="nsinputs"><input type="text" name="DOB" size="14" tabindex="52" maxlength="10" value="<TMPL_VAR NAME=DOB>"></td>
      ...
      <tr>
        ...
        <table border="0" cellpadding="2" cellspacing="0">
          <tr>
            ...
            <td class="inputlabel">&nbsp;<TMPL_UNLESS SSN_ONLY_SEARCH><a class="inputlinklabel" href="javascript:void(0);" onClick="show_state_popup('statelist','OTHER_STATE')">Other State</a><TMPL_ELSE><b>Other State</b></TMPL_UNLESS></td>
            <td class="inputlabel">&nbsp;<TMPL_UNLESS SSN_ONLY_SEARCH><a class="inputlinklabel" href="javascript:void(0);" onClick="show_state_popup('statelist','OTHER_STATE2')">Other State</a><TMPL_ELSE><b>Other State</b></TMPL_UNLESS></td>
          </tr>
          <tr>
