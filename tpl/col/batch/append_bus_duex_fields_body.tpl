...
<table border="0" width="600">
  <tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="600">
      <tr>
        <td style="color: #003399; font-family: arial; font-size: 10pt;" width="50%" align="left"><TMPL_INCLUDE NAME="title_line.tpl"></td>
	<td style="color: #003399; font-family: arial; font-size: 10pt;" width="50%" align="right"><b>Click the&nbsp;<a href="javascript:void(0);" onClick="return overlib('<br>Click this button for more detail regarding a particular corresponding item.<br><br>', CAPTIONSIZE, 2, BORDER, 3, FGCOLOR, '#D4D0C8', WIDTH, 300, VAUTO, STICKY, CAPTION, 'More Detail', CLOSECLICK, CLOSETEXT, '<img border=0 width=16 height=16 alt=\'Close\' title=\'Close\' src=\'<TMPL_VAR NAME=IMGPATH>/closex.gif\'>');"><img src="<TMPL_VAR NAME=IMGPATH>/info.gif" border="0" width="16" height="16"></a>&nbsp;Button For More Detail&nbsp;</b></td>
      </tr>
    </table>
    </td>
  </tr>
  <tr>
    <td align="center" class="banner3" colspan="2"><b>Append Fields</b></td>
  </tr>
<!-- BEGIN -->
<TMPL_IF FREE_TRIAL_CREDITS>
  <tr>
    <td class="style1" align="center"><br><b>This account has <TMPL_VAR FREE_TRIAL_CREDITS> free records to process</b></td>
  </tr>
</TMPL_IF>
...
<table border="1" cellpadding="5" cellspacing="0" width="600" bordercolor="#000000">
  ...
  <tr>
    <td class="unifont1" colspan="2"><font color="#003399"><br>&nbsp;<b>Step 2 Options:</b></td>
  </tr>
  <tr>
	...
	</select>&nbsp;Phones and Addresses for Company&nbsp;-&nbsp;<font color="#003399">$0.25 per hit</font>
    &nbsp;&nbsp;<a href="javascript:void(0);" onClick="return overlib('<br>Appends to the output record up to 5 active phone numbers and probable current addresses for the input company.  A flag of Y will be returned for verified phones.  If a company cannot be found at the input address we will look within a 30 mile radius for the Company name.<br><br>', CAPTIONSIZE, 2, BORDER, 3, FGCOLOR, '#D4D0C8', WIDTH, 300, FIXX, 200, FIXY, 205, STICKY, CAPTION, '&nbsp;', CLOSECLICK, CLOSETEXT, '<img border=0 width=16 height=16 alt=\'Close\' title=\'Close\' src=\'<TMPL_VAR NAME=IMGPATH>/closex.gif\'>');"><img src="<TMPL_VAR NAME=IMGPATH>/info.gif" border="0" width="16" height="16"></a></td>
  </tr>
  <tr>
	...
	</select>&nbsp;Phones for Company&nbsp;-&nbsp;<font color="#003399">$0.25 per hit
    &nbsp;&nbsp;<a href="javascript:void(0);" onClick="return overlib('<br>Appends to the output record up to 5 active phone numbers for the input company.  A flag of Y will be returned for verified phones.  If a company cannot be found at the input address we will look within a 30 mile radius for the Company name.<br><br>', CAPTIONSIZE, 2, BORDER, 3, FGCOLOR, '#D4D0C8', WIDTH, 300, FIXX, 200, FIXY, 205, STICKY, CAPTION, '&nbsp;', CLOSECLICK, CLOSETEXT, '<img border=0 width=16 height=16 alt=\'Close\' title=\'Close\' src=\'<TMPL_VAR NAME=IMGPATH>/closex.gif\'>');"><img src="<TMPL_VAR NAME=IMGPATH>/info.gif" border="0" width="16" height="16"></a></td>
  </tr>
  <tr>
    <td colspan="2" class="smallfont1"><input type="checkbox" name="dedupephones" value="1" <TMPL_VAR NAME=dedupephones> onClick="change_total(this, <TMPL_VAR NAME=dedupephones-price>,document.forms[0].BATCH_TOTAL,document.forms[0].BATCH_PRE_TOTAL)">De-dupe against input&nbsp;-&nbsp;<font color="#003399">$0.10 per record submitted&nbsp;&nbsp;<a href="javascript:void(0);" onClick="return overlib('<br>Compares the input phone number and address to the phone number and address found for the company name, returning the phone number and/or address only if it is different.  Addresses are not returned.<br><br>', CAPTIONSIZE, 2, BORDER, 3, FGCOLOR, '#D4D0C8', WIDTH, 300, FIXX, 200, FIXY, 205, STICKY, CAPTION, '&nbsp;', CLOSECLICK, CLOSETEXT, '<img border=0 width=16 height=16 alt=\'Close\' title=\'Close\' src=\'<TMPL_VAR NAME=IMGPATH>/closex.gif\'>');"><img src="<TMPL_VAR NAME=IMGPATH>/info.gif" border="0" width="16" height="16"></a></td>
  </tr>

<!-- comment out until Moxie is ready 
  <tr>
    <td class="unifont1" colspan="2"><font color="#003399"><br>&nbsp;<b>Additional Append Options:</b></td>
  </tr>
  ...
  <tr>
    <td class="unifont1" colspan="2"><font color="#003399"><br>&nbsp;<b>Additional Principal Append Options:</b></td>
  </tr>
  <tr>
    <td colspan="2" class="smallfont1"><input type="checkbox" name="other_bus_principal" value="1" <TMPL_VAR NAME=other_bus_principal> onClick="">Other Business Affiliations for Principal&nbsp;&nbsp;<a href="javascript:void(0);" onClick="return overlib('<br>TEXT HERE?.<br><br>', CAPTIONSIZE, 2, BORDER, 3, FGCOLOR, '#D4D0C8', WIDTH, 275, FIXX, 330, FIXY, 520, STICKY, CAPTION, 'Other Business Affiliations for Principal', CLOSECLICK, CLOSETEXT, '<img border=0 width=16 height=16 alt=\'Close\' title=\'Close\' src=\'<TMPL_VAR NAME=IMGPATH>/closex.gif\'>');"><img src="<TMPL_VAR NAME=IMGPATH>/info.gif" border="0" width="16" height="16"></a></td>
  </tr>
  <tr>
    <td colspan="2" class="smallfont1">&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="other_bus_principal_bankruptcies" value="1" <TMPL_VAR NAME=other_bus_principal_bankruptcies> onClick="">Check for Bankruptcy&nbsp;&nbsp;<a href="javascript:void(0);" onClick="return overlib('<br>TEXT HERE?.<br><br>', CAPTIONSIZE, 2, BORDER, 3, FGCOLOR, '#D4D0C8', WIDTH, 275, FIXX, 330, FIXY, 520, STICKY, CAPTION, 'Check for Bankruptcy', CLOSECLICK, CLOSETEXT, '<img border=0 width=16 height=16 alt=\'Close\' title=\'Close\' src=\'<TMPL_VAR NAME=IMGPATH>/closex.gif\'>');"><img src="<TMPL_VAR NAME=IMGPATH>/info.gif" border="0" width="16" height="16"></a></td>
  </tr>
  -->
</table>
    </td>
