...
<table border="0" width="600">
  ...
  <tr>
    <td class="batchbanner" align="center"><br><b>Choose FTP JobID to Edit</b></td>
  </tr>
  ...
  <tr>
    <td align="center" class="unifont2"><br><b>Enter the FTP Job ID to edit:</b>&nbsp;&nbsp;<input type=text name="FTP_JOBID" value="<TMPL_VAR FTP_JOBID>"></td>
  </tr>
  ...
  <tr>
	...
	<TMPL_IF JOBS_LOOP>
		...
		<tr>
			<td>&nbsp;</td>
			<td class="unifont1" width="100"><b>Job ID</b></td>
			<td class="unifont1" width="200"><b>Job Name</b></td>
			<td class="unifont1" width="100"><b>Date Created</b></td>
		</tr>
	<TMPL_LOOP JOBS_LOOP>
		<tr>
			<td><input type="radio" value="<TMPL_VAR FTP_USERID>" name="RAD_JOBID" onClick="document.forms[0].FTP_JOBID.value=this.value">&nbsp;</td>
			<td class="unifont1"><TMPL_VAR FTP_USERID></td>
