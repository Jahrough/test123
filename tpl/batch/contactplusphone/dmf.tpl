...
<INPUT TYPE=HIDDEN NAME=EVENT VALUE="CONTACTPLUSPHONEADDRESSBATCH/SAVE_DMF">
...
<table border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td align="center" class="glbtitle"><br><b>DMF Compliance</b></td>
  </tr>
</table>
...
<TMPL_INCLUDE NAME="../dmf_body.tpl">

<br>

<table border="0" cellpadding="10" cellspacing="0" width="600">
  <tr>
    <td valign="bottom" align="right" width="550"><a href="javascript:send_event('CONTACTPLUSPHONEADDRESSBATCH/DPPA')"><img src="<TMPL_VAR NAME=IMGPATH>/BATCH/back.gif" width="87" height="29" border="0"></a></td>
  </tr>
</table>
