<!-- BEGIN contactplusphone/start.tpl -->
<TMPL_INCLUDE NAME="batch_head.tpl">

<INPUT TYPE=HIDDEN NAME=EVENT VALUE="CONTACTPLUSPHONEADDRESSBATCH/SAVE_START">
...
<table border="0" width="600">
  ...
  <tr>
    <td class="batchbanner" align="center"><br><b>Welcome to the Contact Plus Phones and Address Batch Submission Wizard</b></td>
  </tr>
  ...
  <tr>
    ...
    <INPUT TYPE="HIDDEN" NAME="BATCH_TYPE" VALUE="CONTACTPLUSPHONE">
  <tr>
  ...
  <tr>
    <td valign="bottom" align="right" width="550"><a href="javascript:send_event('CONTACTPLUSPHONEADDRESSBATCH/SAVE_START')" onClick="if(!validate()){return false;}"><img src="<TMPL_VAR NAME=IMGPATH>/BATCH/next.gif" width="87" height="29" border="0"></a></td>
  </tr>
...
<table border="0" cellpadding="2" cellspacing="0" bgcolor="#ed1c24">
  <tr>
	...
	<br><br>
	Address(Per Hit)<br>
	Contact Plus Phones (Per Hit)<br>
	Address and Contact Plus Phones (Per Hit)<br>
	Address and/or Phone Confirmation(Per Input)<br>
	</td>
	<td class="unifont1" valign="top" width="10%">
	Single<br><br>
	$0.13<br>
	<TMPL_IF XBPS>$0.56<TMPL_ELSE>$0.26</TMPL_IF><br>
	<TMPL_IF XBPS>$0.63<TMPL_ELSE>$0.33</TMPL_IF><br>
	$0.03<br>
	</td>
	<td class="unifont1" valign="top" width="30%">
	<b>Multiple**</b><br><br>
	$0.16<br>
	<TMPL_IF XBPS>$0.61<TMPL_ELSE>$0.31</TMPL_IF><br>
	<TMPL_IF XBPS>$0.68<TMPL_ELSE>$0.38</TMPL_IF><br>
	$0.04<br>
	</td>
      </tr>
      <tr>
...
<!-- END contactplusphone/start.tpl -->
