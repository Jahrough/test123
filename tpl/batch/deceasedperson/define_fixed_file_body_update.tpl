    ...
    <table border="0" cellpadding="0" cellspacing="0">
      ...
      <td align="left">
       ...
       <option value="0">Select Template from list... </option>
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;<input name="BATCH_DELETE_TEMPLATE" type="button" value="Delete Selected Template" onClick="if(!template_delete_confirm())return false;send_event('DECEASEDPERSONBATCH/DELETE_TEMPLATE');">
      </td>
      </tr>
    </table>
    </td>
