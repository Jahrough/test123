  ...
  <tr>
    ...
    <table width="500" border="0" cellpadding="2" cellspacing="2">
      <tr>
        ...
        <td valign="top" class="unifont1"><b>Deceased Person Batch</b></td>
      </tr>
      <!-- <tr>        
...
<table border="0" width="600">
  ...
  <tr>
    <td valign="bottom" align="right" width="550"><a href="javascript:send_event('DECEASEDPERSONBATCH/<TMPL_IF SHOULD_BATCH_DMF>DMF<TMPL_ELSE>DPPA</TMPL_IF>')"><img src="<TMPL_VAR NAME=IMGPATH>/BATCH/back.gif" width="87" height="29" border="0"></a>&nbsp;&nbsp;&nbsp;<a href="javascript:send_please_wait_event('DECEASEDPERSONBATCH/CONFIRM')"><img src="<TMPL_VAR NAME=IMGPATH>/BATCH/autorder.gif" width="87" height="29" border="0"></a></td>
  </tr>
</table>
