...
<TMPL_ELSE>
    <td valign="bottom" align="right" width="550"><a href="javascript:send_event('<TMPL_UNLESS SHOW_BATCH_UPDATE>BATCH/START_BATCH<TMPL_ELSE>INSTANTIDBATCH/CHOOSE_PROCESS</TMPL_UNLESS>')"><img src="<TMPL_VAR NAME=IMGPATH>/BATCH/back.gif" width="87" height="29" border="0"></a>&nbsp;&nbsp;&nbsp;<a href="javascript:send_please_wait_event('INSTANTIDBATCH/SAVE_FILE_SELECT')" onClick="if(!validate()){return false;}"><img src="<TMPL_VAR NAME=IMGPATH>/BATCH/next.gif" width="87" height="29" border="0"></a></td>
</TMPL_IF>
  </tr>
