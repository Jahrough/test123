...
<INPUT TYPE=HIDDEN NAME=EVENT VALUE="RECOVERSCOREBATCH/SAVE_APPEND_FIELDS">
...
<table border="0" cellpadding="0" cellspacing="0" width="608">
  ...
  <tr>
    ...
    <td width="100%" class="smallfont1" valign="top" align="right"><br><br><a href="javascript:send_event('RECOVERSCOREBATCH/DEFINE_FILE')"><img src="<TMPL_VAR NAME=IMGPATH>/BATCH/back.gif" width="87" height="29" border="0"></a>&nbsp;&nbsp;&nbsp;<a href="javascript:send_event('RECOVERSCOREBATCH/SAVE_APPEND_FIELDS')"><img src="<TMPL_VAR NAME=IMGPATH>/BATCH/next.gif" width="87" height="29" border="0"></a></td>
