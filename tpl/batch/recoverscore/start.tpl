...
<TMPL_INCLUDE NAME="batch_head.tpl">
        ...
        <div align="center">
		  ...
		  Accurint® offers flexible scoring batch processes to help identify and segment accounts.&nbsp; A dedicated Batch Consultant is available to help you customize your requirements from data needs, to input and output delivery methods, so you're assured of a solution best suited to the way you do business.&nbsp; <a href="javascript:show_post_popup('MYACCOUNT/SHOW_BATCH_CONSULTANT_EMAIL','ContactUs',450,500);"><b>Click here</b></a> to contact your Batch Consultant today!</td>
                </tr>
              </table>
              </td>
            </tr>
...
<INPUT TYPE=HIDDEN NAME=EVENT VALUE="RECOVERSCOREBATCH/SAVE_START">
...
<tr>
  ...
  <tr>
    <td valign="bottom" align="right" width="550"><a href="javascript:send_event('RECOVERSCOREBATCH/SAVE_START')" onClick="if(!validate()){return false;}"><img src="<TMPL_VAR NAME=IMGPATH>/BATCH/next.gif" width="87" height="29" border="0"></a></td>
  </tr>
