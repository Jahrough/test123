...
<INPUT TYPE=HIDDEN NAME=EVENT VALUE="BATCH/SAVE_GLB">
...
<table border="0" cellpadding="10" cellspacing="0" width="600">
  <tr>
    <td valign="bottom" align="right" width="550"><a href="javascript:send_event('BATCH/<TMPL_UNLESS SHOW_BATCH_UPDATE>APPEND_FIELDS<TMPL_ELSE>DEFINE_FILE</TMPL_UNLESS>')"><img src="<TMPL_VAR NAME=IMGPATH>/BATCH/back.gif" width="87" height="29" border="0"></a></td>
  </tr>
</table>
