...
<TMPL_INCLUDE NAME="batch_head.tpl">
	...
	<br>
        <div align="center">
		  ...
		  <div align=center><span class="reportselectorinfo"><b>NOTICE:</span>&nbsp; Effective October 16th, this product will no longer be available via the Batch Wizard</b></div>
                  <div>&nbsp;</div>
		  In an effort to streamline processes and deliver the very best information LexisNexis® has to offer, access to this product via the Batch Wizard will be deactivated on October 16th.
		  </TMPL_IF>
		  </TMPL_IF>
		  </TMPL_IF>
...
<INPUT TYPE=HIDDEN NAME=EVENT VALUE="SURECONTACTBATCH/SAVE_START">
...
<table border="0" width="600">
  ...
  <tr>
    <td class="batchbanner" align="center"><br><b>Welcome to the Accurint<small><sup>&reg;</sup></small> SureContact Batch Submission Wizard</b></td>
  </tr>
  ...
  <tr>
    ...
    <INPUT TYPE="HIDDEN" NAME="BATCH_TYPE" VALUE="SURECONTACT">
  <tr>
  ...
  <tr>
    <td valign="bottom" align="right" width="550"><a href="javascript:send_event('SURECONTACTBATCH/SAVE_START')" onClick="if(!validate()){return false;}"><img src="<TMPL_VAR NAME=IMGPATH>/BATCH/next.gif" width="87" height="29" border="0"></a></td>
  </tr>
