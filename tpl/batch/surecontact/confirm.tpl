...
<table border="0" width="600">
  ...
  <tr>
    <td class="batchbanner" align="center"><br><b>Thank you for using Accurint SureContact Batch</b></td>
  </tr>
  <tr>
...
<table border="0" width="600">
  ...
  <TMPL_ELSE>
  <tr>
    <td valign="bottom" align="center"><a href="javascript:window.close()"><img src="<TMPL_VAR NAME=IMGPATH>/BATCH/close.gif" width="87" height="29" border="0"></a>&nbsp;&nbsp;&nbsp;<a href="javascript:printit()"><img src="<TMPL_VAR NAME=IMGPATH>/BATCH/print.gif" width="87" height="29" border="0"></a>&nbsp;&nbsp;&nbsp;<a href="javascript:send_event('SURECONTACTBATCH/START_BATCH');"><img src="<TMPL_VAR NAME=IMGPATH>/BATCH/run_another_batch.gif" width="87" height="29" border="0"></a></td>
  </tr>
  </TMPL_IF>
</table>
