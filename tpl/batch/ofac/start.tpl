...
<INPUT TYPE=HIDDEN NAME=EVENT VALUE="OFACBATCH/SAVE_START">
...
<table border="0" width="600">
  ...
  <tr>
    <td class="batchbanner" align="center"><br><b>Welcome to the Accurint<small><sup>&reg;</sup></small> USA PATRIOT Act Batch Submission Wizard</b></td>
  </tr>
  ...
  <tr>
    ...
    <INPUT TYPE="HIDDEN" NAME="BATCH_TYPE" VALUE="OFAC">
  <tr>
  ...
  <tr>
    <td valign="bottom" align="right" width="550"><a href="javascript:send_event('OFACBATCH/SAVE_START')" onClick="if(!validate()){return false;}"><img src="<TMPL_VAR NAME=IMGPATH>/BATCH/next.gif" width="87" height="29" border="0"></a></td>
  </tr>
