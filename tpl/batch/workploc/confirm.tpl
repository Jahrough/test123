...
<TMPL_UNLESS FTP>
      <tr>
        <td valign="top" class="unifont1" nowrap="nowrap">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;File to Process:</td>
        <td valign="top" class="unifont1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b><TMPL_VAR FILE_NAME><br/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;(<TMPL_VAR FILE_TYPE>)</b></td>
      </tr>
</TMPL_UNLESS>
      <tr>
        <td valign="top" class="unifont1" nowrap="nowrap">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Output Format:</td>
...
<TMPL_UNLESS FTP>
      <tr>
        <td valign="top" class="unifont1" nowrap="nowrap">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Approx. # of Records in File:</td>
        <td valign="top" class="unifont1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b><TMPL_VAR NUM_RECS></b></td>
      </tr>
      <tr>
        <td valign="top" class="unifont1" nowrap="nowrap">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Results will be sent to:</td>
...
<table border="0" width="600">
  <tr>
    <td><img src="<TMPL_VAR IMGPATH>/spacer.gif" width="1" height="30" border="0"></td>
  </tr>
<TMPL_IF IS_BUS_BATCH>
  <tr>
    <td valign="bottom" align="center"><a href="javascript:window.close()"><img src="<TMPL_VAR IMGPATH>/BATCH/close.gif" width="87" height="29" border="0"></a>&nbsp;&nbsp;&nbsp;<a href="javascript:printit()"><img src="<TMPL_VAR IMGPATH>/BATCH/print.gif" width="87" height="29" border="0"></a>&nbsp;&nbsp;&nbsp;<a href="javascript:send_event('BATCH/BUS_START_BATCH');"><img src="<TMPL_VAR IMGPATH>/BATCH/run_another_batch.gif" width="87" height="29" border="0"></a></td>
  </tr>
<TMPL_ELSE>
  <tr>
    <td valign="bottom" align="center"><a href="javascript:window.close()"><img src="<TMPL_VAR IMGPATH>/BATCH/close.gif" width="87" height="29" border="0"></a>&nbsp;&nbsp;&nbsp;<a href="javascript:printit()"><img src="<TMPL_VAR IMGPATH>/BATCH/print.gif" width="87" height="29" border="0"></a>&nbsp;&nbsp;&nbsp;<a href="javascript:send_event('<TMPL_UNLESS SHOW_BATCH_UPDATE>WPL/START_BATCH<TMPL_ELSE>BATCH/SERVICES</TMPL_UNLESS>');"><img src="<TMPL_VAR IMGPATH>/BATCH/run_another_batch.gif" width="87" height="29" border="0"></a></td>
  </tr>
</TMPL_IF>
</table>
