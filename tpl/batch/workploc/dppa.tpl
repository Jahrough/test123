...
<INPUT TYPE=HIDDEN NAME=EVENT VALUE="WPL/SAVE_DPPA">
<INPUT TYPE=HIDDEN NAME=DPPA VALUE="">

<script src="<TMPL_VAR 'JSPATH'>/dppa_info.js"></script>
...
<table border="0" cellpadding="10" cellspacing="0" width="600">
  <tr>
    <td valign="bottom" align="right" width="550"><a href="javascript:send_event('WPL/GLB')"><img src="<TMPL_VAR IMGPATH>/BATCH/back.gif" width="87" height="29" border="0"></a></td>
  </tr>
</table>
