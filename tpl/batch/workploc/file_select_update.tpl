<!-- BEGIN workploc/file_select_update.tpl -->
<TMPL_INCLUDE batch_head.tpl>

<input type="hidden" name="EVENT" value="WPL/SAVE_FILE"/>
...
<table border="0" width="600">
  <tr>
    ...
    <td class="nsinputs"><input type="file" name="BATCH_FILE" size="50" value="<TMPL_VAR BATCH_FILE>"></td>
  </tr>
  <TMPL_IF SHOW_BATCH_UPDATE>
  <TMPL_UNLESS IRS>
  <tr>
...
<table border="0" width="600">
  ...
  <tr>
    <td><img src="<TMPL_VAR IMGPATH>/spacer.gif" width="1" height="35" border="0"/></td>
  </tr>

  <tr>
<TMPL_IF IS_BUS_BATCH>
    <td valign="bottom" align="right" width="550"><a href="javascript:send_event('BATCH/BUS_START_BATCH')"><img src="<TMPL_VAR IMGPATH>/BATCH/back.gif" width="87" height="29" border="0"/></a>&nbsp;&nbsp;&nbsp;<a href="javascript:send_please_wait_event('WPL/SAVE_FILE')" onClick="if(!validate()){return false;}"><img src="<TMPL_VAR IMGPATH>/BATCH/next.gif" width="87" height="29" border="0"/></a></td>
<TMPL_ELSE>
    <td valign="bottom" align="right" width="550"><a href="javascript:send_event('WPL/START_BATCH')"><img src="<TMPL_VAR IMGPATH>/BATCH/back.gif" width="87" height="29" border="0"/></a>&nbsp;&nbsp;&nbsp;<a href="javascript:send_please_wait_event('WPL/SAVE_FILE')" onClick="if(!validate()){return false;}"><img src="<TMPL_VAR IMGPATH>/BATCH/next.gif" width="87" height="29" border="0"/></a></td>
</TMPL_IF>
  </tr>
...
<!-- END workploc/file_select_update.tpl -->
