<!-- BEGIN define_fixed_file_body_update.tpl -->
  ...
  <tr>
    <td><img src="<TMPL_VAR IMGPATH>/spacer.gif" width="1" height="10" border="0"></td>
  </tr>
  ...
  <tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0">
      ...
      <td align="left">
       ...
       <select name="TEMPLATE_DROP_BOX" onChange="if(!template_select_confirm(this.selectedIndex)) return false;send_event('WPL/LOAD_TEMPLATE');"">
       <option value="0">Select Template from list... </option>
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;<input name="BATCH_DELETE_TEMPLATE" type="button" value="Delete Selected Template" onClick="if(!template_delete_confirm())return false;send_event('WPL/DELETE_TEMPLATE');">
      </td>
      </tr>
    </table>
    </td>
  ...
  <tr>
	...
	<option value="dob"<TMPL_IF DOB_C> SELECTED</TMPL_IF>>DOB</option>
        ...
        <!--
        <td class="unifont1" class="nsinputs" align="center" valign="center" nowrap="nowrap">&nbsp;&nbsp;&nbsp;Length:&nbsp;<SELECT NAME="FIELD_SIZE_<TMPL_VAR FIELD_NUM>">
		<TMPL_LOOP SIZES>
        ...
        <td class="unifont1" class="nsinputs" align="center" valign="center" nowrap="nowrap">&nbsp;&nbsp;&nbsp;Start:&nbsp;<SELECT NAME="FIELD_START_SIZE_<TMPL_VAR FIELD_NUM>" onChange="set_fixed_width_column_highlight()" >
        ...
        <td class="unifont1" class="nsinputs" align="center" valign="center" nowrap="nowrap">&nbsp;&nbsp;&nbsp;End:&nbsp;<SELECT NAME="FIELD_END_SIZE_<TMPL_VAR FIELD_NUM>" onChange="set_fixed_width_column_highlight()">
		<TMPL_LOOP END_SIZES>
		  <OPTION VALUE="<TMPL_VAR SIZE>"<TMPL_IF NAME=SELECTED> SELECTED</TMPL_IF>><TMPL_VAR SIZE></OPTION>
		</TMPL_LOOP>
		</SELECT>
        ...
        <INPUT TYPE=HIDDEN NAME="FIELD_SIZE_<TMPL_VAR FIELD_NUM>">
	...
	<td class="unifont1" valign="top" align="left">&nbsp;&nbsp;&nbsp;<input
        ...
        NAME=FIELD_NUM>)">&nbsp;&nbsp;&nbsp;</td>
	<td class="unifont1" valign="top" align="left"><input
        name="BATCH_REMOVE_FIELD" type="button" value="Remove" onClick="if(!validate()) return false;set_fixed_width_field_num(<TMPL_VAR FIELD_NUM>);send_event('WPL/DELETE_FIELD');"></td>
      </tr>
    </TMPL_LOOP>
    </table>
    </td>
...
<INPUT TYPE=HIDDEN NAME="ROW_LENGTH" VALUE="<TMPL_VAR ROW_LENGTH>">
  ...
  <tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0">
      <tr>
        <TMPL_UNLESS SHOW_BATCH_UPDATE>
        <td class="unifont1" valign="middle" align="center"><a href="javascript:send_event('BATCH<TMPL_IF EDIT_FTP>FTP</TMPL_IF>/ADD_FIELD_FIRST')"><img src="<TMPL_VAR IMGPATH>/add_first.gif" width="80" height="20" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
	<td class="unifont1" valign="middle" align="center"><a href="javascript:send_event('BATCH<TMPL_IF EDIT_FTP>FTP</TMPL_IF>/ADD_FIELD_AFTER')"><img src="<TMPL_VAR IMGPATH>/add_after.gif" width="80" height="20" border="0"></a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
	<td class="unifont1" valign="middle" align="center"><a href="javascript:send_event('BATCH<TMPL_IF EDIT_FTP>FTP</TMPL_IF>/DELETE_FIELD')"><img src="<TMPL_VAR IMGPATH>/delete_field.gif" width="80" height="20" border="0"></a></td>
        <TMPL_ELSE>
	<td class="unifont1" valign="top" align="left"><input name="BATCH_ADD_FIELD_AFTER" type="button" value="Add New Field" onClick="if(!validate()) return false;set_fixed_width_field_num(<TMPL_VAR FIELD_COUNT>);send_event('WPL/ADD_FIELD_AFTER');"><i>&nbsp;&nbsp;Use <b>Add New Field</b> until your file is completely mapped. Unmapped fields will be ignored.</i></td>
        </TMPL_UNLESS>
      </tr>
    </table>
    </td>
  ...
  <tr>
    <td><img src="<TMPL_VAR IMGPATH>/spacer.gif" width="1" height="5" border="0"></td>
  </tr>
  <tr>
