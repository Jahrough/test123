...
<table border="0" width="600">
  ...
  <tr>
    <td align="center" class="batchbanner"><br><b>Batch Confirmation</b></td>
  </tr>
...
<TMPL_IF FREE_TRIAL_CREDITS>
  ...
  <tr>
    <td class="unifont2"><br><b>Please verify the following information shown below are the options you have chosen for your batch process including the batch type and options selected:</b><br><br></td>
  </tr>
</table>
  ...
  <tr>
    ...
    <table width="500" border="0" cellpadding="2" cellspacing="2">
      <tr>
        ...
        <td valign="top" class="unifont1"><b>People Batching</b></td>
      </tr>
      <tr>        
...
None of the uses apply
      ...
      <tr>
        ...
        <td valign="top" class="unifont1" nowrap="nowrap"><b><TMPL_VAR DPPA> </b>
      </tr>
      <tr>
...
<table border="0" width="600">
  ...
  <tr>
    <td valign="bottom" align="right" width="550"><a href="javascript:send_event('BATCH/<TMPL_IF SHOULD_BATCH_DMF>DMF<TMPL_ELSE>DPPA</TMPL_IF>')"><img src="<TMPL_VAR NAME=IMGPATH>/BATCH/back.gif" width="87" height="29" border="0"></a>&nbsp;&nbsp;&nbsp;<a href="javascript:send_please_wait_event('BATCH/CONFIRM')"><img src="<TMPL_VAR NAME=IMGPATH>/BATCH/autorder.gif" width="87" height="29" border="0"></a></td>
  </tr>
</table>
