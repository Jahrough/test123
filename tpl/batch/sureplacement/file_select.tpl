...
<INPUT TYPE=HIDDEN NAME=EVENT VALUE="SUREPLACEMENTBATCH/SAVE_FILE">
...
<table border="0" width="600">
  ...
  <tr>
    <td valign="bottom" align="right" width="550"><a href="javascript:send_event('SUREPLACEMENTBATCH/START_BATCH')"><img src="<TMPL_VAR NAME=IMGPATH>/BATCH/back.gif" width="87" height="29" border="0"></a>&nbsp;&nbsp;&nbsp;<a href="javascript:send_please_wait_event('SUREPLACEMENTBATCH/SAVE_FILE')" onClick="if(!validate()){return false;}"><img src="<TMPL_VAR NAME=IMGPATH>/BATCH/next.gif" width="87" height="29" border="0"></a></td>
  </tr>
