...
<br>
  ...
  <td>
    <table border="0" cellpadding="3" cellspacing="0" width="100%">
	<tr valign=middle>
	    <td border=0 cellspacing=0 cellpadding=0 class="batchpricingheader" align="center" width="100%">
		<b>Recover Score</b>
	    </td>
	</tr>
    </table>
