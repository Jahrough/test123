...
<table border="0" cellpadding="10" cellspacing="0" width="600">
  <tr>
    <td class="unifont1" width="600" align="left">The information that this service provides to the end user contains consumer identification information governed by the Gramm-Leach-Bliley Act (GLB).<br><br><b>In accordance with GLB, please <TMPL_IF NAME=RECOVERSCORE>confirm your GLB<TMPL_ELSE>select the</TMPL_IF> purpose for which you intend to utilize this service:</b></td>
  </tr>
  <tr>
