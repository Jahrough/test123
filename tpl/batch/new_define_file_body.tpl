<!-- BEGIN new_define_file_body.tpl -->
	<tr>
...
<INPUT TYPE=HIDDEN NAME="PHONE_INDEX" VALUE=10>
<TMPL_ELSE>
<INPUT TYPE=HIDDEN NAME="STATE_INDEX" VALUE="<TMPL_VAR STATE_INDEX>">
<INPUT TYPE=HIDDEN NAME="ZIP_INDEX" VALUE="<TMPL_VAR ZIP_INDEX>">
<INPUT TYPE=HIDDEN NAME="SSN_INDEX" VALUE="<TMPL_VAR SSN_INDEX>">
<INPUT TYPE=HIDDEN NAME="PHONE_INDEX" VALUE="<TMPL_VAR PHONE_INDEX>">
</TMPL_IF>
</TMPL_IF>
