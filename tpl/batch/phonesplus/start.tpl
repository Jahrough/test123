...
<table border="0" width="600">
  ...
  <tr>
    <td valign="bottom" align="right" width="550"><a href="javascript:send_event('PHONESPLUSBATCH/SAVE_START')" onClick="if(!validate()){return false;}"><img src="<TMPL_VAR NAME=IMGPATH>/BATCH/next.gif" width="87" height="29" border="0"></a></td>
  </tr>
