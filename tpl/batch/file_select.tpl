...
<table border="0" width="600">
  ...
  <TMPL_ELSE>
  <tr>
    <td colspan="2" align="center" class="smallfont1">File Type: <input type=RADIO name="FILE_TYPE" value="1"<TMPL_IF CHECKED_COMMA> CHECKED</TMPL_IF>> <b>Comma Delimited</b>&nbsp;
