...
<table border="0" width="600">
  <tr>
	...
	<TMPL_IF SHOW_AHAS_BATCH>
	  <TMPL_IF GCOL>
	    <td align="right"><a href="javascript:general_win('<TMPL_VAR NAME=HTMLPATH>/gcol/enhanced_phones_batch_popup.html','EnhancedBatch',425,300,0,0,0,1,1,0);void(0);"><img src="<TMPL_VAR NAME=IMGPATH>/main/enhanced_phones_batch_banner2.gif" width="280" height="50" border="0"></a></td>
	  <TMPL_ELSE>
	    <td align="right"><a href="javascript:general_win('<TMPL_VAR NAME=HTMLPATH>/col/enhanced_phones_batch_popup.html','EnhancedBatch',425,350,0,0,0,1,1,0);void(0);"><img src="<TMPL_VAR NAME=IMGPATH>/main/enhanced_phones_batch_banner1.gif" width="280" height="50" border="0"></a></td>
	  </TMPL_IF>
	</TMPL_IF>
    ...
    <script>document.getElementById('batchimg').src=ban['img'];</script>
...
<TMPL_IF SHOW_PHONES_BATCH>
          <tr>
            ...
            <TMPL_ELSE>
            <td nowrap valign="top" align="left" class="smallfont1grey"><TMPL_UNLESS DISABLE_BATCH><a class="mainmenu" href="javascript:show_post_popup('PHONEBATCH/START_BATCH','BatchWin',800,650,0,0,0,1,1,0,'<TMPL_VAR NAME=ACTION_BATCH>');" onClick="">Waterfall Phones and Address</a><TMPL_ELSE>Waterfall Phones and Address</TMPL_UNLESS></td>
          </tr>
          </TMPL_IF>
          </tr>
</TMPL_IF>
<TMPL_UNLESS DELETE_CONTACT_PLUS>
  <TMPL_IF SHOW_CONTACT_PLUS_BATCH>
            <tr>
              <td width="4" valign="top" align="right" class="smallfont1">&#149;</td>            
              <td nowrap valign="top" align="left" class="smallfont1grey">
                <TMPL_UNLESS DISABLE_BATCH>
                  ...
                  <TMPL_ELSE>
                    <a class="mainmenu" href="javascript:show_post_popup('CONTACTPLUSPHONEADDRESSBATCH/START_BATCH','BatchWin',800,650,0,0,0,1,1,0,'<TMPL_VAR NAME=ACTION_BATCH>');" title="Contact Plus Phones and Address">Contact Plus Phones and Address</a><strong><font color="#ed1c24">&nbsp;NEW!</font></strong>
                  </TMPL_IF>
                <TMPL_ELSE>  
                  Contact Plus Phones and Address<strong><font color="#ed1c24">&nbsp;NEW!</font></strong>
                </TMPL_UNLESS>
