...
<INPUT TYPE=HIDDEN NAME=EVENT VALUE="BATCHFTP/SAVE_DPPA">
...
<TMPL_IF surecontactbatch>
    <TMPL_INCLUDE NAME="../surecontact/dppa_body.tpl">
<TMPL_ELSE>
<TMPL_IF sureplacementbatch>
    <TMPL_INCLUDE NAME="../sureplacement/dppa_body.tpl">
<TMPL_ELSE>
<TMPL_IF recoverscorebatch>
    <TMPL_INCLUDE NAME="../recoverscore/dppa_body.tpl">
<TMPL_ELSE>
	<TMPL_INCLUDE NAME="../dppa_body.tpl">
</TMPL_IF>
</TMPL_IF>
...
<table border="0" cellpadding="10" cellspacing="0" width="600">
  <tr>
    <td valign="bottom" align="right" width="550"><a href="javascript:send_event('BATCHFTP/GLB')"><img src="<TMPL_VAR NAME=IMGPATH>/BATCH/back.gif" width="87" height="29" border="0"></a></td>
  </tr>
</table>
