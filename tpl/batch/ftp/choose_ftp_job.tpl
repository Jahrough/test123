...
<table border="0" width="600">
  ...
  <tr>
    <td class="batchbanner" align="center"><br><b>Create FTP Job</b></td>
  </tr>
  ...
  <tr>
    <td align="center" class="unifont2"><br><b>Enter Online Job ID:</b>&nbsp;&nbsp;<input type=text name="FTP_JOBID" value="<TMPL_VAR FTP_JOBID>">&nbsp;&nbsp;<TMPL_INCLUDE NAME="ftp_job_url.tpl"></td>
  </tr>
  ...
  <tr>
    <td valign="bottom" align="right" width="550"><a href="javascript:send_event('BATCH/START_BATCH')"><img src="<TMPL_VAR NAME=IMGPATH>/BATCH/back.gif" width="87" height="29" border="0"></a>&nbsp;&nbsp;&nbsp;<a href="javascript:send_event('BATCHFTP/SAVE_FTP_JOB_ID')" onClick="if(!validate()){return false;}"><img src="<TMPL_VAR NAME=IMGPATH>/BATCH/next.gif" width="87" height="29" border="0"></a></td>
  </tr>
