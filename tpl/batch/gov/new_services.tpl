...
<TMPL_IF SHOW_AHAS_BATCH>
    ...
    <tr>
        <td class="unifont1" colspan="2">Batch Services help you locate subjects, increase contact rates, and speed workflow by using one of the industry's largest and most current contact and locate databases.</td>
    </tr>
    <tr>
          ...
          <tr>
            ...
            <td valign="top" align="left" class="smallfont1grey" nowrap="nowrap">
               <TMPL_UNLESS DISABLE_BATCH>
                  ...
                  <TMPL_ELSE>
                     <a class="mainmenu" href="javascript:show_post_popup('BATCH/START_BATCH','BatchWin',800,650,0,0,0,1,1,0,'<TMPL_VAR NAME=ACTION_BATCH>');">People Batching (including Address and Phone searches)</a>
                  </TMPL_IF>
               <TMPL_ELSE>People Batching  (including Address and Phone Searches)
               </TMPL_UNLESS>
            </td>
          </tr>
   ...
   <TMPL_ELSE>          
      <TMPL_UNLESS HIDE_DISABLED>
          <tr>
            ...
            <td valign="top" align="left" class="smallfont1grey" nowrap="nowrap">
            <font color="#000000">
People Batch (including Address and Phone searches)
            </td>
          </tr>
      </TMPL_UNLESS>
   </TMPL_UNLESS>
   ...
   <TMPL_ELSE>          
      <TMPL_UNLESS HIDE_DISABLED>
          <tr>
            ...
            <td valign="top" align="left" class="smallfont1grey" nowrap="nowrap">
            <font color="#000000">
Waterfall Phones and Addresses
            </td>
          </tr>
      </TMPL_UNLESS>
   ...
   <TMPL_ELSE>          
      <TMPL_UNLESS HIDE_DISABLED>
          <tr>
            <td width="4" valign="top" align="right" class="smallfont1">&#149;</td>
            <td valign="top" align="left" class="smallfont1grey" nowrap="nowrap">
            <font color="#000000">Real-Time Phones Batch
            </td>
          </tr>
      </TMPL_UNLESS>
   </TMPL_UNLESS>
   ...
   <TMPL_ELSE>          
      <TMPL_UNLESS HIDE_DISABLED>
          <tr>
            ...
            <td valign="top" align="left" class="smallfont1grey" nowrap="nowrap">
            <font color="#000000">
Real-Time Motor Vehicle Registration Batch
            </td>
          </tr>
      </TMPL_UNLESS>
   ...
   <TMPL_ELSE>          
      <TMPL_UNLESS HIDE_DISABLED>
          <tr>
            ...
            <td valign="top" align="left" class="smallfont1grey" nowrap="nowrap">
            <font color="#000000">
InstantId Batch (Consumers or Businesses)
            </td>
          </tr>
      </TMPL_UNLESS>
