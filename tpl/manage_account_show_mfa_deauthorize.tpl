...
<table border="0" cellpadding="0" cellspacing="0" class="myaccountborder" width="880">
  <tr>
    ...
    <table cellpadding="0" cellspacing="0" width="856" class="myaccountbody">
      <tr>
        <td align="center" class="myaccounttitle"><br>De-Authorize User Device</td>
      </tr>
      ...
      <tr>
        <td align="center">
          <table border=0 cellpadding="2" cellspacing="0" class="myaccountbody">
            <tr><td>&nbsp;</td></tr>
            <tr>
              <td class="unifont1" align="center"><b>De-Authorize all currently authorized devices for user:</b></td>
            </tr>
            <tr><td>&nbsp;</td></tr>
              <td>
          ...
          <table border=0 cellpadding="2" cellspacing="0">
            <tr>
              ...
              <td align="left"><input name="BUTTON" class="myaccount-btn red-btn" type="button" value="De-Authorize" onClick="send_event('OTP/SEND_MFA_DEAUTHORIZE'); disable_buttons('BUTTON');"></td>
            </tr>
            <tr><td>&nbsp;</td></tr>
            </tr>
          </table>
