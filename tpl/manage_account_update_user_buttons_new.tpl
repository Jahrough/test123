<!-- begin: manage_account_update_user_buttons_new.tpl -->
<table border="0" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td ><a href="javascript:send_event('MANAGE/UPDATE_USER_NOW');" onClick="if(validate(<TMPL_VAR NAME=MIN_PASSWORD_LENGTH><TMPL_IF SHA2_PASSWORD>,1<TMPL_ELSE><TMPL_IF PW_COMPLEXITY_FOUR>,2<TMPL_ELSE>,0</TMPL_IF></TMPL_IF>)) { if('<TMPL_VAR NAME="PENDING_ADMINS">' == '1' && (document.forms[0].ORIG_SYSTEMADMINISTRATOR && document.forms[0].ORIG_SYSTEMADMINISTRATOR.value =='0' )) { return confirm_new_admin()} else {return confirm_unsuspend_user()}} else {return false;}"><img width="81" height="24" border="0" name="updateuser" src="<TMPL_VAR NAME=IMGPATH>/updateuser.gif"></a></td>
    <td class="unifont1">&nbsp;</td>
    ...
    <TMPL_UNLESS IRS>
    <td class="unifont1">&nbsp;</td>
    <td><a href="javascript:send_event('MANAGE/COPY_USER');"><img width="81" height="24" border="0" name="copyuser" src="<TMPL_VAR NAME=IMGPATH>/copyuser.gif"></a></td>
    </TMPL_UNLESS>
    <TMPL_UNLESS CSAML_LOGIN>
      <TMPL_IF NAME="MFA_MACHINE_ACTIVATE_ENABLED">
      <TMPL_UNLESS NAME="MFA_COMPANY_IP_RESTRICT_NOROAM">
        <td class="unifont1">&nbsp;</td>
        <td><a href="javascript:send_event('OTP/MANAGE_OTP_USER');"><img width="130" height="24" border="0" name="otpuser" src="<TMPL_VAR NAME=IMGPATH>/manage_security_tokens.gif"></a></td>
      </TMPL_UNLESS>
      <TMPL_ELSE>
...
<!-- end: manage_account_update_user_buttons_new.tpl -->
