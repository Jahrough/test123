		...
		<tr><td align=left><table>
		 <tr>
		    <td class="unifont1" width=100>
		     ...
		     <input name="BUTTON" class="rb_otp_small" type="button" value="Next" onMouseDown="flip_style(this,'rbd_otp_small');" onClick="checkp(); " onMouseOut="flip_style(this,'rb_otp_small');">
		    </td>
		 </tr>
		</table></td>
		</tr>
