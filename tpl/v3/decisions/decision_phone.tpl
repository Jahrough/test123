...
<TMPL_UNLESS DO_NOT_DISPLAY_PHONE_IDENTIFIER_SEARCH>
    <TMPL_UNLESS DISABLE_PHONE_IDENTIFIER_SEARCH>
        ...
        <TMPL_ELSE>
            <TMPL_IF TCOL>
                <li><a href="javascript:setevent('SEARCH2/SEARCH_PHONE_IDENTIFIER');submitevent();window.close();">Reverse Phone Search Plus</a></li>
            <TMPL_ELSE>
            <TMPL_IF XBPS>
                <li><a href="javascript:setevent('SEARCH2/SEARCH_PHONE_IDENTIFIER');submitevent();window.close();">Reverse Phone Search Plus</a></li>
            <TMPL_ELSE>
...
<TMPL_UNLESS IRS>
    <TMPL_UNLESS DISABLE_DA_WIRELESS>
        <TMPL_UNLESS DIRASSTWIRELESS_CAP_MET>
            <li><a href="javascript:setevent('SEARCH/SEARCH_DA_WIRELESS');submitevent();window.close();">Phones Plus</a></li>
        </TMPL_UNLESS>
    </TMPL_UNLESS>
</TMPL_UNLESS>

<TMPL_IF SHOW_PHONE_HISTORY_REPORT>
    <li><a href="javascript:build_dw_report('<TMPL_VAR NAME=ACTION_REPORT>',1);window.close();">Phone History Report</a></li>
</TMPL_IF>
