    ...
    <td valign="top" id="searchPop" nowrap="nowrap">
     ...
     <div style="margin-left: 20px;"><strong>NON-FCRA Searches</strong></div>
      ...
      <TMPL_UNLESS MVSEARCH_CAP_MET>
        <li><a href="javascript:setevent('SEARCH2/SEARCH_COMBINED_MVR_MV');submitevent();window.close();">Advanced Motor Vehicles</span></a></li>
      </TMPL_UNLESS>
      </TMPL_UNLESS>
      </TMPL_UNLESS>
      ...
      <TMPL_UNLESS DO_NOT_DISPLAY_RT_MVR>
