<!-- END v3/decisions/decision_aircraft.tpl -->
    ...
    <td valign="top" id="searchPop">
      <ul>
        <TMPL_UNLESS DISABLE_AIRCRAFT>
          <li><a title="Search FAA Aircraft" href="javascript:setevent('SEARCH/SEARCH_AIRCRAFT');submitevent();window.close();">FAA AIRCRAFT</span></a></li>
        </TMPL_UNLESS>
