          ...
          <TMPL_UNLESS DISABLE_TRIMERGE_REPORT>
            <li id="fcralinks">
                <TMPL_IF SHOW_TRIMERGE_REPORTS_ESP>
                   <a id="trimergeIcon" href="javascript:show_post_popup('SEARCH/SHOW_TRIMERGE_ESP','TrimergeESPShow',800,800,0,0,0,1,1,0);">Tri-Merge Credit Report</a>
                <TMPL_ELSE>
                   <TMPL_IF OFFLINE_TRIMERGE_REPORT>Tri-Merge Credit Report<TMPL_ELSE><a id="trimergeIcon" href="javascript:show_post_popup('TM/SHOW','TrimergeReport',800,722,0,0,0,1,1,0,'<TMPL_VAR ACTION_REPORT>');">Tri-Merge Credit Report</a></TMPL_IF>
                </TMPL_IF>
            </li>
          </TMPL_UNLESS>
        </TMPL_UNLESS>
    ...
    <div id="peoplelinks">
        <ul>
           ...
           <TMPL_IF ALLOW_EQUIFAX_CREDIT_REPORT>
              <li id="<TMPL_VAR NAME=IDX_EQUIFAX_CREDIT_REPORT>"><TMPL_IF DISABLE_EQUIFAX_CREDIT_REPORT>Equifax Credit Reports<TMPL_ELSE><a href="javascript:show_post_popup('SEARCH/SHOW_EQUIFAX_CREDIT_FCRA','EquifaxWin','900','580',1,1,1,1,1,0);">Equifax Credit Reports</a></TMPL_IF></li>
           </TMPL_IF>
            ...
            <li id="<TMPL_VAR NAME=IDX_LOCATION_REPORT>"<TMPL_IF NAME="LOCATION_REPORT_SEARCH"> class="active"</TMPL_IF>>
              <TMPL_UNLESS DELETE_LOCATION_REPORT>
                <TMPL_UNLESS DISABLE_LOCATION_REPORT>
                  <a href="javascript:pm_tab_v3('SEARCH2/SHOW_LOCATION_REPORT');">Government Location Report</a>
                <TMPL_ELSE>
        ...
        <TMPL_IF SHOW_BIZ_ANALYTICS>
          <TMPL_UNLESS HIDE_BIZ_ANALYTICS_USER>
             <li id="busanalytics" <TMPL_IF ACTIVE> class="active"</TMPL_IF>>
               <a id="myaccAnalysisIcon_sprite" href="javascript:show_post_popup('SEARCH/SHOW_BIZ_ANALYTICS','BusAnalyticsWin',850,650,1,1,1,1,1,0);">Business Integrity Solution</a>
             </li>
          </TMPL_UNLESS>
        </TMPL_IF>
      </ul>
