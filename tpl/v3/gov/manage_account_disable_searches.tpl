<!-- BEGIN v3 gov/manage_account_disable_searches.tpl -->
      ...
      <span class="unifont1bold"><legend>People</legend></span>
        ...
        <TMPL_UNLESS HIDE_RT_PERSON>
          ...
          <TMPL_ELSE>
              ...
              <TMPL_ELSE>
                  <TR>
                    <td width="75%" nowrap class="unifont1" align="left">&nbsp;Government Location Report:</TD>
                    <td width="25%" align="left">
                      <table border="0" cellpadding="0" cellspacing="0">
                        <tr>
     ...
     <fieldset>
      ...
      <TMPL_IF COMPANY_DISABLE_D_AND_B>
        ...
        <TMPL_UNLESS HIDE_BUS_INSTANTID>
          ...
          <TMPL_UNLESS DO_NOT_DISPLAY_SEC>
          <TMPL_UNLESS RESTRICT_LNLP_CONTENT>
          ...
          <TMPL_UNLESS DO_NOT_DISPLAY_OSHA>
          ...
          <TMPL_UNLESS DO_NOT_DISPLAY_DBGLOBAL>
          <TMPL_UNLESS RESTRICT_LNLP_CONTENT>
     ...
     <fieldset>
      <span class="unifont1bold"><legend>Health Care</legend></span>
          ...
          <INPUT TYPE=HIDDEN NAME="DISABLE_DISCLOSED_ENTITY_REPORT" VALUE="<TMPL_IF DISABLE_DISCLOSED_ENTITY_REPORT>1<TMPL_ELSE>0</TMPL_IF>">
          <TMPL_ELSE>
          <TR>
...
<!-- manage users only -->
    ...
    <TMPL_IF NAME="INS">
     ...
     <fieldset>
      <span class="unifont1bold"><legend>Record Retrieval</legend></span>
           <TMPL_UNLESS DO_NOT_DISPLAY_EMSI>
           <table border="0" cellpadding="0" cellspacing="0" width="95%">
              <TR>
    ...
    <TMPL_IF NAME="INS">
     <fieldset>
      <span class="unifont1bold"><legend>Health Care</legend></span>
          ...
          <TMPL_IF COMPANY_DISABLE_MEDICAL_LICENSE>
          <INPUT TYPE=HIDDEN NAME="DISABLE_MEDICAL_LICENSE" VALUE="<TMPL_IF DISABLE_MEDICAL_LICENSE>1<TMPL_ELSE>0</TMPL_IF>">
          <TMPL_ELSE>
          <TR>
          <td width="75%" nowrap class="unifont1" align="left">&nbsp;National Directory of Medical Licenses:&nbsp;&nbsp;</TD>
          <td width="25%" align="left">
          <table border="0" cellpadding="0" cellspacing="0">
          <tr>
          <td><INPUT TYPE=RADIO NAME="DISABLE_MEDICAL_LICENSE" VALUE='0' <TMPL_UNLESS NAME=DISABLE_MEDICAL_LICENSE>CHECKED</TMPL_UNLESS>></td>
          <td class="unifont1">Yes&nbsp;&nbsp;&nbsp;</td>
          <td><INPUT TYPE=RADIO NAME="DISABLE_MEDICAL_LICENSE" VALUE='1' <TMPL_IF NAME=DISABLE_MEDICAL_LICENSE>CHECKED</TMPL_IF>></td>
          <td class="unifont1">No</td>
          </tr>
          </table>
          </td>
  ...
  <TMPL_IF ENABLE_SSN_ONLY_PERSON_SEARCH>
        ...
        <TMPL_IF EQUIFAX_CREDIT_REPORT_SECTION_HIDE_RADIO_BUTTONS>
              <TR>
                ...
                <td width="25%" nowrap class="unifont1" align="left" style="padding-left:52px">&nbsp;<TMPL_VAR NAME=EQUIFAX_CREDIT_REPORT_STATUS></td>
              </TR>
        <TMPL_ELSE>
  ...
  <TMPL_IF SHOW_HIDE_RECENT_SEARCHES>
      <TMPL_IF COMPANY_DISABLE_HIDE_RECENT_SEARCHES>
          <input type="hidden" name="DISABLE_HIDE_RECENT_SEARCHES" value="<TMPL_IF DISABLE_HIDE_RECENT_SEARCHES>1<TMPL_ELSE>0</TMPL_IF>"/>
      <TMPL_ELSE>
          <tr>
            <td width="75%" nowrap="nowrap" class="unifont1" align="left">&nbsp;Hide Recent Searches:&nbsp;&nbsp;</td>
            <td width="25%" align="left">
            <table border="0" cellpadding="0" cellspacing="0">
              <tr>
          <td><input type="radio" name="DISABLE_HIDE_RECENT_SEARCHES" value="1" <TMPL_IF NAME=DISABLE_HIDE_RECENT_SEARCHES>checked="checked" </TMPL_IF>/></td>
          <td class="unifont1">Yes&nbsp;&nbsp;&nbsp;</td>
          <td><input type="radio" name="DISABLE_HIDE_RECENT_SEARCHES" value="0" <TMPL_UNLESS NAME=DISABLE_HIDE_RECENT_SEARCHES>checked="checked" </TMPL_UNLESS>/></td>
          <td class="unifont1">No</td>
              </tr>
            </table>
            </td>
...
<!-- END gov/manage_account_disable_searches.tpl -->
