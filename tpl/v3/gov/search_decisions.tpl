...
<div id="search_decisions" style="display:none;">
  ...
  <TMPL_IF SHOW_RT_PHONE>
    ...
    <TMPL_UNLESS DISABLE_WHOIS>
        <li id="IDX_999">
            <a title="Go to Website" href="javascript:general_win('http://www.google.com','GotoWindow','','',1,1,1,1,1,1);void(0);">Go to Website</a>
        </li>
    </TMPL_UNLESS>  
</ul>
</div>
...
<div id="sample_reports" style="display:none;">
    <div class="researchDisplay showMore">
        <a href="javascript:void(0);" title="Sample Reports" onclick="general_win('<TMPL_VAR NAME=HTMLPATH>/v3/gov_sample_reports.html','HelpWindow',790,600,1,1,1,1,1,0);void(0);">See report type examples</a>
    </div>
</div>
</TMPL_IF>
...
<div id="sample_reports" style="display:none;">
    <div class="researchDisplay showMore">
        <a href="javascript:void(0);" title="Sample Reports" onclick="general_win('<TMPL_VAR NAME=HTMLPATH>/v3/gov_hc_pack_sample_reports.html','HelpWindow',790,600,1,1,1,1,1,0);void(0);">See report type examples</a>
    </div>
</div>
</TMPL_IF>
<TMPL_IF CLIA_SEARCH>
