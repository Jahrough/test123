                                        ...
                                        <div class="reportPop">
                                            ...
                                            <div class="reportPopFooter">
                                                <TMPL_IF NAME="DISABLE_SUMMARY_REPORT">
                                                    <input class="report-btn disabled-btn" type="button" value="Report Disabled" onClick="void(0);" disabled>
                                                    <TMPL_ELSE>
                                                        <input name="BUTTON" class="report-btn red-btn" type="button" value="<TMPL_IF REPORT_BUTTON><TMPL_VAR NAME=REPORT_BUTTON><TMPL_ELSE>Request Report</TMPL_IF>" onclick="send_report_selector('REPORT/SUMMARY');" />
                                                </TMPL_IF>
                                            </div>
                                        </div>
                                    ...
                                    <!-- Start Entitlements Report Section -->
                                       ...
                                       <div class="reportPop">
                                           ...
                                           <TMPL_IF DISABLE_ENTITLEMENTS_REPORT>
                                               <input class="report-btn disabled-btn" type="button" value="Report Disabled" onClick="void(0);" disabled>
                                           <TMPL_ELSE>
                                               <input name="BUTTON" class="report-btn red-btn" type="button" value="<TMPL_IF REPORT_BUTTON><TMPL_VAR NAME=REPORT_BUTTON><TMPL_ELSE>Request Report</TMPL_IF>" onclick="send_report_selector('REPORT/ENTITLEM_REPORT');" />
                                           </TMPL_IF>
                                           </div>
                                        </div>
                                  </TMPL_UNLESS>   
                                        ...
                                        <div class="reportPop">
                                            ...
                                            <div class="reportPopFooter">
                                                <TMPL_IF NAME="DISABLE_ASSET_REPORT">
                                                    <input class="report-btn disabled-btn" type="button" value="Report Disabled" onClick="void(0);" disabled>
                                                    <TMPL_ELSE>
                                                        <input name="BUTTON" class="report-btn red-btn" type="button" value="<TMPL_IF REPORT_BUTTON><TMPL_VAR NAME=REPORT_BUTTON><TMPL_ELSE>Request Report</TMPL_IF>" onclick="send_report_selector('REPORT/ASSET');" />
                                                </TMPL_IF>
                                            </div>
                                        </div>
                                        ...
                                        <div class="reportPop">
                                            ...
                                            <div class="reportPopFooter">
                                                <TMPL_IF NAME="DISABLE_PEOPLE_FINDER_REPORT">
                                                    <input type="button" class="report-btn disabled-btn" value="Report Disabled" onClick="void(0);" disabled>
                                                    <TMPL_ELSE>
                                                        <input name="BUTTON" class="report-btn red-btn" type="button" value="<TMPL_IF REPORT_BUTTON><TMPL_VAR NAME=REPORT_BUTTON><TMPL_ELSE>Request Report</TMPL_IF>" onclick="send_report_selector('REPORT/SHORT_PHONE_REPORT');" />
                                                </TMPL_IF>
                                            </div>
                                        </div>
                                </TMPL_UNLESS>
                                        ...
                                        <div class="reportPop">
                                            ...
                                            <div class="reportPopFooter">
                                                <TMPL_IF NAME="DISABLE_COMP_REPORT">
                                                    <input class="report-btn disabled-btn" type="button" value="Report Disabled" onClick="void(0);" disabled>
                                                    <TMPL_ELSE>
                                                        <input name="BUTTON" class="report-btn red-btn" type="button" value="<TMPL_IF REPORT_BUTTON><TMPL_VAR NAME=REPORT_BUTTON><TMPL_ELSE>Request Report</TMPL_IF>" onclick="send_report_selector('REPORT/SHORT_REPORT');" />
                                                </TMPL_IF>
                                            </div>
                                        </div>
