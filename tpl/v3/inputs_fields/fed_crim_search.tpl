        ...
        <div>
            ...
            <input type="text" class="w150px" id="CASE_NAME" name="CASE_NAME" value="<TMPL_VAR NAME=CASE_NAME>" placeholder="Case Name">
        ...
        <div>
            <input type="text" class="w240px" id="ADDITIONAL_TERMS" name="ADDITIONAL_TERMS" value="<TMPL_VAR NAME=ADDITIONAL_TERMS>" placeholder="Additional Terms">
        </div>
		<div></div>
        <div>
