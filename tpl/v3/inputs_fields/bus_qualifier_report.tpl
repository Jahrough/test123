<!-- begin bus_qualifier_search.tpl -->
<div>
    <input type="text" class="w329px" id="COMPANY_NAME" name="COMPANY_NAME" value="<TMPL_VAR NAME=COMPANY_NAME>" placeholder="Company Name">
</div>
<div>
    <input type="text" class="w150px" id="PHONE"  value="<TMPL_VAR NAME=PHONE>" name="PHONE" placeholder="Phone Number">
    <input type="text" class="w150px" id="FEIN" name="FEIN" value="<TMPL_VAR NAME=FEIN>" placeholder="TIN">
</div>
<div>
