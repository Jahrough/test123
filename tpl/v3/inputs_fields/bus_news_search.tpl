<!-- begin inputs_fields/bus_news_search.tpl -->
<div>
...
<div>
    <input type="text" class="w222px" id="WORDS" name="WORDS" value="<TMPL_VAR NAME=WORDS>" maxlength=255 placeholder="Words in the Article">
    <input type="text" class="w150px" id="NOWORDS" name="NOWORDS" value="<TMPL_VAR NAME=NOWORDS>" maxlength=255 placeholder="Without Words">
</div>

<div>
    <span class="font-Arial12" style="margin-right:15px;"><b>Source:</b></span><br/>
</div>
<div>
...
<div>
    <span class="font-Arial12" style="margin-right:15px;"><b>Date:</b></span><br/>
</div>
...
<div class="verticalRadioGroupRow">
    <div class="checkboxAndText">
        ...
        <span class="font-Arial12">
            <input type=text id="NDATE_BEGIN" name="NDATE_BEGIN" size="10" value="<TMPL_VAR NAME=NDATE_BEGIN>" maxlength=30 placeholder="From">
            <input type=text id="NDATE_END" name="NDATE_END" size="10" value="<TMPL_VAR NAME=NDATE_END>" maxlength=30 placeholder="To">
        </span>
    </div>
</div>
<div>
    <span class="font-Arial12">
        <b style="margin-left:35px;float:left;">(mm/dd/yyyy) OR (mm/yyyy) OR (yyyy)</b>
    </span>
</div>
<!-- end inputs_fields/bus_news_search.tpl -->
