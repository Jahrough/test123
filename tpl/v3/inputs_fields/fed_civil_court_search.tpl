        ...
        <div>
            <input type="text" class="w150px" id="CASE_NUMBER" name="CASE_NUMBER" value="<TMPL_VAR NAME=CASE_NUMBER>" maxlength=255 placeholder="Case Number"/>
            <input type="text" class="w150px" id="CASE_NAME" name="CASE_NAME" value="<TMPL_VAR NAME=CASE_NAME>" maxlength=255 placeholder="Case Name"/>
