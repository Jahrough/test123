<!-- BEGIN v3 hea/manage_account_disable_searches.tpl -->
        ...
        <TMPL_IF SHOW_MANAGE_SM_MONITOR>
	      ...
	      <TMPL_ELSE>
	        <TR>
                ...
                <table border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td><INPUT TYPE=RADIO NAME="DISABLE_SM_MONITOR"<TMPL_UNLESS IM_ON_COMP_SEC> onclick="show_hide_sm_monitor_block(1);"</TMPL_UNLESS> VALUE='0' <TMPL_UNLESS NAME=DISABLE_SM_MONITOR>CHECKED</TMPL_UNLESS>></td>
                    <td class="unifont1">Yes&nbsp;&nbsp;&nbsp;</td>
                    <td><INPUT TYPE=RADIO NAME="DISABLE_SM_MONITOR"<TMPL_UNLESS IM_ON_COMP_SEC> onclick="show_hide_sm_monitor_block(0);"</TMPL_UNLESS> VALUE='1' <TMPL_IF NAME=DISABLE_SM_MONITOR>CHECKED</TMPL_IF>></td>
                    <td class="unifont1">No</td>
                  </tr>
                </table>
                </td>
