<div id="accountMenu">
	...
	<TMPL_IF NAME="SHOW_DEMO_ENV">
	  <li><a href="javascript:open_demo_env('<TMPL_VAR NAME="SHOW_DEMO_ENV">');">Enter Demo Environment</a></li>
	<TMPL_ELSE>
	<TMPL_IF NAME="IS_DEMO_ENV">
	  <li><a href="javascript:void(0);" style="color: #ed1c24;">Currently Demo Environment</a></li>
	</TMPL_IF>
	</TMPL_IF>
