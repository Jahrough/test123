...
<div id="search_decisions" style="display:none;">
  ...
  <TMPL_UNLESS HIDE_MV>
    ...
    <li id="<TMPL_VAR NAME=IDX_MV>"><a href="javascript:srchDecisionEvt('WS_SEARCH/SEARCH_DL_REG');">Motor Vehicles</a></li>
	</TMPL_UNLESS>
  </TMPL_UNLESS>
  ...
  <TMPL_IF SHOW_RT_PHONE>
    ...
    <TMPL_UNLESS DISABLE_DA_WIRELESS>
            <li id="<TMPL_VAR NAME=IDX_DA_WIRELESS>"><a href="javascript:srchDecisionEvt('SEARCH/SEARCH_DA_WIRELESS');">Phones Plus</a></li>
    </TMPL_UNLESS>
    ...
    <li id="<TMPL_VAR NAME=IDX_CIVIL_COURT>"><a href="javascript:setaction('<TMPL_VAR NAME=ACTION_MISC>');setevent('SEARCH/SEARCH_CIVIL_COURT');">Civil Courts</a></li>
	</TMPL_UNLESS>
    ...
    <TMPL_UNLESS DISABLE_WHOIS>
      ...
      <TMPL_UNLESS MVSEARCH_CAP_MET>
        <li id="<TMPL_VAR NAME=IDX_RT_MVR>"><a href="javascript:srchDecisionEvt('SEARCH/SEARCH_RT_MVR');">Real-Time Motor Vehicle Registrations</a></li>
      </TMPL_UNLESS>
      </TMPL_UNLESS>
      </TMPL_UNLESS>
...
<div id="sample_reports" style="display:none;">
    <div class="researchDisplay showMore">
        <a href="javascript:void(0);" onclick="general_win('<TMPL_VAR NAME=HTMLPATH>/v3/hea_sample_reports.html','HelpWindow',790,600,1,1,1,1,1,0);void(0);">See report type examples</a>
    </div>
</div>
</TMPL_IF>
...
<div id="sample_reports" style="display:none;">
    <div class="researchDisplay showMore">
        <a href="javascript:void(0);" onclick="general_win('<TMPL_VAR NAME=HTMLPATH>/v3/hea_hc_pack_sample_reports.html','HelpWindow',790,600,1,1,1,1,1,0);void(0);">See report type examples</a>
    </div>
</div>
</TMPL_IF>
<TMPL_IF CLIA_SEARCH>
