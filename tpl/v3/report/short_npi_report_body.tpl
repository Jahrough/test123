<!-- Begin short_npi_report_body.tpl-->
        ...
        <table class="options-table">
            ...
            <tr>
                <td>
                    <table>
                        <tr>
                            <td class="checkbox-td"><input type="checkbox" name="npi-prompt" id="npi-prompt" value="1" <TMPL_VAR NAME=npi-prompt> ></td>
                            <td class="checkbox-label-td"><label for="npi-prompt">&nbsp;Prompt me for these options for each report.</label> </td>
                        </tr>
                        <tr>
                            <TMPL_IF NAME="ENABLE_SAVE_REPORT">
                                <TMPL_IF NAME="REPORT_MANAGER_OFF">
                                    ...
                                    <td align="left" class="disabled_medblack"><label for="save-report">&nbsp;(Saving Reports currently not available).</label></td>
                                <TMPL_ELSE>
