...
<div class="txtWrapper" style="min-width:780px;">
    <div id="txtCon">
        ...
        <table border="1" align="center" cellpadding="0" cellspacing="0" width="100%"  bgcolor="#ffffff">
          <tr>
            <td>
            <div align="center">
            <table width="100%" border="0" cellpadding="2" cellspacing="0">
              <tr class="medblack">
                ...
                <td valign="top" align="left"><div class="lnin-header">Mapped Address</div></td>
                <td valign="top" align="left">&nbsp;</td>
              </tr>
              <tr class="medblack">
                <td valign="top" align="left">&nbsp;</td>
        ...
        <div id="map_canvas" style="height:400px; width:600px;border:solid black 2px;">
        ...
        <table border="0" align="center" cellpadding="0" cellspacing="0" width="100%"  bgcolor="#ffffff">
          <tr>
            ...
            <table width="100%" border="0" cellpadding="2" cellspacing="0">
              <tr class="medblack">
                <td valign="top" align="left">&nbsp;</td>
            <td valign="top" align="left"><b><a style="color:#007DCF;" href="javascript:toggle_disclaimer('1');"><TMPL_IF FCOL>Collection Solutions<TMPL_ELSE>Accurint</TMPL_IF> Mapping Service End User License Agreement</a></b></td>
                <td valign="top" align="left">&nbsp;</td>
              </tr>
