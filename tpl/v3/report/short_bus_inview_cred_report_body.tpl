...
<div>
    <legend class="myaccountlabel">&nbsp;<TMPL_UNLESS HIDE_PRICES>Base Report Price:&nbsp;&nbsp;<TMPL_IF NAME="REPORT_PRICE"><TMPL_VAR NAME="REPORT_PRICE"><TMPL_ELSE>$15.00</TMPL_IF><TMPL_ELSE>Base Report Features:</TMPL_UNLESS></legend>
</div>
