...
<div class="section-row child-divs-right">
    <div>
        <a class="btn darkgrey-btn" href="javascript:show_batch_event('PHONESPLUSBATCH/SHOW_SUMMARY')">
            Back
        </a>
        <a class="btn red-btn" href="javascript:send_please_wait_event('PHONESPLUSBATCH/CONFIRM_ADMIN')">
            Authorize Order
        </a>
    </div>
</div>
