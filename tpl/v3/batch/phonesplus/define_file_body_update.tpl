<!-- BEGIN define_file_body_update.tpl -->
  ...
  <tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td class="unifont1" valign="middle" align="left" nowrap="nowrap"><label for="sel_tmpl">If using previously saved template batch format, please select from drop down and click on Next.</label>&nbsp;</td>
      </tr>
      <tr>
      <td align="center">
       ...
       <option value="">Select Template from list... </option>
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;<input class="btn darkgrey-btn" name="BATCH_DELETE_TEMPLATE" type="button" value="Delete Selected Template" onClick="if(!validate()) return false;show_batch_event('PHONESPLUSBATCH/DELETE_TEMPLATE');">
      </td>
      </tr>
    </table>
    </td>
  ...
  <tr>
	...
	<TMPL_IF IS_BATCH_ADMIN>
        ...
        <span id="col_<TMPL_VAR FIELD_NUMBER>"><center>Column&nbsp;<TMPL_VAR FIELD_NUMBER></center></span>
