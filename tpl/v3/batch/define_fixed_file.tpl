<!-- BEGIN batch/define_fixed_file.tpl -->
...
<div class="section-row child-divs-right">
    <div>
        <a class="btn darkgrey-btn" href="javascript:send_event('BATCH/FILE_SELECT')">
            Back
        </a>
        <a class="btn red-btn" href="javascript:send_event('BATCH/SAVE_DEFINE_FILE')" onClick="<TMPL_IF SHOW_BATCH_UPDATE>set_fixed_width_field_length();</TMPL_IF>if(!validate_selects() || !check_length()){return false;}">
            Next
        </a>
    </div>
</div>
