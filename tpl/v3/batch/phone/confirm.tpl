...
<table border="0" width="100%">
  ...
  <tr>
    <td valign="bottom" align="center">
        ...
        <a class="btn red-btn" href="javascript:printit()">Print Order Confirmation</a>
        &nbsp;&nbsp;&nbsp;
        <a class="btn red-btn" href="javascript:send_please_wait_event('<TMPL_UNLESS SHOW_BATCH_UPDATE>PHONEBATCH/START_BATCH<TMPL_ELSE>BATCH/SERVICES</TMPL_UNLESS>');">Run Another Batch</a>
     </td>
  </tr>
  </TMPL_IF>
</table>
