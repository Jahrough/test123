<!-- BEGIN define_file_body.tpl -->
  ...
  <tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td class="unifont1" valign="middle" align="center"><label for="frst_row">First row contains the name of the fields:&nbsp;</label></td>
	<td class="unifont1" valign="middle" align="center"><input id="frst_row" type=checkbox name="FIRST_ROW_NAMES" value="1"<TMPL_IF CHECKED_FIRST_ROW_NAMES> CHECKED</TMPL_IF> OnClick="checkbox_set();">&nbsp;&nbsp;&nbsp;&nbsp;</td>
  ...
  <tr>
    ...
    <table border="1" cellpadding="0" cellspacing="0">
      <tr height="30">
        <th id="col_fld_ord" class="unifont2">&nbsp;<b>Field Order</b>&nbsp;</th>
        <th id="col_fld_val" class="unifont2">&nbsp;<b>Field Value</b>&nbsp;</th>
        <th id="col_fld_lbl" class="unifont2">&nbsp;<b>Field Label</b>&nbsp;</th>
      </tr>
      <TMPL_IF DELIM_LOOP>
      <TMPL_LOOP DELIM_LOOP>
      <tr>
        <td headers="col_fld_ord" class="unifont1">&nbsp;<TMPL_VAR FIELD_NUMBER></td>
        
	<td headers="col_fld_val" class="unifont1" class="nsinputs">&nbsp;
	<TMPL_IF FIELD_LOOP>
      <label for="FLD_<TMPL_VAR INDEX>" style="display: none">Dummy</label>
	  <INPUT TYPE=TEXT ID="FLD_<TMPL_VAR INDEX>" NAME="FIELD_<TMPL_VAR FIELD_NUMBER>" VALUE="<TMPL_VAR FIRST_VALUE ESCAPE=HTML>" SIZE=40 readonly tabindex="-1">
	...
	<td headers="col_fld_lbl" class="unifont1">
        <label for="FLD_NAM_<TMPL_VAR FIELD_NUMBER>" style="display: none">Dommy</label>
        <select id="FLD_NAM_<TMPL_VAR FIELD_NUMBER>" name="FIELD_NAME_<TMPL_VAR FIELD_NUMBER>" onBlur="check_fields(this,FIELD_<TMPL_VAR FIELD_NUMBER>);">
        <option value=""></option>
