<!-- BEGIN define_file_body_update.tpl -->
  ...
  <tr>
	...
	<td class="unifont1" valign="middle" align="center"><input aria-labelledby="is_frst_hdr" id="frst_row_nm" type=checkbox name="FIRST_ROW_NAMES" value="1"<TMPL_IF CHECKED_FIRST_ROW_NAMES> CHECKED</TMPL_IF> OnClick="checkbox_set();">&nbsp;<b><label for="frst_row_nm">YES</label></b></td>
	<!--
  ...
  <tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td class="unifont1" valign="middle" align="left" nowrap="nowrap"><label for="tpl_drp_bx">If using previously saved template batch format, please select from drop down and click on Next.&nbsp;</label></td>
      </tr>
      <tr>
      <td align="center">
       <select id="tpl_drp_bx" name="TEMPLATE_DROP_BOX" onChange="if(!template_select_confirm(this.selectedIndex)) return false;reset_labels_template();">
       <option value="">Select Template from list... </option>
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;<input class="btn darkgrey-btn" name="BATCH_DELETE_TEMPLATE" type="button" value="Delete Selected Template" onClick="if(!validate()) return false;show_batch_event('ADVANCEDPERSONBATCH/DELETE_TEMPLATE');">
      </td>
      </tr>
    </table>
    </td>
  ...
  <tr>
    ...
    <table border="1" cellpadding="0" cellspacing="0">
      ...
      <TMPL_LOOP DELIM_LOOP>
        <td class="unifont1">
        <select id="fld_nm_<TMPL_VAR FIELD_NUMBER>" name="FIELD_NAME_<TMPL_VAR FIELD_NUMBER>" onBlur="check_fields(this,FIELD_1[<TMPL_VAR FIELD_NUMBER> - 1]);">
	...
	<TMPL_IF IS_BATCH_ADMIN>
        ...
        <center><label for="fld_nm_<TMPL_VAR FIELD_NUMBER>">Column&nbsp;<TMPL_VAR FIELD_NUMBER></label></center>

	<TMPL_IF FIELD_LOOP>
	  <TMPL_LOOP FIELD_LOOP>
             <label for="FLD_<TMPL_VAR INDEX>" style="display: none">Dummy</label> 
             <INPUT TYPE=TEXT ID="FLD_<TMPL_VAR INDEX>" NAME="FIELD_<TMPL_VAR INDEX>" VALUE="<TMPL_VAR FIELD_VAL ESCAPE=HTML>" SIZE="25" readonly tabindex="-1">
  ...
  <tr>
    ...
    <td class="unifont1"><label for="tpl_nam">Save this Template File Layout (Optional):</label>&nbsp;<INPUT id="tpl_nam" TYPE=TEXT NAME="TEMPLATE_NAME" VALUE="" SIZE="35" maxlength="40"></td>
  </tr>
  <tr>
