    ...
    <table border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td class="unifont1" valign="middle" align="center">
            <a class="btn darkgrey-btn" href="javascript:send_event('PHONEBATCH/ADD_FIELD_FIRST')">Add First</a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
        <td class="unifont1" valign="middle" align="center">
            <a class="btn darkgrey-btn" href="javascript:send_event('PHONEBATCH/ADD_FIELD_AFTER')">Add After</a>&nbsp;&nbsp;&nbsp;&nbsp;</td>
        <td class="unifont1" valign="middle" align="center">
            <a class="btn darkgrey-btn" href="javascript:send_event('PHONEBATCH/DELETE_FIELD')">Delete Field</a></td>
      </tr>
    </table>
    </td>
  </tr>
