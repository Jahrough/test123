<!-- BEGIN define_fixed_file_body_update.tpl -->
  ...
  <tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0">
      ...
      <tr>
      <td align="left">
       <!-- <select name="TEMPLATE_DROP_BOX" onChange="reset_labels_template();send_event('ADVANCEDPERSONBATCH/DEFINE_FILE');""> -->
       <select name="TEMPLATE_DROP_BOX" onChange="if(!template_select_confirm(this.selectedIndex)) return false;send_event('ADVANCEDPERSONBATCH/LOAD_TEMPLATE');"">
       <option value="0">Select Template from list... </option>
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;<input class="btn darkgrey-btn" name="BATCH_DELETE_TEMPLATE" type="button" value="Delete Selected Template" onClick="if(!template_delete_confirm())return false;send_event('ADVANCEDPERSONBATCH/DELETE_TEMPLATE');">
      </td>
      </tr>
    </table>
    </td>
  ...
  <tr>
	...
	<td class="unifont1" valign="top" align="left">&nbsp;&nbsp;&nbsp;<input
        ...
        NAME=FIELD_NUM>)">&nbsp;&nbsp;&nbsp;</td>
	<td class="unifont1" valign="top" align="left"><input
        name="BATCH_REMOVE_FIELD" type="button" value="Remove" onClick="if(!validate()){return false;}set_fixed_width_field_num(<TMPL_VAR NAME=FIELD_NUM>);send_event('ADVANCEDPERSONBATCH/DELETE_FIELD');"></td>
      </tr>
    </TMPL_LOOP>
    </table>
    </td>
...
<INPUT TYPE=HIDDEN NAME="ROW_LENGTH" VALUE="<TMPL_VAR ROW_LENGTH>">
  ...
  <tr>
	...
	<td class="unifont1" valign="middle" align="center"><a class="btn darkgrey-btn" href="javascript:send_event('BATCH<TMPL_IF EDIT_FTP>FTP</TMPL_IF>/DELETE_FIELD')">Delete Field</a></td>
        <TMPL_ELSE>
	<td class="unifont1" valign="top" align="left"><input name="BATCH_ADD_FIELD_AFTER" type="button" value="Add New Field" onClick="if(!validate()){return false;}set_fixed_width_field_num(<TMPL_VAR FIELD_COUNT>);send_event('ADVANCEDPERSONBATCH/ADD_FIELD_AFTER');"><i>&nbsp;&nbsp;Use <b>Add New Field</b> until your file is completely mapped. Unmapped fields will be ignored.</i></td>
        </TMPL_UNLESS>
      </tr>
    </table>
    </td>
