<!DOCTYPE html>
<!-- BEGIN v3/batch/advancedperson/define_file.tpl -->
...
<div class="section-row child-divs-right">
    <div>
        <a class="btn darkgrey-btn" href="javascript:show_batch_event('ADVANCEDPERSONBATCH/FILE_SELECT')">
            Back
        </a>
        ...
        <TMPL_ELSE>
            <a class="btn red-btn" href="javascript:show_batch_event('ADVANCEDPERSONBATCH/SAVE_DEFINE_FILE')" onClick="if(!validate_selects()){return false;}">
                Next
            </a>
        </TMPL_IF>
    </div>
...
<!-- END v3/batch/advancedperson/define_file.tpl -->
