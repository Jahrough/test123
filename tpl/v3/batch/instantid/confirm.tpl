<!DOCTYPE html>
<!-- BEGIN v3/batch/instantid/confirm.tpl -->
...
<table border="0" width="600">
  ...
  <tr>
    <td valign="bottom" align="center">
        ...
        &nbsp;&nbsp;&nbsp;
        <a class="btn darkgrey-btn" href="javascript:printit()">
            Print
        </a>
        &nbsp;&nbsp;&nbsp;
        <a class="btn darkgrey-btn" class="btn darkgrey-btn" href="javascript:send_event('BATCH/BUS_START_BATCH');">
            Run Another Batch
        </a>
    </td>
  </tr>
...
<!-- END v3/batch/instantid/confirm.tpl -->
