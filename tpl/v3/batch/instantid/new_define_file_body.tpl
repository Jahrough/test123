...
<TMPL_ELSE>&nbsp;</TMPL_IF>
				...
				<td class="unifont1" class="nsinputs"><select name="FIELD_NAME_<TMPL_VAR FIELD_NUMBER>" onBlur="check_fields(this,FIELD_<TMPL_VAR FIELD_NUMBER>);">
				<option value=""></option>
...
<TMPL_ELSE>
                ...
                <tr>
                  ...
                  <table border="1" cellpadding="0" cellspacing="0">
                    ...
                    <TMPL_LOOP DELIM_LOOP>
                      <td class="unifont1">
                      <select name="FIELD_NAME_<TMPL_VAR FIELD_NUMBER>" onBlur="check_fields(this,FIELD_NAME_<TMPL_VAR FIELD_NUMBER>.selectedIndex);" STYLE="width: 277px;">
                      <TMPL_IF IS_BIID_BATCH>
		      ...
		      <option value="dob"<TMPL_IF DOB_C> SELECTED</TMPL_IF>>Authorized Representative DOB</option>
                      ...
                      <TMPL_IF FIELD_LOOP>
                        <TMPL_LOOP FIELD_LOOP>
                           <INPUT TYPE=TEXT NAME="FIELD_<TMPL_VAR INDEX>" VALUE="<TMPL_VAR FIELD_VAL ESCAPE=HTML>" SIZE="42" readonly tabindex="-1">
                           <INPUT TYPE=HIDDEN NAME="FIELD_VALUE_<TMPL_VAR INDEX>" VALUE="<TMPL_VAR FIELD_VAL ESCAPE=HTML>">
                        </TMPL_LOOP>
                      <TMPL_ELSE>&nbsp;</TMPL_IF>
                      </td>
