<!DOCTYPE html>
<!-- BEGIN instantid/file_select_update.tpl -->
<TMPL_INCLUDE NAME="batch_head.tpl">

<INPUT TYPE=HIDDEN NAME=EVENT VALUE="INSTANTIDBATCH/SAVE_FILE_SELECT">
...
<table border="0" width="600">
  <tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="600">
      ...
      <tr>
        <td class="wizardcounter" align="left"><TMPL_INCLUDE NAME="../shared/help_contact_line.tpl"></td>
      </tr>
      </TMPL_IF>
    </table>
    </td>
...
<TMPL_IF IS_BUS_BATCH>
    <td valign="bottom" align="right" width="550"><a class="btn darkgrey-btn" href="javascript:send_event('BATCH/BUS_START_BATCH')">Back</a>&nbsp;&nbsp;&nbsp;<a href="javascript:send_please_wait_event('PHONEBATCH/SAVE_FILE')" onClick="if(!validate()){return false;}">Next</a></td>
<TMPL_ELSE>
    <td valign="bottom" align="right" width="550"><a class="btn darkgrey-btn" href="javascript:send_event('<TMPL_UNLESS SHOW_BATCH_UPDATE>BATCH/START_BATCH<TMPL_ELSE>INSTANTIDBATCH/CHOOSE_PROCESS</TMPL_UNLESS>')">Back</a>&nbsp;&nbsp;&nbsp;<a href="javascript:send_please_wait_event('INSTANTIDBATCH/SAVE_FILE_SELECT')" onClick="if(!validate()){return false;}">Next</a></td>
</TMPL_IF>
  </tr>
...
<!-- END instantid/file_select_update.tpl -->
