...
<table>
    <tr>
        ...
        <table>
            <tr>
                ...
                <table>
                    <tr>
                        <td class="batchpricingheader" colspan="2">&nbsp;<b><span id="sel_inst">Select the InstantID process you want your data to utilize:</span><BR></b></td>
                    </tr>
                    <tr>
                        <td class="unifont1">
                        <blockquote>
                        <table>
                            <tr>
                                <td class="unifont1">
                                <input aria-labelledby="sel_inst" id="con_ins" type=radio name=PROCESS_TYPE onclick="javascript:enable_red_flags(1);" value="1"<TMPL_IF 1_CHECKED> CHECKED</TMPL_IF>><label for="con_ins">1&nbsp;-&nbsp;Consumer InstantID</label>&nbsp;
                                </td>
                                <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                            </tr>
                            <tr>
                                <td class="unifont1">
                                <input aria-labelledby="sel_inst" id="con_bus" type=radio name=PROCESS_TYPE onclick="javascript:enable_red_flags(2);" value="2"<TMPL_IF 2_CHECKED> CHECKED</TMPL_IF>><label for="con_bus">2&nbsp;-&nbsp;Business InstantID</label>&nbsp;
                                </td>
                                <td>&nbsp;&nbsp;&nbsp;&nbsp;</td>
                            </tr>
                        </table>
            ...
            <tr>
                ...
                <table>
                    <tr>
                        <td class="batchpricingheader" colspan="2">&nbsp;<b><label for="threshold">Global Watchlist Threshold Level:</label><BR></b></td>
                    </tr>
                    <tr>
                        <td class="smallfont1" colspan="2">
                        <blockquote>
        <TMPL_IF THRESHOLD_LOOP>
                        <select id="threshold" name="THRESHOLD" style="width:300px;" width="10" height="3" size="1">
    ...
    height="16" alt="More information"></a>
                        </blockquote>
                        </td>
                    </tr>
                </table>
            ...
            <tr>
                <td>
                  <table>
                      <tr>
                        <td class="batchpricingheader" colspan="2">&nbsp;<b><span id="frd_def">Fraud Defender:</span><br></b></td>
                    </tr>
                    <tr>
                        <td class="unifont1">
                        <blockquote>
                        <table>
                            <tr>
                                <td class="unifont1">
                                <input aria-labelledby="frd_def" id="us_frd_def" type="checkbox" name="USE_FRAUD_DEFENDER" value="1"<TMPL_IF USE_FRAUD_DEFENDER> CHECKED</TMPL_IF>><label for="us_frd_def"> Use Fraud Defender</label><super>&reg;</super></td>
                            </tr>
                        </table>
                          </blockquote>
                        </td>
                      ...
                      <tr>
                        <td class="batchpricingheader" colspan="2">&nbsp;<b><span id="red_flg">Red Flags Rule Report:</span><br></b></td>
                    </tr>
                    <tr>
                        <td class="unifont1">
                        <blockquote>
                        <table>
                            <tr>
                                <td class="unifont1">
                                <input aria-labelledby="red_flg" id="us_red_flg" type="checkbox" name="USE_RED_FLAGS_RULE" value="1"<TMPL_IF USE_RED_FLAGS_RULE> CHECKED</TMPL_IF>><label for="us_red_flg"> Use Red Flags Rule</label></td>
                            </tr>
                        </table>
                          </blockquote>
                        </td>
