<!-- BEGIN instantid/define_file_body_update.tpl -->
    <tr>
        <td align="left">
            <table>
                <tr>
                    ...
                    <TMPL_UNLESS SHOW_BATCH_UPDATE>
				        <td class="unifont1" valign="middle" align="center">&nbsp;<a class="myaccLnk" href="javascript:reset_labels();">RESET SELECTIONS</a></td>
                    </TMPL_UNLESS>
                </tr>
    ...
    <tr>
        <td align="left">
            <table>
                <tr>
                    <td class="unifont1" style="padding-bottom: 6px;"><label for="id_tmpl_drp_bx">If using previously saved template batch format, please select from drop down and click on Next.</label>&nbsp;</td>
                </tr>
                <tr>
                    <td>
                    ...
                    <TMPL_IF DELIM_LOOP>
                        <tr>
                            <TMPL_LOOP DELIM_LOOP>
                                <td>
                                    <select aria-labelledby="col_<TMPL_VAR FIELD_NUMBER>" style="margin-bottom:6px;width:200px;" name="FIELD_NAME_<TMPL_VAR FIELD_NUMBER>" onBlur="check_fields(this,FIELD_NAME_<TMPL_VAR FIELD_NUMBER>.selectedIndex);" STYLE="width: 277px;">
    ...
    <tr>
        <td class="unifont1">
            <label for="tmpl_nam">Save this Template File Layout (Optional):</label>&nbsp;<INPUT id="tmpl_nam" TYPE=TEXT NAME="TEMPLATE_NAME" VALUE="" SIZE="35" maxlength="40">
        </td>
    </tr>
    <tr>
...
<!-- END instantid/define_file_body_update.tpl -->
