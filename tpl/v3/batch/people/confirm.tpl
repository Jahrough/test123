...
<table border="0" width="600">
  ...
  <tr>
    <td valign="bottom" align="center">
		...
		<a class="btn red-btn" href="javascript:send_please_wait_event('<tmpl_var name=BATCH_CONTROLLER>/BUS_START_BATCH');">Run Another Batch</a>
    </td>
  </tr>
  <TMPL_ELSE>
  <tr>
    <td valign="bottom" align="center">
        <a class="btn darkgrey-btn" href="javascript:window.close()">Close</a>&nbsp;&nbsp;&nbsp;
		<a class="btn red-btn" href="javascript:printit()">Print Order Confirmation</a>&nbsp;&nbsp;&nbsp;
		<a class="btn red-btn" href="javascript:send_please_wait_event('<tmpl_var name=BATCH_CONTROLLER>/<TMPL_UNLESS SHOW_BATCH_UPDATE>START_BATCH<TMPL_ELSE>SERVICES</TMPL_UNLESS>');">Run Another Batch</a>
    </td>
  </tr>
  </TMPL_IF>
</table>
