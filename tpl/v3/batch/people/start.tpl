...
<div class="fieldset-title">Welcome to the Accurint<small><sup>&reg;</sup></small> <TMPL_IF IS_BUS_BATCH>Business <TMPL_ELSE><TMPL_IF IS_BUS_BATCH_DUEX>Business </TMPL_IF></TMPL_IF>Batch Submission Wizard</div>
...
<div class="section-row child-divs-right">
    <div>
        <a class="btn darkgrey-btn" href="javascript:send_event('BATCH/SAVE_START')" onClick="if(!validate()){return false;}">
            Next
        </a>
    </div>
</div>
