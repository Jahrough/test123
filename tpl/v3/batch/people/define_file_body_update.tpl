<!-- BEGIN define_file_body_update.tpl -->
  ...
  <tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td class="unifont1" valign="middle" align="left" nowrap="nowrap"><span id="hdr_txt">Is your first record a title row or does it contain the name of the corresponding fields?</span>&nbsp;</td>
	<td class="unifont1" valign="middle" align="center"><input aria-labelledby="hdr_txt" id="hrd_yes" type=checkbox name="FIRST_ROW_NAMES" value="1"<TMPL_IF CHECKED_FIRST_ROW_NAMES> CHECKED</TMPL_IF> OnClick="checkbox_set();">&nbsp;<b><label for="hrd_yes">YES</label></b></td>
	<!--
  ...
  <tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0">
      <tr>
        <td class="unifont1" style="padding-bottom: 6px;"><label for="sel_tmpl">If using previously saved template batch format, please select from drop down and click on Next.</label>&nbsp;</td>
      </tr>
      <tr>
      <td>
       <select id="sel_tmpl" name="TEMPLATE_DROP_BOX" onChange="if(!template_select_confirm(this.selectedIndex)) return false;reset_labels_template();">
                    ...
                    <tr>
                        <TMPL_LOOP DELIM_LOOP>
                            <td>
                                ...
                                <select aria-labelledby="col_<TMPL_VAR FIELD_NUMBER>" id="fld_nam_<TMPL_VAR FIELD_NUMBER>" style="margin-bottom:6px;" name="FIELD_NAME_<TMPL_VAR FIELD_NUMBER>" onBlur="check_fields(this,FIELD_1[<TMPL_VAR FIELD_NUMBER> - 1]);">
                                ...
                                <br>
                                <span id="col_<TMPL_VAR FIELD_NUMBER>" style="padding-left:2px;">Column&nbsp;<TMPL_VAR FIELD_NUMBER></span>
                                <br>
                                <TMPL_IF FIELD_LOOP>
