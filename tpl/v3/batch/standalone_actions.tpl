...
<table border="0" cellpadding="0" cellspacing="0" align="right">
  <tr>
  <td align="right" class="unifont1"><b><label for="otr_rpt">Other Reports:</label>&nbsp;&nbsp;</b></td>
  <td align="right" class="unifont1">
    <select class="unifont1" id="otr_rpt" name="NEW_ACTION" onChange="setupEvent(document.forms[0].NEW_ACTION.value);">
