<!DOCTYPE html>
<!-- BEGIN v3/batch/rtmvr/edit_xml.tpl -->
...
<div class="section-row child-divs-right">
    <div>
        <a class="btn darkgrey-btn" href="javascript:send_event('RTMVRBATCH/SHOW_SUMMARY')">
            Back
        </a>
        <a class="btn red-btn" href="javascript:send_please_wait_event('RTMVRBATCH/CONFIRM_ADMIN')">
            Next
        </a>
    </div>
</div>
...
<!-- END v3/batch/rtmvr/edit_xml.tpl -->
