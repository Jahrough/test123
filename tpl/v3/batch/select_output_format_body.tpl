<!-- BEGIN select_output_format_body.tpl -->
  ...
  <tr>
    <td class="unifont1">
	  ...
	  <tr>
    	<td class="unifont1">
      	<input id="com_del" type=radio name=OUTPUT_TYPE value="1"<TMPL_IF 1_CHECKED> CHECKED</TMPL_IF>><label for="com_del">1&nbsp;-&nbsp;Comma Delimited Output File</label>&nbsp;
		</td>
		<td>
			&nbsp;&nbsp;&nbsp;&nbsp;<a class="btn red-btn" href="<TMPL_VAR NAME=HLPPATH>/batch/comma_test_appended.csv" target="_batch_sample">View Sample</a> 
		</td>
	  </tr>
    <!--
	  <tr>
    ...
    -->
	  ...
	  <tr>
    	<td class="unifont1">
      <input id="pre_out_la" type=radio name=OUTPUT_TYPE value="5"<TMPL_IF 5_CHECKED> CHECKED</TMPL_IF>><label for="pre_out_la">5&nbsp;-&nbsp;Predefined Output Layout</label>&nbsp;
		</td>
		<td>
			&nbsp;&nbsp;&nbsp;&nbsp;
