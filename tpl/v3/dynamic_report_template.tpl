	<div class="templateData">
        ...
        <div style="color:#2777A1;font-weight:bold;margin:5px 0 5px 0;"><label for="REPORT_ORDER_PREFS">User-Defined Templates</label> </div>
                <tmpl_if name=saved_pref_count>
                     <select name="REPORT_ORDER_PREFS" id="REPORT_ORDER_PREFS" style="width:180px;" onchange="show_template(this.value);">
        ...
        <div id="tpl_btns" style="display:none;">
            ...
            <table width="90%" class="smallfont1">
                <thead style="display: none">
                  <tr>
                    <th aiea-label="Details">&nbsp;</th>
                  </tr>
                </thead>
                <tr><td align="center"><span class="templateText green" id="tpl_text"> </span></td></tr>
                <tr><td align="center"><label for="template_name" style="display: none">Name of template:</label><input style="width:120px;" type="text" id="template_name" size="20"></input></td></tr>
                <tr><td align="center">
