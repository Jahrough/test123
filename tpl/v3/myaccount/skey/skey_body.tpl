<!-- begin skey_login_body -->
<table border="0" cellpadding="5" cellspacing="0" width="803">
  <tr>
    <td valign="top" align="center"><img src="<TMPL_VAR NAME=IMGPATH>/<TMPL_VAR NAME=SITEKEY_IMG>.jpg" border="0" width="247" height="221"><br>
    <table border="0" cellpadding="2" cellspacing="0">
      <tr>
        <td nowrap class="unifont1" align="center"><b>The phrase you have assigned to your sitekey image is : </b></td>
      </tr>
      <tr>
        <td nowrap class="unifont2" align="center"><font color="#ed1c24"><b><TMPL_VAR NAME="SITEKEY_PHRASE"></b></font></td>
      </tr>
    </table>
    </td>
    <td>
    ...
    <TMPL_IF ENABLE_LOGIN_TOKEN>
      <tr>
        <td colspan="2" class="unifont2"><b>To ensure the security of your account<br>If you recognize the sitekey image please enter the following to log in:</b></td>
      </tr>
      <tr>
