...
<div class="section-row child-divs-center">
    <div>
        <input name="BUTTON" class="btn grey-btn" type="button" value="<< Back" onClick="send_event('OTP/SHOW_EDIT_SMS_OTP_FORM');">
        <input name="BUTTON" class="btn red-btn" type="button" value="Update" onClick="return do_edit();  ">
    </div>
</div>
<!-- end manage_account_show_edit_otp_token_form.tpl-->
