<!-- BEGIN manage_account_email_domain.tpl -->
	...
	<fieldset>
		<div align="left" class="unifont1bold" style="height:25px;">
			<legend>Email
			Domains
			</legend>
		</div>
		<div id="wrapper">
			...
			<table width="100%" cellspacing="0" cellpadding="0" border="0" id="emailDomainHC" >
				...
				<tr>
					<td class="pd15" style="vertical-align:top;">
						<p class="medblack"><label for="newDomain"><strong>Add Domain</strong></label></p>
						<input name="newDomain" value="" id="newDomain" onKeyPress="return disableEnterKey(event)">
					</td>
					<td class="pd15" style="vertical-align:top;">
						<p class="medblack"><label for="curDomain"><strong>Current Domain(s):</strong></label></p>
			...
			<TMPL_IF ENABLE_HC_EMAIL_DOMAIN><script>document.getElementById("emailDomainHC").style.display="block";</script><noscript>Your browser does not support JavaScript!</noscript></TMPL_IF>
