...
<table border="0" cellpadding="0" cellspacing="4" width="97%" bgcolor="#FFFFFF" class="sortable" id="">
  ...
  <tr>
    <td width="20%" class="nsinputs" align="right"><label for="ord_status">Order Status</label></td>
    <td width="10%" align="left">
      <select id="ord_status" name="POLICE_RECORDS_ORDER_STATUS">
  ...
  <tr>
    <td width="20%" class="nsinputs" align="right"><label for="clm_num">Claim #</label></td>
    <td width="10%" align="left">
      <input id="clm_num" type="text" name="CLAIM_NUMBER" value="<TMPL_VAR NAME=CLAIM_NUMBER>">
    </td>
    <td width="10%" align="right"></td>
    <td width="10%" align="right"></td>
    <td width="10%" align="right"></td>
  ...
  <tr>
    <td width="10%" class="nsinputs" align="right"><label for="frst_nam">First Name</label></td>
    <td width="10%" align="left">
      <input id="frst_nam" type="text" name="FIRST_NAME" value="<TMPL_VAR NAME=FIRST_NAME>">
    </td>
    <td width="10%" class="nsinputs" align="right"><label for="lst_nam">Last Name</label></td>
    <td>
      <input id="lst_nam" type="text" name="LAST_NAME" value="<TMPL_VAR NAME=LAST_NAME>">
    </td>
    <td width="10%" class="nsinputs" align="left">
      <label for="prty">Party</label>&nbsp;<select id="prty" name="PARTY">
...
<table border="1" cellpadding="0" cellspacing="1" width="756" bgcolor="#d0ccd0" class="sortable" id="order_list">
  <TMPL_IF NAME="ENABLE_SAVE_REPORT">
    ...
    <tr height="20">
      <th id="col_status" class="unifont1" style="text-align:center; vertical-align: middle;" width="7%" nowrap="nowrap">Status</th>
      <th id="col_ord_num" class="unifont1" style="text-align:center; vertical-align: middle;" width="7%" nowrap="nowrap">Order #</th>
      <th id="col_adj" class="unifont1" style="text-align:center; vertical-align: middle;" width="8%" nowrap="nowrap">Adjuster</th>
      <th id="col_clm_num" class="unifont1" style="text-align:center; vertical-align: middle;" width="7%" nowrap="nowrap">Claim #</th>
      <th id="col_rpt_typ" class="unifont1" style="text-align:center; vertical-align: middle;" width="10%" nowrap="nowrap">Report Type</th>
      <th id="col_prty_1" class="unifont1" style="text-align:center; vertical-align: middle;" width="7%" nowrap="nowrap">Party 1</th>
      <th id="col_ord_dtl" class="unifont1" style="text-align:center; vertical-align: middle;" width="10%" nowrap="nowrap">Order Detail</th>
    </tr>
	...
	<tr height="20" bgcolor="#ffffff">
	  <td headers="col_status" class="smallfont1" nowrap align="center" valign="middle"><TMPL_IF NAME="REPORT_STATUS_MESSAGE"><TMPL_VAR NAME="REPORT_STATUS_MESSAGE"><TMPL_ELSE>N/A&nbsp;</TMPL_IF></td>
	  <td headers="col_ord_num" class="smallfont1" nowrap align="center" valign="middle">
	  ...
	  <td headers="col_adj" class="smallfont1" nowrap align="center" valign="middle"><TMPL_IF NAME="REPORT_LOGIN_ID"><TMPL_VAR NAME="REPORT_LOGIN_ID"><TMPL_ELSE>N/A&nbsp;</TMPL_IF></td>
	  <td headers="col_clm_num" class="smallfont1" nowrap align="center" valign="middle"><TMPL_IF NAME="REPORT_CLAIM_NUMBER"><TMPL_VAR NAME="REPORT_CLAIM_NUMBER"><TMPL_ELSE>N/A&nbsp;</TMPL_IF></td>
          </td>
	  <td headers="col_rpt_typ" class="smallfont1" nowrap align="center" valign="middle"><TMPL_IF NAME="REPORT_TYPE"><TMPL_VAR NAME="REPORT_TYPE"><TMPL_ELSE>N/A&nbsp;</TMPL_IF></td>
	  <td headers="col_prty_1" class="smallfont1" nowrap align="center" valign="middle"><TMPL_IF NAME="REPORT_PARTY_1"><TMPL_VAR NAME="REPORT_PARTY_1"><TMPL_ELSE>N/A&nbsp;</TMPL_IF></td>
	  <td headers="col_ord_dtl" class="smallfont1" nowrap align="left" valign="middle">&nbsp;<a href="javascript:police_records_order('MYACCOUNT/SHOW_POLICE_RECORDS_ORDER_DETAIL','<TMPL_VAR NAME=REPORT_ORDER_ID>');"> 
