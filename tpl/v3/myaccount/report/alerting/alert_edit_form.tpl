...
<td class="unifont1" width="20%">
<select name="ALERT_LENGTH" error_message="Please select a duration for the alert" lnpattern="generic" optional="1">
...
<td class="formfld" width="30">
    <input onclick="displayDatePicker('ALERT_EXPIRATION_DATE');" type="text" name="ALERT_EXPIRATION_DATE" value="<TMPL_VAR NAME="ALERT_EXPIRATION_DATE">" size="8" maxlength="10" error_message="Please select an end date for the alert" lnpattern="date" optional="1" /> 
</td>
<td class="formfld">
...
<TMPL_IF NAME="EDIT_ALERT">
    ...
    <a class="btn red-btn" href="javascript:save_edit_alert('<TMPL_VAR NAME="SUBSCRIPTION_ID">')">
       Save Alert
    </a>
    </td>
    </tr>
...
<TMPL_ELSE>
    ...
    <tr>
      <td colspan="2" align="right">
        ...
        <input class="btn darkgrey-btn" name="CANCEL_ALERT" value="Cancel" onclick="if(confirm('Are you sure you want to Cancel?')) window.close();" type="button">
      </td>
    </tr>
    </table>
</TMPL_IF>
