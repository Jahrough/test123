<!-- begin leg/lite/search_inputs_tabs.tpl -->
...
<TMPL_IF NAME=IM_ON_ASSET_SEARCH>
	...
	<TMPL_UNLESS DELETE_MV><td align="center" nowrap <TMPL_IF NAME=DL_REG_SEARCH>class="activetabs"</TMPL_IF>><a class="searchtabs" href="javascript:send_event('WS_SEARCH/SHOW_DL_REG')">Motor Vehicles</a></td></TMPL_UNLESS>
        <TMPL_IF NAME="LEG">
...
<TMPL_IF NAME=IM_ON_SEARCH>
  ...
  <TMPL_IF COL>
        <td width="10%" class="utiltabs" align="center" nowrap><a class="searchtabs" href="javascript:void(0);" onClick="show_post_popup('LOGIN/SHOW_POPUP','HTMLCoverage','420','350',0,0,0,0,0,0,'','coverage/all50_coverage');">Coverage</a></td>
        <td width="6%" class="utiltabs" align="center" nowrap><a class="searchtabs"  href="javascript:void(0);" onClick="general_win('<TMPL_VAR NAME=HLPPATH>/<TMPL_VAR NAME=APPLICATION_TYPE>/advanced_person_help.html','HelpWindow',680,490,1,1,1,1,1,0);void(0);">Help</a></td>
  <TMPL_ELSE>
  <TMPL_IF LE>
        <td width="10%" class="utiltabs" align="center" nowrap><a class="searchtabs" href="javascript:void(0);" onClick="show_post_popup('LOGIN/SHOW_POPUP','HTMLCoverage','420','350',0,0,0,0,0,0,'','coverage/all50_coverage');">Coverage</a></td>
        <td width="6%" class="utiltabs" align="center" nowrap><a class="searchtabs"  href="javascript:void(0);" onClick="general_win('<TMPL_VAR NAME=HLPPATH>/<TMPL_VAR NAME=APPLICATION_TYPE>/advanced_person_help.html','HelpWindow',680,490,1,1,1,1,1,0);void(0);">Help</a></td>
...
<TMPL_IF NAME=CRIM_SEARCH>
        <td width="10%" class="utiltabs" align="center" nowrap><a class="searchtabs" href="javascript:void(0);" onClick="show_post_popup('LOGIN/SHOW_POPUP','HTMLCoverage','600','450',1,1,1,1,1,0,'','coverage/crim_coverage');">Coverage</a></td>
  ...
  <TMPL_UNLESS DELETE_BUS_CREDIT><td align="center" nowrap <TMPL_IF NAME=BUS_CREDIT_SEARCH>class="activetabs"</TMPL_IF>><a class="searchtabs" href="javascript:send_event('SEARCH/SHOW_BUS_CREDIT')">Business<br>Credit</a></td></TMPL_UNLESS>
	...
	<TMPL_IF LEG>
      ...
      <TMPL_IF NAME=PROVIDER_SEARCH>
        ...
        <td width="6%" class="utiltabs" align="center" nowrap><a class="searchtabs" href="javascript:void(0);" onClick="general_win('<TMPL_VAR NAME=HLPPATH>/leg/provider_search_help.html','HelpWindow',680,490,1,1,1,1,1,0);void(0);">Help</a></td>
      </TMPL_IF>
      <TMPL_IF NAME=SANCTION_SEARCH>
        <td width="10%" class="utiltabs" align="center" nowrap><a class="searchtabs" href="javascript:void(0);" onClick="show_post_popup('LOGIN/SHOW_POPUP','CoverageWindow',420,350,0,0,0,0,0,0,'','coverage/all50_coverage');">Coverage</a></td>
        <td width="6%" class="utiltabs" align="center" nowrap><a class="searchtabs" href="javascript:void(0);" onClick="general_win('<TMPL_VAR NAME=HLPPATH>/leg/provider_sanction_search_help.html','HelpWindow',680,490,1,1,1,1,1,0);void(0);">Help</a></td>
      </TMPL_IF>
...
<TMPL_IF NAME=IM_ON_HEALTH_CARE_SEARCH>
    <TMPL_UNLESS DELETE_MEDICAL_LICENSE><td align="center" nowrap <TMPL_IF NAME=MEDICAL_LICENSE_SEARCH>class="activetabs"</TMPL_IF>><a class="searchtabs" href="javascript:send_event('SEARCH/SHOW_MEDICAL_LICENSE')">Medical<br>Licenses</a></td></TMPL_UNLESS>
    <TMPL_UNLESS DELETE_MP_PROVIDERS><td align="center" nowrap <TMPL_IF NAME=MP_PROVIDERS_SEARCH>class="activetabs"</TMPL_IF>><a class="searchtabs" href="javascript:send_event('SEARCH/SHOW_MP_PROVIDERS')">Medical Professions<br>Providers</a></td></TMPL_UNLESS>
    <TMPL_UNLESS DELETE_MP_SPECIALITIES><td align="center" nowrap <TMPL_IF NAME=MP_SPECIALITIES_SEARCH>class="activetabs"</TMPL_IF>><a class="searchtabs" href="javascript:send_event('SEARCH/SHOW_MP_SPECIALITIES')">Medical Professions<br>Specialties</a></td></TMPL_UNLESS>
    <TMPL_UNLESS DELETE_MP_HOSPITALS><td align="center" nowrap <TMPL_IF NAME=MP_HOSPITALS_SEARCH>class="activetabs"</TMPL_IF>><a class="searchtabs" href="javascript:send_event('SEARCH/SHOW_MP_HOSPITALS')">Medical Professions<br>Hospitals</a></td></TMPL_UNLESS>
    <TMPL_UNLESS DELETE_PROVIDER><td align="center" nowrap <TMPL_IF NAME=PROVIDER_SEARCH>class="activetabs"</TMPL_IF>><a class="searchtabs" href="javascript:send_event('SEARCH/SHOW_PROVIDER')">Provider</a></td></TMPL_UNLESS>

    <TMPL_UNLESS DELETE_SANCTION><td align="center" nowrap <TMPL_IF NAME=SANCTION_SEARCH>class="activetabs"</TMPL_IF>><a class="searchtabs" href="javascript:send_event('SEARCH/SHOW_SANCTION')">Provider Sanction</a></td></TMPL_UNLESS>

<TMPL_IF NAME="MEDICAL_LICENSE_SEARCH">
    <td width="10%" class="utiltabs" align="center" nowrap><a class="searchtabs" href="javascript:void(0);" onClick="show_post_popup('LOGIN/SHOW_POPUP','HTMLCoverage','420','350',0,0,0,0,0,0,'','coverage/medical_license_coverage');">Coverage</a></td>
    <td width="6%" class="utiltabs" align="center" nowrap><a class="searchtabs" href="javascript:void(0);" onClick="general_win('<TMPL_VAR NAME=HLPPATH>/nationwide_directory_medical_licenses_help.html','HelpWindow',680,490,1,1,1,1,1,0);void(0);">Help</a></td>
</TMPL_IF>
<TMPL_IF NAME="MP_PROVIDERS_SEARCH">
    <td width="10%" class="utiltabs" align="center" nowrap><a class="searchtabs" href="javascript:void(0);" onClick="show_post_popup('LOGIN/SHOW_POPUP','HTMLCoverage','420','350',0,0,0,0,0,0,'','coverage/mp_providers_coverage');">Coverage</a></td>
    <td width="6%" class="utiltabs" align="center" nowrap><a class="searchtabs" href="javascript:void(0);" onClick="general_win('<TMPL_VAR NAME=HLPPATH>/medical_professions_providers_help.html','HelpWindow',680,490,1,1,1,1,1,0);void(0);">Help</a></td>
</TMPL_IF>
<TMPL_IF NAME="MP_SPECIALITIES_SEARCH">
    <td width="10%" class="utiltabs" align="center" nowrap><a class="searchtabs" href="javascript:void(0);" onClick="show_post_popup('LOGIN/SHOW_POPUP','HTMLCoverage','420','350',0,0,0,0,0,0,'','coverage/mp_specialites_coverage');">Coverage</a></td>
    <td width="6%" class="utiltabs" align="center" nowrap><a class="searchtabs" href="javascript:void(0);" onClick="general_win('<TMPL_VAR NAME=HLPPATH>/medical_professions_specialties_help.html','HelpWindow',680,490,1,1,1,1,1,0);void(0);">Help</a></td>
</TMPL_IF>
<TMPL_IF NAME="MP_HOSPITALS_SEARCH">
    <td width="10%" class="utiltabs" align="center" nowrap><a class="searchtabs" href="javascript:void(0);" onClick="show_post_popup('LOGIN/SHOW_POPUP','HTMLCoverage','420','350',0,0,0,0,0,0,'','coverage/mp_hospitals_coverage');">Coverage</a></td>
    <td width="6%" class="utiltabs" align="center" nowrap><a class="searchtabs" href="javascript:void(0);" onClick="general_win('<TMPL_VAR NAME=HLPPATH>/medical_professions_hospitals_help.html','HelpWindow',680,490,1,1,1,1,1,0);void(0);">Help</a></td>
</TMPL_IF>
<TMPL_IF NAME=PROVIDER_SEARCH>
<td width="10%" class="utiltabs" align="center" nowrap><a class="searchtabs" href="javascript:void(0);" onClick="show_post_popup('LOGIN/SHOW_POPUP','HTMLCoverage','420','350',0,0,0,0,0,0,'','coverage/all50_coverage');">Coverage</a></td>
...
<TMPL_IF NAME=IM_ON_ANTOOLS_SEARCH>
	<TMPL_UNLESS DELETE_RATE_EVASION><td align="center" nowrap  <TMPL_IF NAME=RATE_EVASION_REPORT>class="activetabs"</TMPL_IF>><a class="searchtabs" href="javascript:send_event('SEARCH/SHOW_RATE_EVASION')">Rate Evasion Evaluation</a></td></TMPL_UNLESS>
</TMPL_IF>
...
<!-- end leg/lite/search_inputs_tabs.tpl -->
