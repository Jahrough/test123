             ...
             <li><font color="red"><b>NEW!&nbsp;</b></font>Choose your Accurint theme.<br/>After clicking Save Preferences the new theme will be applied the next time you run a search.</li>
                        ...
                        <tr>
                                <td align="center" width="25%"><img width="100" height="100" border="0" src="<TMPL_VAR NAME=IMGPATH>/v2/ac_th5.gif"></td>
                        ...
                        <tr class="smalllabel">
                                <td align="center"><label for="ut3"><b>Red n' Gray (Default)</b></label></td>
                                <td align="center"><label for="ut2"><b>Red n' Tan<b></label></td>
                                <td align="center"><label for="ut1"><b>Blue Accurint</b></label></td>
