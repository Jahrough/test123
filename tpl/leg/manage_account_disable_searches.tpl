<!-- BEGIN leg/manage_account_disable_searches.tpl -->
	 ...
	 <fieldset>
	  ...
	  <TMPL_IF COMPANY_DISABLE_D_AND_B>
	     ...
	     <TMPL_UNLESS RESTRICT_LNLP_CONTENT>
	      ...
	      <!-- Added two new searches from health to Legal in the Businesses-->
	 ...
	 <fieldset>
	  <span class="unifont1bold"><legend>Assets</legend></span>
	      ...
	      <TMPL_ELSE>
              <TR>
                <td width="75%" nowrap class="unifont1" align="left">&nbsp;Motor Vehicle Gateway:&nbsp;&nbsp;</TD>
                <td width="25%" align="left">
                <table border="0" cellpadding="0" cellspacing="0">
                  <tr>
...
<!-- END leg/manage_account_disable_searches.tpl -->
