<!-- begin leg/leg_search_inputs_tabs.tpl -->
...
<TMPL_IF NAME=IM_ON_ASSET_SEARCH>
  ...
  <TMPL_ELSE>
    <td><a href="javascript:send_event('SEARCH/SHOW_CARFAX');" onMouseOver="carfax.src='<TMPL_VAR NAME=IMGPATH>/carfax_tab_over.gif';showalt('CARFAX','carfax');" onMouseOut="carfax.src='<TMPL_VAR NAME=IMGPATH>/carfax_tab_on.gif';return nd();"><img width="52" height="46" border="0" name="carfax" src="<TMPL_VAR NAME=IMGPATH>/carfax_tab_on.gif" id="carfax"></a></td>
  </TMPL_IF>
  </TMPL_UNLESS>
...
<!-- end leg/leg_search_inputs_tabs.tpl -->
