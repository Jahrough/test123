...
<TMPL_UNLESS DA_ONLY>
  ...
  <fieldset>
    ...
    <td class="unifont1">No</td>
          ...
          <TMPL_IF COMPANY_DISABLE_LINKED_COMP_REPORT>
          <input type="hidden" name="DISABLE_LINKED_COMP_REPORT" value="<TMPL_IF DISABLE_LINKED_REPORT>1<TMPL_ELSE>0</TMPL_IF>"/>
          <TMPL_ELSE>
            <TR>
              <td width="75%" nowrap class="unifont1" align="left">Linked Comprehensive Report:</TD>
              <td width="25%" align="left">
              <table border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td><INPUT TYPE=RADIO NAME="DISABLE_LINKED_COMP_REPORT" VALUE='0' <TMPL_UNLESS NAME=DISABLE_LINKED_COMP_REPORT>CHECKED</TMPL_UNLESS>></td>
                  <td class="unifont1">Yes&nbsp;&nbsp;&nbsp;</td>
                  <td><INPUT TYPE=RADIO NAME="DISABLE_LINKED_COMP_REPORT" VALUE='1' <TMPL_IF NAME=DISABLE_LINKED_COMP_REPORT>CHECKED</TMPL_IF>></td>
                  <td class="unifont1">No</td>
                </tr>
              </table>
              </td>
	  ...
	  <TMPL_ELSE>
	  <TR>
	    <td width="75%" nowrap class="unifont1" align="left">Results Found Report:&nbsp;&nbsp;</TD>
	    <td width="25%" align="left">
	    <table border="0" cellpadding="0" cellspacing="0">
	      <tr>
  ...
  <fieldset>
    ...
    <td class="unifont1">No</td>
	  ...
	  <TMPL_UNLESS COMPANY_DISABLE_FCRA_PRE_LIT_REPORT>
	  <TR>
	    <td class="unifont1" align="left" width="75%" nowrap="">Pre-Litigation Reports:</TD>
	    <td align="left" width="25%">
	    <table border="0" cellpadding="0" cellspacing="0">
	      <tr>
		<td><INPUT TYPE=RADIO NAME=DISABLE_FCRA_PRE_LIT_REPORT VALUE='0' <TMPL_UNLESS NAME=DISABLE_FCRA_PRE_LIT_REPORT>CHECKED</TMPL_UNLESS>></td>
		<td class="unifont1">Yes&nbsp;&nbsp;&nbsp;</td>
		<td><INPUT TYPE=RADIO NAME=DISABLE_FCRA_PRE_LIT_REPORT VALUE='1' <TMPL_IF NAME=DISABLE_FCRA_PRE_LIT_REPORT>CHECKED</TMPL_IF>></td>
		<td class="unifont1">No</td>
	      </tr>
	    </table>
	    </td>
