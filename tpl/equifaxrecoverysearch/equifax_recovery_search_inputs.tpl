<!-- begin equifaxrecoverysearch/equifax_recovery_search_inputs.tpl -->
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tr>
	  <TMPL_INCLUDE NAME="equifaxrecoverysearch/search_inputs_tabs.tpl">
  </tr>
</table>
</td>
</tr>
  ...
  <tr>
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="632">
      <tr height="25">
		...
		<TMPL_INCLUDE NAME="equifaxrecoverysearch/search_inputs_fields.tpl">
	  <TMPL_INCLUDE NAME="equifaxrecoverysearch/search_inputs_results_type.tpl">
      <tr height="10">
      ...
      <tr>
		...
		<TMPL_IF LEXIS_SEARCH>
		   <TMPL_INCLUDE NAME="equifaxrecoverysearch/lexisnexis_cpr.tpl">
		</TMPL_IF>
    <TMPL_UNLESS HIDE_DISCLAIMER>
		<TMPL_INCLUDE NAME="equifaxrecoverysearch/search_inputs_disclaimer.tpl">
    </TMPL_UNLESS>
		<TMPL_IF DL_REG_SEARCH>
			<TMPL_INCLUDE NAME="equifaxrecoverysearch/search_inputs_disclaimer2.tpl">
		</TMPL_IF>
    ...
    <TMPL_IF NAME=D_AND_B_SEARCH>
      <TMPL_INCLUDE NAME="equifaxrecoverysearch/dnb_terms.tpl">
    </TMPL_IF>
        </table>
        </td>
      </tr>
	...
	<table border="0" cellpadding="2" cellspacing="0">
	  <TMPL_INCLUDE NAME="equifaxrecoverysearch/coverage_help.tpl">
	</table>
	</td>
      </tr>
      <tr>
        <td align="center"><TMPL_INCLUDE NAME="equifaxrecoverysearch/search_buttons.tpl"></td>
      </tr>
      <tr height="5">
        <td height="5" class="unifont1"></td>
      </tr>
...
<TMPL_IF INS>
  <TMPL_INCLUDE NAME="equifaxrecoverysearch/search_inputs_dol_date.tpl">
</TMPL_IF>
</TMPL_UNLESS>
<TMPL_IF HEA>
  <TMPL_INCLUDE NAME="equifaxrecoverysearch/search_inputs_dol_date.tpl">
...
<TMPL_UNLESS SSN_ONLY_SEARCH>
      <tr height="5">
        <td class="unifont1" align="center">
          <TMPL_INCLUDE NAME="equifaxrecoverysearch/advanced_insert.tpl">
	</td>
      </tr>
</TMPL_UNLESS>
</TMPL_IF>
...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  <tr>
	...
	<TMPL_INCLUDE NAME="equifaxrecoverysearch/search_messages.tpl">
	</td>
      </tr>
    </table>
    </td>
...
<!-- end equifaxrecoverysearch/equifax_recovery_search_inputs.tpl -->
