		 ...
		 <tr>
			<td colspan="4" align="center" valign="top">
			   ...
			   <TMPL_LOOP NAME="USER_LOOP">
				...
				<td class="unifont1"><a href="javascript:resync_token('OTP/SHOW_RESYNC_OTP_TOKENS_FORM','<TMPL_VAR NAME=LOGINID>','<TMPL_VAR NAME=DETAIL1>')"><TMPL_VAR NAME="DETAIL1"></a></td>
				</tr>
			   </TMPL_LOOP>
		           </table>
			</td>
