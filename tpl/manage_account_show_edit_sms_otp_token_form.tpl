<!-- begin manage_account_show_edit_otp_token_form.tpl -->
...
function do_edit() 
{
    ...
    //df.submit;
    validateSMSOTPRegForm('OTP/DO_EDIT_SMS_OTP_TOKEN_USER');
    //return true;
    }
}
...
<table border="0" cellpadding="0" cellspacing="0" class="myaccountborder" width="880">
  <tr>
     ...
     <span class="successmessage"><TMPL_VAR NAME="MESSAGE">&nbsp;</span>
      ...
      <tr>
        ...
        <td width="10">&nbsp;</td>
          ...
          <tr>
        <td width="10">&nbsp;</td>
            <td class="unifont1" align="left" width="20%">Current SMS Phone #:</td>
    ...
    <tr>
      <tr>
        <td align="right"><input name="BUTTON" class="rb_otp_small" type="button" value="<< Back" onMouseDown="flip_style(this,'rbd_otp_small');" onClick="send_event('OTP/SHOW_EDIT_SMS_OTP_FORM');disable_buttons('BUTTON');" onMouseOut="flip_style(this,'rb_otp_small');"></td>
        <td align="left"><input name="BUTTON" class="rb_otp_small" type="button" value="Update" onMouseDown="flip_style(this,'rbd_otp_small');" onClick="return do_edit(); disable_buttons('BUTTON'); " onMouseOut="flip_style(this,'rb_otp_small');"></td>
      </tr>
        </table>
    <br><br><br>
    </td>
...
<!-- manage_account_show_edit_otp_token_form.tpl-->
