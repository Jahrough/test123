...
<table border="0" width="600">
  ...
  <tr>
    <td class="batchbanner" align="center"><br><b>Thank you for using RES</b></td>
  </tr>
  <tr>
  ...
  <TMPL_UNLESS FTP>
  <tr>
    <td class="unifont2" align="center"><br>Results will be eMailed to: <b><TMPL_VAR BATCH_EMAIL_TO></b><br><br></td>
  </tr>
  </TMPL_UNLESS>
</table>
...
None of the uses apply
      ...
      -->
      <tr>
        <td class="unifont1" align="left" valign="top" colspan="2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Report Options Selected:</td>
      </tr>
      <tr>
        <td align="center" valign="top" colspan="2">
        <table border="0" cellpadding="3" cellspacing="0" width="400">
          <tr>
            <td class="unifont1"><b><TMPL_VAR REPORT_OPTIONS></b></td>
          </tr>
        </table>
        </td>
      </tr>
...
<table border="0" width="600">
  ...
  <tr>
    <td valign="bottom" align="center"><a href="javascript:void(0);" onClick="self.onerror = function() {window.close(); return true;}; if (opener) {if (!opener.closed){opener.focus()}}; window.close();"><img src="<TMPL_VAR NAME=IMGPATH>/BATCH/close.gif" width="87" height="29" border="0"></a>&nbsp;&nbsp;&nbsp;<a href="javascript:printit()"><img src="<TMPL_VAR NAME=IMGPATH>/BATCH/print.gif" width="87" height="29" border="0"></a>&nbsp;&nbsp;&nbsp;<a href="javascript:send_event('RESBATCH/BUS_START_BATCH');"><img src="<TMPL_VAR NAME=IMGPATH>/BATCH/run_another_batch.gif" width="87" height="29" border="0"></a></td>
  </tr>
  <TMPL_ELSE>
  <tr>
    <td valign="bottom" align="center"><a href="javascript:void(0);" onClick="self.onerror = function() {window.close(); return true;}; if (opener) {if (!opener.closed){opener.focus()}}; window.close();"><img src="<TMPL_VAR NAME=IMGPATH>/BATCH/close.gif" width="87" height="29" border="0"></a>&nbsp;&nbsp;&nbsp;<a href="javascript:printit()"><img src="<TMPL_VAR NAME=IMGPATH>/BATCH/print.gif" width="87" height="29" border="0"></a>&nbsp;&nbsp;&nbsp;<a href="javascript:send_event('RESBATCH/START_BATCH');"><img src="<TMPL_VAR NAME=IMGPATH>/BATCH/run_another_batch.gif" width="87" height="29" border="0"></a></td>
  </tr>
  </TMPL_IF>
</table>
