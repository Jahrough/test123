...
<table border="1" cellpadding="0" cellspacing="0" width="500">
  <tr>
    ...
    <table width="500" border="0" cellpadding="2" cellspacing="2">
      ...
      <tr>
        <td valign="top" class="unifont1" NOWRAP>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Notification of Results will be sent to:</td>
...
<!--       </tr>                                                                                                                                                                                           -->
<!--       <tr>                                                                                                                                                                                            -->
<!--         <td valign="top" class="unifont1" NOWRAP>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Approx. Price:</td>                                                                                                    -->
<!--         <td valign="top" class="unifont1">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>$&nbsp;<TMPL_VAR PRICE></b><TMPL_IF NAME="SHOW_MVR_PRICE_WARNING">&nbsp;&nbsp;Excludes any charges for MVRs</TMPL_IF></td> -->
<!--       </tr>                                                                                                                                                                                           -->
      <!--
...
<table border="0" width="600">
  ...
  <tr>
    <td valign="bottom" align="right" width="550"><a href="javascript:send_event('RESBATCH/DPPA')"><img src="<TMPL_VAR NAME=IMGPATH>/BATCH/back.gif" width="87" height="29" border="0"></a>&nbsp;&nbsp;&nbsp;<a href="javascript:send_please_wait_event('RESBATCH/SHOW_SUMMARY_NEXT','<TMPL_VAR NAME=HTMLPATH>/please_wait.html')"><img src="<TMPL_VAR NAME=IMGPATH>/BATCH/autorder.gif" width="87" height="29" border="0"></a></td>
  </tr>
</table>
